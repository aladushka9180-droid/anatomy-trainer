...
const CONTENT_REVIEW = Object.freeze({
  ...
  status: "reviewed",
  reviewKind: "Редакционная сверка по указанным источникам",
  version: "2026.08.29",
  reviewer: "Независимый рецензент не указан",
  reviewerQualification: "Медицинская или преподавательская квалификация не заявлена",
  reviewerDisclosure: "Материалы сверены редакционно по открытым учебным и официальным источникам. Независимая рецензия преподавателем анатомии или медицинским специалистом пока не заявлена — это явно указано, чтобы не создавать ложного впечатления о сертификации.",
  scope: Object.freeze([
    "анатомия",
    "кинезиология",
