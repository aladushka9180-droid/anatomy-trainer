...
assert.match(providerHtml, /theme-catalog\.js\?v=594/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=594/);
assert.match(indexHtml, /theme-catalog\.js\?v=594/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v594`/);
assert.match(sw, /theme-catalog\.js\?v=594/);
...
console.log('client theme selection v594 tests passed');
