...
assert.match(providerHtml, /theme-catalog\.js\?v=784/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=784/);
assert.match(indexHtml, /theme-catalog\.js\?v=784/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v784`/);
assert.match(sw, /theme-catalog\.js\?v=784/);
...
console.log('client theme selection v784 tests passed');
