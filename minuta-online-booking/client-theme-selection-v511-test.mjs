...
assert.match(providerHtml, /theme-catalog\.js\?v=649/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=649/);
assert.match(indexHtml, /theme-catalog\.js\?v=649/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v649`/);
assert.match(sw, /theme-catalog\.js\?v=649/);
...
console.log('client theme selection v649 tests passed');
