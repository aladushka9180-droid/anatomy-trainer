...
assert.match(providerHtml, /theme-catalog\.js\?v=728/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=728/);
assert.match(indexHtml, /theme-catalog\.js\?v=728/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v728`/);
assert.match(sw, /theme-catalog\.js\?v=728/);
...
console.log('client theme selection v728 tests passed');
