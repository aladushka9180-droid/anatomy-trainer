...
assert.match(providerHtml, /theme-catalog\.js\?v=662/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=662/);
assert.match(indexHtml, /theme-catalog\.js\?v=662/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v662`/);
assert.match(sw, /theme-catalog\.js\?v=662/);
...
console.log('client theme selection v662 tests passed');
