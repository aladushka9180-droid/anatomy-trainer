...
assert.match(providerHtml, /theme-catalog\.js\?v=644/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=644/);
assert.match(indexHtml, /theme-catalog\.js\?v=644/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v644`/);
assert.match(sw, /theme-catalog\.js\?v=644/);
...
console.log('client theme selection v644 tests passed');
