...
assert.match(providerHtml, /theme-catalog\.js\?v=526/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=526/);
assert.match(indexHtml, /theme-catalog\.js\?v=526/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v526`/);
assert.match(sw, /theme-catalog\.js\?v=526/);
assert.match(providerHtml, /voice-assistant\.js\?v=526/);

console.log('client theme selection v526 tests passed');
