...
assert.match(providerHtml, /theme-catalog\.js\?v=764/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=764/);
assert.match(indexHtml, /theme-catalog\.js\?v=764/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v764`/);
assert.match(sw, /theme-catalog\.js\?v=764/);
...
console.log('client theme selection v764 tests passed');
