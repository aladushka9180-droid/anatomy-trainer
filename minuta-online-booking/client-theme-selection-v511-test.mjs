...
assert.match(providerHtml, /theme-catalog\.js\?v=568/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=568/);
assert.match(indexHtml, /theme-catalog\.js\?v=568/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v568`/);
assert.match(sw, /theme-catalog\.js\?v=568/);
...
console.log('client theme selection v568 tests passed');
