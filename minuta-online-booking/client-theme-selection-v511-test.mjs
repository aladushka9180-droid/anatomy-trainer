...
assert.match(providerHtml, /theme-catalog\.js\?v=530/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=530/);
assert.match(indexHtml, /theme-catalog\.js\?v=530/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v530`/);
assert.match(sw, /theme-catalog\.js\?v=530/);
assert.match(providerHtml, /voice-assistant\.js\?v=530/);

console.log('client theme selection v530 tests passed');
