...
assert.match(providerHtml, /theme-catalog\.js\?v=521/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=521/);
assert.match(indexHtml, /theme-catalog\.js\?v=521/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v521`/);
assert.match(sw, /theme-catalog\.js\?v=521/);
assert.match(providerHtml, /voice-assistant\.js\?v=521/);

console.log('client theme selection v521 tests passed');
