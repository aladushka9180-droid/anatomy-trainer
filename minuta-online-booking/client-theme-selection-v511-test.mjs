...
assert.match(providerHtml, /theme-catalog\.js\?v=646/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=646/);
assert.match(indexHtml, /theme-catalog\.js\?v=646/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v646`/);
assert.match(sw, /theme-catalog\.js\?v=646/);
...
console.log('client theme selection v646 tests passed');
