...
assert.match(providerHtml, /theme-catalog\.js\?v=520/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=520/);
assert.match(indexHtml, /theme-catalog\.js\?v=520/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v520`/);
assert.match(sw, /theme-catalog\.js\?v=520/);
assert.match(providerHtml, /voice-assistant\.js\?v=520/);

console.log('client theme selection v520 tests passed');
