...
assert.match(providerHtml, /theme-catalog\.js\?v=733/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=733/);
assert.match(indexHtml, /theme-catalog\.js\?v=733/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v733`/);
assert.match(sw, /theme-catalog\.js\?v=733/);
...
console.log('client theme selection v733 tests passed');
