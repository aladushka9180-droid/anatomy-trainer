...
assert.match(providerHtml, /theme-catalog\.js\?v=704/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=704/);
assert.match(indexHtml, /theme-catalog\.js\?v=704/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v704`/);
assert.match(sw, /theme-catalog\.js\?v=704/);
...
console.log('client theme selection v704 tests passed');
