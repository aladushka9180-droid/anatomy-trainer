...
assert.match(providerHtml, /theme-catalog\.js\?v=707/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=707/);
assert.match(indexHtml, /theme-catalog\.js\?v=707/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v707`/);
assert.match(sw, /theme-catalog\.js\?v=707/);
...
console.log('client theme selection v707 tests passed');
