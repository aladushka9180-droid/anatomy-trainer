...
assert.match(providerHtml, /theme-catalog\.js\?v=737/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=737/);
assert.match(indexHtml, /theme-catalog\.js\?v=737/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v737`/);
assert.match(sw, /theme-catalog\.js\?v=737/);
...
console.log('client theme selection v737 tests passed');
