...
assert.match(providerHtml, /theme-catalog\.js\?v=631/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=631/);
assert.match(indexHtml, /theme-catalog\.js\?v=631/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v631`/);
assert.match(sw, /theme-catalog\.js\?v=631/);
...
console.log('client theme selection v631 tests passed');
