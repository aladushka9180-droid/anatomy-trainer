...
assert.match(providerHtml, /theme-catalog\.js\?v=656/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=656/);
assert.match(indexHtml, /theme-catalog\.js\?v=656/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v656`/);
assert.match(sw, /theme-catalog\.js\?v=656/);
...
console.log('client theme selection v656 tests passed');
