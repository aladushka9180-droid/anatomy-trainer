...
assert.match(providerHtml, /theme-catalog\.js\?v=555/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=555/);
assert.match(indexHtml, /theme-catalog\.js\?v=555/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v555`/);
assert.match(sw, /theme-catalog\.js\?v=555/);
assert.match(providerHtml, /voice-assistant\.js\?v=555/);

console.log('client theme selection v555 tests passed');
