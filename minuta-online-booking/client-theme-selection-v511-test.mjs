...
assert.match(providerHtml, /theme-catalog\.js\?v=597/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=597/);
assert.match(indexHtml, /theme-catalog\.js\?v=597/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v597`/);
assert.match(sw, /theme-catalog\.js\?v=597/);
...
console.log('client theme selection v597 tests passed');
