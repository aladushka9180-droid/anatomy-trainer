...
assert.match(providerHtml, /theme-catalog\.js\?v=669/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=669/);
assert.match(indexHtml, /theme-catalog\.js\?v=669/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v669`/);
assert.match(sw, /theme-catalog\.js\?v=669/);
...
console.log('client theme selection v669 tests passed');
