...
assert.match(providerHtml, /theme-catalog\.js\?v=618/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=618/);
assert.match(indexHtml, /theme-catalog\.js\?v=618/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v618`/);
assert.match(sw, /theme-catalog\.js\?v=618/);
...
console.log('client theme selection v618 tests passed');
