...
assert.match(providerHtml, /theme-catalog\.js\?v=609/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=609/);
assert.match(indexHtml, /theme-catalog\.js\?v=609/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v609`/);
assert.match(sw, /theme-catalog\.js\?v=609/);
...
console.log('client theme selection v609 tests passed');
