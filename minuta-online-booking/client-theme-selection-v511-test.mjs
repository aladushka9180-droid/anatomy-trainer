...
assert.match(providerHtml, /theme-catalog\.js\?v=536/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=536/);
assert.match(indexHtml, /theme-catalog\.js\?v=536/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v536`/);
assert.match(sw, /theme-catalog\.js\?v=536/);
assert.match(providerHtml, /voice-assistant\.js\?v=536/);

console.log('client theme selection v536 tests passed');
