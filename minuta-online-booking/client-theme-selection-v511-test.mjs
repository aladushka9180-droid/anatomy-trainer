...
assert.match(providerHtml, /theme-catalog\.js\?v=562/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=562/);
assert.match(indexHtml, /theme-catalog\.js\?v=562/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v562`/);
assert.match(sw, /theme-catalog\.js\?v=562/);
assert.match(providerHtml, /voice-assistant\.js\?v=562/);

console.log('client theme selection v562 tests passed');
