...
assert.match(providerHtml, /theme-catalog\.js\?v=661/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=661/);
assert.match(indexHtml, /theme-catalog\.js\?v=661/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v661`/);
assert.match(sw, /theme-catalog\.js\?v=661/);
...
console.log('client theme selection v661 tests passed');
