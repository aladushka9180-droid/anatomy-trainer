...
assert.match(providerHtml, /theme-catalog\.js\?v=616/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=616/);
assert.match(indexHtml, /theme-catalog\.js\?v=616/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v616`/);
assert.match(sw, /theme-catalog\.js\?v=616/);
...
console.log('client theme selection v616 tests passed');
