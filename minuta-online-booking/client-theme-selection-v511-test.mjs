...
assert.match(providerHtml, /theme-catalog\.js\?v=545/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=545/);
assert.match(indexHtml, /theme-catalog\.js\?v=545/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v545`/);
assert.match(sw, /theme-catalog\.js\?v=545/);
assert.match(providerHtml, /voice-assistant\.js\?v=545/);

console.log('client theme selection v545 tests passed');
