...
assert.match(providerHtml, /theme-catalog\.js\?v=550/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=550/);
assert.match(indexHtml, /theme-catalog\.js\?v=550/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v550`/);
assert.match(sw, /theme-catalog\.js\?v=550/);
assert.match(providerHtml, /voice-assistant\.js\?v=550/);

console.log('client theme selection v550 tests passed');
