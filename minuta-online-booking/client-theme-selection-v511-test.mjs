...
assert.match(providerHtml, /theme-catalog\.js\?v=673/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=673/);
assert.match(indexHtml, /theme-catalog\.js\?v=673/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v673`/);
assert.match(sw, /theme-catalog\.js\?v=673/);
...
console.log('client theme selection v673 tests passed');
