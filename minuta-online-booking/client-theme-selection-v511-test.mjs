...
assert.match(providerHtml, /theme-catalog\.js\?v=516/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=516/);
assert.match(indexHtml, /theme-catalog\.js\?v=516/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v516`/);
assert.match(sw, /theme-catalog\.js\?v=516/);
assert.match(providerHtml, /voice-assistant\.js\?v=516/);

console.log('client theme selection v516 tests passed');
