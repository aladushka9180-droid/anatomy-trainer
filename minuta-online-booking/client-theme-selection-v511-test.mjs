...
assert.match(providerHtml, /theme-catalog\.js\?v=667/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=667/);
assert.match(indexHtml, /theme-catalog\.js\?v=667/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v667`/);
assert.match(sw, /theme-catalog\.js\?v=667/);
...
console.log('client theme selection v667 tests passed');
