...
assert.match(providerHtml, /theme-catalog\.js\?v=566/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=566/);
assert.match(indexHtml, /theme-catalog\.js\?v=566/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v566`/);
assert.match(sw, /theme-catalog\.js\?v=566/);
...
console.log('client theme selection v566 tests passed');
