...
assert.match(providerHtml, /theme-catalog\.js\?v=602/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=602/);
assert.match(indexHtml, /theme-catalog\.js\?v=602/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v602`/);
assert.match(sw, /theme-catalog\.js\?v=602/);
...
console.log('client theme selection v602 tests passed');
