...
assert.match(providerHtml, /theme-catalog\.js\?v=610/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=610/);
assert.match(indexHtml, /theme-catalog\.js\?v=610/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v610`/);
assert.match(sw, /theme-catalog\.js\?v=610/);
...
console.log('client theme selection v610 tests passed');
