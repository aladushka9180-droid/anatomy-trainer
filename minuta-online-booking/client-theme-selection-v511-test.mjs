...
assert.match(providerHtml, /theme-catalog\.js\?v=603/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=603/);
assert.match(indexHtml, /theme-catalog\.js\?v=603/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v603`/);
assert.match(sw, /theme-catalog\.js\?v=603/);
...
console.log('client theme selection v603 tests passed');
