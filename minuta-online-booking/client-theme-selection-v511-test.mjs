...
assert.match(providerHtml, /theme-catalog\.js\?v=729/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=729/);
assert.match(indexHtml, /theme-catalog\.js\?v=729/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v729`/);
assert.match(sw, /theme-catalog\.js\?v=729/);
...
console.log('client theme selection v729 tests passed');
