...
assert.match(providerHtml, /theme-catalog\.js\?v=776/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=776/);
assert.match(indexHtml, /theme-catalog\.js\?v=776/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v776`/);
assert.match(sw, /theme-catalog\.js\?v=776/);
...
console.log('client theme selection v776 tests passed');
