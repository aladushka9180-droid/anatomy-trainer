...
assert.match(providerHtml, /theme-catalog\.js\?v=782/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=782/);
assert.match(indexHtml, /theme-catalog\.js\?v=782/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v782`/);
assert.match(sw, /theme-catalog\.js\?v=782/);
...
console.log('client theme selection v782 tests passed');
