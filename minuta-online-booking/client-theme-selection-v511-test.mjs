...
assert.match(providerHtml, /theme-catalog\.js\?v=653/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=653/);
assert.match(indexHtml, /theme-catalog\.js\?v=653/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v653`/);
assert.match(sw, /theme-catalog\.js\?v=653/);
...
console.log('client theme selection v653 tests passed');
