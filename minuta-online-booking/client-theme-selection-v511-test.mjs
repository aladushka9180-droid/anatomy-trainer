...
assert.match(providerHtml, /theme-catalog\.js\?v=519/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=519/);
assert.match(indexHtml, /theme-catalog\.js\?v=519/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v519`/);
assert.match(sw, /theme-catalog\.js\?v=519/);
assert.match(providerHtml, /voice-assistant\.js\?v=519/);

console.log('client theme selection v519 tests passed');
