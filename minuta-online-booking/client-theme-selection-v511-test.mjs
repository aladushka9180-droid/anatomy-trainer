...
assert.match(providerHtml, /theme-catalog\.js\?v=648/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=648/);
assert.match(indexHtml, /theme-catalog\.js\?v=648/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v648`/);
assert.match(sw, /theme-catalog\.js\?v=648/);
...
console.log('client theme selection v648 tests passed');
