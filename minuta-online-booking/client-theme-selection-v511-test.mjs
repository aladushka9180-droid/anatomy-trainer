...
assert.match(providerHtml, /theme-catalog\.js\?v=571/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=571/);
assert.match(indexHtml, /theme-catalog\.js\?v=571/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v571`/);
assert.match(sw, /theme-catalog\.js\?v=571/);
...
console.log('client theme selection v571 tests passed');
