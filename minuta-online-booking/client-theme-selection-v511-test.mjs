...
assert.match(providerHtml, /theme-catalog\.js\?v=720/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=720/);
assert.match(indexHtml, /theme-catalog\.js\?v=720/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v720`/);
assert.match(sw, /theme-catalog\.js\?v=720/);
...
console.log('client theme selection v720 tests passed');
