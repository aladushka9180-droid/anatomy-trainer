...
assert.match(providerHtml, /theme-catalog\.js\?v=725/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=725/);
assert.match(indexHtml, /theme-catalog\.js\?v=725/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v725`/);
assert.match(sw, /theme-catalog\.js\?v=725/);
...
console.log('client theme selection v725 tests passed');
