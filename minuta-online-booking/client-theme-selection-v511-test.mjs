...
assert.match(providerHtml, /theme-catalog\.js\?v=556/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=556/);
assert.match(indexHtml, /theme-catalog\.js\?v=556/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v556`/);
assert.match(sw, /theme-catalog\.js\?v=556/);
assert.match(providerHtml, /voice-assistant\.js\?v=556/);

console.log('client theme selection v556 tests passed');
