...
assert.match(providerHtml, /theme-catalog\.js\?v=766/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=766/);
assert.match(indexHtml, /theme-catalog\.js\?v=766/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v766`/);
assert.match(sw, /theme-catalog\.js\?v=766/);
...
console.log('client theme selection v766 tests passed');
