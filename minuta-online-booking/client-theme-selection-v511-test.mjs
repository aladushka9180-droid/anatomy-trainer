...
assert.match(providerHtml, /theme-catalog\.js\?v=718/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=718/);
assert.match(indexHtml, /theme-catalog\.js\?v=718/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v718`/);
assert.match(sw, /theme-catalog\.js\?v=718/);
...
console.log('client theme selection v718 tests passed');
