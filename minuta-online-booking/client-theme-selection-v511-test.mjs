...
assert.match(providerHtml, /theme-catalog\.js\?v=763/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=763/);
assert.match(indexHtml, /theme-catalog\.js\?v=763/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v763`/);
assert.match(sw, /theme-catalog\.js\?v=763/);
...
console.log('client theme selection v763 tests passed');
