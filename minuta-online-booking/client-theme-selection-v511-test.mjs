...
assert.match(providerHtml, /theme-catalog\.js\?v=512/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /client-themes\.css\?v=512/);
assert.match(indexHtml, /theme-catalog\.js\?v=512/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v512`/);
assert.match(sw, /theme-catalog\.js\?v=512/);
assert.match(providerHtml, /voice-assistant\.js\?v=512/);

console.log('client theme selection v512 tests passed');
