...
assert.match(providerHtml, /theme-catalog\.js\?v=757/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=757/);
assert.match(indexHtml, /theme-catalog\.js\?v=757/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v757`/);
assert.match(sw, /theme-catalog\.js\?v=757/);
...
console.log('client theme selection v757 tests passed');
