...
assert.match(providerHtml, /theme-catalog\.js\?v=567/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=567/);
assert.match(indexHtml, /theme-catalog\.js\?v=567/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v567`/);
assert.match(sw, /theme-catalog\.js\?v=567/);
...
console.log('client theme selection v567 tests passed');
