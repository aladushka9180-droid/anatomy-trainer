...
assert.match(providerHtml, /theme-catalog\.js\?v=761/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=761/);
assert.match(indexHtml, /theme-catalog\.js\?v=761/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v761`/);
assert.match(sw, /theme-catalog\.js\?v=761/);
...
console.log('client theme selection v761 tests passed');
