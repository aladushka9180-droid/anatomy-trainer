...
assert.match(providerHtml, /theme-catalog\.js\?v=598/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=598/);
assert.match(indexHtml, /theme-catalog\.js\?v=598/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v598`/);
assert.match(sw, /theme-catalog\.js\?v=598/);
...
console.log('client theme selection v598 tests passed');
