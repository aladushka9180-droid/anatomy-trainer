...
assert.match(providerHtml, /theme-catalog\.js\?v=703/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=703/);
assert.match(indexHtml, /theme-catalog\.js\?v=703/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v703`/);
assert.match(sw, /theme-catalog\.js\?v=703/);
...
console.log('client theme selection v703 tests passed');
