...
assert.match(providerHtml, /theme-catalog\.js\?v=635/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=635/);
assert.match(indexHtml, /theme-catalog\.js\?v=635/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v635`/);
assert.match(sw, /theme-catalog\.js\?v=635/);
...
console.log('client theme selection v635 tests passed');
