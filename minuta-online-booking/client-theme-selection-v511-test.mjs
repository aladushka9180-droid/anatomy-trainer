...
assert.match(providerHtml, /theme-catalog\.js\?v=612/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=612/);
assert.match(indexHtml, /theme-catalog\.js\?v=612/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v612`/);
assert.match(sw, /theme-catalog\.js\?v=612/);
...
console.log('client theme selection v612 tests passed');
