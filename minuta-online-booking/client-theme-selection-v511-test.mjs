...
assert.match(providerHtml, /theme-catalog\.js\?v=749/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=749/);
assert.match(indexHtml, /theme-catalog\.js\?v=749/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v749`/);
assert.match(sw, /theme-catalog\.js\?v=749/);
...
console.log('client theme selection v749 tests passed');
