...
assert.match(providerHtml, /theme-catalog\.js\?v=682/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=682/);
assert.match(indexHtml, /theme-catalog\.js\?v=682/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v682`/);
assert.match(sw, /theme-catalog\.js\?v=682/);
...
console.log('client theme selection v682 tests passed');
