...
assert.match(providerHtml, /theme-catalog\.js\?v=641/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=641/);
assert.match(indexHtml, /theme-catalog\.js\?v=641/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v641`/);
assert.match(sw, /theme-catalog\.js\?v=641/);
...
console.log('client theme selection v641 tests passed');
