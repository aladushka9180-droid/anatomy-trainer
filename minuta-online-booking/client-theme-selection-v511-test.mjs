...
assert.match(providerHtml, /theme-catalog\.js\?v=745/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=745/);
assert.match(indexHtml, /theme-catalog\.js\?v=745/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v745`/);
assert.match(sw, /theme-catalog\.js\?v=745/);
...
console.log('client theme selection v745 tests passed');
