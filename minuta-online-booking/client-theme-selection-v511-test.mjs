...
assert.match(providerHtml, /theme-catalog\.js\?v=587/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=587/);
assert.match(indexHtml, /theme-catalog\.js\?v=587/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v587`/);
assert.match(sw, /theme-catalog\.js\?v=587/);
...
console.log('client theme selection v587 tests passed');
