...
assert.match(providerHtml, /theme-catalog\.js\?v=700/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=700/);
assert.match(indexHtml, /theme-catalog\.js\?v=700/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v700`/);
assert.match(sw, /theme-catalog\.js\?v=700/);
...
console.log('client theme selection v700 tests passed');
