...
assert.match(providerHtml, /theme-catalog\.js\?v=595/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=595/);
assert.match(indexHtml, /theme-catalog\.js\?v=595/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v595`/);
assert.match(sw, /theme-catalog\.js\?v=595/);
...
console.log('client theme selection v595 tests passed');
