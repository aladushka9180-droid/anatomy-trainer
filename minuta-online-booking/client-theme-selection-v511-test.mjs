...
assert.match(providerHtml, /theme-catalog\.js\?v=581/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=581/);
assert.match(indexHtml, /theme-catalog\.js\?v=581/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v581`/);
assert.match(sw, /theme-catalog\.js\?v=581/);
...
console.log('client theme selection v581 tests passed');
