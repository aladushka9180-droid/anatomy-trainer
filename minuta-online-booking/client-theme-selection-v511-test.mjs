...
assert.match(providerHtml, /theme-catalog\.js\?v=596/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=596/);
assert.match(indexHtml, /theme-catalog\.js\?v=596/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v596`/);
assert.match(sw, /theme-catalog\.js\?v=596/);
...
console.log('client theme selection v596 tests passed');
