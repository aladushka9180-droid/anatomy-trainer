...
assert.match(providerHtml, /theme-catalog\.js\?v=696/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=696/);
assert.match(indexHtml, /theme-catalog\.js\?v=696/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v696`/);
assert.match(sw, /theme-catalog\.js\?v=696/);
...
console.log('client theme selection v696 tests passed');
