...
assert.match(providerHtml, /theme-catalog\.js\?v=687/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=687/);
assert.match(indexHtml, /theme-catalog\.js\?v=687/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v687`/);
assert.match(sw, /theme-catalog\.js\?v=687/);
...
console.log('client theme selection v687 tests passed');
