...
assert.match(providerHtml, /theme-catalog\.js\?v=642/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=642/);
assert.match(indexHtml, /theme-catalog\.js\?v=642/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v642`/);
assert.match(sw, /theme-catalog\.js\?v=642/);
...
console.log('client theme selection v642 tests passed');
