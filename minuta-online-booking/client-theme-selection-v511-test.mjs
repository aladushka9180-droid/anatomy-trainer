...
assert.match(providerHtml, /theme-catalog\.js\?v=655/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=655/);
assert.match(indexHtml, /theme-catalog\.js\?v=655/);
...
assert.match(sw, /theme-catalog\.js\?v=655/);
