...
assert.match(providerHtml, /theme-catalog\.js\?v=677/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=677/);
assert.match(indexHtml, /theme-catalog\.js\?v=677/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v677`/);
assert.match(sw, /theme-catalog\.js\?v=677/);
...
console.log('client theme selection v677 tests passed');
