...
assert.match(providerHtml, /theme-catalog\.js\?v=659/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=659/);
assert.match(indexHtml, /theme-catalog\.js\?v=659/);
...
assert.match(sw, /theme-catalog\.js\?v=659/);
