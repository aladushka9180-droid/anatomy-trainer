...
assert.match(providerHtml, /theme-catalog\.js\?v=711/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=711/);
assert.match(indexHtml, /theme-catalog\.js\?v=711/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v711`/);
assert.match(sw, /theme-catalog\.js\?v=711/);
...
console.log('client theme selection v711 tests passed');
