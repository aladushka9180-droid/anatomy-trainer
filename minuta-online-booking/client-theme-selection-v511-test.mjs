...
assert.match(providerHtml, /theme-catalog\.js\?v=511/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /client-themes\.css\?v=511/);
assert.match(indexHtml, /theme-catalog\.js\?v=511/);
...
assert.match(sw, /theme-catalog\.js\?v=511/);
assert.match(providerHtml, /voice-assistant\.js\?v=511/);
