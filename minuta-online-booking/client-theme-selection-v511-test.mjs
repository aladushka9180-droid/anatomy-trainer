...
assert.match(providerHtml, /theme-catalog\.js\?v=559/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=559/);
assert.match(indexHtml, /theme-catalog\.js\?v=559/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v559`/);
assert.match(sw, /theme-catalog\.js\?v=559/);
assert.match(providerHtml, /voice-assistant\.js\?v=559/);

console.log('client theme selection v559 tests passed');
