...
assert.match(providerHtml, /theme-catalog\.js\?v=619/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=619/);
assert.match(indexHtml, /theme-catalog\.js\?v=619/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v619`/);
assert.match(sw, /theme-catalog\.js\?v=619/);
...
console.log('client theme selection v619 tests passed');
