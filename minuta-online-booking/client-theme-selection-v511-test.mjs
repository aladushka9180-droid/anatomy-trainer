...
assert.match(providerHtml, /theme-catalog\.js\?v=608/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=608/);
assert.match(indexHtml, /theme-catalog\.js\?v=608/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v608`/);
assert.match(sw, /theme-catalog\.js\?v=608/);
...
console.log('client theme selection v608 tests passed');
