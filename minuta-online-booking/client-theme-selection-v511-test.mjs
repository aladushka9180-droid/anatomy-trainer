...
assert.match(providerHtml, /theme-catalog\.js\?v=665/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=665/);
assert.match(indexHtml, /theme-catalog\.js\?v=665/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v665`/);
assert.match(sw, /theme-catalog\.js\?v=665/);
...
console.log('client theme selection v665 tests passed');
