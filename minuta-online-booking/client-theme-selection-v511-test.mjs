...
assert.match(providerHtml, /theme-catalog\.js\?v=572/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=572/);
assert.match(indexHtml, /theme-catalog\.js\?v=572/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v572`/);
assert.match(sw, /theme-catalog\.js\?v=572/);
...
console.log('client theme selection v572 tests passed');
