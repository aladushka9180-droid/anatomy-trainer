...
assert.match(providerHtml, /theme-catalog\.js\?v=599/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=599/);
assert.match(indexHtml, /theme-catalog\.js\?v=599/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v599`/);
assert.match(sw, /theme-catalog\.js\?v=599/);
...
console.log('client theme selection v599 tests passed');
