...
assert.match(providerHtml, /theme-catalog\.js\?v=647/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=647/);
assert.match(indexHtml, /theme-catalog\.js\?v=647/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v647`/);
assert.match(sw, /theme-catalog\.js\?v=647/);
...
console.log('client theme selection v647 tests passed');
