...
assert.match(providerHtml, /theme-catalog\.js\?v=573/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=573/);
assert.match(indexHtml, /theme-catalog\.js\?v=573/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v573`/);
assert.match(sw, /theme-catalog\.js\?v=573/);
...
console.log('client theme selection v573 tests passed');
