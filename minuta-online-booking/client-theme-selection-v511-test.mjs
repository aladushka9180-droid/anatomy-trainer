...
assert.match(providerHtml, /theme-catalog\.js\?v=675/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=675/);
assert.match(indexHtml, /theme-catalog\.js\?v=675/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v675`/);
assert.match(sw, /theme-catalog\.js\?v=675/);
...
console.log('client theme selection v675 tests passed');
