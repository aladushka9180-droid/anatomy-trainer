...
assert.match(providerHtml, /theme-catalog\.js\?v=705/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=705/);
assert.match(indexHtml, /theme-catalog\.js\?v=705/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v705`/);
assert.match(sw, /theme-catalog\.js\?v=705/);
...
console.log('client theme selection v705 tests passed');
