...
assert.match(providerHtml, /theme-catalog\.js\?v=518/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=518/);
assert.match(indexHtml, /theme-catalog\.js\?v=518/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v518`/);
assert.match(sw, /theme-catalog\.js\?v=518/);
assert.match(providerHtml, /voice-assistant\.js\?v=518/);

console.log('client theme selection v518 tests passed');
