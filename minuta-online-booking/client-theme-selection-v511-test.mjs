...
assert.match(providerHtml, /theme-catalog\.js\?v=560/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=560/);
assert.match(indexHtml, /theme-catalog\.js\?v=560/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v560`/);
assert.match(sw, /theme-catalog\.js\?v=560/);
assert.match(providerHtml, /voice-assistant\.js\?v=560/);

console.log('client theme selection v560 tests passed');
