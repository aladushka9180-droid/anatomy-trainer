...
assert.match(providerHtml, /theme-catalog\.js\?v=553/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=553/);
assert.match(indexHtml, /theme-catalog\.js\?v=553/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v553`/);
assert.match(sw, /theme-catalog\.js\?v=553/);
assert.match(providerHtml, /voice-assistant\.js\?v=553/);

console.log('client theme selection v553 tests passed');
