...
assert.match(providerHtml, /theme-catalog\.js\?v=683/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=683/);
assert.match(indexHtml, /theme-catalog\.js\?v=683/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v683`/);
assert.match(sw, /theme-catalog\.js\?v=683/);
...
console.log('client theme selection v683 tests passed');
