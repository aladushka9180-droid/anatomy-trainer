...
assert.match(providerHtml, /theme-catalog\.js\?v=577/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=577/);
assert.match(indexHtml, /theme-catalog\.js\?v=577/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v577`/);
assert.match(sw, /theme-catalog\.js\?v=577/);
...
console.log('client theme selection v577 tests passed');
