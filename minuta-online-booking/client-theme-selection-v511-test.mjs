...
assert.match(providerHtml, /theme-catalog\.js\?v=591/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=591/);
assert.match(indexHtml, /theme-catalog\.js\?v=591/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v591`/);
assert.match(sw, /theme-catalog\.js\?v=591/);
...
console.log('client theme selection v591 tests passed');
