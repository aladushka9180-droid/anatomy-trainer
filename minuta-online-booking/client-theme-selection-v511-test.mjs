...
assert.match(providerHtml, /theme-catalog\.js\?v=772/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=772/);
assert.match(indexHtml, /theme-catalog\.js\?v=772/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v772`/);
assert.match(sw, /theme-catalog\.js\?v=772/);
...
console.log('client theme selection v772 tests passed');
