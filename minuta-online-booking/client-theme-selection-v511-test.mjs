...
assert.match(providerHtml, /theme-catalog\.js\?v=712/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=712/);
assert.match(indexHtml, /theme-catalog\.js\?v=712/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v712`/);
assert.match(sw, /theme-catalog\.js\?v=712/);
...
console.log('client theme selection v712 tests passed');
