...
assert.match(providerHtml, /theme-catalog\.js\?v=752/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=752/);
assert.match(indexHtml, /theme-catalog\.js\?v=752/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v752`/);
assert.match(sw, /theme-catalog\.js\?v=752/);
...
console.log('client theme selection v752 tests passed');
