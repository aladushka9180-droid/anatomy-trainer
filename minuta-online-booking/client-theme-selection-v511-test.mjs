...
assert.match(providerHtml, /theme-catalog\.js\?v=541/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=541/);
assert.match(indexHtml, /theme-catalog\.js\?v=541/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v541`/);
assert.match(sw, /theme-catalog\.js\?v=541/);
assert.match(providerHtml, /voice-assistant\.js\?v=541/);

console.log('client theme selection v541 tests passed');
