...
assert.match(providerHtml, /theme-catalog\.js\?v=781/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=781/);
assert.match(indexHtml, /theme-catalog\.js\?v=781/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v781`/);
assert.match(sw, /theme-catalog\.js\?v=781/);
...
console.log('client theme selection v781 tests passed');
