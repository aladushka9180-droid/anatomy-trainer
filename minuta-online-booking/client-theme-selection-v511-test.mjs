...
assert.match(providerHtml, /theme-catalog\.js\?v=514/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=514/);
assert.match(indexHtml, /theme-catalog\.js\?v=514/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v514`/);
assert.match(sw, /theme-catalog\.js\?v=514/);
assert.match(providerHtml, /voice-assistant\.js\?v=514/);

console.log('client theme selection v514 tests passed');
