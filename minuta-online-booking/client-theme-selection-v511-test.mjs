...
assert.match(providerHtml, /theme-catalog\.js\?v=755/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=755/);
assert.match(indexHtml, /theme-catalog\.js\?v=755/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v755`/);
assert.match(sw, /theme-catalog\.js\?v=755/);
...
console.log('client theme selection v755 tests passed');
