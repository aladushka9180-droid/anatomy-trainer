...
assert.match(providerHtml, /theme-catalog\.js\?v=684/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=684/);
assert.match(indexHtml, /theme-catalog\.js\?v=684/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v684`/);
assert.match(sw, /theme-catalog\.js\?v=684/);
...
console.log('client theme selection v684 tests passed');
