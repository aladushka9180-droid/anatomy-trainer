...
assert.match(providerHtml, /theme-catalog\.js\?v=542/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=542/);
assert.match(indexHtml, /theme-catalog\.js\?v=542/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v542`/);
assert.match(sw, /theme-catalog\.js\?v=542/);
assert.match(providerHtml, /voice-assistant\.js\?v=542/);

console.log('client theme selection v542 tests passed');
