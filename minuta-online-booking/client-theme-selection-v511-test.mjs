...
assert.match(providerHtml, /theme-catalog\.js\?v=583/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=583/);
assert.match(indexHtml, /theme-catalog\.js\?v=583/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v583`/);
assert.match(sw, /theme-catalog\.js\?v=583/);
...
console.log('client theme selection v583 tests passed');
