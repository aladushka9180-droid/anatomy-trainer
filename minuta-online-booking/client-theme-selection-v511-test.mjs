...
assert.match(providerHtml, /theme-catalog\.js\?v=762/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=762/);
assert.match(indexHtml, /theme-catalog\.js\?v=762/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v762`/);
assert.match(sw, /theme-catalog\.js\?v=762/);
...
console.log('client theme selection v762 tests passed');
