...
assert.match(providerHtml, /theme-catalog\.js\?v=640/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=640/);
assert.match(indexHtml, /theme-catalog\.js\?v=640/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v640`/);
assert.match(sw, /theme-catalog\.js\?v=640/);
...
console.log('client theme selection v640 tests passed');
