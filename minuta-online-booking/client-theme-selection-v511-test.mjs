...
assert.match(providerHtml, /theme-catalog\.js\?v=523/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=523/);
assert.match(indexHtml, /theme-catalog\.js\?v=523/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v523`/);
assert.match(sw, /theme-catalog\.js\?v=523/);
assert.match(providerHtml, /voice-assistant\.js\?v=523/);

console.log('client theme selection v523 tests passed');
