...
assert.match(providerHtml, /theme-catalog\.js\?v=624/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=624/);
assert.match(indexHtml, /theme-catalog\.js\?v=624/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v624`/);
assert.match(sw, /theme-catalog\.js\?v=624/);
...
console.log('client theme selection v624 tests passed');
