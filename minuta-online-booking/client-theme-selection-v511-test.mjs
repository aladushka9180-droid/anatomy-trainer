...
assert.match(providerHtml, /theme-catalog\.js\?v=701/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=701/);
assert.match(indexHtml, /theme-catalog\.js\?v=701/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v701`/);
assert.match(sw, /theme-catalog\.js\?v=701/);
...
console.log('client theme selection v701 tests passed');
