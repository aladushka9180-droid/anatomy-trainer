...
assert.match(providerHtml, /theme-catalog\.js\?v=643/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=643/);
assert.match(indexHtml, /theme-catalog\.js\?v=643/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v643`/);
assert.match(sw, /theme-catalog\.js\?v=643/);
...
console.log('client theme selection v643 tests passed');
