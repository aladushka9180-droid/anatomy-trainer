...
assert.match(providerHtml, /theme-catalog\.js\?v=586/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=586/);
assert.match(indexHtml, /theme-catalog\.js\?v=586/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v586`/);
assert.match(sw, /theme-catalog\.js\?v=586/);
...
console.log('client theme selection v586 tests passed');
