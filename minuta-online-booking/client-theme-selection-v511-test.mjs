...
assert.match(providerHtml, /theme-catalog\.js\?v=688/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=688/);
assert.match(indexHtml, /theme-catalog\.js\?v=688/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v688`/);
assert.match(sw, /theme-catalog\.js\?v=688/);
...
console.log('client theme selection v688 tests passed');
