...
assert.match(providerHtml, /theme-catalog\.js\?v=674/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=674/);
assert.match(indexHtml, /theme-catalog\.js\?v=674/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v674`/);
assert.match(sw, /theme-catalog\.js\?v=674/);
...
console.log('client theme selection v674 tests passed');
