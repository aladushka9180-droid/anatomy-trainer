...
assert.match(providerHtml, /theme-catalog\.js\?v=513/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=513/);
assert.match(indexHtml, /theme-catalog\.js\?v=513/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v513`/);
assert.match(sw, /theme-catalog\.js\?v=513/);
assert.match(providerHtml, /voice-assistant\.js\?v=513/);

console.log('client theme selection v513 tests passed');
