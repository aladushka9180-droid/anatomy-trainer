...
assert.match(providerHtml, /theme-catalog\.js\?v=695/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=695/);
assert.match(indexHtml, /theme-catalog\.js\?v=695/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v695`/);
assert.match(sw, /theme-catalog\.js\?v=695/);
...
console.log('client theme selection v695 tests passed');
