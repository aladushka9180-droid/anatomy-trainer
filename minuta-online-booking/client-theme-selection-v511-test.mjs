...
assert.match(providerHtml, /theme-catalog\.js\?v=650/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=650/);
assert.match(indexHtml, /theme-catalog\.js\?v=650/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v650`/);
assert.match(sw, /theme-catalog\.js\?v=650/);
...
console.log('client theme selection v650 tests passed');
