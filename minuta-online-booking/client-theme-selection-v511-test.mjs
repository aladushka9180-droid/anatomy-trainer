...
assert.match(providerHtml, /theme-catalog\.js\?v=592/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=592/);
assert.match(indexHtml, /theme-catalog\.js\?v=592/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v592`/);
assert.match(sw, /theme-catalog\.js\?v=592/);
...
console.log('client theme selection v592 tests passed');
