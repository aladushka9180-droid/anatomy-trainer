...
assert.match(providerHtml, /theme-catalog\.js\?v=693/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=693/);
assert.match(indexHtml, /theme-catalog\.js\?v=693/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v693`/);
assert.match(sw, /theme-catalog\.js\?v=693/);
...
console.log('client theme selection v693 tests passed');
