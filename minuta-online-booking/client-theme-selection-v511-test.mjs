...
assert.match(providerHtml, /theme-catalog\.js\?v=605/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=605/);
assert.match(indexHtml, /theme-catalog\.js\?v=605/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v605`/);
assert.match(sw, /theme-catalog\.js\?v=605/);
...
console.log('client theme selection v605 tests passed');
