...
assert.match(providerHtml, /theme-catalog\.js\?v=590/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=590/);
assert.match(indexHtml, /theme-catalog\.js\?v=590/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v590`/);
assert.match(sw, /theme-catalog\.js\?v=590/);
...
console.log('client theme selection v590 tests passed');
