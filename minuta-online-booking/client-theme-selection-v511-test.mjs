...
assert.match(providerHtml, /theme-catalog\.js\?v=551/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=551/);
assert.match(indexHtml, /theme-catalog\.js\?v=551/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v551`/);
assert.match(sw, /theme-catalog\.js\?v=551/);
assert.match(providerHtml, /voice-assistant\.js\?v=551/);

console.log('client theme selection v551 tests passed');
