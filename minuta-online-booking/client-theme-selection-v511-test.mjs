...
assert.match(providerHtml, /theme-catalog\.js\?v=522/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=522/);
assert.match(indexHtml, /theme-catalog\.js\?v=522/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v522`/);
assert.match(sw, /theme-catalog\.js\?v=522/);
assert.match(providerHtml, /voice-assistant\.js\?v=522/);

console.log('client theme selection v522 tests passed');
