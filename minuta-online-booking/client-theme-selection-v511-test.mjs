...
assert.match(providerHtml, /theme-catalog\.js\?v=732/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=732/);
assert.match(indexHtml, /theme-catalog\.js\?v=732/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v732`/);
assert.match(sw, /theme-catalog\.js\?v=732/);
...
console.log('client theme selection v732 tests passed');
