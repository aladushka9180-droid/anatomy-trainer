...
assert.match(providerHtml, /theme-catalog\.js\?v=600/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=600/);
assert.match(indexHtml, /theme-catalog\.js\?v=600/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v600`/);
assert.match(sw, /theme-catalog\.js\?v=600/);
...
console.log('client theme selection v600 tests passed');
