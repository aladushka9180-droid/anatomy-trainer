...
assert.match(providerHtml, /theme-catalog\.js\?v=578/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=578/);
assert.match(indexHtml, /theme-catalog\.js\?v=578/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v578`/);
assert.match(sw, /theme-catalog\.js\?v=578/);
...
console.log('client theme selection v578 tests passed');
