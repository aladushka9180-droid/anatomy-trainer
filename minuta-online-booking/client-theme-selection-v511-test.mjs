...
assert.match(providerHtml, /theme-catalog\.js\?v=734/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=734/);
assert.match(indexHtml, /theme-catalog\.js\?v=734/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v734`/);
assert.match(sw, /theme-catalog\.js\?v=734/);
...
console.log('client theme selection v734 tests passed');
