...
assert.match(providerHtml, /theme-catalog\.js\?v=584/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=584/);
assert.match(indexHtml, /theme-catalog\.js\?v=584/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v584`/);
assert.match(sw, /theme-catalog\.js\?v=584/);
...
console.log('client theme selection v584 tests passed');
