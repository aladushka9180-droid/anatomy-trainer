...
assert.match(providerHtml, /theme-catalog\.js\?v=638/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=638/);
assert.match(indexHtml, /theme-catalog\.js\?v=638/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v638`/);
assert.match(sw, /theme-catalog\.js\?v=638/);
...
console.log('client theme selection v638 tests passed');
