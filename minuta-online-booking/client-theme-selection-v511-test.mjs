...
assert.match(providerHtml, /theme-catalog\.js\?v=627/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=627/);
assert.match(indexHtml, /theme-catalog\.js\?v=627/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v627`/);
assert.match(sw, /theme-catalog\.js\?v=627/);
...
console.log('client theme selection v627 tests passed');
