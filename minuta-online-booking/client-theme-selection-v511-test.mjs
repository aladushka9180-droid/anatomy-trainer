...
assert.match(providerHtml, /theme-catalog\.js\?v=614/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=614/);
assert.match(indexHtml, /theme-catalog\.js\?v=614/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v614`/);
assert.match(sw, /theme-catalog\.js\?v=614/);
...
console.log('client theme selection v614 tests passed');
