...
assert.match(providerHtml, /theme-catalog\.js\?v=709/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=709/);
assert.match(indexHtml, /theme-catalog\.js\?v=709/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v709`/);
assert.match(sw, /theme-catalog\.js\?v=709/);
...
console.log('client theme selection v709 tests passed');
