...
assert.match(providerHtml, /theme-catalog\.js\?v=715/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=715/);
assert.match(indexHtml, /theme-catalog\.js\?v=715/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v715`/);
assert.match(sw, /theme-catalog\.js\?v=715/);
...
console.log('client theme selection v715 tests passed');
