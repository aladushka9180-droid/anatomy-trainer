...
assert.match(providerHtml, /theme-catalog\.js\?v=637/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=637/);
assert.match(indexHtml, /theme-catalog\.js\?v=637/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v637`/);
assert.match(sw, /theme-catalog\.js\?v=637/);
...
console.log('client theme selection v637 tests passed');
