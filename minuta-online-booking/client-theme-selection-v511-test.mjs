...
assert.match(providerHtml, /theme-catalog\.js\?v=756/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=756/);
assert.match(indexHtml, /theme-catalog\.js\?v=756/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v756`/);
assert.match(sw, /theme-catalog\.js\?v=756/);
...
console.log('client theme selection v756 tests passed');
