...
assert.match(providerHtml, /theme-catalog\.js\?v=558/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=558/);
assert.match(indexHtml, /theme-catalog\.js\?v=558/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v558`/);
assert.match(sw, /theme-catalog\.js\?v=558/);
assert.match(providerHtml, /voice-assistant\.js\?v=558/);

console.log('client theme selection v558 tests passed');
