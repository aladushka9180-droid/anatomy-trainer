...
assert.match(providerHtml, /theme-catalog\.js\?v=615/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=615/);
assert.match(indexHtml, /theme-catalog\.js\?v=615/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v615`/);
assert.match(sw, /theme-catalog\.js\?v=615/);
...
console.log('client theme selection v615 tests passed');
