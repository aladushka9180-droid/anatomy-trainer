...
assert.match(providerHtml, /theme-catalog\.js\?v=561/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=561/);
assert.match(indexHtml, /theme-catalog\.js\?v=561/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v561`/);
assert.match(sw, /theme-catalog\.js\?v=561/);
assert.match(providerHtml, /voice-assistant\.js\?v=561/);

console.log('client theme selection v561 tests passed');
