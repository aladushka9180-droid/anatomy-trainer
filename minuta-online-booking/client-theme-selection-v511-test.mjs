...
assert.match(providerHtml, /theme-catalog\.js\?v=769/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=769/);
assert.match(indexHtml, /theme-catalog\.js\?v=769/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v769`/);
assert.match(sw, /theme-catalog\.js\?v=769/);
...
console.log('client theme selection v769 tests passed');
