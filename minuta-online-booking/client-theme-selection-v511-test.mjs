...
assert.match(providerHtml, /theme-catalog\.js\?v=539/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=539/);
assert.match(indexHtml, /theme-catalog\.js\?v=539/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v539`/);
assert.match(sw, /theme-catalog\.js\?v=539/);
assert.match(providerHtml, /voice-assistant\.js\?v=539/);

console.log('client theme selection v539 tests passed');
