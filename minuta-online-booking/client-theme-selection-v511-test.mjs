...
assert.match(providerHtml, /theme-catalog\.js\?v=629/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=629/);
assert.match(indexHtml, /theme-catalog\.js\?v=629/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v629`/);
assert.match(sw, /theme-catalog\.js\?v=629/);
...
console.log('client theme selection v629 tests passed');
