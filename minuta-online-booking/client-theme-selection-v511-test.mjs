...
assert.match(providerHtml, /theme-catalog\.js\?v=783/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=783/);
assert.match(indexHtml, /theme-catalog\.js\?v=783/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v783`/);
assert.match(sw, /theme-catalog\.js\?v=783/);
...
console.log('client theme selection v783 tests passed');
