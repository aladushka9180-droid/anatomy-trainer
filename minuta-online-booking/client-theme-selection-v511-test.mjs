...
assert.match(providerHtml, /theme-catalog\.js\?v=613/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=613/);
assert.match(indexHtml, /theme-catalog\.js\?v=613/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v613`/);
assert.match(sw, /theme-catalog\.js\?v=613/);
...
console.log('client theme selection v613 tests passed');
