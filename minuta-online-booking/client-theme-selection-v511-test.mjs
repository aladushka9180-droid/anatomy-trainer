...
assert.match(providerHtml, /theme-catalog\.js\?v=606/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=606/);
assert.match(indexHtml, /theme-catalog\.js\?v=606/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v606`/);
assert.match(sw, /theme-catalog\.js\?v=606/);
...
console.log('client theme selection v606 tests passed');
