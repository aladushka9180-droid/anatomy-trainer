...
assert.match(providerHtml, /theme-catalog\.js\?v=636/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=636/);
assert.match(indexHtml, /theme-catalog\.js\?v=636/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v636`/);
assert.match(sw, /theme-catalog\.js\?v=636/);
...
console.log('client theme selection v636 tests passed');
