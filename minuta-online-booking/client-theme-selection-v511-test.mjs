...
assert.match(providerHtml, /theme-catalog\.js\?v=731/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=731/);
assert.match(indexHtml, /theme-catalog\.js\?v=731/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v731`/);
assert.match(sw, /theme-catalog\.js\?v=731/);
...
console.log('client theme selection v731 tests passed');
