...
assert.match(providerHtml, /theme-catalog\.js\?v=544/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=544/);
assert.match(indexHtml, /theme-catalog\.js\?v=544/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v544`/);
assert.match(sw, /theme-catalog\.js\?v=544/);
assert.match(providerHtml, /voice-assistant\.js\?v=544/);

console.log('client theme selection v544 tests passed');
