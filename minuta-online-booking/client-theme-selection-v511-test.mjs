...
assert.match(providerHtml, /theme-catalog\.js\?v=735/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=735/);
assert.match(indexHtml, /theme-catalog\.js\?v=735/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v735`/);
assert.match(sw, /theme-catalog\.js\?v=735/);
...
console.log('client theme selection v735 tests passed');
