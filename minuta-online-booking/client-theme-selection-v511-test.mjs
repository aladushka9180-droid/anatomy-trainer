...
assert.match(providerHtml, /theme-catalog\.js\?v=714/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=714/);
assert.match(indexHtml, /theme-catalog\.js\?v=714/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v714`/);
assert.match(sw, /theme-catalog\.js\?v=714/);
...
console.log('client theme selection v714 tests passed');
