...
assert.match(providerHtml, /theme-catalog\.js\?v=681/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=681/);
assert.match(indexHtml, /theme-catalog\.js\?v=681/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v681`/);
assert.match(sw, /theme-catalog\.js\?v=681/);
...
console.log('client theme selection v681 tests passed');
