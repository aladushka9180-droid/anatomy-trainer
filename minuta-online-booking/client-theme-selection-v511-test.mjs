...
assert.match(providerHtml, /theme-catalog\.js\?v=770/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=770/);
assert.match(indexHtml, /theme-catalog\.js\?v=770/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v770`/);
assert.match(sw, /theme-catalog\.js\?v=770/);
...
console.log('client theme selection v770 tests passed');
