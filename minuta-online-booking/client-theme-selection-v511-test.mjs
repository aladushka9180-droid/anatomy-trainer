...
assert.match(providerHtml, /theme-catalog\.js\?v=768/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=768/);
assert.match(indexHtml, /theme-catalog\.js\?v=768/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v768`/);
assert.match(sw, /theme-catalog\.js\?v=768/);
...
console.log('client theme selection v768 tests passed');
