...
assert.match(providerHtml, /theme-catalog\.js\?v=570/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=570/);
assert.match(indexHtml, /theme-catalog\.js\?v=570/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v570`/);
assert.match(sw, /theme-catalog\.js\?v=570/);
...
console.log('client theme selection v570 tests passed');
