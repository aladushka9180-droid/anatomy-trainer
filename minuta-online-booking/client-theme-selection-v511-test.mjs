...
assert.match(providerHtml, /theme-catalog\.js\?v=554/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=554/);
assert.match(indexHtml, /theme-catalog\.js\?v=554/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v554`/);
assert.match(sw, /theme-catalog\.js\?v=554/);
assert.match(providerHtml, /voice-assistant\.js\?v=554/);

console.log('client theme selection v554 tests passed');
