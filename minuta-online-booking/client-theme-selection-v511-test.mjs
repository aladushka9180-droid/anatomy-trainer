...
assert.match(providerHtml, /theme-catalog\.js\?v=786/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=786/);
assert.match(indexHtml, /theme-catalog\.js\?v=786/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v786`/);
assert.match(sw, /theme-catalog\.js\?v=786/);
...
console.log('client theme selection v786 tests passed');
