...
assert.match(providerHtml, /theme-catalog\.js\?v=623/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=623/);
assert.match(indexHtml, /theme-catalog\.js\?v=623/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v623`/);
assert.match(sw, /theme-catalog\.js\?v=623/);
...
console.log('client theme selection v623 tests passed');
