...
assert.match(providerHtml, /theme-catalog\.js\?v=723/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=723/);
assert.match(indexHtml, /theme-catalog\.js\?v=723/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v723`/);
assert.match(sw, /theme-catalog\.js\?v=723/);
...
console.log('client theme selection v723 tests passed');
