...
assert.match(providerHtml, /theme-catalog\.js\?v=785/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=785/);
assert.match(indexHtml, /theme-catalog\.js\?v=785/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v785`/);
assert.match(sw, /theme-catalog\.js\?v=785/);
...
console.log('client theme selection v785 tests passed');
