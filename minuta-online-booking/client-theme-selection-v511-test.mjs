...
assert.match(providerHtml, /theme-catalog\.js\?v=569/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=569/);
assert.match(indexHtml, /theme-catalog\.js\?v=569/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v569`/);
assert.match(sw, /theme-catalog\.js\?v=569/);
...
console.log('client theme selection v569 tests passed');
