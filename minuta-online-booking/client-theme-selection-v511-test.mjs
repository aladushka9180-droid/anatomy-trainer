...
assert.match(providerHtml, /theme-catalog\.js\?v=773/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=773/);
assert.match(indexHtml, /theme-catalog\.js\?v=773/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v773`/);
assert.match(sw, /theme-catalog\.js\?v=773/);
...
console.log('client theme selection v773 tests passed');
