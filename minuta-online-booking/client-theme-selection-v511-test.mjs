...
assert.match(providerHtml, /theme-catalog\.js\?v=565/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=565/);
assert.match(indexHtml, /theme-catalog\.js\?v=565/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v565`/);
assert.match(sw, /theme-catalog\.js\?v=565/);
...
console.log('client theme selection v565 tests passed');
