...
assert.match(providerHtml, /theme-catalog\.js\?v=607/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=607/);
assert.match(indexHtml, /theme-catalog\.js\?v=607/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v607`/);
assert.match(sw, /theme-catalog\.js\?v=607/);
...
console.log('client theme selection v607 tests passed');
