...
assert.match(providerHtml, /theme-catalog\.js\?v=740/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=740/);
assert.match(indexHtml, /theme-catalog\.js\?v=740/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v740`/);
assert.match(sw, /theme-catalog\.js\?v=740/);
...
console.log('client theme selection v740 tests passed');
