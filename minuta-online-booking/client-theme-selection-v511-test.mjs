...
assert.match(providerHtml, /theme-catalog\.js\?v=680/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=680/);
assert.match(indexHtml, /theme-catalog\.js\?v=680/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v680`/);
assert.match(sw, /theme-catalog\.js\?v=680/);
...
console.log('client theme selection v680 tests passed');
