...
assert.match(providerHtml, /theme-catalog\.js\?v=727/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=727/);
assert.match(indexHtml, /theme-catalog\.js\?v=727/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v727`/);
assert.match(sw, /theme-catalog\.js\?v=727/);
...
console.log('client theme selection v727 tests passed');
