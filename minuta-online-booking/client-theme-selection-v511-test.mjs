...
assert.match(providerHtml, /theme-catalog\.js\?v=719/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=719/);
assert.match(indexHtml, /theme-catalog\.js\?v=719/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v719`/);
assert.match(sw, /theme-catalog\.js\?v=719/);
...
console.log('client theme selection v719 tests passed');
