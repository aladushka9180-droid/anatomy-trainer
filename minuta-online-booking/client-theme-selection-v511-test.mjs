...
assert.match(providerHtml, /theme-catalog\.js\?v=741/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=741/);
assert.match(indexHtml, /theme-catalog\.js\?v=741/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v741`/);
assert.match(sw, /theme-catalog\.js\?v=741/);
...
console.log('client theme selection v741 tests passed');
