...
assert.match(providerHtml, /theme-catalog\.js\?v=630/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=630/);
assert.match(indexHtml, /theme-catalog\.js\?v=630/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v630`/);
assert.match(sw, /theme-catalog\.js\?v=630/);
...
console.log('client theme selection v630 tests passed');
