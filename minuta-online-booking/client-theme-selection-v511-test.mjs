...
assert.match(providerHtml, /theme-catalog\.js\?v=588/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=588/);
assert.match(indexHtml, /theme-catalog\.js\?v=588/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v588`/);
assert.match(sw, /theme-catalog\.js\?v=588/);
...
console.log('client theme selection v588 tests passed');
