...
assert.match(providerHtml, /theme-catalog\.js\?v=527/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=527/);
assert.match(indexHtml, /theme-catalog\.js\?v=527/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v527`/);
assert.match(sw, /theme-catalog\.js\?v=527/);
assert.match(providerHtml, /voice-assistant\.js\?v=527/);

console.log('client theme selection v527 tests passed');
