...
assert.match(providerHtml, /theme-catalog\.js\?v=698/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=698/);
assert.match(indexHtml, /theme-catalog\.js\?v=698/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v698`/);
assert.match(sw, /theme-catalog\.js\?v=698/);
...
console.log('client theme selection v698 tests passed');
