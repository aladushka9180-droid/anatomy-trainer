...
assert.match(providerHtml, /theme-catalog\.js\?v=626/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=626/);
assert.match(indexHtml, /theme-catalog\.js\?v=626/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v626`/);
assert.match(sw, /theme-catalog\.js\?v=626/);
...
console.log('client theme selection v626 tests passed');
