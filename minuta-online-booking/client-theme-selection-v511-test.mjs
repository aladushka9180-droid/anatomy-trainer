...
assert.match(providerHtml, /theme-catalog\.js\?v=744/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=744/);
assert.match(indexHtml, /theme-catalog\.js\?v=744/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v744`/);
assert.match(sw, /theme-catalog\.js\?v=744/);
...
console.log('client theme selection v744 tests passed');
