...
assert.match(providerHtml, /theme-catalog\.js\?v=691/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=691/);
assert.match(indexHtml, /theme-catalog\.js\?v=691/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v691`/);
assert.match(sw, /theme-catalog\.js\?v=691/);
...
console.log('client theme selection v691 tests passed');
