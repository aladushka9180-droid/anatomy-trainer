...
assert.match(providerHtml, /theme-catalog\.js\?v=690/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=690/);
assert.match(indexHtml, /theme-catalog\.js\?v=690/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v690`/);
assert.match(sw, /theme-catalog\.js\?v=690/);
...
console.log('client theme selection v690 tests passed');
