...
assert.match(providerHtml, /theme-catalog\.js\?v=563/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=563/);
assert.match(indexHtml, /theme-catalog\.js\?v=563/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v563`/);
assert.match(sw, /theme-catalog\.js\?v=563/);
...
console.log('client theme selection v563 tests passed');
