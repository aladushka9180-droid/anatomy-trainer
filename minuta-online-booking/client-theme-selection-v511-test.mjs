...
assert.match(providerHtml, /theme-catalog\.js\?v=716/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=716/);
assert.match(indexHtml, /theme-catalog\.js\?v=716/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v716`/);
assert.match(sw, /theme-catalog\.js\?v=716/);
...
console.log('client theme selection v716 tests passed');
