...
assert.match(providerHtml, /theme-catalog\.js\?v=515/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=515/);
assert.match(indexHtml, /theme-catalog\.js\?v=515/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v515`/);
assert.match(sw, /theme-catalog\.js\?v=515/);
assert.match(providerHtml, /voice-assistant\.js\?v=515/);

console.log('client theme selection v515 tests passed');
