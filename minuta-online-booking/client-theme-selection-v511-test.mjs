...
assert.match(providerHtml, /theme-catalog\.js\?v=678/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=678/);
assert.match(indexHtml, /theme-catalog\.js\?v=678/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v678`/);
assert.match(sw, /theme-catalog\.js\?v=678/);
...
console.log('client theme selection v678 tests passed');
