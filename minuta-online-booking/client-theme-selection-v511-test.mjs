...
assert.match(providerHtml, /theme-catalog\.js\?v=529/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=529/);
assert.match(indexHtml, /theme-catalog\.js\?v=529/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v529`/);
assert.match(sw, /theme-catalog\.js\?v=529/);
assert.match(providerHtml, /voice-assistant\.js\?v=529/);

console.log('client theme selection v529 tests passed');
