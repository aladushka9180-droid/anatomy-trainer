...
assert.match(providerHtml, /theme-catalog\.js\?v=694/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=694/);
assert.match(indexHtml, /theme-catalog\.js\?v=694/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v694`/);
assert.match(sw, /theme-catalog\.js\?v=694/);
...
console.log('client theme selection v694 tests passed');
