...
assert.match(providerHtml, /theme-catalog\.js\?v=543/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=543/);
assert.match(indexHtml, /theme-catalog\.js\?v=543/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v543`/);
assert.match(sw, /theme-catalog\.js\?v=543/);
assert.match(providerHtml, /voice-assistant\.js\?v=543/);

console.log('client theme selection v543 tests passed');
