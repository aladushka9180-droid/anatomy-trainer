...
assert.match(providerHtml, /theme-catalog\.js\?v=689/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=689/);
assert.match(indexHtml, /theme-catalog\.js\?v=689/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v689`/);
assert.match(sw, /theme-catalog\.js\?v=689/);
...
console.log('client theme selection v689 tests passed');
