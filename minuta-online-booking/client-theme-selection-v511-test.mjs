...
assert.match(providerHtml, /theme-catalog\.js\?v=697/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=697/);
assert.match(indexHtml, /theme-catalog\.js\?v=697/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v697`/);
assert.match(sw, /theme-catalog\.js\?v=697/);
...
console.log('client theme selection v697 tests passed');
