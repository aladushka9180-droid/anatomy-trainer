...
assert.match(providerHtml, /theme-catalog\.js\?v=634/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=634/);
assert.match(indexHtml, /theme-catalog\.js\?v=634/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v634`/);
assert.match(sw, /theme-catalog\.js\?v=634/);
...
console.log('client theme selection v634 tests passed');
