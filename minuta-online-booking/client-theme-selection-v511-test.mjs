...
assert.match(providerHtml, /theme-catalog\.js\?v=722/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=722/);
assert.match(indexHtml, /theme-catalog\.js\?v=722/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v722`/);
assert.match(sw, /theme-catalog\.js\?v=722/);
...
console.log('client theme selection v722 tests passed');
