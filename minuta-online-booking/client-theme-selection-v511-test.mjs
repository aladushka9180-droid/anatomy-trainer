...
assert.match(providerHtml, /theme-catalog\.js\?v=579/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=579/);
assert.match(indexHtml, /theme-catalog\.js\?v=579/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v579`/);
assert.match(sw, /theme-catalog\.js\?v=579/);
...
console.log('client theme selection v579 tests passed');
