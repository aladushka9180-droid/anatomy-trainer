...
assert.match(providerHtml, /theme-catalog\.js\?v=746/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=746/);
assert.match(indexHtml, /theme-catalog\.js\?v=746/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v746`/);
assert.match(sw, /theme-catalog\.js\?v=746/);
...
console.log('client theme selection v746 tests passed');
