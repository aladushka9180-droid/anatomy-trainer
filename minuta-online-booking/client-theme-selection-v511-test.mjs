...
assert.match(providerHtml, /theme-catalog\.js\?v=664/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=664/);
assert.match(indexHtml, /theme-catalog\.js\?v=664/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v664`/);
assert.match(sw, /theme-catalog\.js\?v=664/);
...
console.log('client theme selection v664 tests passed');
