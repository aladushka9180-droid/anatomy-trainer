...
assert.match(providerHtml, /theme-catalog\.js\?v=628/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=628/);
assert.match(indexHtml, /theme-catalog\.js\?v=628/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v628`/);
assert.match(sw, /theme-catalog\.js\?v=628/);
...
console.log('client theme selection v628 tests passed');
