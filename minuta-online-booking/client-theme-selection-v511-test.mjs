...
assert.match(providerHtml, /theme-catalog\.js\?v=611/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=611/);
assert.match(indexHtml, /theme-catalog\.js\?v=611/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v611`/);
assert.match(sw, /theme-catalog\.js\?v=611/);
...
console.log('client theme selection v611 tests passed');
