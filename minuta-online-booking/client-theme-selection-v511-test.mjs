...
assert.match(providerHtml, /theme-catalog\.js\?v=663/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=663/);
assert.match(indexHtml, /theme-catalog\.js\?v=663/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v663`/);
assert.match(sw, /theme-catalog\.js\?v=663/);
...
console.log('client theme selection v663 tests passed');
