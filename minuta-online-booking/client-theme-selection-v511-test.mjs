...
assert.match(providerHtml, /theme-catalog\.js\?v=585/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=585/);
assert.match(indexHtml, /theme-catalog\.js\?v=585/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v585`/);
assert.match(sw, /theme-catalog\.js\?v=585/);
...
console.log('client theme selection v585 tests passed');
