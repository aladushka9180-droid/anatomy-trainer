...
assert.match(providerHtml, /theme-catalog\.js\?v=557/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=557/);
assert.match(indexHtml, /theme-catalog\.js\?v=557/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v557`/);
assert.match(sw, /theme-catalog\.js\?v=557/);
assert.match(providerHtml, /voice-assistant\.js\?v=557/);

console.log('client theme selection v557 tests passed');
