...
assert.match(providerHtml, /theme-catalog\.js\?v=546/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=546/);
assert.match(indexHtml, /theme-catalog\.js\?v=546/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v546`/);
assert.match(sw, /theme-catalog\.js\?v=546/);
assert.match(providerHtml, /voice-assistant\.js\?v=546/);

console.log('client theme selection v546 tests passed');
