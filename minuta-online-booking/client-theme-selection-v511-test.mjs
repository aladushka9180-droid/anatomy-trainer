...
assert.match(providerHtml, /theme-catalog\.js\?v=668/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=668/);
assert.match(indexHtml, /theme-catalog\.js\?v=668/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v668`/);
assert.match(sw, /theme-catalog\.js\?v=668/);
...
console.log('client theme selection v668 tests passed');
