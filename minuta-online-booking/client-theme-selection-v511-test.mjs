...
assert.match(providerHtml, /theme-catalog\.js\?v=645/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=645/);
assert.match(indexHtml, /theme-catalog\.js\?v=645/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v645`/);
assert.match(sw, /theme-catalog\.js\?v=645/);
...
console.log('client theme selection v645 tests passed');
