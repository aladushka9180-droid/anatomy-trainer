...
assert.match(providerHtml, /theme-catalog\.js\?v=708/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=708/);
assert.match(indexHtml, /theme-catalog\.js\?v=708/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v708`/);
assert.match(sw, /theme-catalog\.js\?v=708/);
...
console.log('client theme selection v708 tests passed');
