...
assert.match(providerHtml, /theme-catalog\.js\?v=632/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=632/);
assert.match(indexHtml, /theme-catalog\.js\?v=632/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v632`/);
assert.match(sw, /theme-catalog\.js\?v=632/);
...
console.log('client theme selection v632 tests passed');
