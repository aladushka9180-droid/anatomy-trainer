...
assert.match(providerHtml, /theme-catalog\.js\?v=780/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=780/);
assert.match(indexHtml, /theme-catalog\.js\?v=780/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v780`/);
assert.match(sw, /theme-catalog\.js\?v=780/);
...
console.log('client theme selection v780 tests passed');
