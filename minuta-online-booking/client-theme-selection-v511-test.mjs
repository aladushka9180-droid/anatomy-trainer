...
assert.match(providerHtml, /theme-catalog\.js\?v=777/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=777/);
assert.match(indexHtml, /theme-catalog\.js\?v=777/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v777`/);
assert.match(sw, /theme-catalog\.js\?v=777/);
...
console.log('client theme selection v777 tests passed');
