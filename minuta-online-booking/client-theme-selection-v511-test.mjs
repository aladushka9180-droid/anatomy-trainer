...
assert.match(providerHtml, /theme-catalog\.js\?v=765/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=765/);
assert.match(indexHtml, /theme-catalog\.js\?v=765/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v765`/);
assert.match(sw, /theme-catalog\.js\?v=765/);
...
console.log('client theme selection v765 tests passed');
