...
assert.match(providerHtml, /theme-catalog\.js\?v=738/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=738/);
assert.match(indexHtml, /theme-catalog\.js\?v=738/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v738`/);
assert.match(sw, /theme-catalog\.js\?v=738/);
...
console.log('client theme selection v738 tests passed');
