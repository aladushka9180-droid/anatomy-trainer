...
assert.match(providerHtml, /theme-catalog\.js\?v=621/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=621/);
assert.match(indexHtml, /theme-catalog\.js\?v=621/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v621`/);
assert.match(sw, /theme-catalog\.js\?v=621/);
...
console.log('client theme selection v621 tests passed');
