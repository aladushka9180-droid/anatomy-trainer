...
assert.match(providerHtml, /theme-catalog\.js\?v=754/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=754/);
assert.match(indexHtml, /theme-catalog\.js\?v=754/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v754`/);
assert.match(sw, /theme-catalog\.js\?v=754/);
...
console.log('client theme selection v754 tests passed');
