...
assert.match(providerHtml, /theme-catalog\.js\?v=702/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=702/);
assert.match(indexHtml, /theme-catalog\.js\?v=702/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v702`/);
assert.match(sw, /theme-catalog\.js\?v=702/);
...
console.log('client theme selection v702 tests passed');
