...
assert.match(providerHtml, /theme-catalog\.js\?v=658/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=658/);
assert.match(indexHtml, /theme-catalog\.js\?v=658/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v658`/);
assert.match(sw, /theme-catalog\.js\?v=658/);
...
console.log('client theme selection v658 tests passed');
