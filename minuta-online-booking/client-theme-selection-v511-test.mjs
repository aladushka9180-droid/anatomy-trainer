...
assert.match(providerHtml, /theme-catalog\.js\?v=721/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=721/);
assert.match(indexHtml, /theme-catalog\.js\?v=721/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v721`/);
assert.match(sw, /theme-catalog\.js\?v=721/);
...
console.log('client theme selection v721 tests passed');
