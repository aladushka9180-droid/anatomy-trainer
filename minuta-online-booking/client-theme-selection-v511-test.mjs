...
assert.match(providerHtml, /theme-catalog\.js\?v=582/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=582/);
assert.match(indexHtml, /theme-catalog\.js\?v=582/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v582`/);
assert.match(sw, /theme-catalog\.js\?v=582/);
...
console.log('client theme selection v582 tests passed');
