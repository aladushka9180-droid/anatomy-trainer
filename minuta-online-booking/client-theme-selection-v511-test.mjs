...
assert.match(providerHtml, /theme-catalog\.js\?v=589/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=589/);
assert.match(indexHtml, /theme-catalog\.js\?v=589/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v589`/);
assert.match(sw, /theme-catalog\.js\?v=589/);
...
console.log('client theme selection v589 tests passed');
