...
assert.match(providerHtml, /theme-catalog\.js\?v=726/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=726/);
assert.match(indexHtml, /theme-catalog\.js\?v=726/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v726`/);
assert.match(sw, /theme-catalog\.js\?v=726/);
...
console.log('client theme selection v726 tests passed');
