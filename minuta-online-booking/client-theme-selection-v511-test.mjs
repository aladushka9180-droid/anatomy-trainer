...
assert.match(providerHtml, /theme-catalog\.js\?v=717/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=717/);
assert.match(indexHtml, /theme-catalog\.js\?v=717/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v717`/);
assert.match(sw, /theme-catalog\.js\?v=717/);
...
console.log('client theme selection v717 tests passed');
