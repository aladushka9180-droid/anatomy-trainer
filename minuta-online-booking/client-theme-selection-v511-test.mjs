...
assert.match(providerHtml, /theme-catalog\.js\?v=699/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=699/);
assert.match(indexHtml, /theme-catalog\.js\?v=699/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v699`/);
assert.match(sw, /theme-catalog\.js\?v=699/);
...
console.log('client theme selection v699 tests passed');
