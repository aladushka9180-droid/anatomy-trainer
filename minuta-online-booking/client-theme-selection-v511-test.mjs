...
assert.match(providerHtml, /theme-catalog\.js\?v=676/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=676/);
assert.match(indexHtml, /theme-catalog\.js\?v=676/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v676`/);
assert.match(sw, /theme-catalog\.js\?v=676/);
...
console.log('client theme selection v676 tests passed');
