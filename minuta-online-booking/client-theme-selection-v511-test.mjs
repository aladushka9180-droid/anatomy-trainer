...
assert.match(providerHtml, /theme-catalog\.js\?v=549/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=549/);
assert.match(indexHtml, /theme-catalog\.js\?v=549/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v549`/);
assert.match(sw, /theme-catalog\.js\?v=549/);
assert.match(providerHtml, /voice-assistant\.js\?v=549/);

console.log('client theme selection v549 tests passed');
