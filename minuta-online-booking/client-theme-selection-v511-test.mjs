...
assert.match(providerHtml, /theme-catalog\.js\?v=652/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=652/);
assert.match(indexHtml, /theme-catalog\.js\?v=652/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v652`/);
assert.match(sw, /theme-catalog\.js\?v=652/);
...
console.log('client theme selection v652 tests passed');
