...
assert.match(providerHtml, /theme-catalog\.js\?v=651/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=651/);
assert.match(indexHtml, /theme-catalog\.js\?v=651/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v651`/);
assert.match(sw, /theme-catalog\.js\?v=651/);
...
console.log('client theme selection v651 tests passed');
