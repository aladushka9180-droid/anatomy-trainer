...
assert.match(providerHtml, /theme-catalog\.js\?v=771/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=771/);
assert.match(indexHtml, /theme-catalog\.js\?v=771/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v771`/);
assert.match(sw, /theme-catalog\.js\?v=771/);
...
console.log('client theme selection v771 tests passed');
