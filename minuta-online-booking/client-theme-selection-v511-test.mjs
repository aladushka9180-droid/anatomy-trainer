...
assert.match(providerHtml, /theme-catalog\.js\?v=622/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=622/);
assert.match(indexHtml, /theme-catalog\.js\?v=622/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v622`/);
assert.match(sw, /theme-catalog\.js\?v=622/);
...
console.log('client theme selection v622 tests passed');
