...
assert.match(providerHtml, /theme-catalog\.js\?v=604/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=604/);
assert.match(indexHtml, /theme-catalog\.js\?v=604/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v604`/);
assert.match(sw, /theme-catalog\.js\?v=604/);
...
console.log('client theme selection v604 tests passed');
