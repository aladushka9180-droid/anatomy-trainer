...
assert.match(providerHtml, /theme-catalog\.js\?v=617/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=617/);
assert.match(indexHtml, /theme-catalog\.js\?v=617/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v617`/);
assert.match(sw, /theme-catalog\.js\?v=617/);
...
console.log('client theme selection v617 tests passed');
