...
assert.match(providerHtml, /theme-catalog\.js\?v=528/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=528/);
assert.match(indexHtml, /theme-catalog\.js\?v=528/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v528`/);
assert.match(sw, /theme-catalog\.js\?v=528/);
assert.match(providerHtml, /voice-assistant\.js\?v=528/);

console.log('client theme selection v528 tests passed');
