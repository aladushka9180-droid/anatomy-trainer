...
assert.match(providerHtml, /theme-catalog\.js\?v=548/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=548/);
assert.match(indexHtml, /theme-catalog\.js\?v=548/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v548`/);
assert.match(sw, /theme-catalog\.js\?v=548/);
assert.match(providerHtml, /voice-assistant\.js\?v=548/);

console.log('client theme selection v548 tests passed');
