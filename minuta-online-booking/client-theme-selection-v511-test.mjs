...
assert.match(providerHtml, /theme-catalog\.js\?v=736/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=736/);
assert.match(indexHtml, /theme-catalog\.js\?v=736/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v736`/);
assert.match(sw, /theme-catalog\.js\?v=736/);
...
console.log('client theme selection v736 tests passed');
