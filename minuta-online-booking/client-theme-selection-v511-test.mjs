...
assert.match(providerHtml, /theme-catalog\.js\?v=679/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=679/);
assert.match(indexHtml, /theme-catalog\.js\?v=679/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v679`/);
assert.match(sw, /theme-catalog\.js\?v=679/);
...
console.log('client theme selection v679 tests passed');
