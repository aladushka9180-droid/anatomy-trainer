...
assert.match(providerHtml, /theme-catalog\.js\?v=552/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=552/);
assert.match(indexHtml, /theme-catalog\.js\?v=552/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v552`/);
assert.match(sw, /theme-catalog\.js\?v=552/);
assert.match(providerHtml, /voice-assistant\.js\?v=552/);

console.log('client theme selection v552 tests passed');
