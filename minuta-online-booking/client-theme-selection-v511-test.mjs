...
assert.match(providerHtml, /theme-catalog\.js\?v=531/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=531/);
assert.match(indexHtml, /theme-catalog\.js\?v=531/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v531`/);
assert.match(sw, /theme-catalog\.js\?v=531/);
assert.match(providerHtml, /voice-assistant\.js\?v=531/);

console.log('client theme selection v531 tests passed');
