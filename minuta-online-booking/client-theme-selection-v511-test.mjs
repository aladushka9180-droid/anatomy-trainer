...
assert.match(providerHtml, /theme-catalog\.js\?v=670/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=670/);
assert.match(indexHtml, /theme-catalog\.js\?v=670/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v670`/);
assert.match(sw, /theme-catalog\.js\?v=670/);
...
console.log('client theme selection v670 tests passed');
