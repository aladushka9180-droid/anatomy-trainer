...
assert.match(providerHtml, /theme-catalog\.js\?v=625/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=625/);
assert.match(indexHtml, /theme-catalog\.js\?v=625/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v625`/);
assert.match(sw, /theme-catalog\.js\?v=625/);
...
console.log('client theme selection v625 tests passed');
