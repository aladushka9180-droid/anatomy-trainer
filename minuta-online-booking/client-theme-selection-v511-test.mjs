...
assert.match(providerHtml, /theme-catalog\.js\?v=713/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=713/);
assert.match(indexHtml, /theme-catalog\.js\?v=713/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v713`/);
assert.match(sw, /theme-catalog\.js\?v=713/);
...
console.log('client theme selection v713 tests passed');
