...
assert.match(providerHtml, /theme-catalog\.js\?v=620/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=620/);
assert.match(indexHtml, /theme-catalog\.js\?v=620/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v620`/);
assert.match(sw, /theme-catalog\.js\?v=620/);
...
console.log('client theme selection v620 tests passed');
