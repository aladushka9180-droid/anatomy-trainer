...
assert.match(providerHtml, /theme-catalog\.js\?v=758/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=758/);
assert.match(indexHtml, /theme-catalog\.js\?v=758/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v758`/);
assert.match(sw, /theme-catalog\.js\?v=758/);
...
console.log('client theme selection v758 tests passed');
