...
assert.match(providerHtml, /theme-catalog\.js\?v=540/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=540/);
assert.match(indexHtml, /theme-catalog\.js\?v=540/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v540`/);
assert.match(sw, /theme-catalog\.js\?v=540/);
assert.match(providerHtml, /voice-assistant\.js\?v=540/);

console.log('client theme selection v540 tests passed');
