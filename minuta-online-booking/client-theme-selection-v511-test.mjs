...
assert.match(providerHtml, /theme-catalog\.js\?v=574/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=574/);
assert.match(indexHtml, /theme-catalog\.js\?v=574/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v574`/);
assert.match(sw, /theme-catalog\.js\?v=574/);
...
console.log('client theme selection v574 tests passed');
