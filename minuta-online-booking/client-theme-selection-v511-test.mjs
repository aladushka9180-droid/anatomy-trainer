...
assert.match(providerHtml, /theme-catalog\.js\?v=730/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=730/);
assert.match(indexHtml, /theme-catalog\.js\?v=730/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v730`/);
assert.match(sw, /theme-catalog\.js\?v=730/);
...
console.log('client theme selection v730 tests passed');
