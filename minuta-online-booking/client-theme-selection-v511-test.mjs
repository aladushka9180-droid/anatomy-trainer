...
assert.match(providerHtml, /theme-catalog\.js\?v=593/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=593/);
assert.match(indexHtml, /theme-catalog\.js\?v=593/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v593`/);
assert.match(sw, /theme-catalog\.js\?v=593/);
...
console.log('client theme selection v593 tests passed');
