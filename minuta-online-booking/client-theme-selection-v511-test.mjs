...
assert.match(providerHtml, /theme-catalog\.js\?v=706/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=706/);
assert.match(indexHtml, /theme-catalog\.js\?v=706/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v706`/);
assert.match(sw, /theme-catalog\.js\?v=706/);
...
console.log('client theme selection v706 tests passed');
