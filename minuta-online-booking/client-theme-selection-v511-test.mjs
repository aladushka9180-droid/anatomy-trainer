...
assert.match(providerHtml, /theme-catalog\.js\?v=639/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=639/);
assert.match(indexHtml, /theme-catalog\.js\?v=639/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v639`/);
assert.match(sw, /theme-catalog\.js\?v=639/);
...
console.log('client theme selection v639 tests passed');
