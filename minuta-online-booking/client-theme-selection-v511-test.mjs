...
assert.match(providerHtml, /theme-catalog\.js\?v=666/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=666/);
assert.match(indexHtml, /theme-catalog\.js\?v=666/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v666`/);
assert.match(sw, /theme-catalog\.js\?v=666/);
...
console.log('client theme selection v666 tests passed');
