...
assert.match(providerHtml, /theme-catalog\.js\?v=660/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=660/);
assert.match(indexHtml, /theme-catalog\.js\?v=660/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v659`/);
assert.match(sw, /theme-catalog\.js\?v=660/);
...
console.log('client theme selection v659 tests passed');
