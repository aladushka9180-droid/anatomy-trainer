...
assert.match(providerHtml, /theme-catalog\.js\?v=672/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=672/);
assert.match(indexHtml, /theme-catalog\.js\?v=672/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v672`/);
assert.match(sw, /theme-catalog\.js\?v=672/);
...
console.log('client theme selection v672 tests passed');
