...
assert.match(providerHtml, /theme-catalog\.js\?v=564/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=564/);
assert.match(indexHtml, /theme-catalog\.js\?v=564/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v564`/);
assert.match(sw, /theme-catalog\.js\?v=564/);
...
console.log('client theme selection v564 tests passed');
