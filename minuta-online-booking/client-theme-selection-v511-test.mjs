...
assert.match(providerHtml, /theme-catalog\.js\?v=601/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=601/);
assert.match(indexHtml, /theme-catalog\.js\?v=601/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v601`/);
assert.match(sw, /theme-catalog\.js\?v=601/);
...
console.log('client theme selection v601 tests passed');
