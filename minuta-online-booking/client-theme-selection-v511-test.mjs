...
assert.match(providerHtml, /theme-catalog\.js\?v=753/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=753/);
assert.match(indexHtml, /theme-catalog\.js\?v=753/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v753`/);
assert.match(sw, /theme-catalog\.js\?v=753/);
...
console.log('client theme selection v753 tests passed');
