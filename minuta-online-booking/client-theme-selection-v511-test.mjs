...
assert.match(providerHtml, /theme-catalog\.js\?v=580/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=580/);
assert.match(indexHtml, /theme-catalog\.js\?v=580/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v580`/);
assert.match(sw, /theme-catalog\.js\?v=580/);
...
console.log('client theme selection v580 tests passed');
