...
assert.match(providerHtml, /theme-catalog\.js\?v=657/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=657/);
assert.match(indexHtml, /theme-catalog\.js\?v=657/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v657`/);
assert.match(sw, /theme-catalog\.js\?v=657/);
...
console.log('client theme selection v657 tests passed');
