...
assert.match(providerHtml, /theme-catalog\.js\?v=724/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=724/);
assert.match(indexHtml, /theme-catalog\.js\?v=724/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v724`/);
assert.match(sw, /theme-catalog\.js\?v=724/);
...
console.log('client theme selection v724 tests passed');
