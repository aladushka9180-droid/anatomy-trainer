...
assert.match(providerHtml, /theme-catalog\.js\?v=671/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=671/);
assert.match(indexHtml, /theme-catalog\.js\?v=671/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v671`/);
assert.match(sw, /theme-catalog\.js\?v=671/);
...
console.log('client theme selection v671 tests passed');
