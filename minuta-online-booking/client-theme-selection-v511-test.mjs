...
assert.match(providerHtml, /theme-catalog\.js\?v=692/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=692/);
assert.match(indexHtml, /theme-catalog\.js\?v=692/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v692`/);
assert.match(sw, /theme-catalog\.js\?v=692/);
...
console.log('client theme selection v692 tests passed');
