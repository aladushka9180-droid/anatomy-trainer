...
assert.match(providerHtml, /theme-catalog\.js\?v=767/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=767/);
assert.match(indexHtml, /theme-catalog\.js\?v=767/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v767`/);
assert.match(sw, /theme-catalog\.js\?v=767/);
...
console.log('client theme selection v767 tests passed');
