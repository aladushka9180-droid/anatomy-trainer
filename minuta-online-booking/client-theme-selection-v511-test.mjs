...
assert.match(providerHtml, /theme-catalog\.js\?v=751/);
assert.match(indexHtml, /id="clientThemeDialog"/);
assert.match(indexHtml, /id="clientHeroTitle"/);
assert.match(indexHtml, /client-themes\.css\?v=751/);
assert.match(indexHtml, /theme-catalog\.js\?v=751/);
...
assert.match(sw, /const CACHE = `\$\{CACHE_PREFIX\}v751`/);
assert.match(sw, /theme-catalog\.js\?v=751/);
...
console.log('client theme selection v751 tests passed');
