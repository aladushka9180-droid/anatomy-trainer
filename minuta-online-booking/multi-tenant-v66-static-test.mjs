...
assert.match(providerHtml, /organization\.js\?v=127/i, 'provider must load the v127 organization controller');
assert.match(serviceWorker, /organization\.js\?v=127/i, 'service worker must cache the organization controller');
