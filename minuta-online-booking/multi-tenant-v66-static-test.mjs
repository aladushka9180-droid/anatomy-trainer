...
assert.match(providerHtml, /organization\.js\?v=132/i, 'provider must load the v132 organization controller');
assert.match(serviceWorker, /organization\.js\?v=132/i, 'service worker must cache the organization controller');
