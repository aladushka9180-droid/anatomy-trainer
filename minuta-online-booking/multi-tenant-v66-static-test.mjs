...
assert.match(providerHtml, /organization\.js\?v=133/i, 'provider must load the v133 organization controller');
assert.match(serviceWorker, /organization\.js\?v=133/i, 'service worker must cache the organization controller');
