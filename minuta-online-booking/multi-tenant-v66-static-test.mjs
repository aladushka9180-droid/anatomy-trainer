...
assert.match(providerHtml, /organization\.js\?v=135/i, 'provider must load the v135 organization controller');
assert.match(serviceWorker, /organization\.js\?v=135/i, 'service worker must cache the organization controller');
