...
assert.match(providerHtml, /organization\.js\?v=121/i, 'provider must load the v121 organization controller');
assert.match(serviceWorker, /organization\.js\?v=121/i, 'service worker must cache the organization controller');
