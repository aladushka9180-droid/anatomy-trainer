...
assert.match(providerHtml, /organization\.js\?v=142/i, 'provider must load the current organization controller');
assert.match(serviceWorker, /organization\.js\?v=142/i, 'service worker must cache the organization controller');
