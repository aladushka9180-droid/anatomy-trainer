...
assert.match(providerHtml, /organization\.js\?v=128/i, 'provider must load the v128 organization controller');
assert.match(serviceWorker, /organization\.js\?v=128/i, 'service worker must cache the organization controller');
