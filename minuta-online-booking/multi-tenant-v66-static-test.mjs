...
assert.match(providerHtml, /organization\.js\?v=206/i, 'provider must load the current organization controller');
assert.match(serviceWorker, /organization\.js\?v=206/i, 'service worker must cache the organization controller');
