...
assert.match(providerHtml, /organization\.js\?v=131/i, 'provider must load the v131 organization controller');
assert.match(serviceWorker, /organization\.js\?v=131/i, 'service worker must cache the organization controller');
