...
assert.match(providerHtml, /organization\.js\?v=126/i, 'provider must load the v126 organization controller');
assert.match(serviceWorker, /organization\.js\?v=126/i, 'service worker must cache the organization controller');
