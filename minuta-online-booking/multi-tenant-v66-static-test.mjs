...
assert.match(providerHtml, /organization\.js\?v=130/i, 'provider must load the v130 organization controller');
assert.match(serviceWorker, /organization\.js\?v=130/i, 'service worker must cache the organization controller');
