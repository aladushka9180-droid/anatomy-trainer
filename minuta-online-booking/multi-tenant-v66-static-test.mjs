...
assert.match(providerHtml, /organization\.js\?v=120/i, 'provider must load the v120 organization controller');
assert.match(serviceWorker, /organization\.js\?v=120/i, 'service worker must cache the organization controller');
