...
assert.match(providerHtml, /organization\.js\?v=129/i, 'provider must load the v129 organization controller');
assert.match(serviceWorker, /organization\.js\?v=129/i, 'service worker must cache the organization controller');
