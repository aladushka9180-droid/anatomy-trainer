...
assert.match(providerHtml, /organization\.js\?v=136/i, 'provider must load the v136 organization controller');
assert.match(serviceWorker, /organization\.js\?v=136/i, 'service worker must cache the organization controller');
