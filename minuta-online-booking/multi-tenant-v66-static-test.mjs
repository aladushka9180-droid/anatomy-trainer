...
assert.match(providerHtml, /organization\.js\?v=134/i, 'provider must load the v134 organization controller');
assert.match(serviceWorker, /organization\.js\?v=134/i, 'service worker must cache the organization controller');
