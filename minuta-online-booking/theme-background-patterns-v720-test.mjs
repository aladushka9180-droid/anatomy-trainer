...
assert.match(provider, /theme-catalog\.js\?v=720/);
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v720`/);
assert.match(worker, /\.\/theme-catalog\.js\?v=720/);
...
console.log('Theme background patterns v720: PASS');
