...
for (const html of [index, booking]) {
  ...
  assert.match(html, /telegram-auth\.js\?v=521/, 'Telegram authorization controller is not loaded');
}
...
assert.match(sw, /'\.\/telegram-auth\.js\?v=521'/, 'Telegram authorization controller is not cached');
