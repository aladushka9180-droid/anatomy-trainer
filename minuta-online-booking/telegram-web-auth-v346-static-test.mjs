...
assert.match(html, /telegram-auth\.js\?v=758/, 'Telegram authorization controller is not loaded');
}
...
assert.match(sw, /'\.\/telegram-auth\.js\?v=758'/, 'Telegram authorization controller is not cached');
