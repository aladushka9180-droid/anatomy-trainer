...
assert.match(html, /telegram-auth\.js\?v=799/, 'Telegram authorization controller is not loaded');
}
...
assert.doesNotMatch(sw, /'\.\/telegram-auth\.js\?v=799'/,
  'Server-dependent Telegram authorization must be runtime-cached');
