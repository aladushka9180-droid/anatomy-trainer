...
assert.match(html, /telegram-auth\.js\?v=776/, 'Telegram authorization controller is not loaded');
}
...
assert.match(sw, /'\.\/telegram-auth\.js\?v=776'/, 'Telegram authorization controller is not cached');
