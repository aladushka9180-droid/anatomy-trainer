...
assert.match(html, /report-demo-live\.js\?v=682/, 'Демо-режим не подключает виртуальное течение времени');
assert.match(read('sw.js'), /\.\/report-demo-live\.js\?v=682/, 'Service Worker не кэширует виртуальные демо-данные');
