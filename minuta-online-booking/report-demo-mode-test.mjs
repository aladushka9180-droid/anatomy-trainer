...
assert.match(html, /report-demo-live\.js\?v=604/, 'Демо-режим не подключает виртуальное течение времени');
assert.match(read('sw.js'), /\.\/report-demo-live\.js\?v=604/, 'Service Worker не кэширует виртуальные демо-данные');
