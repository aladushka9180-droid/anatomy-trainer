...
assert.match(html, /report-demo-live\.js\?v=790/, 'Демо-режим не подключает виртуальное течение времени');
assert.match(read('sw.js'), /\.\/report-demo-live\.js\?v=790/, 'Service Worker не кэширует виртуальные демо-данные');
