...
assert.match(sw, /\.\/code-scanner\.js\?v=502/);
assert.match(sw, /\.\/code-scanner\.css\?v=502/);
...
assert.match(providerHtml, /client-records\.js\?v=502/);
assert.match(sw, /\.\/client-records\.js\?v=502/);
...
assert.match(sw, /CACHE_PREFIX}v502/);
