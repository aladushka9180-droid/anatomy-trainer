...
assert.match(sw, /\.\/code-scanner\.js\?v=578/);
assert.match(sw, /\.\/code-scanner\.css\?v=578/);
...
assert.match(providerHtml, /client-records\.js\?v=578/);
assert.match(sw, /\.\/client-records\.js\?v=578/);
...
assert.match(sw, /CACHE_PREFIX}v578/);
