...
assert.match(sw, /\.\/code-scanner\.js\?v=627/);
assert.match(sw, /\.\/code-scanner\.css\?v=627/);
...
assert.match(providerHtml, /client-records\.js\?v=627/);
assert.match(sw, /\.\/client-records\.js\?v=627/);
...
assert.match(sw, /CACHE_PREFIX}v627/);
