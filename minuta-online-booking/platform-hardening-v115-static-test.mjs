...
assert.match(sw, /\.\/code-scanner\.js\?v=691/);
assert.match(sw, /\.\/code-scanner\.css\?v=691/);
...
assert.match(providerHtml, /client-records\.js\?v=691/);
assert.match(sw, /\.\/client-records\.js\?v=691/);
...
assert.match(sw, /CACHE_PREFIX}v691/);
