...
assert.match(sw, /\.\/code-scanner\.js\?v=715/);
assert.match(sw, /\.\/code-scanner\.css\?v=715/);
...
assert.match(providerHtml, /client-records\.js\?v=715/);
assert.match(sw, /\.\/client-records\.js\?v=715/);
...
assert.match(sw, /CACHE_PREFIX}v715/);
