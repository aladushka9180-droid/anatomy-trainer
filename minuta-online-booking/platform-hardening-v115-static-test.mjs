...
assert.match(sw, /\.\/code-scanner\.js\?v=732/);
assert.match(sw, /\.\/code-scanner\.css\?v=732/);
...
assert.match(providerHtml, /client-records\.js\?v=732/);
assert.match(sw, /\.\/client-records\.js\?v=732/);
...
assert.match(sw, /CACHE_PREFIX}v732/);
