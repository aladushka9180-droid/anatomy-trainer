...
assert.match(sw, /\.\/code-scanner\.js\?v=754/);
assert.match(sw, /\.\/code-scanner\.css\?v=754/);
...
assert.match(providerHtml, /client-records\.js\?v=754/);
assert.match(sw, /\.\/client-records\.js\?v=754/);
...
assert.match(sw, /CACHE_PREFIX}v754/);
