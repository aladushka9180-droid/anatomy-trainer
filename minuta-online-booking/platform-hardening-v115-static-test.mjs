...
assert.match(sw, /\.\/code-scanner\.js\?v=516/);
assert.match(sw, /\.\/code-scanner\.css\?v=516/);
...
assert.match(providerHtml, /client-records\.js\?v=516/);
assert.match(sw, /\.\/client-records\.js\?v=516/);
...
assert.match(sw, /CACHE_PREFIX}v516/);
