...
assert.match(sw, /\.\/code-scanner\.js\?v=532/);
assert.match(sw, /\.\/code-scanner\.css\?v=532/);
...
assert.match(providerHtml, /client-records\.js\?v=532/);
assert.match(sw, /\.\/client-records\.js\?v=532/);
...
assert.match(sw, /CACHE_PREFIX}v532/);
