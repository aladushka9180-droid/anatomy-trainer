...
assert.match(sw, /\.\/code-scanner\.js\?v=735/);
assert.match(sw, /\.\/code-scanner\.css\?v=735/);
...
assert.match(providerHtml, /client-records\.js\?v=735/);
assert.match(sw, /\.\/client-records\.js\?v=735/);
...
assert.match(sw, /CACHE_PREFIX}v735/);
