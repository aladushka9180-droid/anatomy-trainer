...
assert.match(sw, /\.\/code-scanner\.js\?v=648/);
assert.match(sw, /\.\/code-scanner\.css\?v=648/);
...
assert.match(providerHtml, /client-records\.js\?v=648/);
assert.match(sw, /\.\/client-records\.js\?v=648/);
...
assert.match(sw, /CACHE_PREFIX}v648/);
