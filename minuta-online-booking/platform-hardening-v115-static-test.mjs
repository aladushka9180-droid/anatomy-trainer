...
assert.match(sw, /\.\/code-scanner\.js\?v=730/);
assert.match(sw, /\.\/code-scanner\.css\?v=730/);
...
assert.match(providerHtml, /client-records\.js\?v=730/);
assert.match(sw, /\.\/client-records\.js\?v=730/);
...
assert.match(sw, /CACHE_PREFIX}v730/);
