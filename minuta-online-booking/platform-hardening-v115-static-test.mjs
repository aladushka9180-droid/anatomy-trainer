...
assert.match(sw, /\.\/code-scanner\.js\?v=761/);
assert.match(sw, /\.\/code-scanner\.css\?v=761/);
...
assert.match(providerHtml, /client-records\.js\?v=761/);
assert.match(sw, /\.\/client-records\.js\?v=761/);
...
assert.match(sw, /CACHE_PREFIX}v761/);
