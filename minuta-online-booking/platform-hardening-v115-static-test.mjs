...
assert.match(sw, /\.\/code-scanner\.js\?v=640/);
assert.match(sw, /\.\/code-scanner\.css\?v=640/);
...
assert.match(providerHtml, /client-records\.js\?v=640/);
assert.match(sw, /\.\/client-records\.js\?v=640/);
...
assert.match(sw, /CACHE_PREFIX}v640/);
