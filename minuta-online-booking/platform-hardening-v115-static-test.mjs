...
assert.match(sw, /\.\/code-scanner\.js\?v=548/);
assert.match(sw, /\.\/code-scanner\.css\?v=548/);
...
assert.match(providerHtml, /client-records\.js\?v=548/);
assert.match(sw, /\.\/client-records\.js\?v=548/);
...
assert.match(sw, /CACHE_PREFIX}v548/);
