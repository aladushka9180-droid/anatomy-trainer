...
assert.match(sw, /\.\/code-scanner\.js\?v=724/);
assert.match(sw, /\.\/code-scanner\.css\?v=724/);
...
assert.match(providerHtml, /client-records\.js\?v=724/);
assert.match(sw, /\.\/client-records\.js\?v=724/);
...
assert.match(sw, /CACHE_PREFIX}v724/);
