...
assert.match(sw, /\.\/code-scanner\.js\?v=643/);
assert.match(sw, /\.\/code-scanner\.css\?v=643/);
...
assert.match(providerHtml, /client-records\.js\?v=643/);
assert.match(sw, /\.\/client-records\.js\?v=643/);
...
assert.match(sw, /CACHE_PREFIX}v643/);
