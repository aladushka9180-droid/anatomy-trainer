...
assert.match(sw, /\.\/code-scanner\.js\?v=580/);
assert.match(sw, /\.\/code-scanner\.css\?v=580/);
...
assert.match(providerHtml, /client-records\.js\?v=580/);
assert.match(sw, /\.\/client-records\.js\?v=580/);
...
assert.match(sw, /CACHE_PREFIX}v580/);
