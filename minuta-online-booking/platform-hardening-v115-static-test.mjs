...
assert.match(sw, /\.\/code-scanner\.js\?v=510/);
assert.match(sw, /\.\/code-scanner\.css\?v=510/);
...
assert.match(providerHtml, /client-records\.js\?v=510/);
assert.match(sw, /\.\/client-records\.js\?v=510/);
