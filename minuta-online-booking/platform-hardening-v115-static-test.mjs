...
assert.match(sw, /\.\/code-scanner\.js\?v=584/);
assert.match(sw, /\.\/code-scanner\.css\?v=584/);
...
assert.match(providerHtml, /client-records\.js\?v=584/);
assert.match(sw, /\.\/client-records\.js\?v=584/);
...
assert.match(sw, /CACHE_PREFIX}v584/);
