...
assert.match(sw, /\.\/code-scanner\.js\?v=620/);
assert.match(sw, /\.\/code-scanner\.css\?v=620/);
...
assert.match(providerHtml, /client-records\.js\?v=620/);
assert.match(sw, /\.\/client-records\.js\?v=620/);
...
assert.match(sw, /CACHE_PREFIX}v620/);
