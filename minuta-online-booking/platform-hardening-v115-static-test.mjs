...
assert.match(sw, /\.\/code-scanner\.js\?v=551/);
assert.match(sw, /\.\/code-scanner\.css\?v=551/);
...
assert.match(providerHtml, /client-records\.js\?v=551/);
assert.match(sw, /\.\/client-records\.js\?v=551/);
...
assert.match(sw, /CACHE_PREFIX}v551/);
