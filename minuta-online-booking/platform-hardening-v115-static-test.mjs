...
assert.match(sw, /\.\/code-scanner\.js\?v=651/);
assert.match(sw, /\.\/code-scanner\.css\?v=651/);
...
assert.match(providerHtml, /client-records\.js\?v=651/);
assert.match(sw, /\.\/client-records\.js\?v=651/);
...
assert.match(sw, /CACHE_PREFIX}v651/);
