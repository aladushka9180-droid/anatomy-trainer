...
assert.match(sw, /\.\/code-scanner\.js\?v=682/);
assert.match(sw, /\.\/code-scanner\.css\?v=682/);
...
assert.match(providerHtml, /client-records\.js\?v=682/);
assert.match(sw, /\.\/client-records\.js\?v=682/);
...
assert.match(sw, /CACHE_PREFIX}v682/);
