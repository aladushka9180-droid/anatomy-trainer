...
assert.match(sw, /\.\/code-scanner\.js\?v=511/);
assert.match(sw, /\.\/code-scanner\.css\?v=511/);
...
assert.match(providerHtml, /client-records\.js\?v=511/);
assert.match(sw, /\.\/client-records\.js\?v=511/);
