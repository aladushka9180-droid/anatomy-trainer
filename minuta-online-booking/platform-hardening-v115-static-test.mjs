...
assert.match(sw, /\.\/code-scanner\.js\?v=687/);
assert.match(sw, /\.\/code-scanner\.css\?v=687/);
...
assert.match(providerHtml, /client-records\.js\?v=687/);
assert.match(sw, /\.\/client-records\.js\?v=687/);
...
assert.match(sw, /CACHE_PREFIX}v687/);
