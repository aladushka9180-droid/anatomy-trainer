...
assert.match(sw, /\.\/code-scanner\.js\?v=570/);
assert.match(sw, /\.\/code-scanner\.css\?v=570/);
...
assert.match(providerHtml, /client-records\.js\?v=570/);
assert.match(sw, /\.\/client-records\.js\?v=570/);
...
assert.match(sw, /CACHE_PREFIX}v570/);
