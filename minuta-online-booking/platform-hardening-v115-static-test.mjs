...
assert.match(sw, /\.\/code-scanner\.js\?v=515/);
assert.match(sw, /\.\/code-scanner\.css\?v=515/);
...
assert.match(providerHtml, /client-records\.js\?v=515/);
assert.match(sw, /\.\/client-records\.js\?v=515/);
...
assert.match(sw, /CACHE_PREFIX}v515/);
