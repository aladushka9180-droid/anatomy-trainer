...
assert.match(sw, /\.\/code-scanner\.js\?v=519/);
assert.match(sw, /\.\/code-scanner\.css\?v=519/);
...
assert.match(providerHtml, /client-records\.js\?v=519/);
assert.match(sw, /\.\/client-records\.js\?v=519/);
...
assert.match(sw, /CACHE_PREFIX}v519/);
