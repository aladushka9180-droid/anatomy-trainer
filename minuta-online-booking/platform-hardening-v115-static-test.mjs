...
assert.match(sw, /\.\/code-scanner\.js\?v=726/);
assert.match(sw, /\.\/code-scanner\.css\?v=726/);
...
assert.match(providerHtml, /client-records\.js\?v=726/);
assert.match(sw, /\.\/client-records\.js\?v=726/);
...
assert.match(sw, /CACHE_PREFIX}v726/);
