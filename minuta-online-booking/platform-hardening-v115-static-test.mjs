...
assert.match(sw, /\.\/code-scanner\.js\?v=740/);
assert.match(sw, /\.\/code-scanner\.css\?v=740/);
...
assert.match(providerHtml, /client-records\.js\?v=740/);
assert.match(sw, /\.\/client-records\.js\?v=740/);
...
assert.match(sw, /CACHE_PREFIX}v740/);
