...
assert.match(sw, /\.\/code-scanner\.js\?v=674/);
assert.match(sw, /\.\/code-scanner\.css\?v=674/);
...
assert.match(providerHtml, /client-records\.js\?v=674/);
assert.match(sw, /\.\/client-records\.js\?v=674/);
...
assert.match(sw, /CACHE_PREFIX}v674/);
