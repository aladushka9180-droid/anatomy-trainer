...
assert.match(sw, /\.\/code-scanner\.js\?v=677/);
assert.match(sw, /\.\/code-scanner\.css\?v=677/);
...
assert.match(providerHtml, /client-records\.js\?v=677/);
assert.match(sw, /\.\/client-records\.js\?v=677/);
...
assert.match(sw, /CACHE_PREFIX}v677/);
