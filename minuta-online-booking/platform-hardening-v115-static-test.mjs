...
assert.match(sw, /\.\/code-scanner\.js\?v=792/);
assert.match(sw, /\.\/code-scanner\.css\?v=792/);
...
assert.match(providerHtml, /client-records\.js\?v=792/);
assert.match(sw, /\.\/client-records\.js\?v=792/);
...
assert.match(sw, /CACHE_PREFIX}v792/);
