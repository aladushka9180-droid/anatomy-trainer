...
assert.match(sw, /\.\/code-scanner\.js\?v=750/);
assert.match(sw, /\.\/code-scanner\.css\?v=750/);
...
assert.match(providerHtml, /client-records\.js\?v=750/);
assert.match(sw, /\.\/client-records\.js\?v=750/);
...
assert.match(sw, /CACHE_PREFIX}v750/);
