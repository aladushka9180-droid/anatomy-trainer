...
assert.match(sw, /\.\/code-scanner\.js\?v=713/);
assert.match(sw, /\.\/code-scanner\.css\?v=713/);
...
assert.match(providerHtml, /client-records\.js\?v=713/);
assert.match(sw, /\.\/client-records\.js\?v=713/);
...
assert.match(sw, /CACHE_PREFIX}v713/);
