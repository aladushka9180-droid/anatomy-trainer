...
assert.match(sw, /\.\/code-scanner\.js\?v=752/);
assert.match(sw, /\.\/code-scanner\.css\?v=752/);
...
assert.match(providerHtml, /client-records\.js\?v=752/);
assert.match(sw, /\.\/client-records\.js\?v=752/);
...
assert.match(sw, /CACHE_PREFIX}v752/);
