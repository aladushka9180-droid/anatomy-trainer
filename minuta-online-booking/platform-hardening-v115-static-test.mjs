...
assert.match(sw, /\.\/code-scanner\.js\?v=764/);
assert.match(sw, /\.\/code-scanner\.css\?v=764/);
...
assert.match(providerHtml, /client-records\.js\?v=764/);
assert.match(sw, /\.\/client-records\.js\?v=764/);
...
assert.match(sw, /CACHE_PREFIX}v764/);
