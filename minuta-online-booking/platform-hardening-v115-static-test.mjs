...
assert.match(sw, /\.\/code-scanner\.js\?v=638/);
assert.match(sw, /\.\/code-scanner\.css\?v=638/);
...
assert.match(providerHtml, /client-records\.js\?v=638/);
assert.match(sw, /\.\/client-records\.js\?v=638/);
...
assert.match(sw, /CACHE_PREFIX}v638/);
