...
assert.match(sw, /\.\/code-scanner\.js\?v=658/);
assert.match(sw, /\.\/code-scanner\.css\?v=658/);
...
assert.match(providerHtml, /client-records\.js\?v=658/);
assert.match(sw, /\.\/client-records\.js\?v=658/);
...
assert.match(sw, /CACHE_PREFIX}v658/);
