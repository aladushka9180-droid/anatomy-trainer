...
const financeController = read('../finance-center.js');
...
assert.match(html, /id="reportRevenue"/);
assert.match(html, /id="financeExpenses"/);
assert.match(html, /id="financeNet"/);
assert.match(financeController, /get_minuta_finance_expenses_v163/);
assert.match(html, /id="clientCommerceHistory"/);
assert.match(html, /commerce-management\.js\?v=796/);
assert.match(worker, /commerce-management\.js\?v=796/);
