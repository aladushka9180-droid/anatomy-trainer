...
assert.match(html, /id="commerceRefundEmpty"[\s\S]*Возврат станет доступен после первой продажи/);
...
assert.match(html, /commerce-management\.js\?v=729/);
assert.match(worker, /commerce-management\.js\?v=729/);
