...
assert.match(html, /commerce-management\.js\?v=739/);
assert.match(html, /styles\.css\?v=739/);
assert.match(worker, /commerce-management\.js\?v=739/);
assert.match(worker, /styles\.css\?v=739/);
assert.match(worker, /CACHE_PREFIX}v739/);
