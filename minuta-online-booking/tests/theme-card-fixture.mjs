...
function runner() {
  return `<!doctype html><html lang="ru"><meta charset="utf-8"><title>Матрица оформления</title><h1>32 темы × 6 компоновок × 2 ширины</h1><p>Локальные тестовые карточки, без доступа к клиентской базе.</p><button id="run">Проверить все сочетания</button><pre id="result" role="status">Готово к проверке</pre><iframe title="Проверяемые карточки" src="/fixture" style="width:390px;height:900px;border:0"></iframe><script type="module">
