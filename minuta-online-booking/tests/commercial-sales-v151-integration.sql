...
begin
  ...
  perform public.sell_minuta_commercial_product_v151(organization_id,booking_id,client_id,seller_id,'benefit_product',pass_id,null,null,1,300000,0,'cash',cash_id,gen_random_uuid());
