...
assert.match(providerHtml, /site-update\.js\?v=880/);
assert.match(providerHtml, /provider\.js\?v=878/);
assert.match(workerSource, /CACHE = `\$\{CACHE_PREFIX\}v880`/);
assert.match(workerSource, /provider-ux\.css\?v=865/);
assert.match(workerSource, /site-update\.js\?v=880/);
assert.match(workerSource, /provider\.js\?v=878/);
assert.match(updateSource, /sw\.js\?v=880/);
