...
for(const asset of ['./messages.html','./messages-center.css?v=811','./messages-core.js?v=811','./provider-messages-center.js?v=811','./client-messages.js?v=885'])assert.ok(sw.includes(asset),`${asset} is not cached by sw.js`);
