...
assert.match(provider, /provider-theme-families\.css\?v=797[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=797/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=797/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=797/);

console.log('Provider theme families v797: PASS (39 themes, 9 families).');
