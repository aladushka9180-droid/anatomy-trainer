...
assert.match(provider, /provider-theme-families\.css\?v=780[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=780/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=780/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=780/);

console.log('Provider theme families v780: PASS (39 themes, 9 families).');
