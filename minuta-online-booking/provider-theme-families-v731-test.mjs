...
assert.match(provider, /provider-theme-families\.css\?v=791[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=791/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=791/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=791/);

console.log('Provider theme families v791: PASS (39 themes, 9 families).');
