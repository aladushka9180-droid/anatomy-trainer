...
assert.match(provider, /provider-theme-families\.css\?v=790[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=790/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=790/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=790/);

console.log('Provider theme families v790: PASS (39 themes, 9 families).');
