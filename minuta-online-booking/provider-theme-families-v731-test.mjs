...
assert.match(provider, /provider-theme-families\.css\?v=782[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=782/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=782/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=782/);

console.log('Provider theme families v782: PASS (39 themes, 9 families).');
