...
assert.match(provider, /provider-theme-families\.css\?v=783[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=783/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=783/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=783/);

console.log('Provider theme families v783: PASS (39 themes, 9 families).');
