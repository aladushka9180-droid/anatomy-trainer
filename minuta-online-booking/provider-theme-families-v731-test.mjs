...
assert.match(provider, /provider-theme-families\.css\?v=741[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=741/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=741/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=741/);

console.log('Provider theme families v741: PASS (39 themes, 9 families).');
