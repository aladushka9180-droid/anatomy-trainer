...
assert.match(provider, /provider-theme-families\.css\?v=736[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=736/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=736/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=736/);

console.log('Provider theme families v736: PASS (39 themes, 9 families).');
