...
assert.match(provider, /provider-theme-families\.css\?v=799[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=799/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=799/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=799/);

console.log('Provider theme families v799: PASS (39 themes, 9 families).');
