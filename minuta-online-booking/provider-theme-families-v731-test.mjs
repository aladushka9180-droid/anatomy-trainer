...
assert.match(provider, /provider-theme-families\.css\?v=761[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=761/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=761/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=761/);

console.log('Provider theme families v761: PASS (39 themes, 9 families).');
