...
assert.match(provider, /provider-theme-families\.css\?v=738[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=738/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=738/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=738/);

console.log('Provider theme families v738: PASS (39 themes, 9 families).');
