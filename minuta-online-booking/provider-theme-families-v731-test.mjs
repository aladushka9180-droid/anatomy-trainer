...
assert.match(provider, /provider-theme-families\.css\?v=765[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=765/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=765/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=765/);

console.log('Provider theme families v765: PASS (39 themes, 9 families).');
