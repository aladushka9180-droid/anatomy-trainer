...
assert.match(provider, /provider-theme-families\.css\?v=774[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=774/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=774/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=774/);

console.log('Provider theme families v774: PASS (39 themes, 9 families).');
