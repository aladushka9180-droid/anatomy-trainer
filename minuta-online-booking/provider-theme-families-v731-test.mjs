...
assert.match(provider, /provider-theme-families\.css\?v=801[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=801/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=801/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=801/);

console.log('Provider theme families v801: PASS (39 themes, 9 families).');
