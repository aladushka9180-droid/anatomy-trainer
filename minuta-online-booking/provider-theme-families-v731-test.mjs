...
assert.match(provider, /provider-theme-families\.css\?v=779[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=779/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=779/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=779/);

console.log('Provider theme families v779: PASS (39 themes, 9 families).');
