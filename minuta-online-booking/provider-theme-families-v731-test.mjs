...
assert.match(provider, /provider-theme-families\.css\?v=784[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=784/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=784/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=784/);

console.log('Provider theme families v784: PASS (39 themes, 9 families).');
