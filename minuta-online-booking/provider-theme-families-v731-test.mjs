...
assert.match(provider, /provider-theme-families\.css\?v=792[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=792/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=792/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=792/);

console.log('Provider theme families v792: PASS (39 themes, 9 families).');
