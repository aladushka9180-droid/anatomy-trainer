...
assert.match(provider, /provider-theme-families\.css\?v=804[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=804/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=804/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=804/);

console.log('Provider theme families v804: PASS (39 themes, 9 families).');
