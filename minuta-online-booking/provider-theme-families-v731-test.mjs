...
assert.match(provider, /provider-theme-families\.css\?v=773[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=773/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=773/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=773/);

console.log('Provider theme families v773: PASS (39 themes, 9 families).');
