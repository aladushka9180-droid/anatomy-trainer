...
assert.match(provider, /provider-theme-families\.css\?v=810[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=810/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=810/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=810/);

console.log('Provider theme families v810: PASS (39 themes, 9 families).');
