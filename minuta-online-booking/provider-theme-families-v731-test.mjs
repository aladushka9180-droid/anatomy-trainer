...
assert.match(provider, /provider-theme-families\.css\?v=795[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=795/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=795/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=795/);

console.log('Provider theme families v795: PASS (39 themes, 9 families).');
