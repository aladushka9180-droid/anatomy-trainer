...
assert.match(provider, /provider-theme-families\.css\?v=742[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=742/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=742/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=742/);

console.log('Provider theme families v742: PASS (39 themes, 9 families).');
