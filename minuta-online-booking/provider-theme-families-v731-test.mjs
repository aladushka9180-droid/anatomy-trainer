...
assert.match(provider, /provider-theme-families\.css\?v=807[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=807/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=807/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=807/);

console.log('Provider theme families v807: PASS (39 themes, 9 families).');
