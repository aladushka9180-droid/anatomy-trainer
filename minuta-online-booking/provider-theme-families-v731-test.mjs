...
assert.match(provider, /provider-theme-families\.css\?v=800[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=800/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=800/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=800/);

console.log('Provider theme families v800: PASS (39 themes, 9 families).');
