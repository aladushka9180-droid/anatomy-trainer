...
assert.match(provider, /provider-theme-families\.css\?v=805[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=805/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=805/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=805/);

console.log('Provider theme families v805: PASS (39 themes, 9 families).');
