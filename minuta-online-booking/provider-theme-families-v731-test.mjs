...
assert.match(provider, /provider-theme-families\.css\?v=763[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=763/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=763/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=763/);

console.log('Provider theme families v763: PASS (39 themes, 9 families).');
