...
assert.match(provider, /provider-theme-families\.css\?v=785[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=785/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=785/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=785/);

console.log('Provider theme families v785: PASS (39 themes, 9 families).');
