...
assert.match(provider, /provider-theme-families\.css\?v=754[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=754/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=754/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=754/);

console.log('Provider theme families v754: PASS (39 themes, 9 families).');
