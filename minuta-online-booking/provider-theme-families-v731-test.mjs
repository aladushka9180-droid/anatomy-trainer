...
assert.match(provider, /provider-theme-families\.css\?v=757[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=757/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=757/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=757/);

console.log('Provider theme families v757: PASS (39 themes, 9 families).');
