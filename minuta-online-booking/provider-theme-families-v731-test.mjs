...
assert.match(provider, /provider-theme-families\.css\?v=748[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=748/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=748/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=748/);

console.log('Provider theme families v748: PASS (39 themes, 9 families).');
