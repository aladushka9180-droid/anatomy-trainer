...
assert.match(provider, /provider-theme-families\.css\?v=806[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=806/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=806/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=806/);

console.log('Provider theme families v806: PASS (39 themes, 9 families).');
