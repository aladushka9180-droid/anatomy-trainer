...
assert.match(provider, /provider-theme-families\.css\?v=737[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=737/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=737/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=737/);

console.log('Provider theme families v737: PASS (39 themes, 9 families).');
