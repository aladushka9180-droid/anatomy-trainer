...
assert.match(provider, /provider-theme-families\.css\?v=803[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=803/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=803/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=803/);

console.log('Provider theme families v803: PASS (39 themes, 9 families).');
