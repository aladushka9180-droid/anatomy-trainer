...
assert.match(provider, /provider-theme-families\.css\?v=796[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=796/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=796/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=796/);

console.log('Provider theme families v796: PASS (39 themes, 9 families).');
