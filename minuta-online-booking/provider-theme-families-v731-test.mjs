...
assert.match(provider, /provider-theme-families\.css\?v=772[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=772/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=772/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=772/);

console.log('Provider theme families v772: PASS (39 themes, 9 families).');
