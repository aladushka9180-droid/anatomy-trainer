...
assert.match(provider, /provider-theme-families\.css\?v=767[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=767/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=767/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=767/);

console.log('Provider theme families v767: PASS (39 themes, 9 families).');
