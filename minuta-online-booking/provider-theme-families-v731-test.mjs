...
assert.match(provider, /provider-theme-families\.css\?v=743[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=743/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=743/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=743/);

console.log('Provider theme families v743: PASS (39 themes, 9 families).');
