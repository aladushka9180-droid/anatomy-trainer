...
assert.match(provider, /provider-theme-families\.css\?v=756[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=756/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=756/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=756/);

console.log('Provider theme families v756: PASS (39 themes, 9 families).');
