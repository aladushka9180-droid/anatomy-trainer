...
assert.match(provider, /provider-theme-families\.css\?v=740[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=740/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=740/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=740/);

console.log('Provider theme families v740: PASS (39 themes, 9 families).');
