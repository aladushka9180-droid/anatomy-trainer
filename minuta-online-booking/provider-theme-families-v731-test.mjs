...
assert.match(provider, /provider-theme-families\.css\?v=802[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=802/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=802/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=802/);

console.log('Provider theme families v802: PASS (39 themes, 9 families).');
