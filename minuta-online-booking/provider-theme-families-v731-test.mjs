...
assert.match(provider, /provider-theme-families\.css\?v=776[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=776/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=776/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=776/);

console.log('Provider theme families v776: PASS (39 themes, 9 families).');
