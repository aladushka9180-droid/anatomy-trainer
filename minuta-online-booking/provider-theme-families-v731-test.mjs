...
assert.match(provider, /provider-theme-families\.css\?v=794[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=794/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=794/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=794/);

console.log('Provider theme families v794: PASS (39 themes, 9 families).');
