...
assert.match(provider, /provider-theme-families\.css\?v=793[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=793/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=793/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=793/);

console.log('Provider theme families v793: PASS (39 themes, 9 families).');
