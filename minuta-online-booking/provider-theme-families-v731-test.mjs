...
assert.match(provider, /provider-theme-families\.css\?v=777[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=777/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=777/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=777/);

console.log('Provider theme families v777: PASS (39 themes, 9 families).');
