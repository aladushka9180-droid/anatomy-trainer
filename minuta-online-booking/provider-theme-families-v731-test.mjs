...
assert.match(provider, /provider-theme-families\.css\?v=786[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=786/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=786/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=786/);

console.log('Provider theme families v786: PASS (39 themes, 9 families).');
