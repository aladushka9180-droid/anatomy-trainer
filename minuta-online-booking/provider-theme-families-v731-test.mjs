...
assert.match(provider, /provider-theme-families\.css\?v=755[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=755/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=755/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=755/);

console.log('Provider theme families v755: PASS (39 themes, 9 families).');
