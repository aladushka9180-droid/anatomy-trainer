...
assert.match(provider, /provider-theme-families\.css\?v=760[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=760/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=760/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=760/);

console.log('Provider theme families v760: PASS (39 themes, 9 families).');
