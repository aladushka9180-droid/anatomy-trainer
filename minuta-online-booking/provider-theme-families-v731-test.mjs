...
assert.match(provider, /provider-theme-families\.css\?v=778[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=778/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=778/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=778/);

console.log('Provider theme families v778: PASS (39 themes, 9 families).');
