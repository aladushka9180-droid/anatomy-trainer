...
assert.match(provider, /provider-theme-families\.css\?v=781[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=781/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=781/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=781/);

console.log('Provider theme families v781: PASS (39 themes, 9 families).');
