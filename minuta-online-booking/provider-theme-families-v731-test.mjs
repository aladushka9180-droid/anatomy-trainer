...
assert.match(provider, /provider-theme-families\.css\?v=775[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=775/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=775/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=775/);

console.log('Provider theme families v775: PASS (39 themes, 9 families).');
