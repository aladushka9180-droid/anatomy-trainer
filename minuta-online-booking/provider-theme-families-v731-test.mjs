...
assert.match(provider, /provider-theme-families\.css\?v=808[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=808/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=808/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=808/);

console.log('Provider theme families v808: PASS (39 themes, 9 families).');
