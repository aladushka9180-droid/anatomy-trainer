...
assert.match(provider, /provider-theme-families\.css\?v=769[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=769/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=769/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=769/);

console.log('Provider theme families v769: PASS (39 themes, 9 families).');
