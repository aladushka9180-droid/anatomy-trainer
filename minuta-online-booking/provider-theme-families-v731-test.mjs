...
assert.match(provider, /provider-theme-families\.css\?v=768[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=768/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=768/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=768/);

console.log('Provider theme families v768: PASS (39 themes, 9 families).');
