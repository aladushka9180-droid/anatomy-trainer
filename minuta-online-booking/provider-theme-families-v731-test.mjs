...
assert.match(provider, /provider-theme-families\.css\?v=764[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=764/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=764/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=764/);

console.log('Provider theme families v764: PASS (39 themes, 9 families).');
