...
assert.match(provider, /provider-theme-families\.css\?v=766[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=766/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=766/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=766/);

console.log('Provider theme families v766: PASS (39 themes, 9 families).');
