...
assert.match(provider, /provider-theme-families\.css\?v=798[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=798/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=798/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=798/);

console.log('Provider theme families v798: PASS (39 themes, 9 families).');
