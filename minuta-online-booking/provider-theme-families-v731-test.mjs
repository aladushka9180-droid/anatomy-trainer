...
assert.match(provider, /provider-theme-families\.css\?v=809[\s\S]*?provider-theme-backgrounds-tema1\.css\?v=809/);
assert.match(worker, /\.\/provider-theme-families\.css\?v=809/);
assert.match(worker, /\.\/provider-theme-backgrounds-tema1\.css\?v=809/);

console.log('Provider theme families v809: PASS (39 themes, 9 families).');
