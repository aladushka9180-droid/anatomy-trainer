...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=723"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=723"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=723"/);
...
assert.match(worker, /provider\.webmanifest\?v=723/);
...
assert.match(provider, /provider\.js\?v=723/);

console.log(`PrimeTime Pro brand v723: PASS (${publicBrandFiles.length} public text surfaces)`);
