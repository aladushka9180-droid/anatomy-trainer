...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=722"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=722"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=722"/);
...
assert.match(worker, /provider\.webmanifest\?v=722/);
...
assert.match(provider, /provider\.js\?v=722/);

console.log(`PrimeTime Pro brand v722: PASS (${publicBrandFiles.length} public text surfaces)`);
