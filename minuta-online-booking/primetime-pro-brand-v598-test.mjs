...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=745"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=745"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=745"/);
...
assert.match(worker, /provider\.webmanifest\?v=745/);
...
assert.match(provider, /provider\.js\?v=745/);

console.log(`PrimeTime Pro brand v745: PASS (${publicBrandFiles.length} public text surfaces)`);
