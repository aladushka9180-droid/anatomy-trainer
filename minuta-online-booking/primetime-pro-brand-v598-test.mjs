...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=754"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=754"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=754"/);
...
assert.match(worker, /provider\.webmanifest\?v=754/);
...
assert.match(provider, /provider\.js\?v=754/);

console.log(`PrimeTime Pro brand v754: PASS (${publicBrandFiles.length} public text surfaces)`);
