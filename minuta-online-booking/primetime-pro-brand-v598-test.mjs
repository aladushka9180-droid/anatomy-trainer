...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=744"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=744"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=744"/);
...
assert.match(worker, /provider\.webmanifest\?v=744/);
...
assert.match(provider, /provider\.js\?v=744/);

console.log(`PrimeTime Pro brand v744: PASS (${publicBrandFiles.length} public text surfaces)`);
