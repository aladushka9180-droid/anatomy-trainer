...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=724"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=724"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=724"/);
...
assert.match(worker, /provider\.webmanifest\?v=724/);
...
assert.match(provider, /provider\.js\?v=724/);

console.log(`PrimeTime Pro brand v724: PASS (${publicBrandFiles.length} public text surfaces)`);
