...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=736"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=736"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=736"/);
...
assert.match(worker, /provider\.webmanifest\?v=736/);
...
assert.match(provider, /provider\.js\?v=736/);

console.log(`PrimeTime Pro brand v736: PASS (${publicBrandFiles.length} public text surfaces)`);
