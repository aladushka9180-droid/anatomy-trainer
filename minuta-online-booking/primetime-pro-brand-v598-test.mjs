...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=764"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=764"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=764"/);
...
assert.match(worker, /provider\.webmanifest\?v=764/);
...
assert.match(provider, /provider\.js\?v=764/);

console.log(`PrimeTime Pro brand v764: PASS (${publicBrandFiles.length} public text surfaces)`);
