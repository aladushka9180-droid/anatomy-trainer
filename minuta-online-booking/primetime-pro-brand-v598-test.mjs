...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=753"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=753"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=753"/);
...
assert.match(worker, /provider\.webmanifest\?v=753/);
...
assert.match(provider, /provider\.js\?v=753/);

console.log(`PrimeTime Pro brand v753: PASS (${publicBrandFiles.length} public text surfaces)`);
