...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=738"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=738"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=738"/);
...
assert.match(worker, /provider\.webmanifest\?v=738/);
...
assert.match(provider, /provider\.js\?v=738/);

console.log(`PrimeTime Pro brand v738: PASS (${publicBrandFiles.length} public text surfaces)`);
