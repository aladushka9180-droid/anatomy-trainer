...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=735"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=735"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=735"/);
...
assert.match(worker, /provider\.webmanifest\?v=735/);
...
assert.match(provider, /provider\.js\?v=735/);

console.log(`PrimeTime Pro brand v735: PASS (${publicBrandFiles.length} public text surfaces)`);
