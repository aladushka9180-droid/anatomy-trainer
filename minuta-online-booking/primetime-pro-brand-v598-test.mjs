...
assert.match(provider, /rel="icon" href="provider-icon\.svg\?v=725"/);
assert.match(provider, /property="og:image" content="[^"]+\/provider-og\.png\?v=725"/);
assert.match(provider, /name="twitter:image" content="[^"]+\/provider-og\.png\?v=725"/);
...
assert.match(worker, /provider\.webmanifest\?v=725/);
...
assert.match(provider, /provider\.js\?v=725/);

console.log(`PrimeTime Pro brand v725: PASS (${publicBrandFiles.length} public text surfaces)`);
