...
for(const marker of ['data-provider-view="messages"','data-provider-panel="messages"','provider-messages-center.js?v=797'])assert.ok(providerHtml.includes(marker),marker);
