...
for(const marker of ['data-provider-view="messages"','data-provider-panel="messages"','provider-messages-center.js?v=798'])assert.ok(providerHtml.includes(marker),marker);
