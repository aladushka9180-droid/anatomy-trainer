...
assert.match(html, /provider-feedback-inbox\.js\?v=717/);
...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v717`/);
assert.match(worker, /'\.\/provider-feedback-inbox\.js\?v=717'/);
