...
assert.match(html, /provider-feedback-inbox\.js\?v=716/);
...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v716`/);
assert.match(worker, /'\.\/provider-feedback-inbox\.js\?v=716'/);
