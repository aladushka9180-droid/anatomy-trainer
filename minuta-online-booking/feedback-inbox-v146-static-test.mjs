...
assert.match(html, /provider-feedback-inbox\.js\?v=718/);
...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v718`/);
assert.match(worker, /'\.\/provider-feedback-inbox\.js\?v=718'/);
