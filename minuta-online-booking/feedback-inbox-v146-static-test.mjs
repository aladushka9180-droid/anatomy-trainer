...
assert.match(html, /provider-feedback-inbox\.js\?v=719/);
...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v719`/);
assert.match(worker, /'\.\/provider-feedback-inbox\.js\?v=719'/);
