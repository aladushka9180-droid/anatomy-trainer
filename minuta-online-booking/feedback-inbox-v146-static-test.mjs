...
assert.match(html, /provider-feedback-inbox\.js\?v=713/);
...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v713`/);
assert.match(worker, /'\.\/provider-feedback-inbox\.js\?v=713'/);
