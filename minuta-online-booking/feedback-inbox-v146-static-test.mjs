...
assert.match(html, /provider-feedback-inbox\.js\?v=712/);
...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v712`/);
assert.match(worker, /'\.\/provider-feedback-inbox\.js\?v=712'/);
