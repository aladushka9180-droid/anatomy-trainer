...
assert.match(html, /provider-feedback-inbox\.js\?v=715/);
...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v715`/);
assert.match(worker, /'\.\/provider-feedback-inbox\.js\?v=715'/);
