...
assert.match(html, /provider-feedback-inbox\.js\?v=714/);
...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v714`/);
assert.match(worker, /'\.\/provider-feedback-inbox\.js\?v=714'/);
