...
assert.match(html, /provider-feedback-inbox\.js\?v=711/);
...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v711`/);
assert.match(worker, /'\.\/provider-feedback-inbox\.js\?v=711'/);
