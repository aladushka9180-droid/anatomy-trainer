...
do $$ begin
  if to_regprocedure('public.upsert_minuta_inventory_warehouse(uuid,uuid,uuid,text,boolean)') is null then
    raise exception using errcode='P0001',message='v108_rollback_requires_inventory_v82';
  end if;
end $$;
