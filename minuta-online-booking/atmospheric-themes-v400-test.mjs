...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v656`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=656/, 'Кабинет не подключает актуальные стили');
