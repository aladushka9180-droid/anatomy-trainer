...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v531`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=531/, 'Кабинет не подключает актуальные стили');
