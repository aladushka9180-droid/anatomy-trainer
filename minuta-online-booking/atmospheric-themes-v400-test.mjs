...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v520`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=520/, 'Кабинет не подключает актуальные стили');
