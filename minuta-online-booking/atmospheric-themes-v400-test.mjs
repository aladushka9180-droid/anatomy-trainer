...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v423`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=423/, 'Кабинет не подключает актуальные стили');
