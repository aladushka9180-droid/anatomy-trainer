...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v461`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=461/, 'Кабинет не подключает актуальные стили');
