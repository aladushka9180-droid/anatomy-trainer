...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v560`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=560/, 'Кабинет не подключает актуальные стили');
