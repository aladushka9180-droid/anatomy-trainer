...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v652`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=652/, 'Кабинет не подключает актуальные стили');
