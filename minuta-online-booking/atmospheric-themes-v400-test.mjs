...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v505`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=505/, 'Кабинет не подключает актуальные стили');
