...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v484`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=484/, 'Кабинет не подключает актуальные стили');
