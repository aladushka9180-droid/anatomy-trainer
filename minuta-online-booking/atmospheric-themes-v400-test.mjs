...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v704`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=704/, 'Кабинет не подключает актуальные стили');
