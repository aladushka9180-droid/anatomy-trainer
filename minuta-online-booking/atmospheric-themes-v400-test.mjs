...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v756`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=756/, 'Кабинет не подключает актуальные стили');
