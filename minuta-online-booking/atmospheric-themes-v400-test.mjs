...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v556`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=556/, 'Кабинет не подключает актуальные стили');
