...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v792`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=792/, 'Кабинет не подключает актуальные стили');
