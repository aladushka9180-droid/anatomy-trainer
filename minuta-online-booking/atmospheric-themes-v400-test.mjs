...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v661`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=661/, 'Кабинет не подключает актуальные стили');
