...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v468`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=468/, 'Кабинет не подключает актуальные стили');
