...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v586`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=586/, 'Кабинет не подключает актуальные стили');
