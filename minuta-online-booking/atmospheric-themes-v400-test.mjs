...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v725`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=725/, 'Кабинет не подключает актуальные стили');
