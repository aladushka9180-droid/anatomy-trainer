...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v571`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=571/, 'Кабинет не подключает актуальные стили');
