...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v681`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=681/, 'Кабинет не подключает актуальные стили');
