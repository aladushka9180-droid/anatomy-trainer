...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v402`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=402/, 'Кабинет не подключает актуальные стили');
