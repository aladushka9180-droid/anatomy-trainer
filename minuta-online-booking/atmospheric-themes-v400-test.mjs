...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v526`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=526/, 'Кабинет не подключает актуальные стили');
