...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v432`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=432/, 'Кабинет не подключает актуальные стили');
