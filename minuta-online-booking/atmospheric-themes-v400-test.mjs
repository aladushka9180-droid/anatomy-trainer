...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v749`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=749/, 'Кабинет не подключает актуальные стили');
