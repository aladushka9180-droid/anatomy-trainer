...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v806`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=806/, 'Кабинет не подключает актуальные стили');
