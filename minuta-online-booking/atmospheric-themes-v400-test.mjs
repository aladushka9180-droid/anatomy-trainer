...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v700`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=700/, 'Кабинет не подключает актуальные стили');
