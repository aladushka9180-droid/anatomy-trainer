...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v668`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=668/, 'Кабинет не подключает актуальные стили');
