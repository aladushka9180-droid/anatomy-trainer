...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v594`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=594/, 'Кабинет не подключает актуальные стили');
