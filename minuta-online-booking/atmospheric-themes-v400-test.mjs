...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v475`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=475/, 'Кабинет не подключает актуальные стили');
