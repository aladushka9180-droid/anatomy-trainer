...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v592`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=592/, 'Кабинет не подключает актуальные стили');
