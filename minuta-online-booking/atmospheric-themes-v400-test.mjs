...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v488`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=488/, 'Кабинет не подключает актуальные стили');
