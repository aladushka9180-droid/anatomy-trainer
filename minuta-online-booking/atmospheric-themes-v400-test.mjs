...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v472`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=472/, 'Кабинет не подключает актуальные стили');
