...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v497`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=497/, 'Кабинет не подключает актуальные стили');
