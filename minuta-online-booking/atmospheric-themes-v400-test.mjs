...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v506`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=506/, 'Кабинет не подключает актуальные стили');
