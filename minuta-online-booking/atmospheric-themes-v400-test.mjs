...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v721`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=721/, 'Кабинет не подключает актуальные стили');
