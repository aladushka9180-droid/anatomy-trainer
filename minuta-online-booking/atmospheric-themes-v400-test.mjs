...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v503`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=503/, 'Кабинет не подключает актуальные стили');
