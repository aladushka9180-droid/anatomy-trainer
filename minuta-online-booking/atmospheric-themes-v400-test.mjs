...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v577`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=577/, 'Кабинет не подключает актуальные стили');
