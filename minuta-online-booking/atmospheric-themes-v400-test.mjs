...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v455`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=455/, 'Кабинет не подключает актуальные стили');
