...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v597`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=597/, 'Кабинет не подключает актуальные стили');
