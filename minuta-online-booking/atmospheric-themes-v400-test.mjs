...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v447`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=447/, 'Кабинет не подключает актуальные стили');
