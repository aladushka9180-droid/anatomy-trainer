...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v788`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=788/, 'Кабинет не подключает актуальные стили');
