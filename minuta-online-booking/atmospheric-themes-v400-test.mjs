...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v627`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=627/, 'Кабинет не подключает актуальные стили');
