...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v693`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=693/, 'Кабинет не подключает актуальные стили');
