...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v437`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=437/, 'Кабинет не подключает актуальные стили');
