...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v688`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=688/, 'Кабинет не подключает актуальные стили');
