...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v583`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=583/, 'Кабинет не подключает актуальные стили');
