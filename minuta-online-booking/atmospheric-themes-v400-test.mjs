...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v440`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=440/, 'Кабинет не подключает актуальные стили');
