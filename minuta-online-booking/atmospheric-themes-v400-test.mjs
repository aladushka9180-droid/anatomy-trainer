...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v772`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=772/, 'Кабинет не подключает актуальные стили');
