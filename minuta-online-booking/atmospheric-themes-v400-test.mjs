...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v551`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=551/, 'Кабинет не подключает актуальные стили');
