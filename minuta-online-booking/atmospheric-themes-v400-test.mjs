...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v779`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=779/, 'Кабинет не подключает актуальные стили');
