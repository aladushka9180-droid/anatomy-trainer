...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v692`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=692/, 'Кабинет не подключает актуальные стили');
