...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v666`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=666/, 'Кабинет не подключает актуальные стили');
