...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v719`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=719/, 'Кабинет не подключает актуальные стили');
