...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v810`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=810/, 'Кабинет не подключает актуальные стили');
