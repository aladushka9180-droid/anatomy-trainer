...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v808`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=808/, 'Кабинет не подключает актуальные стили');
