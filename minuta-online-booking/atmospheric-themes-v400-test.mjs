...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v442`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=442/, 'Кабинет не подключает актуальные стили');
