...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v643`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=643/, 'Кабинет не подключает актуальные стили');
