...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v420`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=420/, 'Кабинет не подключает актуальные стили');
