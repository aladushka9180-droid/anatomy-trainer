...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v776`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=776/, 'Кабинет не подключает актуальные стили');
