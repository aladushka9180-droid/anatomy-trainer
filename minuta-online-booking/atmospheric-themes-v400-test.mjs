...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v769`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=769/, 'Кабинет не подключает актуальные стили');
