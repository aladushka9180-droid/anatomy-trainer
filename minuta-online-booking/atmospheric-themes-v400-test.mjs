...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v785`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=785/, 'Кабинет не подключает актуальные стили');
