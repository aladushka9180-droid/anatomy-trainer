...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v658`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=658/, 'Кабинет не подключает актуальные стили');
