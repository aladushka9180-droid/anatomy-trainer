...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v781`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=781/, 'Кабинет не подключает актуальные стили');
