...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v465`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=465/, 'Кабинет не подключает актуальные стили');
