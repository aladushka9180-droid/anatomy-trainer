...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v768`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=768/, 'Кабинет не подключает актуальные стили');
