...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v639`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=639/, 'Кабинет не подключает актуальные стили');
