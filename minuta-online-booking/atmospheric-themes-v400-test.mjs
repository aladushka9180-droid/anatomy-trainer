...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v489`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=489/, 'Кабинет не подключает актуальные стили');
