...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v608`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=608/, 'Кабинет не подключает актуальные стили');
