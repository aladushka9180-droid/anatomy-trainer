...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v527`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=527/, 'Кабинет не подключает актуальные стили');
