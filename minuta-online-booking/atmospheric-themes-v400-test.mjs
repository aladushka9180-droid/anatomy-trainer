...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v536`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=536/, 'Кабинет не подключает актуальные стили');
