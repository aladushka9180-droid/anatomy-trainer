...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v728`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=728/, 'Кабинет не подключает актуальные стили');
