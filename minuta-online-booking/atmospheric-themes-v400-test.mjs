...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v418`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=418/, 'Кабинет не подключает актуальные стили');
