...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v535`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=535/, 'Кабинет не подключает актуальные стили');
