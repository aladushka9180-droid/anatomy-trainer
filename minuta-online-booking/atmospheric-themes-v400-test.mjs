...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v471`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=471/, 'Кабинет не подключает актуальные стили');
