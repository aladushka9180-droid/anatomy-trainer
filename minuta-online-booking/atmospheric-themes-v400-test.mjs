...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v589`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=589/, 'Кабинет не подключает актуальные стили');
