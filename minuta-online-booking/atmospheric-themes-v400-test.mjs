...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v438`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=438/, 'Кабинет не подключает актуальные стили');
