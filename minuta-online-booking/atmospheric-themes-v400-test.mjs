...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v626`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=626/, 'Кабинет не подключает актуальные стили');
