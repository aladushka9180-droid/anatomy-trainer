...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v444`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=444/, 'Кабинет не подключает актуальные стили');
