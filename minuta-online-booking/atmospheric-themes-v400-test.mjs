...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v783`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=783/, 'Кабинет не подключает актуальные стили');
