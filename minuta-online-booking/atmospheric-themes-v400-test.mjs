...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v516`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=516/, 'Кабинет не подключает актуальные стили');
