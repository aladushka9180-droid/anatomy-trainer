...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v710`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=710/, 'Кабинет не подключает актуальные стили');
