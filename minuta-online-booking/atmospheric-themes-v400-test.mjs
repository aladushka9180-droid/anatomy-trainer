...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v448`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=448/, 'Кабинет не подключает актуальные стили');
