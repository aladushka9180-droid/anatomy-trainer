...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v540`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=540/, 'Кабинет не подключает актуальные стили');
