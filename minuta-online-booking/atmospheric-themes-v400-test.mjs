...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v568`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=568/, 'Кабинет не подключает актуальные стили');
