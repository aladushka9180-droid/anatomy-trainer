...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v618`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=618/, 'Кабинет не подключает актуальные стили');
