...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v587`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=587/, 'Кабинет не подключает актуальные стили');
