...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v524`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=524/, 'Кабинет не подключает актуальные стили');
