...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v546`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=546/, 'Кабинет не подключает актуальные стили');
