...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v777`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=777/, 'Кабинет не подключает актуальные стили');
