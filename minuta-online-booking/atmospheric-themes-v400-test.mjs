...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v761`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=761/, 'Кабинет не подключает актуальные стили');
