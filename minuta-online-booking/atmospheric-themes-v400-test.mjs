...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v405`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=405/, 'Кабинет не подключает актуальные стили');
