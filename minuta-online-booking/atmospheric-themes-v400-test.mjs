...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v559`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=559/, 'Кабинет не подключает актуальные стили');
