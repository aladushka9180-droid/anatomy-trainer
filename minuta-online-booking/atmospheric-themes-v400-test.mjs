...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v403`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=403/, 'Кабинет не подключает актуальные стили');
