...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v529`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=529/, 'Кабинет не подключает актуальные стили');
