...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v508`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=508/, 'Кабинет не подключает актуальные стили');
