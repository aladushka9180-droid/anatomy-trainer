...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v502`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=502/, 'Кабинет не подключает актуальные стили');
