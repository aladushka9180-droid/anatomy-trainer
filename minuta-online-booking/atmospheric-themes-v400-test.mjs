...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v670`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=670/, 'Кабинет не подключает актуальные стили');
