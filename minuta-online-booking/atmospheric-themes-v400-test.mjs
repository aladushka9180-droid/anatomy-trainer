...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v755`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=755/, 'Кабинет не подключает актуальные стили');
