...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v579`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=579/, 'Кабинет не подключает актуальные стили');
