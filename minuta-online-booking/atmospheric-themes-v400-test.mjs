...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v685`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=685/, 'Кабинет не подключает актуальные стили');
