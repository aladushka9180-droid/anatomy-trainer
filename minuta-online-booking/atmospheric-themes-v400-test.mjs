...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v713`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=713/, 'Кабинет не подключает актуальные стили');
