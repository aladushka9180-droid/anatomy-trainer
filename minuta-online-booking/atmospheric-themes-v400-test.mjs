...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v421`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=421/, 'Кабинет не подключает актуальные стили');
