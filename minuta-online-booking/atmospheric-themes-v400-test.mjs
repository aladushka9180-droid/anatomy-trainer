...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v532`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=532/, 'Кабинет не подключает актуальные стили');
