...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v460`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=460/, 'Кабинет не подключает актуальные стили');
