...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v553`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=553/, 'Кабинет не подключает актуальные стили');
