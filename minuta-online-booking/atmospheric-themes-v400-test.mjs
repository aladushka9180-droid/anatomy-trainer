...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v691`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=691/, 'Кабинет не подключает актуальные стили');
