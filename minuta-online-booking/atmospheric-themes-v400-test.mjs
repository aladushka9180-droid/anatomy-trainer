...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v499`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=499/, 'Кабинет не подключает актуальные стили');
