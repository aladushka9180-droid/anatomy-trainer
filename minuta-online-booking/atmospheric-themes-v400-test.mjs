...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v623`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=623/, 'Кабинет не подключает актуальные стили');
