...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v491`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=491/, 'Кабинет не подключает актуальные стили');
