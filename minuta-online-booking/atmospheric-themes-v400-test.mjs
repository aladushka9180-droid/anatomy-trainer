...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v795`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=795/, 'Кабинет не подключает актуальные стили');
