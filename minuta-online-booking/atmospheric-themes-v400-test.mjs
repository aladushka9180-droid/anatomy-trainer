...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v519`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=519/, 'Кабинет не подключает актуальные стили');
