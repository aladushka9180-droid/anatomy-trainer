...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v695`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=695/, 'Кабинет не подключает актуальные стили');
