...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v485`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=485/, 'Кабинет не подключает актуальные стили');
