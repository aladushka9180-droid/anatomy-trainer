...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v760`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=760/, 'Кабинет не подключает актуальные стили');
