...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v585`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=585/, 'Кабинет не подключает актуальные стили');
