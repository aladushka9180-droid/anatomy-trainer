...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v682`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=682/, 'Кабинет не подключает актуальные стили');
