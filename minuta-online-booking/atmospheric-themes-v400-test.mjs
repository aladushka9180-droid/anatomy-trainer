...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v620`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=620/, 'Кабинет не подключает актуальные стили');
