...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v746`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=746/, 'Кабинет не подключает актуальные стили');
