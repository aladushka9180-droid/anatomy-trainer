...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v674`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=674/, 'Кабинет не подключает актуальные стили');
