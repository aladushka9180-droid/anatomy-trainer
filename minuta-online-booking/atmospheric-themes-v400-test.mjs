...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v422`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=422/, 'Кабинет не подключает актуальные стили');
