...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v507`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=507/, 'Кабинет не подключает актуальные стили');
