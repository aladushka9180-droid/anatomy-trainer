...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v454`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=454/, 'Кабинет не подключает актуальные стили');
