...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v675`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=675/, 'Кабинет не подключает актуальные стили');
