...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v750`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=750/, 'Кабинет не подключает актуальные стили');
