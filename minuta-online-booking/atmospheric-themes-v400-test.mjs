...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v701`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=701/, 'Кабинет не подключает актуальные стили');
