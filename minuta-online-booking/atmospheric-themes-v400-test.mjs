...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v483`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=483/, 'Кабинет не подключает актуальные стили');
