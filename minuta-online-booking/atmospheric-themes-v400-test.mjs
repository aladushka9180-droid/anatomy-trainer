...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v718`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=718/, 'Кабинет не подключает актуальные стили');
