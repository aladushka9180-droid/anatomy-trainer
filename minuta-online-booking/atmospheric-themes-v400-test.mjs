...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v445`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=445/, 'Кабинет не подключает актуальные стили');
