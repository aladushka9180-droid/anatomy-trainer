...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v419`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=419/, 'Кабинет не подключает актуальные стили');
