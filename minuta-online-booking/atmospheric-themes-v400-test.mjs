...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v581`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=581/, 'Кабинет не подключает актуальные стили');
