...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v521`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=521/, 'Кабинет не подключает актуальные стили');
