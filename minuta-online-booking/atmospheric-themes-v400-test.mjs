...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v451`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=451/, 'Кабинет не подключает актуальные стили');
