...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v602`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=602/, 'Кабинет не подключает актуальные стили');
