...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v561`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=561/, 'Кабинет не подключает актуальные стили');
