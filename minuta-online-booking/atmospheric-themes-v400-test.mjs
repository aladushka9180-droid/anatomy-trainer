...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v699`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=699/, 'Кабинет не подключает актуальные стили');
