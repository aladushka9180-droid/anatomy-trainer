...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v630`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=630/, 'Кабинет не подключает актуальные стили');
