...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v782`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=782/, 'Кабинет не подключает актуальные стили');
