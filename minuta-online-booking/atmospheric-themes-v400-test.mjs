...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v539`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=539/, 'Кабинет не подключает актуальные стили');
