...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v555`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=555/, 'Кабинет не подключает актуальные стили');
