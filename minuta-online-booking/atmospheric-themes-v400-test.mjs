...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v629`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=629/, 'Кабинет не подключает актуальные стили');
