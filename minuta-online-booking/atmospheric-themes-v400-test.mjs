...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v603`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=603/, 'Кабинет не подключает актуальные стили');
