...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v518`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=518/, 'Кабинет не подключает актуальные стили');
