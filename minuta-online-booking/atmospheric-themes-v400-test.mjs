...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v496`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=496/, 'Кабинет не подключает актуальные стили');
