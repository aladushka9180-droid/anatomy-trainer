...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v604`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=604/, 'Кабинет не подключает актуальные стили');
