...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v406`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=406/, 'Кабинет не подключает актуальные стили');
