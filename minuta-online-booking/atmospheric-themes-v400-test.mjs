...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v510`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=510/, 'Кабинет не подключает актуальные стили');
