...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v665`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=665/, 'Кабинет не подключает актуальные стили');
