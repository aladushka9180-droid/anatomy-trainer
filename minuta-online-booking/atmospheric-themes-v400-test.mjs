...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v514`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=514/, 'Кабинет не подключает актуальные стили');
