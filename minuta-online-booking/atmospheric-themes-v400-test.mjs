...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v609`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=609/, 'Кабинет не подключает актуальные стили');
