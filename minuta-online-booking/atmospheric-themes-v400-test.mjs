...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v791`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=791/, 'Кабинет не подключает актуальные стили');
