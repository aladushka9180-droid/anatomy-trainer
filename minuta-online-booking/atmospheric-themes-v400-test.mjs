...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v557`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=557/, 'Кабинет не подключает актуальные стили');
