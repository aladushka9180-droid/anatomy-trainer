...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v687`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=687/, 'Кабинет не подключает актуальные стили');
