...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v425`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=425/, 'Кабинет не подключает актуальные стили');
