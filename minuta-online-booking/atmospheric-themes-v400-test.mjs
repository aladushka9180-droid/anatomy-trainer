...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v758`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=758/, 'Кабинет не подключает актуальные стили');
