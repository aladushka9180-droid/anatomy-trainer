...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v766`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=766/, 'Кабинет не подключает актуальные стили');
