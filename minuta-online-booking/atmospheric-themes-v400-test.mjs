...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v487`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=487/, 'Кабинет не подключает актуальные стили');
