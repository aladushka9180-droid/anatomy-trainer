...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v717`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=717/, 'Кабинет не подключает актуальные стили');
