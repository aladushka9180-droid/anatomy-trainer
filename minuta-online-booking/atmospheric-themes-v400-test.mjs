...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v712`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=712/, 'Кабинет не подключает актуальные стили');
