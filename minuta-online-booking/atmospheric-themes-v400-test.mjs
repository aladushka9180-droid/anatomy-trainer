...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v663`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=663/, 'Кабинет не подключает актуальные стили');
