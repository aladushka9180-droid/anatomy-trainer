...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v727`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=727/, 'Кабинет не подключает актуальные стили');
