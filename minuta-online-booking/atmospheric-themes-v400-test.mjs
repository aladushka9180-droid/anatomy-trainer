...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v543`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=543/, 'Кабинет не подключает актуальные стили');
