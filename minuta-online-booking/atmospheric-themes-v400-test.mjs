...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v680`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=680/, 'Кабинет не подключает актуальные стили');
