...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v601`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=601/, 'Кабинет не подключает актуальные стили');
