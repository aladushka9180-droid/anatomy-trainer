...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v590`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=590/, 'Кабинет не подключает актуальные стили');
