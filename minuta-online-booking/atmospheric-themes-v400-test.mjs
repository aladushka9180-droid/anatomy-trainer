...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v775`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=775/, 'Кабинет не подключает актуальные стили');
