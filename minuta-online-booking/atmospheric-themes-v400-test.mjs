...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v737`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=737/, 'Кабинет не подключает актуальные стили');
