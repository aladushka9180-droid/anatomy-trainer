...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v694`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=694/, 'Кабинет не подключает актуальные стили');
