...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v522`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=522/, 'Кабинет не подключает актуальные стили');
