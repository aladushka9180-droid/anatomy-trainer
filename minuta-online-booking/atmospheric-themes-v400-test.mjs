...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v715`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=715/, 'Кабинет не подключает актуальные стили');
