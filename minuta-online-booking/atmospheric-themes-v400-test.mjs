...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v426`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=426/, 'Кабинет не подключает актуальные стили');
