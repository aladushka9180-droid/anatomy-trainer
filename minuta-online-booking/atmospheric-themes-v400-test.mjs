...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v676`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=676/, 'Кабинет не подключает актуальные стили');
