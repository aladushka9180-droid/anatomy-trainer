...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v515`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=515/, 'Кабинет не подключает актуальные стили');
