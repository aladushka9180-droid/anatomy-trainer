...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v570`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=570/, 'Кабинет не подключает актуальные стили');
