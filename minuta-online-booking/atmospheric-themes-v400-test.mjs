...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v790`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=790/, 'Кабинет не подключает актуальные стили');
