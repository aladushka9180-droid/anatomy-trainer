...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v642`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=642/, 'Кабинет не подключает актуальные стили');
