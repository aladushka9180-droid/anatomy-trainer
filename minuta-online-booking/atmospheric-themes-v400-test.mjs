...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v424`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=424/, 'Кабинет не подключает актуальные стили');
