...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v679`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=679/, 'Кабинет не подключает актуальные стили');
