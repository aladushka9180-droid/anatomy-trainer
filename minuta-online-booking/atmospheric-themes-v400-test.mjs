...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v523`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=523/, 'Кабинет не подключает актуальные стили');
