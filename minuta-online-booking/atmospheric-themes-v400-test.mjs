...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v631`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=631/, 'Кабинет не подключает актуальные стили');
