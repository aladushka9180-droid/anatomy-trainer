...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v794`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=794/, 'Кабинет не подключает актуальные стили');
