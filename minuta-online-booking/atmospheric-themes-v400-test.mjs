...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v646`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=646/, 'Кабинет не подключает актуальные стили');
