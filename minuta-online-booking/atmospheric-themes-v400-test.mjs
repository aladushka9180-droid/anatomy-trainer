...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v703`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=703/, 'Кабинет не подключает актуальные стили');
