...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v724`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=724/, 'Кабинет не подключает актуальные стили');
