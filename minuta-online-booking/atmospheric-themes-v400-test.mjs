...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v622`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=622/, 'Кабинет не подключает актуальные стили');
