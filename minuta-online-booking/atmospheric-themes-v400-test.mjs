...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v552`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=552/, 'Кабинет не подключает актуальные стили');
