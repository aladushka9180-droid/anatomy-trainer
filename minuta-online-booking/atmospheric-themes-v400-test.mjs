...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v564`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=564/, 'Кабинет не подключает актуальные стили');
