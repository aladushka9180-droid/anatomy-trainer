...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v453`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=453/, 'Кабинет не подключает актуальные стили');
