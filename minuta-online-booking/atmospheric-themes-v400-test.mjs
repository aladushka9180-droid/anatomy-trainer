...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v632`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=632/, 'Кабинет не подключает актуальные стили');
