...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v542`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=542/, 'Кабинет не подключает актуальные стили');
