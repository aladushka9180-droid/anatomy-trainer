...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v578`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=578/, 'Кабинет не подключает актуальные стили');
