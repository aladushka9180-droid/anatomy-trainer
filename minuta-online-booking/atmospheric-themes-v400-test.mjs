...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v436`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=436/, 'Кабинет не подключает актуальные стили');
