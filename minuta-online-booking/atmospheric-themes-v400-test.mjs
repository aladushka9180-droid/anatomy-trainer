...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v797`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=797/, 'Кабинет не подключает актуальные стили');
