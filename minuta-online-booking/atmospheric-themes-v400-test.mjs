...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v404`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=404/, 'Кабинет не подключает актуальные стили');
