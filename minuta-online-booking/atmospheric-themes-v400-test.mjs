...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v509`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=509/, 'Кабинет не подключает актуальные стили');
