...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v807`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=807/, 'Кабинет не подключает актуальные стили');
