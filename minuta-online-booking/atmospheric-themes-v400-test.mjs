...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v683`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=683/, 'Кабинет не подключает актуальные стили');
