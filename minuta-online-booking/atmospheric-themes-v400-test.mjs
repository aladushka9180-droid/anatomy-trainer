...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v765`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=765/, 'Кабинет не подключает актуальные стили');
