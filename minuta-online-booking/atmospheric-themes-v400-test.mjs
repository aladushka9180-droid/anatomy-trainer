...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v474`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=474/, 'Кабинет не подключает актуальные стили');
