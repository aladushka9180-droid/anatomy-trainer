...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v580`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=580/, 'Кабинет не подключает актуальные стили');
