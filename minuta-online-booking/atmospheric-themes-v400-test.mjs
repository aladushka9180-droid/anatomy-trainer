...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v641`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=641/, 'Кабинет не подключает актуальные стили');
