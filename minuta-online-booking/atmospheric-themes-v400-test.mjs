...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v707`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=707/, 'Кабинет не подключает актуальные стили');
