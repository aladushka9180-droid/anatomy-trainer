...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v480`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=480/, 'Кабинет не подключает актуальные стили');
