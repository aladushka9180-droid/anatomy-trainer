...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v770`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=770/, 'Кабинет не подключает актуальные стили');
