...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v732`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=732/, 'Кабинет не подключает актуальные стили');
