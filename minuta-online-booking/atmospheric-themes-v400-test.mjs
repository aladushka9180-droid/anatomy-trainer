...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v504`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=504/, 'Кабинет не подключает актуальные стили');
