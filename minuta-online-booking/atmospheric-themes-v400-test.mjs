...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v600`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=600/, 'Кабинет не подключает актуальные стили');
