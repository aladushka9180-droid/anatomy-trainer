...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v446`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=446/, 'Кабинет не подключает актуальные стили');
