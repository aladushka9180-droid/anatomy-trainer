...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v621`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=621/, 'Кабинет не подключает актуальные стили');
