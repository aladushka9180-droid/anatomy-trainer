...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v458`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=458/, 'Кабинет не подключает актуальные стили');
