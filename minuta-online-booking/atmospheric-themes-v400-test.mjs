...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v464`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=464/, 'Кабинет не подключает актуальные стили');
