...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v596`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=596/, 'Кабинет не подключает актуальные стили');
