...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v800`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=800/, 'Кабинет не подключает актуальные стили');
