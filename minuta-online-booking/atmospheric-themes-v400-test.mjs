...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v415`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=415/, 'Кабинет не подключает актуальные стили');
