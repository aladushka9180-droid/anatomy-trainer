...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v563`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=563/, 'Кабинет не подключает актуальные стили');
