...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v740`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=740/, 'Кабинет не подключает актуальные стили');
