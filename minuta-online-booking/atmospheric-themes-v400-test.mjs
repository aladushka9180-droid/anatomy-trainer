...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v774`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=774/, 'Кабинет не подключает актуальные стили');
