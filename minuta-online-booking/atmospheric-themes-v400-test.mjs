...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v614`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=614/, 'Кабинет не подключает актуальные стили');
