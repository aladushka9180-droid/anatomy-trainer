...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v486`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=486/, 'Кабинет не подключает актуальные стили');
