...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v731`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=731/, 'Кабинет не подключает актуальные стили');
