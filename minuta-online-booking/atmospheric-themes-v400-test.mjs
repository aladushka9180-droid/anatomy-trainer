...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v588`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=588/, 'Кабинет не подключает актуальные стили');
