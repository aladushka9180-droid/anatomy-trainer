...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v633`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=633/, 'Кабинет не подключает актуальные стили');
