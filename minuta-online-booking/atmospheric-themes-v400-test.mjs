...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v741`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=741/, 'Кабинет не подключает актуальные стили');
