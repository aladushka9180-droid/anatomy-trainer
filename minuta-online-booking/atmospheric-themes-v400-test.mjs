...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v697`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=697/, 'Кабинет не подключает актуальные стили');
