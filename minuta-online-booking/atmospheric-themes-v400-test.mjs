...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v801`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=801/, 'Кабинет не подключает актуальные стили');
