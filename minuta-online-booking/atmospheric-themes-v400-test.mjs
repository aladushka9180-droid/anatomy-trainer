...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v466`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=466/, 'Кабинет не подключает актуальные стили');
