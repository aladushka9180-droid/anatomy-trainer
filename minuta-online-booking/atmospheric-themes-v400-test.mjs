...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v809`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=809/, 'Кабинет не подключает актуальные стили');
