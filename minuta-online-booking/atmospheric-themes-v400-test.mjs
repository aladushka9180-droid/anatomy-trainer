...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v716`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=716/, 'Кабинет не подключает актуальные стили');
