...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v517`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=517/, 'Кабинет не подключает актуальные стили');
