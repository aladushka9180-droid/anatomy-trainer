...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v410`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=410/, 'Кабинет не подключает актуальные стили');
