...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v457`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=457/, 'Кабинет не подключает актуальные стили');
