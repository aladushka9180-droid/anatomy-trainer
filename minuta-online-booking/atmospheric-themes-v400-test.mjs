...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v635`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=635/, 'Кабинет не подключает актуальные стили');
