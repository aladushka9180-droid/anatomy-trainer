...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v747`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=747/, 'Кабинет не подключает актуальные стили');
