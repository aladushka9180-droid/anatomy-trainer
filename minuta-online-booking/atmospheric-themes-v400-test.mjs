...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v730`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=730/, 'Кабинет не подключает актуальные стили');
