...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v554`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=554/, 'Кабинет не подключает актуальные стили');
