...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v584`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=584/, 'Кабинет не подключает актуальные стили');
