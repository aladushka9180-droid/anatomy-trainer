...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v771`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=771/, 'Кабинет не подключает актуальные стили');
