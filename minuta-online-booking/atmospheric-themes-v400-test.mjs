...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v640`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=640/, 'Кабинет не подключает актуальные стили');
