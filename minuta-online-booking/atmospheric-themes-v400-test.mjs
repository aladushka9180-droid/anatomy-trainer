...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v427`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=427/, 'Кабинет не подключает актуальные стили');
