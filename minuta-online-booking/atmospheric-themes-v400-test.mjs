...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v413`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=413/, 'Кабинет не подключает актуальные стили');
