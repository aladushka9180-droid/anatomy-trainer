...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v443`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=443/, 'Кабинет не подключает актуальные стили');
