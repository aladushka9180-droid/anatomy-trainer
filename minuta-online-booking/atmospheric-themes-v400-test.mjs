...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v748`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=748/, 'Кабинет не подключает актуальные стили');
