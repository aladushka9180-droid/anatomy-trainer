...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v684`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=684/, 'Кабинет не подключает актуальные стили');
