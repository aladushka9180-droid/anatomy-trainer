...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v653`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=653/, 'Кабинет не подключает актуальные стили');
