...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v481`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=481/, 'Кабинет не подключает актуальные стили');
