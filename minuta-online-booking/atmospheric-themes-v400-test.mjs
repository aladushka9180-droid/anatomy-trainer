...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v566`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=566/, 'Кабинет не подключает актуальные стили');
