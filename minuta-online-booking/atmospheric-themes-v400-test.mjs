...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v567`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=567/, 'Кабинет не подключает актуальные стили');
