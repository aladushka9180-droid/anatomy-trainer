...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v742`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=742/, 'Кабинет не подключает актуальные стили');
