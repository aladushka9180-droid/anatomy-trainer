...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v576`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=576/, 'Кабинет не подключает актуальные стили');
