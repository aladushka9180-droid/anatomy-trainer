...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v541`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=541/, 'Кабинет не подключает актуальные стили');
