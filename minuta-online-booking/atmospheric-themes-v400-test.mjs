...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v582`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=582/, 'Кабинет не подключает актуальные стили');
