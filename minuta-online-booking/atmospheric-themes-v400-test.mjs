...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v512`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=512/, 'Кабинет не подключает актуальные стили');
