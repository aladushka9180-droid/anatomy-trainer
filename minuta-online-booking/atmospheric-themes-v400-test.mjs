...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v549`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=549/, 'Кабинет не подключает актуальные стили');
