...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v599`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=599/, 'Кабинет не подключает актуальные стили');
