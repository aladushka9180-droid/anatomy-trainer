...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v459`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=459/, 'Кабинет не подключает актуальные стили');
