...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v544`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=544/, 'Кабинет не подключает актуальные стили');
