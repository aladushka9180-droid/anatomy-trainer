...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v433`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=433/, 'Кабинет не подключает актуальные стили');
