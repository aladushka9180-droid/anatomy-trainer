...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v469`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=469/, 'Кабинет не подключает актуальные стили');
