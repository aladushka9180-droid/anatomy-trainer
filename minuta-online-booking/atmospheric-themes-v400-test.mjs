...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v528`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=528/, 'Кабинет не подключает актуальные стили');
