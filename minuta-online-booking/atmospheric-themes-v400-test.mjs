...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v628`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=628/, 'Кабинет не подключает актуальные стили');
