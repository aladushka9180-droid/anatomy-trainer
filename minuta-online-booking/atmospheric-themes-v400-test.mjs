...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v753`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=753/, 'Кабинет не подключает актуальные стили');
