...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v550`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=550/, 'Кабинет не подключает актуальные стили');
