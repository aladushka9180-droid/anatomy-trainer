...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v799`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=799/, 'Кабинет не подключает актуальные стили');
