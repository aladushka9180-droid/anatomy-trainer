...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v478`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=478/, 'Кабинет не подключает актуальные стили');
