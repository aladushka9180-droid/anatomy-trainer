...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v409`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=409/, 'Кабинет не подключает актуальные стили');
