...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v657`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=657/, 'Кабинет не подключает актуальные стили');
