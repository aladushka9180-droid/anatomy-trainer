...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v619`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=619/, 'Кабинет не подключает актуальные стили');
