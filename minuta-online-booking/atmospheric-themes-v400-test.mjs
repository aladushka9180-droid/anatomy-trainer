...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v678`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=678/, 'Кабинет не подключает актуальные стили');
