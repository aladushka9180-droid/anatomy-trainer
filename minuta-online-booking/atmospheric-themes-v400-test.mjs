...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v482`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=482/, 'Кабинет не подключает актуальные стили');
