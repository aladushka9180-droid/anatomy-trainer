...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v789`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=789/, 'Кабинет не подключает актуальные стили');
