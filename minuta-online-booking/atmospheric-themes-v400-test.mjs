...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v612`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=612/, 'Кабинет не подключает актуальные стили');
