...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v647`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=647/, 'Кабинет не подключает актуальные стили');
