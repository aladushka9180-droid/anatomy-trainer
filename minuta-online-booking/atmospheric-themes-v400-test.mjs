...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v593`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=593/, 'Кабинет не подключает актуальные стили');
