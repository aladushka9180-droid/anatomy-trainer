...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v435`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=435/, 'Кабинет не подключает актуальные стили');
