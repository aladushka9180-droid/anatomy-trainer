...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v819`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=811/, 'Кабинет не подключает актуальные стили');
