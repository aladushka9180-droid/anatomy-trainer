...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v786`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=786/, 'Кабинет не подключает актуальные стили');
