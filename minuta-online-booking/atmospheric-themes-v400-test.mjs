...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v759`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=759/, 'Кабинет не подключает актуальные стили');
