...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v495`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=495/, 'Кабинет не подключает актуальные стили');
