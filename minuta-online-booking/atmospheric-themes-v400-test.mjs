...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v638`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=638/, 'Кабинет не подключает актуальные стили');
