...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v595`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=595/, 'Кабинет не подключает актуальные стили');
