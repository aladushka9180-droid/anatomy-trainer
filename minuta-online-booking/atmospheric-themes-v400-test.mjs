...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v569`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=569/, 'Кабинет не подключает актуальные стили');
