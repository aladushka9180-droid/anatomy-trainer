...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v708`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=708/, 'Кабинет не подключает актуальные стили');
