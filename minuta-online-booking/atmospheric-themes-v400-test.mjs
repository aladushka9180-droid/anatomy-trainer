...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v805`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=805/, 'Кабинет не подключает актуальные стили');
