...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v513`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=513/, 'Кабинет не подключает актуальные стили');
