...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v494`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=494/, 'Кабинет не подключает актуальные стили');
