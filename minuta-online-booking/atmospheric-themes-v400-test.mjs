...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v479`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=479/, 'Кабинет не подключает актуальные стили');
