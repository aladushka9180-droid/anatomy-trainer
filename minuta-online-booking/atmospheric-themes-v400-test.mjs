...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v439`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=439/, 'Кабинет не подключает актуальные стили');
