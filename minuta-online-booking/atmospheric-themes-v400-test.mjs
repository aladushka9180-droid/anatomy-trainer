...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v490`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=490/, 'Кабинет не подключает актуальные стили');
