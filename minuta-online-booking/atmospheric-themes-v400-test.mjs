...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v636`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=636/, 'Кабинет не подключает актуальные стили');
