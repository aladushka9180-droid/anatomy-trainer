...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v525`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=525/, 'Кабинет не подключает актуальные стили');
