...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v417`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=417/, 'Кабинет не подключает актуальные стили');
