...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v611`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=611/, 'Кабинет не подключает актуальные стили');
