...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v615`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=615/, 'Кабинет не подключает актуальные стили');
