...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v754`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=754/, 'Кабинет не подключает актуальные стили');
