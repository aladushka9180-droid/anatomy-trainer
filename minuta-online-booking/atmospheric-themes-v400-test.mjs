...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v764`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=764/, 'Кабинет не подключает актуальные стили');
