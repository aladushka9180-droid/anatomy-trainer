...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v573`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=573/, 'Кабинет не подключает актуальные стили');
