...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v530`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=530/, 'Кабинет не подключает актуальные стили');
