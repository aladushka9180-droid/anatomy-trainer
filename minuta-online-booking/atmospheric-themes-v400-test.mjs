...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v767`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=767/, 'Кабинет не подключает актуальные стили');
