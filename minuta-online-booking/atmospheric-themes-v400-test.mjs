...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v752`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=752/, 'Кабинет не подключает актуальные стили');
