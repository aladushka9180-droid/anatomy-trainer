...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v686`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=686/, 'Кабинет не подключает актуальные стили');
