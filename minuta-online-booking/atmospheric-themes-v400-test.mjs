...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v802`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=802/, 'Кабинет не подключает актуальные стили');
