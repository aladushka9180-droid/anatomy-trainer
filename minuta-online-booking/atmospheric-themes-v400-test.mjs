...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v498`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=498/, 'Кабинет не подключает актуальные стили');
