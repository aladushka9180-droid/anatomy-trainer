...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v651`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=651/, 'Кабинет не подключает актуальные стили');
