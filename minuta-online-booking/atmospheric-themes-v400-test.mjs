...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v677`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=677/, 'Кабинет не подключает актуальные стили');
