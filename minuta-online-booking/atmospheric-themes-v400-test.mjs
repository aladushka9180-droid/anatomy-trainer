...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v773`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=773/, 'Кабинет не подключает актуальные стили');
