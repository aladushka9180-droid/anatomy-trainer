...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v416`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=416/, 'Кабинет не подключает актуальные стили');
