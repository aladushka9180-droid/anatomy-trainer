...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v607`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=607/, 'Кабинет не подключает актуальные стили');
