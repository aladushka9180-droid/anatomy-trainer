...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v650`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=650/, 'Кабинет не подключает актуальные стили');
