...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v709`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=709/, 'Кабинет не подключает актуальные стили');
