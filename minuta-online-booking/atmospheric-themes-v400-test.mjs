...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v473`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=473/, 'Кабинет не подключает актуальные стили');
