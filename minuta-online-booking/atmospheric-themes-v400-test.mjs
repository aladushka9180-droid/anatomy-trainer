...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v733`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=733/, 'Кабинет не подключает актуальные стили');
