...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v492`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=492/, 'Кабинет не подключает актуальные стили');
