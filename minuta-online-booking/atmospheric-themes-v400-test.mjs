...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v662`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=662/, 'Кабинет не подключает актуальные стили');
