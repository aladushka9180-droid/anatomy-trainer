...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v613`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=613/, 'Кабинет не подключает актуальные стили');
