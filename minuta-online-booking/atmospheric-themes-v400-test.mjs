...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v762`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=762/, 'Кабинет не подключает актуальные стили');
