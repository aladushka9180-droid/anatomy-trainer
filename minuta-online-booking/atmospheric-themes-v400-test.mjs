...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v414`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=414/, 'Кабинет не подключает актуальные стили');
