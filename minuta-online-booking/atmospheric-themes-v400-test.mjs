...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v798`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=798/, 'Кабинет не подключает актуальные стили');
