...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v644`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=644/, 'Кабинет не подключает актуальные стили');
