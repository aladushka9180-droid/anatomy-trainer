...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v441`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=441/, 'Кабинет не подключает актуальные стили');
