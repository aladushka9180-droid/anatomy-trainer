...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v456`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=456/, 'Кабинет не подключает актуальные стили');
