...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v547`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=547/, 'Кабинет не подключает актуальные стили');
