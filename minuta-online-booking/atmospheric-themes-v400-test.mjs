...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v723`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=723/, 'Кабинет не подключает актуальные стили');
