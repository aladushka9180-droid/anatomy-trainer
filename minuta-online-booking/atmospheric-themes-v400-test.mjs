...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v476`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=476/, 'Кабинет не подключает актуальные стили');
