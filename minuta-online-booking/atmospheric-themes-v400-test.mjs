...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v467`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=467/, 'Кабинет не подключает актуальные стили');
