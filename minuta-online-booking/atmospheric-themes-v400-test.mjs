...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v720`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=720/, 'Кабинет не подключает актуальные стили');
