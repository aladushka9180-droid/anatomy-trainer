...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v572`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=572/, 'Кабинет не подключает актуальные стили');
