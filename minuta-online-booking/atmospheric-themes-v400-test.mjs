...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v673`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=673/, 'Кабинет не подключает актуальные стили');
