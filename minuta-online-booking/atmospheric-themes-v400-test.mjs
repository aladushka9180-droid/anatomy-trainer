...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v654`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=654/, 'Кабинет не подключает актуальные стили');
