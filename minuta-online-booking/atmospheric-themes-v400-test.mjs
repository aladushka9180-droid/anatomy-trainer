...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v574`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=574/, 'Кабинет не подключает актуальные стили');
