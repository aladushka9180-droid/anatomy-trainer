...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v698`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=698/, 'Кабинет не подключает актуальные стили');
