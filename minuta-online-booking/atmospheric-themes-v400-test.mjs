...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v634`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=634/, 'Кабинет не подключает актуальные стили');
