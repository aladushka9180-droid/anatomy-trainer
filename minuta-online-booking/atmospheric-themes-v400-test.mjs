...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v671`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=671/, 'Кабинет не подключает актуальные стили');
