...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v751`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=751/, 'Кабинет не подключает актуальные стили');
