...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v449`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=449/, 'Кабинет не подключает актуальные стили');
