...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v412`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=412/, 'Кабинет не подключает актуальные стили');
