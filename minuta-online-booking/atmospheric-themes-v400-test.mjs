...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v591`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=591/, 'Кабинет не подключает актуальные стили');
