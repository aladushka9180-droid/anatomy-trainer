...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v562`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=562/, 'Кабинет не подключает актуальные стили');
