...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v493`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=493/, 'Кабинет не подключает актуальные стили');
