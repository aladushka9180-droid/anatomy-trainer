...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v565`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=565/, 'Кабинет не подключает актуальные стили');
