...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v738`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=738/, 'Кабинет не подключает актуальные стили');
