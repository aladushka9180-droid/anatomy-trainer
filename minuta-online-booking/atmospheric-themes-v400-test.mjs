...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v711`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=711/, 'Кабинет не подключает актуальные стили');
