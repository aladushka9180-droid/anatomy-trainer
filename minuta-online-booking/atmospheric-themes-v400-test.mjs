...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v545`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=545/, 'Кабинет не подключает актуальные стили');
