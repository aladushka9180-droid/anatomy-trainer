...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v431`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=431/, 'Кабинет не подключает актуальные стили');
