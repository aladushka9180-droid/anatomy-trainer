...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v637`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=637/, 'Кабинет не подключает актуальные стили');
