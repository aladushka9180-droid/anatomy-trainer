...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v452`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=452/, 'Кабинет не подключает актуальные стили');
