...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v411`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=411/, 'Кабинет не подключает актуальные стили');
