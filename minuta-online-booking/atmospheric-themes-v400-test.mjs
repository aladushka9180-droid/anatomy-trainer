...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v803`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=803/, 'Кабинет не подключает актуальные стили');
