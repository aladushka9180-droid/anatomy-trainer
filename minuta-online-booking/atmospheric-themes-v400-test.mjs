...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v648`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=648/, 'Кабинет не подключает актуальные стили');
