...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v744`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=744/, 'Кабинет не подключает актуальные стили');
