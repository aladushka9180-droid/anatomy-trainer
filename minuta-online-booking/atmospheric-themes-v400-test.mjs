...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v743`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=743/, 'Кабинет не подключает актуальные стили');
