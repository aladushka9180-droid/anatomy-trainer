...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v714`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=714/, 'Кабинет не подключает актуальные стили');
