...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v780`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=780/, 'Кабинет не подключает актуальные стили');
