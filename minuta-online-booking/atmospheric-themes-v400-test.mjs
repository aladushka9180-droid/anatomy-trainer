...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v726`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=726/, 'Кабинет не подключает актуальные стили');
