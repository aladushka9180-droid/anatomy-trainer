...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v804`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=804/, 'Кабинет не подключает актуальные стили');
