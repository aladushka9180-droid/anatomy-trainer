...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v434`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=434/, 'Кабинет не подключает актуальные стили');
