...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v696`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=696/, 'Кабинет не подключает актуальные стили');
