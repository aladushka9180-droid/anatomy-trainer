...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v450`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=450/, 'Кабинет не подключает актуальные стили');
