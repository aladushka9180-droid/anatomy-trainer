...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v548`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=548/, 'Кабинет не подключает актуальные стили');
