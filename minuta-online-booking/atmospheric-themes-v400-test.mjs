...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v667`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=667/, 'Кабинет не подключает актуальные стили');
