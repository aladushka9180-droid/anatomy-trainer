...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v624`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=624/, 'Кабинет не подключает актуальные стили');
