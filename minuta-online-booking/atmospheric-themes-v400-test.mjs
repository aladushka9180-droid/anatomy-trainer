...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v729`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=729/, 'Кабинет не подключает актуальные стили');
