...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v734`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=734/, 'Кабинет не подключает актуальные стили');
