...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v669`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=669/, 'Кабинет не подключает актуальные стили');
