...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v616`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=616/, 'Кабинет не подключает актуальные стили');
