...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v430`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=430/, 'Кабинет не подключает актуальные стили');
