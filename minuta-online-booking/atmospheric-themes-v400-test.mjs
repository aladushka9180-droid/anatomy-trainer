...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v705`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=705/, 'Кабинет не подключает актуальные стили');
