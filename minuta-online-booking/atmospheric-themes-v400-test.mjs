...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v735`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=735/, 'Кабинет не подключает актуальные стили');
