...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v664`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=664/, 'Кабинет не подключает актуальные стили');
