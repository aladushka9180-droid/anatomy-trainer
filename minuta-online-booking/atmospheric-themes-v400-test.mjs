...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v736`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=736/, 'Кабинет не подключает актуальные стили');
