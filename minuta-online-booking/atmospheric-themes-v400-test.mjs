...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v477`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=477/, 'Кабинет не подключает актуальные стили');
