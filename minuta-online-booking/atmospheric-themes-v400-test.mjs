...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v617`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=617/, 'Кабинет не подключает актуальные стили');
