...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v605`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=605/, 'Кабинет не подключает актуальные стили');
