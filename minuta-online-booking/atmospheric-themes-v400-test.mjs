...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v558`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=558/, 'Кабинет не подключает актуальные стили');
