...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v649`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=649/, 'Кабинет не подключает актуальные стили');
