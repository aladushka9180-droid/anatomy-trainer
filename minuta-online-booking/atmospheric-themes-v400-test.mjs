...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v821`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=821/, 'Кабинет не подключает актуальные стили');
