...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v429`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=429/, 'Кабинет не подключает актуальные стили');
