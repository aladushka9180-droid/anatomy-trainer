...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v745`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=745/, 'Кабинет не подключает актуальные стили');
