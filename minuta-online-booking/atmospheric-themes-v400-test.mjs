...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v625`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=625/, 'Кабинет не подключает актуальные стили');
