...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v511`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=511/, 'Кабинет не подключает актуальные стили');
