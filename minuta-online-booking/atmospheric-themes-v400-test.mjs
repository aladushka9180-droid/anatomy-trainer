...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v575`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=575/, 'Кабинет не подключает актуальные стили');
