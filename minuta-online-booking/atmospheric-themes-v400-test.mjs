...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v702`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=702/, 'Кабинет не подключает актуальные стили');
