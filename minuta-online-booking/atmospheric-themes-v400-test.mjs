...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v784`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=784/, 'Кабинет не подключает актуальные стили');
