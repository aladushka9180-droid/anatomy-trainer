...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v793`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=793/, 'Кабинет не подключает актуальные стили');
