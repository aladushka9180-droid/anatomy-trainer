...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v722`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=722/, 'Кабинет не подключает актуальные стили');
