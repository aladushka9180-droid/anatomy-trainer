...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v610`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=610/, 'Кабинет не подключает актуальные стили');
