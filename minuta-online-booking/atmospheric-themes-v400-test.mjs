...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v763`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=763/, 'Кабинет не подключает актуальные стили');
