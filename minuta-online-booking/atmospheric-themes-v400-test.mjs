...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v778`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=778/, 'Кабинет не подключает актуальные стили');
