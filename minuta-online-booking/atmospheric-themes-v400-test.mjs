...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v796`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=796/, 'Кабинет не подключает актуальные стили');
