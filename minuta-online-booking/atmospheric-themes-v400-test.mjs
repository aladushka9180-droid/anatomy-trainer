...
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v757`;/, 'Кэш приложения не обновлён для атмосферных тем');
assert.match(provider, /styles\.css\?v=757/, 'Кабинет не подключает актуальные стили');
