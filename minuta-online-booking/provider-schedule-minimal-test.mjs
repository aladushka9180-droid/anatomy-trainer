...
assert.match(styles, /timeline-booking-client[\s\S]*provider-booking-note-full[\s\S]*color:color-mix\(in srgb,var\(--theme-muted\) 62%,var\(--theme-ink\)\)!important;[\s\S]*opacity:1;/s);
