...
assert.match(providerHtml, /team-calendar\.js\?v=126/, 'Кабинет не подключает контроллер командного календаря');
...
assert.match(providerHtml, /rel="manifest" href="provider\.webmanifest\?v=126"/, 'Кабинет не подключает собственный устанавливаемый манифест');
