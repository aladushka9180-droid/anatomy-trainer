...
assert.match(settingsNavScroll, /nav\.scrollBy\(/, 'Стрелки вкладок настроек не прокручивают ленту');
assert.doesNotMatch(settingsNavScroll, /target\.click\(\)/, 'Стрелки вкладок настроек снова переключают раздел');
...
assert.deepEqual(providerThemes, ['sage','nordic','warm','graphite','lavender','luxury','loft','eco','hitech','japandi','midnight','mono','desert','rose','botanical','burgundy','coastal','pearl','butter','celadon','snow-leopard', 'apricot-tiger', 'golden-cheetah', 'pearl-zebra'], 'Набор тем кабинета неожиданно изменился');
...
for (const theme of ['sage', 'nordic', 'warm', 'graphite', 'lavender', 'luxury', 'loft', 'eco', 'hitech', 'japandi', 'midnight', 'mono', 'desert', 'rose', 'botanical', 'burgundy', 'coastal', 'pearl', 'butter', 'celadon', 'snow-leopard', 'apricot-tiger', 'golden-cheetah', 'pearl-zebra']) assert.match(allProviderThemeStyles, new RegExp(`data-provider-theme="${theme}"`), `Нет CSS темы ${theme}`);
...
for (const layout of ['linear', 'soft', 'capsule', 'editorial', 'bento', 'split']) {
  for (const theme of ['luxury', 'loft', 'eco', 'hitech', 'japandi', 'midnight', 'mono', 'desert', 'rose', 'botanical', 'burgundy', 'coastal', 'pearl', 'butter', 'celadon', 'snow-leopard', 'apricot-tiger', 'golden-cheetah', 'pearl-zebra']) {
...
assert.match(provider, /\$\{timelineClientRow\}\$\{badgeMarkup\}\$\{renderedNote\}/, 'Метки клиента снова растягивают строку и срезают заметку');
