...
assert.match(styles, /\.booking-sheet-client>\.booking-client-avatar-control \{[^}]*align-self:start;[^}]*transform:translateY\(-20px\);/, 'Аватар клиента снова не поднят к началу блока');
