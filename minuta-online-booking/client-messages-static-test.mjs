...
for(const asset of ['messages-center.css?v=811','messages-core.js?v=811','provider-messages-center.js?v=811','client-messages.js?v=811'])assert.ok(html.includes(asset),asset);
