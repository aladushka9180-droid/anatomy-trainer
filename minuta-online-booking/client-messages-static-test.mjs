...
for(const asset of ['messages-center.css?v=801','messages-core.js?v=801','provider-messages-center.js?v=801','client-messages.js?v=801'])assert.ok(html.includes(asset),asset);
