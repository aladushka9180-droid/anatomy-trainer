...
for(const asset of ['messages-center.css?v=800','messages-core.js?v=800','provider-messages-center.js?v=800','client-messages.js?v=800'])assert.ok(html.includes(asset),asset);
