...
for(const asset of ['messages-center.css?v=808','messages-core.js?v=808','provider-messages-center.js?v=808','client-messages.js?v=808'])assert.ok(html.includes(asset),asset);
