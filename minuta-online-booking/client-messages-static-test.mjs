...
for(const asset of ['messages-center.css?v=802','messages-core.js?v=802','provider-messages-center.js?v=802','client-messages.js?v=802'])assert.ok(html.includes(asset),asset);
