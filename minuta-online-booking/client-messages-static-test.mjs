...
for(const asset of ['messages-center.css?v=795','messages-core.js?v=795','provider-messages-center.js?v=795','client-messages.js?v=795'])assert.ok(html.includes(asset),asset);
