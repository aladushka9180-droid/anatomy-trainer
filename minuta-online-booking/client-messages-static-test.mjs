...
for(const asset of ['messages-center.css?v=799','messages-core.js?v=799','provider-messages-center.js?v=799','client-messages.js?v=799'])assert.ok(html.includes(asset),asset);
