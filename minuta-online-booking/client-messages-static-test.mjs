...
for(const asset of ['messages-center.css?v=796','messages-core.js?v=796','provider-messages-center.js?v=796','client-messages.js?v=796'])assert.ok(html.includes(asset),asset);
