...
for(const asset of ['messages-center.css?v=810','messages-core.js?v=810','provider-messages-center.js?v=810','client-messages.js?v=810'])assert.ok(html.includes(asset),asset);
