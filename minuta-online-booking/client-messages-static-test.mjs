...
for(const asset of ['messages-center.css?v=803','messages-core.js?v=803','provider-messages-center.js?v=803','client-messages.js?v=803'])assert.ok(html.includes(asset),asset);
