...
for(const asset of ['messages-center.css?v=798','messages-core.js?v=798','provider-messages-center.js?v=798','client-messages.js?v=798'])assert.ok(html.includes(asset),asset);
