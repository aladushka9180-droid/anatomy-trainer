...
for(const asset of ['messages-center.css?v=886','messages-core.js?v=811','provider-messages-center.js?v=886','client-messages.js?v=885'])assert.ok(html.includes(asset),asset);
