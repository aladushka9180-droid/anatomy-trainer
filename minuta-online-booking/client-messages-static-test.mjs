...
for(const asset of ['messages-center.css?v=797','messages-core.js?v=797','provider-messages-center.js?v=797','client-messages.js?v=797'])assert.ok(html.includes(asset),asset);
