...
for(const asset of ['messages-center.css?v=805','messages-core.js?v=805','provider-messages-center.js?v=805','client-messages.js?v=805'])assert.ok(html.includes(asset),asset);
