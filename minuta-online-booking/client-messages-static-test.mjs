...
for(const asset of ['messages-center.css?v=809','messages-core.js?v=809','provider-messages-center.js?v=809','client-messages.js?v=809'])assert.ok(html.includes(asset),asset);
