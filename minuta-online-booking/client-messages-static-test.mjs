...
for(const asset of ['messages-center.css?v=804','messages-core.js?v=804','provider-messages-center.js?v=804','client-messages.js?v=804'])assert.ok(html.includes(asset),asset);
