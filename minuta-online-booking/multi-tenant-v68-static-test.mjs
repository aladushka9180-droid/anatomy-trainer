...
assert.match(integration, /distinct on \(available\.booking_date\)/i, 'integration must select bookings on separate days so adjacent available slots cannot overlap');
