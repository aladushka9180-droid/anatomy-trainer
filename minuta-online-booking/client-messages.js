(function initializeClientMessages(global) {
  ...
  const CLIENT_RPC_MAP = Object.freeze({
    capability:'get_minuta_client_message_capability_v161',
    openConversation:'open_minuta_client_conversation_v161',
    listConversations:'list_minuta_client_conversations_v161',
    timeline:'get_minuta_client_message_timeline_v161',
    send:'send_minuta_client_message_v161',
    markRead:'mark_minuta_client_message_read_v161',
    prepareAction:'prepare_minuta_message_action_v161',
    applyAction:'apply_minuta_message_action_v161',
    openSupport:'open_minuta_client_support_v161'
  });
