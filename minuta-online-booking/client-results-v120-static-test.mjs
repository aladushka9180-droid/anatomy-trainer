...
assert.match(providerHtml,/client-results\.css\?v=793/);
assert.match(providerHtml,/client-results\.js\?v=793[\s\S]*provider\.js\?v=793/);
...
assert.match(serviceWorker,/client-results\.css\?v=793/);
assert.match(serviceWorker,/client-results\.js\?v=793/);
assert.match(serviceWorker,/provider\.js\?v=793/);
assert.match(serviceWorker,/CACHE_PREFIX}v793/);
