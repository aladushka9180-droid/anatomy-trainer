...
assert.match(providerHtml,/client-results\.css\?v=543/);
assert.match(providerHtml,/client-results\.js\?v=543[\s\S]*provider\.js\?v=543/);
...
assert.match(serviceWorker,/client-results\.css\?v=543/);
assert.match(serviceWorker,/client-results\.js\?v=543/);
assert.match(serviceWorker,/provider\.js\?v=543/);
assert.match(serviceWorker,/CACHE_PREFIX}v543/);
