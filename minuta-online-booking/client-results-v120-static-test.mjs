...
assert.match(providerHtml,/client-results\.css\?v=652/);
assert.match(providerHtml,/client-results\.js\?v=652[\s\S]*provider\.js\?v=652/);
...
assert.match(serviceWorker,/client-results\.css\?v=652/);
assert.match(serviceWorker,/client-results\.js\?v=652/);
assert.match(serviceWorker,/provider\.js\?v=652/);
assert.match(serviceWorker,/CACHE_PREFIX}v652/);
