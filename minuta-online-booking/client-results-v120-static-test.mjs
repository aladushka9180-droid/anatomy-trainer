...
assert.match(providerHtml,/client-results\.css\?v=579/);
assert.match(providerHtml,/client-results\.js\?v=579[\s\S]*provider\.js\?v=579/);
...
assert.match(serviceWorker,/client-results\.css\?v=579/);
assert.match(serviceWorker,/client-results\.js\?v=579/);
assert.match(serviceWorker,/provider\.js\?v=579/);
assert.match(serviceWorker,/CACHE_PREFIX}v579/);
