...
assert.match(providerHtml,/client-results\.css\?v=700/);
assert.match(providerHtml,/client-results\.js\?v=700[\s\S]*provider\.js\?v=700/);
...
assert.match(serviceWorker,/client-results\.css\?v=700/);
assert.match(serviceWorker,/client-results\.js\?v=700/);
assert.match(serviceWorker,/provider\.js\?v=700/);
assert.match(serviceWorker,/CACHE_PREFIX}v700/);
