...
assert.match(providerHtml,/client-results\.css\?v=544/);
assert.match(providerHtml,/client-results\.js\?v=544[\s\S]*provider\.js\?v=544/);
...
assert.match(serviceWorker,/client-results\.css\?v=544/);
assert.match(serviceWorker,/client-results\.js\?v=544/);
assert.match(serviceWorker,/provider\.js\?v=544/);
assert.match(serviceWorker,/CACHE_PREFIX}v544/);
