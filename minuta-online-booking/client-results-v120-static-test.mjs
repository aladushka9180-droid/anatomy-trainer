...
assert.match(providerHtml,/client-results\.css\?v=542/);
assert.match(providerHtml,/client-results\.js\?v=542[\s\S]*provider\.js\?v=542/);
...
assert.match(serviceWorker,/client-results\.css\?v=542/);
assert.match(serviceWorker,/client-results\.js\?v=542/);
assert.match(serviceWorker,/provider\.js\?v=542/);
assert.match(serviceWorker,/CACHE_PREFIX}v542/);
