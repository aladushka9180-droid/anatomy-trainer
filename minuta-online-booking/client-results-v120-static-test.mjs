...
assert.match(providerHtml,/client-results\.css\?v=651/);
assert.match(providerHtml,/client-results\.js\?v=651[\s\S]*provider\.js\?v=651/);
...
assert.match(serviceWorker,/client-results\.css\?v=651/);
assert.match(serviceWorker,/client-results\.js\?v=651/);
assert.match(serviceWorker,/provider\.js\?v=651/);
assert.match(serviceWorker,/CACHE_PREFIX}v651/);
