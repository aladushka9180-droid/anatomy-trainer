...
assert.match(providerHtml,/client-results\.css\?v=670/);
assert.match(providerHtml,/client-results\.js\?v=670[\s\S]*provider\.js\?v=670/);
...
assert.match(serviceWorker,/client-results\.css\?v=670/);
assert.match(serviceWorker,/client-results\.js\?v=670/);
assert.match(serviceWorker,/provider\.js\?v=670/);
assert.match(serviceWorker,/CACHE_PREFIX}v670/);
