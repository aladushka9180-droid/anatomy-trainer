...
assert.match(providerHtml,/client-results\.css\?v=589/);
assert.match(providerHtml,/client-results\.js\?v=589[\s\S]*provider\.js\?v=589/);
...
assert.match(serviceWorker,/client-results\.css\?v=589/);
assert.match(serviceWorker,/client-results\.js\?v=589/);
assert.match(serviceWorker,/provider\.js\?v=589/);
assert.match(serviceWorker,/CACHE_PREFIX}v589/);
