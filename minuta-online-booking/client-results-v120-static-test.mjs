...
assert.match(providerHtml,/client-results\.css\?v=563/);
assert.match(providerHtml,/client-results\.js\?v=563[\s\S]*provider\.js\?v=563/);
...
assert.match(serviceWorker,/client-results\.css\?v=563/);
assert.match(serviceWorker,/client-results\.js\?v=563/);
assert.match(serviceWorker,/provider\.js\?v=563/);
assert.match(serviceWorker,/CACHE_PREFIX}v563/);
