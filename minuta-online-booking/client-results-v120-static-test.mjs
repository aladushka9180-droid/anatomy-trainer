...
assert.match(providerHtml,/client-results\.css\?v=567/);
assert.match(providerHtml,/client-results\.js\?v=567[\s\S]*provider\.js\?v=567/);
...
assert.match(serviceWorker,/client-results\.css\?v=567/);
assert.match(serviceWorker,/client-results\.js\?v=567/);
assert.match(serviceWorker,/provider\.js\?v=567/);
assert.match(serviceWorker,/CACHE_PREFIX}v567/);
