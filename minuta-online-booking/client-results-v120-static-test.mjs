...
assert.match(providerHtml,/client-results\.css\?v=667/);
assert.match(providerHtml,/client-results\.js\?v=667[\s\S]*provider\.js\?v=667/);
...
assert.match(serviceWorker,/client-results\.css\?v=667/);
assert.match(serviceWorker,/client-results\.js\?v=667/);
assert.match(serviceWorker,/provider\.js\?v=667/);
assert.match(serviceWorker,/CACHE_PREFIX}v667/);
