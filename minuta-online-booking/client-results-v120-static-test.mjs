...
assert.match(providerHtml,/client-results\.css\?v=699/);
assert.match(providerHtml,/client-results\.js\?v=699[\s\S]*provider\.js\?v=699/);
...
assert.match(serviceWorker,/client-results\.css\?v=699/);
assert.match(serviceWorker,/client-results\.js\?v=699/);
assert.match(serviceWorker,/provider\.js\?v=699/);
assert.match(serviceWorker,/CACHE_PREFIX}v699/);
