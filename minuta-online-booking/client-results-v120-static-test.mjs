...
assert.match(providerHtml,/client-results\.css\?v=576/);
assert.match(providerHtml,/client-results\.js\?v=576[\s\S]*provider\.js\?v=576/);
...
assert.match(serviceWorker,/client-results\.css\?v=576/);
assert.match(serviceWorker,/client-results\.js\?v=576/);
assert.match(serviceWorker,/provider\.js\?v=576/);
assert.match(serviceWorker,/CACHE_PREFIX}v576/);
