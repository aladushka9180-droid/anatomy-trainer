...
assert.match(providerHtml,/client-results\.css\?v=612/);
assert.match(providerHtml,/client-results\.js\?v=612[\s\S]*provider\.js\?v=612/);
...
assert.match(serviceWorker,/client-results\.css\?v=612/);
assert.match(serviceWorker,/client-results\.js\?v=612/);
assert.match(serviceWorker,/provider\.js\?v=612/);
assert.match(serviceWorker,/CACHE_PREFIX}v612/);
