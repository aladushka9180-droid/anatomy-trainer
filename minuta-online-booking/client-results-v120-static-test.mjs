...
assert.match(providerHtml,/client-results\.css\?v=603/);
assert.match(providerHtml,/client-results\.js\?v=603[\s\S]*provider\.js\?v=603/);
...
assert.match(serviceWorker,/client-results\.css\?v=603/);
assert.match(serviceWorker,/client-results\.js\?v=603/);
assert.match(serviceWorker,/provider\.js\?v=603/);
assert.match(serviceWorker,/CACHE_PREFIX}v603/);
