...
assert.match(providerHtml,/client-results\.css\?v=599/);
assert.match(providerHtml,/client-results\.js\?v=599[\s\S]*provider\.js\?v=599/);
...
assert.match(serviceWorker,/client-results\.css\?v=599/);
assert.match(serviceWorker,/client-results\.js\?v=599/);
assert.match(serviceWorker,/provider\.js\?v=599/);
assert.match(serviceWorker,/CACHE_PREFIX}v599/);
