...
assert.match(providerHtml,/client-results\.css\?v=550/);
assert.match(providerHtml,/client-results\.js\?v=550[\s\S]*provider\.js\?v=550/);
...
assert.match(serviceWorker,/client-results\.css\?v=550/);
assert.match(serviceWorker,/client-results\.js\?v=550/);
assert.match(serviceWorker,/provider\.js\?v=550/);
assert.match(serviceWorker,/CACHE_PREFIX}v550/);
