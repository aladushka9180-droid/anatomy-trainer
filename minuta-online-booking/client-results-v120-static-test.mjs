...
assert.match(providerHtml,/client-results\.css\?v=556/);
assert.match(providerHtml,/client-results\.js\?v=556[\s\S]*provider\.js\?v=556/);
...
assert.match(serviceWorker,/client-results\.css\?v=556/);
assert.match(serviceWorker,/client-results\.js\?v=556/);
assert.match(serviceWorker,/provider\.js\?v=556/);
assert.match(serviceWorker,/CACHE_PREFIX}v556/);
