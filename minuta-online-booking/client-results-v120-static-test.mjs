...
assert.match(providerHtml,/client-results\.css\?v=713/);
assert.match(providerHtml,/client-results\.js\?v=713[\s\S]*provider\.js\?v=713/);
...
assert.match(serviceWorker,/client-results\.css\?v=713/);
assert.match(serviceWorker,/client-results\.js\?v=713/);
assert.match(serviceWorker,/provider\.js\?v=713/);
assert.match(serviceWorker,/CACHE_PREFIX}v713/);
