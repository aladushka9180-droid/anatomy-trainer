...
assert.match(providerHtml,/client-results\.css\?v=564/);
assert.match(providerHtml,/client-results\.js\?v=564[\s\S]*provider\.js\?v=564/);
...
assert.match(serviceWorker,/client-results\.css\?v=564/);
assert.match(serviceWorker,/client-results\.js\?v=564/);
assert.match(serviceWorker,/provider\.js\?v=564/);
assert.match(serviceWorker,/CACHE_PREFIX}v564/);
