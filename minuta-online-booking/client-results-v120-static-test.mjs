...
assert.match(providerHtml,/client-results\.css\?v=632/);
assert.match(providerHtml,/client-results\.js\?v=632[\s\S]*provider\.js\?v=632/);
...
assert.match(serviceWorker,/client-results\.css\?v=632/);
assert.match(serviceWorker,/client-results\.js\?v=632/);
assert.match(serviceWorker,/provider\.js\?v=632/);
assert.match(serviceWorker,/CACHE_PREFIX}v632/);
