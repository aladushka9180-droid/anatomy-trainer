...
assert.match(providerHtml,/client-results\.css\?v=757/);
assert.match(providerHtml,/client-results\.js\?v=757[\s\S]*provider\.js\?v=757/);
...
assert.match(serviceWorker,/client-results\.css\?v=757/);
assert.match(serviceWorker,/client-results\.js\?v=757/);
assert.match(serviceWorker,/provider\.js\?v=757/);
assert.match(serviceWorker,/CACHE_PREFIX}v757/);
