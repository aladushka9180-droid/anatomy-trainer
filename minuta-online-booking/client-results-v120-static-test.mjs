...
assert.match(providerHtml,/client-results\.css\?v=693/);
assert.match(providerHtml,/client-results\.js\?v=693[\s\S]*provider\.js\?v=693/);
...
assert.match(serviceWorker,/client-results\.css\?v=693/);
assert.match(serviceWorker,/client-results\.js\?v=693/);
assert.match(serviceWorker,/provider\.js\?v=693/);
assert.match(serviceWorker,/CACHE_PREFIX}v693/);
