...
assert.match(providerHtml,/client-results\.css\?v=587/);
assert.match(providerHtml,/client-results\.js\?v=587[\s\S]*provider\.js\?v=587/);
...
assert.match(serviceWorker,/client-results\.css\?v=587/);
assert.match(serviceWorker,/client-results\.js\?v=587/);
assert.match(serviceWorker,/provider\.js\?v=587/);
assert.match(serviceWorker,/CACHE_PREFIX}v587/);
