...
assert.match(providerHtml,/client-results\.css\?v=688/);
assert.match(providerHtml,/client-results\.js\?v=688[\s\S]*provider\.js\?v=688/);
...
assert.match(serviceWorker,/client-results\.css\?v=688/);
assert.match(serviceWorker,/client-results\.js\?v=688/);
assert.match(serviceWorker,/provider\.js\?v=688/);
assert.match(serviceWorker,/CACHE_PREFIX}v688/);
