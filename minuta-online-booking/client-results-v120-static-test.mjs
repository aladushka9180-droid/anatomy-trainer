...
assert.match(providerHtml,/client-results\.js\?v=876[\s\S]*provider\.js\?v=877/);
...
assert.match(serviceWorker,/provider\.js\?v=877/);
assert.match(serviceWorker,/CACHE_PREFIX}v877/);
