...
assert.match(providerHtml,/client-results\.css\?v=575/);
assert.match(providerHtml,/client-results\.js\?v=575[\s\S]*provider\.js\?v=575/);
...
assert.match(serviceWorker,/client-results\.css\?v=575/);
assert.match(serviceWorker,/client-results\.js\?v=575/);
assert.match(serviceWorker,/provider\.js\?v=575/);
assert.match(serviceWorker,/CACHE_PREFIX}v575/);
