...
assert.match(providerHtml,/client-results\.css\?v=748/);
assert.match(providerHtml,/client-results\.js\?v=748[\s\S]*provider\.js\?v=748/);
...
assert.match(serviceWorker,/client-results\.css\?v=748/);
assert.match(serviceWorker,/client-results\.js\?v=748/);
assert.match(serviceWorker,/provider\.js\?v=748/);
assert.match(serviceWorker,/CACHE_PREFIX}v748/);
