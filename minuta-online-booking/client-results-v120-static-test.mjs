...
assert.match(providerHtml,/client-results\.css\?v=614/);
assert.match(providerHtml,/client-results\.js\?v=614[\s\S]*provider\.js\?v=614/);
...
assert.match(serviceWorker,/client-results\.css\?v=614/);
assert.match(serviceWorker,/client-results\.js\?v=614/);
assert.match(serviceWorker,/provider\.js\?v=614/);
assert.match(serviceWorker,/CACHE_PREFIX}v614/);
