...
assert.match(providerHtml,/client-results\.css\?v=702/);
assert.match(providerHtml,/client-results\.js\?v=702[\s\S]*provider\.js\?v=702/);
...
assert.match(serviceWorker,/client-results\.css\?v=702/);
assert.match(serviceWorker,/client-results\.js\?v=702/);
assert.match(serviceWorker,/provider\.js\?v=702/);
assert.match(serviceWorker,/CACHE_PREFIX}v702/);
