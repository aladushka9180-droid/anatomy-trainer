...
assert.match(providerHtml,/client-results\.css\?v=791/);
assert.match(providerHtml,/client-results\.js\?v=791[\s\S]*provider\.js\?v=791/);
...
assert.match(serviceWorker,/client-results\.css\?v=791/);
assert.match(serviceWorker,/client-results\.js\?v=791/);
assert.match(serviceWorker,/provider\.js\?v=791/);
assert.match(serviceWorker,/CACHE_PREFIX}v791/);
