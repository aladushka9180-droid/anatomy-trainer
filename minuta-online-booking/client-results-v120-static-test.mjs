...
assert.match(providerHtml,/client-results\.css\?v=695/);
assert.match(providerHtml,/client-results\.js\?v=695[\s\S]*provider\.js\?v=695/);
...
assert.match(serviceWorker,/client-results\.css\?v=695/);
assert.match(serviceWorker,/client-results\.js\?v=695/);
assert.match(serviceWorker,/provider\.js\?v=695/);
assert.match(serviceWorker,/CACHE_PREFIX}v695/);
