...
assert.match(providerHtml,/client-results\.css\?v=811/);
assert.match(providerHtml,/client-results\.js\?v=811[\s\S]*provider\.js\?v=811/);
...
assert.match(serviceWorker,/client-results\.css\?v=811/);
assert.match(serviceWorker,/client-results\.js\?v=811/);
assert.match(serviceWorker,/provider\.js\?v=811/);
assert.match(serviceWorker,/CACHE_PREFIX}v811/);
