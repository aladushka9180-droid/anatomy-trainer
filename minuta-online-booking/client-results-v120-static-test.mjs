...
assert.match(providerHtml,/client-results\.css\?v=596/);
assert.match(providerHtml,/client-results\.js\?v=596[\s\S]*provider\.js\?v=596/);
...
assert.match(serviceWorker,/client-results\.css\?v=596/);
assert.match(serviceWorker,/client-results\.js\?v=596/);
assert.match(serviceWorker,/provider\.js\?v=596/);
assert.match(serviceWorker,/CACHE_PREFIX}v596/);
