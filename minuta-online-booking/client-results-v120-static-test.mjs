...
assert.match(providerHtml,/client-results\.css\?v=805/);
assert.match(providerHtml,/client-results\.js\?v=805[\s\S]*provider\.js\?v=805/);
...
assert.match(serviceWorker,/client-results\.css\?v=805/);
assert.match(serviceWorker,/client-results\.js\?v=805/);
assert.match(serviceWorker,/provider\.js\?v=805/);
assert.match(serviceWorker,/CACHE_PREFIX}v805/);
