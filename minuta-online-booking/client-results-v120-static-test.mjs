...
assert.match(providerHtml,/client-results\.css\?v=610/);
assert.match(providerHtml,/client-results\.js\?v=610[\s\S]*provider\.js\?v=610/);
...
assert.match(serviceWorker,/client-results\.css\?v=610/);
assert.match(serviceWorker,/client-results\.js\?v=610/);
assert.match(serviceWorker,/provider\.js\?v=610/);
assert.match(serviceWorker,/CACHE_PREFIX}v610/);
