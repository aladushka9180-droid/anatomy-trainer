...
assert.match(providerHtml,/client-results\.css\?v=809/);
assert.match(providerHtml,/client-results\.js\?v=809[\s\S]*provider\.js\?v=809/);
...
assert.match(serviceWorker,/client-results\.css\?v=809/);
assert.match(serviceWorker,/client-results\.js\?v=809/);
assert.match(serviceWorker,/provider\.js\?v=809/);
assert.match(serviceWorker,/CACHE_PREFIX}v809/);
