...
assert.match(providerHtml,/client-results\.css\?v=794/);
assert.match(providerHtml,/client-results\.js\?v=794[\s\S]*provider\.js\?v=794/);
...
assert.match(serviceWorker,/client-results\.css\?v=794/);
assert.match(serviceWorker,/client-results\.js\?v=794/);
assert.match(serviceWorker,/provider\.js\?v=794/);
assert.match(serviceWorker,/CACHE_PREFIX}v794/);
