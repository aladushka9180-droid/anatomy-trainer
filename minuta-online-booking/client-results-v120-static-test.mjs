...
assert.match(providerHtml,/client-results\.css\?v=745/);
assert.match(providerHtml,/client-results\.js\?v=745[\s\S]*provider\.js\?v=745/);
...
assert.match(serviceWorker,/client-results\.css\?v=745/);
assert.match(serviceWorker,/client-results\.js\?v=745/);
assert.match(serviceWorker,/provider\.js\?v=745/);
assert.match(serviceWorker,/CACHE_PREFIX}v745/);
