...
assert.match(providerHtml,/client-results\.css\?v=733/);
assert.match(providerHtml,/client-results\.js\?v=733[\s\S]*provider\.js\?v=733/);
...
assert.match(serviceWorker,/client-results\.css\?v=733/);
assert.match(serviceWorker,/client-results\.js\?v=733/);
assert.match(serviceWorker,/provider\.js\?v=733/);
assert.match(serviceWorker,/CACHE_PREFIX}v733/);
