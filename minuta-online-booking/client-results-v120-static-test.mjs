...
assert.match(providerHtml,/client-results\.css\?v=536/);
assert.match(providerHtml,/client-results\.js\?v=536[\s\S]*provider\.js\?v=536/);
...
assert.match(serviceWorker,/client-results\.css\?v=536/);
assert.match(serviceWorker,/client-results\.js\?v=536/);
assert.match(serviceWorker,/provider\.js\?v=536/);
assert.match(serviceWorker,/CACHE_PREFIX}v536/);
