...
assert.match(providerHtml,/client-results\.css\?v=720/);
assert.match(providerHtml,/client-results\.js\?v=720[\s\S]*provider\.js\?v=720/);
...
assert.match(serviceWorker,/client-results\.css\?v=720/);
assert.match(serviceWorker,/client-results\.js\?v=720/);
assert.match(serviceWorker,/provider\.js\?v=720/);
assert.match(serviceWorker,/CACHE_PREFIX}v720/);
