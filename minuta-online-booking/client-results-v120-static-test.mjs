...
assert.match(providerHtml,/client-results\.css\?v=540/);
assert.match(providerHtml,/client-results\.js\?v=540[\s\S]*provider\.js\?v=540/);
...
assert.match(serviceWorker,/client-results\.css\?v=540/);
assert.match(serviceWorker,/client-results\.js\?v=540/);
assert.match(serviceWorker,/provider\.js\?v=540/);
assert.match(serviceWorker,/CACHE_PREFIX}v540/);
