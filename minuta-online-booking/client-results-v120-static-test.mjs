...
assert.match(providerHtml,/client-results\.css\?v=736/);
assert.match(providerHtml,/client-results\.js\?v=736[\s\S]*provider\.js\?v=736/);
...
assert.match(serviceWorker,/client-results\.css\?v=736/);
assert.match(serviceWorker,/client-results\.js\?v=736/);
assert.match(serviceWorker,/provider\.js\?v=736/);
assert.match(serviceWorker,/CACHE_PREFIX}v736/);
