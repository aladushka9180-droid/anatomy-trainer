...
assert.match(providerHtml,/client-results\.css\?v=669/);
assert.match(providerHtml,/client-results\.js\?v=669[\s\S]*provider\.js\?v=669/);
...
assert.match(serviceWorker,/client-results\.css\?v=669/);
assert.match(serviceWorker,/client-results\.js\?v=669/);
assert.match(serviceWorker,/provider\.js\?v=669/);
assert.match(serviceWorker,/CACHE_PREFIX}v669/);
