...
assert.match(providerHtml,/client-results\.css\?v=768/);
assert.match(providerHtml,/client-results\.js\?v=768[\s\S]*provider\.js\?v=768/);
...
assert.match(serviceWorker,/client-results\.css\?v=768/);
assert.match(serviceWorker,/client-results\.js\?v=768/);
assert.match(serviceWorker,/provider\.js\?v=768/);
assert.match(serviceWorker,/CACHE_PREFIX}v768/);
