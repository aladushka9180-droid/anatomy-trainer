...
assert.match(providerHtml,/client-results\.css\?v=726/);
assert.match(providerHtml,/client-results\.js\?v=726[\s\S]*provider\.js\?v=726/);
...
assert.match(serviceWorker,/client-results\.css\?v=726/);
assert.match(serviceWorker,/client-results\.js\?v=726/);
assert.match(serviceWorker,/provider\.js\?v=726/);
assert.match(serviceWorker,/CACHE_PREFIX}v726/);
