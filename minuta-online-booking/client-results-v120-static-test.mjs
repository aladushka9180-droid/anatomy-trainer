...
assert.match(providerHtml,/client-results\.css\?v=644/);
assert.match(providerHtml,/client-results\.js\?v=644[\s\S]*provider\.js\?v=644/);
...
assert.match(serviceWorker,/client-results\.css\?v=644/);
assert.match(serviceWorker,/client-results\.js\?v=644/);
assert.match(serviceWorker,/provider\.js\?v=644/);
assert.match(serviceWorker,/CACHE_PREFIX}v644/);
