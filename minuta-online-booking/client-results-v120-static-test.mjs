...
assert.match(providerHtml,/client-results\.css\?v=608/);
assert.match(providerHtml,/client-results\.js\?v=608[\s\S]*provider\.js\?v=608/);
...
assert.match(serviceWorker,/client-results\.css\?v=608/);
assert.match(serviceWorker,/client-results\.js\?v=608/);
assert.match(serviceWorker,/provider\.js\?v=608/);
assert.match(serviceWorker,/CACHE_PREFIX}v608/);
