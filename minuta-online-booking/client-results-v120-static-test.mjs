...
assert.match(providerHtml,/client-results\.css\?v=686/);
assert.match(providerHtml,/client-results\.js\?v=686[\s\S]*provider\.js\?v=686/);
...
assert.match(serviceWorker,/client-results\.css\?v=686/);
assert.match(serviceWorker,/client-results\.js\?v=686/);
assert.match(serviceWorker,/provider\.js\?v=686/);
assert.match(serviceWorker,/CACHE_PREFIX}v686/);
