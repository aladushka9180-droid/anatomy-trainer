...
assert.match(providerHtml,/client-results\.css\?v=782/);
assert.match(providerHtml,/client-results\.js\?v=782[\s\S]*provider\.js\?v=782/);
...
assert.match(serviceWorker,/client-results\.css\?v=782/);
assert.match(serviceWorker,/client-results\.js\?v=782/);
assert.match(serviceWorker,/provider\.js\?v=782/);
assert.match(serviceWorker,/CACHE_PREFIX}v782/);
