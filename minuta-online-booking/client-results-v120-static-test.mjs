...
assert.match(providerHtml,/client-results\.css\?v=692/);
assert.match(providerHtml,/client-results\.js\?v=692[\s\S]*provider\.js\?v=692/);
...
assert.match(serviceWorker,/client-results\.css\?v=692/);
assert.match(serviceWorker,/client-results\.js\?v=692/);
assert.match(serviceWorker,/provider\.js\?v=692/);
assert.match(serviceWorker,/CACHE_PREFIX}v692/);
