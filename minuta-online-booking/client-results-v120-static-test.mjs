...
assert.match(providerHtml,/client-results\.css\?v=741/);
assert.match(providerHtml,/client-results\.js\?v=741[\s\S]*provider\.js\?v=741/);
...
assert.match(serviceWorker,/client-results\.css\?v=741/);
assert.match(serviceWorker,/client-results\.js\?v=741/);
assert.match(serviceWorker,/provider\.js\?v=741/);
assert.match(serviceWorker,/CACHE_PREFIX}v741/);
