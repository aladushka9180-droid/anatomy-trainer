...
assert.match(providerHtml,/client-results\.css\?v=784/);
assert.match(providerHtml,/client-results\.js\?v=784[\s\S]*provider\.js\?v=784/);
...
assert.match(serviceWorker,/client-results\.css\?v=784/);
assert.match(serviceWorker,/client-results\.js\?v=784/);
assert.match(serviceWorker,/provider\.js\?v=784/);
assert.match(serviceWorker,/CACHE_PREFIX}v784/);
