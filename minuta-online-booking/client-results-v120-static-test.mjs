...
assert.match(providerHtml,/client-results\.css\?v=666/);
assert.match(providerHtml,/client-results\.js\?v=666[\s\S]*provider\.js\?v=666/);
...
assert.match(serviceWorker,/client-results\.css\?v=666/);
assert.match(serviceWorker,/client-results\.js\?v=666/);
assert.match(serviceWorker,/provider\.js\?v=666/);
assert.match(serviceWorker,/CACHE_PREFIX}v666/);
