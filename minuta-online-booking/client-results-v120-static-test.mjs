...
assert.match(providerHtml,/client-results\.css\?v=766/);
assert.match(providerHtml,/client-results\.js\?v=766[\s\S]*provider\.js\?v=766/);
...
assert.match(serviceWorker,/client-results\.css\?v=766/);
assert.match(serviceWorker,/client-results\.js\?v=766/);
assert.match(serviceWorker,/provider\.js\?v=766/);
assert.match(serviceWorker,/CACHE_PREFIX}v766/);
