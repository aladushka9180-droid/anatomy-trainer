...
assert.match(providerHtml,/client-results\.css\?v=781/);
assert.match(providerHtml,/client-results\.js\?v=781[\s\S]*provider\.js\?v=781/);
...
assert.match(serviceWorker,/client-results\.css\?v=781/);
assert.match(serviceWorker,/client-results\.js\?v=781/);
assert.match(serviceWorker,/provider\.js\?v=781/);
assert.match(serviceWorker,/CACHE_PREFIX}v781/);
