...
assert.match(providerHtml,/client-results\.css\?v=561/);
assert.match(providerHtml,/client-results\.js\?v=561[\s\S]*provider\.js\?v=561/);
...
assert.match(serviceWorker,/client-results\.css\?v=561/);
assert.match(serviceWorker,/client-results\.js\?v=561/);
assert.match(serviceWorker,/provider\.js\?v=561/);
assert.match(serviceWorker,/CACHE_PREFIX}v561/);
