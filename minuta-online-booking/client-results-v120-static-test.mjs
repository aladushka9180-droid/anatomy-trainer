...
assert.match(providerHtml,/client-results\.css\?v=689/);
assert.match(providerHtml,/client-results\.js\?v=689[\s\S]*provider\.js\?v=689/);
...
assert.match(serviceWorker,/client-results\.css\?v=689/);
assert.match(serviceWorker,/client-results\.js\?v=689/);
assert.match(serviceWorker,/provider\.js\?v=689/);
assert.match(serviceWorker,/CACHE_PREFIX}v689/);
