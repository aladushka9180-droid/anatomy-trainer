...
assert.match(providerHtml,/client-results\.css\?v=583/);
assert.match(providerHtml,/client-results\.js\?v=583[\s\S]*provider\.js\?v=583/);
...
assert.match(serviceWorker,/client-results\.css\?v=583/);
assert.match(serviceWorker,/client-results\.js\?v=583/);
assert.match(serviceWorker,/provider\.js\?v=583/);
assert.match(serviceWorker,/CACHE_PREFIX}v583/);
