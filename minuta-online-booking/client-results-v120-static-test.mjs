...
assert.match(providerHtml,/client-results\.css\?v=728/);
assert.match(providerHtml,/client-results\.js\?v=728[\s\S]*provider\.js\?v=728/);
...
assert.match(serviceWorker,/client-results\.css\?v=728/);
assert.match(serviceWorker,/client-results\.js\?v=728/);
assert.match(serviceWorker,/provider\.js\?v=728/);
assert.match(serviceWorker,/CACHE_PREFIX}v728/);
