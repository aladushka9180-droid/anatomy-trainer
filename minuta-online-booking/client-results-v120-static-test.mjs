...
assert.match(providerHtml,/client-results\.css\?v=725/);
assert.match(providerHtml,/client-results\.js\?v=725[\s\S]*provider\.js\?v=725/);
...
assert.match(serviceWorker,/client-results\.css\?v=725/);
assert.match(serviceWorker,/client-results\.js\?v=725/);
assert.match(serviceWorker,/provider\.js\?v=725/);
assert.match(serviceWorker,/CACHE_PREFIX}v725/);
