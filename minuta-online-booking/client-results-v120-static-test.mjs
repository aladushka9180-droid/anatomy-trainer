...
assert.match(providerHtml,/client-results\.css\?v=737/);
assert.match(providerHtml,/client-results\.js\?v=737[\s\S]*provider\.js\?v=737/);
...
assert.match(serviceWorker,/client-results\.css\?v=737/);
assert.match(serviceWorker,/client-results\.js\?v=737/);
assert.match(serviceWorker,/provider\.js\?v=737/);
assert.match(serviceWorker,/CACHE_PREFIX}v737/);
