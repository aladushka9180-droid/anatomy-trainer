...
assert.match(providerHtml,/client-results\.css\?v=569/);
assert.match(providerHtml,/client-results\.js\?v=569[\s\S]*provider\.js\?v=569/);
...
assert.match(serviceWorker,/client-results\.css\?v=569/);
assert.match(serviceWorker,/client-results\.js\?v=569/);
assert.match(serviceWorker,/provider\.js\?v=569/);
assert.match(serviceWorker,/CACHE_PREFIX}v569/);
