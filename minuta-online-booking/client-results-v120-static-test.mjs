...
assert.match(providerHtml,/client-results\.css\?v=705/);
assert.match(providerHtml,/client-results\.js\?v=705[\s\S]*provider\.js\?v=705/);
...
assert.match(serviceWorker,/client-results\.css\?v=705/);
assert.match(serviceWorker,/client-results\.js\?v=705/);
assert.match(serviceWorker,/provider\.js\?v=705/);
assert.match(serviceWorker,/CACHE_PREFIX}v705/);
