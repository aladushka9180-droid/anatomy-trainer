...
assert.match(providerHtml,/client-results\.css\?v=655/);
assert.match(providerHtml,/client-results\.js\?v=655[\s\S]*provider\.js\?v=655/);
...
assert.match(serviceWorker,/client-results\.css\?v=655/);
assert.match(serviceWorker,/client-results\.js\?v=655/);
assert.match(serviceWorker,/provider\.js\?v=655/);
assert.match(serviceWorker,/CACHE_PREFIX}v655/);
