...
assert.match(providerHtml,/client-results\.css\?v=628/);
assert.match(providerHtml,/client-results\.js\?v=628[\s\S]*provider\.js\?v=628/);
...
assert.match(serviceWorker,/client-results\.css\?v=628/);
assert.match(serviceWorker,/client-results\.js\?v=628/);
assert.match(serviceWorker,/provider\.js\?v=628/);
assert.match(serviceWorker,/CACHE_PREFIX}v628/);
