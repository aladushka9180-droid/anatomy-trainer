...
assert.match(providerHtml,/client-results\.css\?v=578/);
assert.match(providerHtml,/client-results\.js\?v=578[\s\S]*provider\.js\?v=578/);
...
assert.match(serviceWorker,/client-results\.css\?v=578/);
assert.match(serviceWorker,/client-results\.js\?v=578/);
assert.match(serviceWorker,/provider\.js\?v=578/);
assert.match(serviceWorker,/CACHE_PREFIX}v578/);
