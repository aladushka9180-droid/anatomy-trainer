...
assert.match(providerHtml,/client-results\.css\?v=771/);
assert.match(providerHtml,/client-results\.js\?v=771[\s\S]*provider\.js\?v=771/);
...
assert.match(serviceWorker,/client-results\.css\?v=771/);
assert.match(serviceWorker,/client-results\.js\?v=771/);
assert.match(serviceWorker,/provider\.js\?v=771/);
assert.match(serviceWorker,/CACHE_PREFIX}v771/);
