...
assert.match(providerHtml,/client-results\.css\?v=656/);
assert.match(providerHtml,/client-results\.js\?v=656[\s\S]*provider\.js\?v=656/);
...
assert.match(serviceWorker,/client-results\.css\?v=656/);
assert.match(serviceWorker,/client-results\.js\?v=656/);
assert.match(serviceWorker,/provider\.js\?v=656/);
assert.match(serviceWorker,/CACHE_PREFIX}v656/);
