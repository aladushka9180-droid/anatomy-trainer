...
assert.match(providerHtml,/client-results\.css\?v=759/);
assert.match(providerHtml,/client-results\.js\?v=759[\s\S]*provider\.js\?v=759/);
...
assert.match(serviceWorker,/client-results\.css\?v=759/);
assert.match(serviceWorker,/client-results\.js\?v=759/);
assert.match(serviceWorker,/provider\.js\?v=759/);
assert.match(serviceWorker,/CACHE_PREFIX}v759/);
