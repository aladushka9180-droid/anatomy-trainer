...
assert.match(providerHtml,/client-results\.css\?v=668/);
assert.match(providerHtml,/client-results\.js\?v=668[\s\S]*provider\.js\?v=668/);
...
assert.match(serviceWorker,/client-results\.css\?v=668/);
assert.match(serviceWorker,/client-results\.js\?v=668/);
assert.match(serviceWorker,/provider\.js\?v=668/);
assert.match(serviceWorker,/CACHE_PREFIX}v668/);
