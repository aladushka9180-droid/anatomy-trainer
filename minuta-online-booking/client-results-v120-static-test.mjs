...
assert.match(providerHtml,/client-results\.css\?v=758/);
assert.match(providerHtml,/client-results\.js\?v=758[\s\S]*provider\.js\?v=758/);
...
assert.match(serviceWorker,/client-results\.css\?v=758/);
assert.match(serviceWorker,/client-results\.js\?v=758/);
assert.match(serviceWorker,/provider\.js\?v=758/);
assert.match(serviceWorker,/CACHE_PREFIX}v758/);
