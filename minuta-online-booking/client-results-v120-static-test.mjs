...
assert.match(providerHtml,/client-results\.css\?v=697/);
assert.match(providerHtml,/client-results\.js\?v=697[\s\S]*provider\.js\?v=697/);
...
assert.match(serviceWorker,/client-results\.css\?v=697/);
assert.match(serviceWorker,/client-results\.js\?v=697/);
assert.match(serviceWorker,/provider\.js\?v=697/);
assert.match(serviceWorker,/CACHE_PREFIX}v697/);
