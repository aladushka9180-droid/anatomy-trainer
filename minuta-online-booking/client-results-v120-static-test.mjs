...
assert.match(providerHtml,/client-results\.css\?v=709/);
assert.match(providerHtml,/client-results\.js\?v=709[\s\S]*provider\.js\?v=709/);
...
assert.match(serviceWorker,/client-results\.css\?v=709/);
assert.match(serviceWorker,/client-results\.js\?v=709/);
assert.match(serviceWorker,/provider\.js\?v=709/);
assert.match(serviceWorker,/CACHE_PREFIX}v709/);
