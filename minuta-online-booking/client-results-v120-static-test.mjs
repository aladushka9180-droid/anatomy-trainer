...
assert.match(providerHtml,/client-results\.css\?v=719/);
assert.match(providerHtml,/client-results\.js\?v=719[\s\S]*provider\.js\?v=719/);
...
assert.match(serviceWorker,/client-results\.css\?v=719/);
assert.match(serviceWorker,/client-results\.js\?v=719/);
assert.match(serviceWorker,/provider\.js\?v=719/);
assert.match(serviceWorker,/CACHE_PREFIX}v719/);
