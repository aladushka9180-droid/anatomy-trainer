...
assert.match(providerHtml,/client-results\.css\?v=622/);
assert.match(providerHtml,/client-results\.js\?v=622[\s\S]*provider\.js\?v=622/);
...
assert.match(serviceWorker,/client-results\.css\?v=622/);
assert.match(serviceWorker,/client-results\.js\?v=622/);
assert.match(serviceWorker,/provider\.js\?v=622/);
assert.match(serviceWorker,/CACHE_PREFIX}v622/);
