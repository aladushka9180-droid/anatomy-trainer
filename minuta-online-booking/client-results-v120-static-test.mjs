...
assert.match(providerHtml,/client-results\.css\?v=617/);
assert.match(providerHtml,/client-results\.js\?v=617[\s\S]*provider\.js\?v=617/);
...
assert.match(serviceWorker,/client-results\.css\?v=617/);
assert.match(serviceWorker,/client-results\.js\?v=617/);
assert.match(serviceWorker,/provider\.js\?v=617/);
assert.match(serviceWorker,/CACHE_PREFIX}v617/);
