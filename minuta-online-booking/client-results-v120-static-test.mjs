...
assert.match(providerHtml,/client-results\.css\?v=545/);
assert.match(providerHtml,/client-results\.js\?v=545[\s\S]*provider\.js\?v=545/);
...
assert.match(serviceWorker,/client-results\.css\?v=545/);
assert.match(serviceWorker,/client-results\.js\?v=545/);
assert.match(serviceWorker,/provider\.js\?v=545/);
assert.match(serviceWorker,/CACHE_PREFIX}v545/);
