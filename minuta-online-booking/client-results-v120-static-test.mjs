...
assert.match(providerHtml,/client-results\.css\?v=662/);
assert.match(providerHtml,/client-results\.js\?v=662[\s\S]*provider\.js\?v=662/);
...
assert.match(serviceWorker,/client-results\.css\?v=662/);
assert.match(serviceWorker,/client-results\.js\?v=662/);
assert.match(serviceWorker,/provider\.js\?v=662/);
assert.match(serviceWorker,/CACHE_PREFIX}v662/);
