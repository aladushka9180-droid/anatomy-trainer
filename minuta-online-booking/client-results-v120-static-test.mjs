...
assert.match(providerHtml,/client-results\.css\?v=772/);
assert.match(providerHtml,/client-results\.js\?v=772[\s\S]*provider\.js\?v=772/);
...
assert.match(serviceWorker,/client-results\.css\?v=772/);
assert.match(serviceWorker,/client-results\.js\?v=772/);
assert.match(serviceWorker,/provider\.js\?v=772/);
assert.match(serviceWorker,/CACHE_PREFIX}v772/);
