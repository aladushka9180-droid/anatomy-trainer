...
assert.match(providerHtml,/client-results\.css\?v=799/);
assert.match(providerHtml,/client-results\.js\?v=799[\s\S]*provider\.js\?v=799/);
...
assert.match(serviceWorker,/client-results\.css\?v=799/);
assert.match(serviceWorker,/client-results\.js\?v=799/);
assert.match(serviceWorker,/provider\.js\?v=799/);
assert.match(serviceWorker,/CACHE_PREFIX}v799/);
