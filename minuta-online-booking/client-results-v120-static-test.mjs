...
assert.match(providerHtml,/client-results\.css\?v=592/);
assert.match(providerHtml,/client-results\.js\?v=592[\s\S]*provider\.js\?v=592/);
...
assert.match(serviceWorker,/client-results\.css\?v=592/);
assert.match(serviceWorker,/client-results\.js\?v=592/);
assert.match(serviceWorker,/provider\.js\?v=592/);
assert.match(serviceWorker,/CACHE_PREFIX}v592/);
