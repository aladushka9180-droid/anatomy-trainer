...
assert.match(providerHtml,/client-results\.css\?v=657/);
assert.match(providerHtml,/client-results\.js\?v=657[\s\S]*provider\.js\?v=657/);
...
assert.match(serviceWorker,/client-results\.css\?v=657/);
assert.match(serviceWorker,/client-results\.js\?v=657/);
assert.match(serviceWorker,/provider\.js\?v=657/);
assert.match(serviceWorker,/CACHE_PREFIX}v657/);
