...
assert.match(providerHtml,/client-results\.css\?v=704/);
assert.match(providerHtml,/client-results\.js\?v=704[\s\S]*provider\.js\?v=704/);
...
assert.match(serviceWorker,/client-results\.css\?v=704/);
assert.match(serviceWorker,/client-results\.js\?v=704/);
assert.match(serviceWorker,/provider\.js\?v=704/);
assert.match(serviceWorker,/CACHE_PREFIX}v704/);
