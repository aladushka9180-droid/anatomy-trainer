...
assert.match(providerHtml,/client-results\.css\?v=591/);
assert.match(providerHtml,/client-results\.js\?v=591[\s\S]*provider\.js\?v=591/);
...
assert.match(serviceWorker,/client-results\.css\?v=591/);
assert.match(serviceWorker,/client-results\.js\?v=591/);
assert.match(serviceWorker,/provider\.js\?v=591/);
assert.match(serviceWorker,/CACHE_PREFIX}v591/);
