...
assert.match(providerHtml,/client-results\.css\?v=807/);
assert.match(providerHtml,/client-results\.js\?v=807[\s\S]*provider\.js\?v=807/);
...
assert.match(serviceWorker,/client-results\.css\?v=807/);
assert.match(serviceWorker,/client-results\.js\?v=807/);
assert.match(serviceWorker,/provider\.js\?v=807/);
assert.match(serviceWorker,/CACHE_PREFIX}v807/);
