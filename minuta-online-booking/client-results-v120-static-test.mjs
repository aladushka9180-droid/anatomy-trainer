...
assert.match(providerHtml,/client-results\.css\?v=646/);
assert.match(providerHtml,/client-results\.js\?v=646[\s\S]*provider\.js\?v=646/);
...
assert.match(serviceWorker,/client-results\.css\?v=646/);
assert.match(serviceWorker,/client-results\.js\?v=646/);
assert.match(serviceWorker,/provider\.js\?v=646/);
assert.match(serviceWorker,/CACHE_PREFIX}v646/);
