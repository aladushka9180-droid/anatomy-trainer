...
assert.match(providerHtml,/client-results\.css\?v=621/);
assert.match(providerHtml,/client-results\.js\?v=621[\s\S]*provider\.js\?v=621/);
...
assert.match(serviceWorker,/client-results\.css\?v=621/);
assert.match(serviceWorker,/client-results\.js\?v=621/);
assert.match(serviceWorker,/provider\.js\?v=621/);
assert.match(serviceWorker,/CACHE_PREFIX}v621/);
