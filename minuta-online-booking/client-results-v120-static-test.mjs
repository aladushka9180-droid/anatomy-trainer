...
assert.match(providerHtml,/client-results\.css\?v=663/);
assert.match(providerHtml,/client-results\.js\?v=663[\s\S]*provider\.js\?v=663/);
...
assert.match(serviceWorker,/client-results\.css\?v=663/);
assert.match(serviceWorker,/client-results\.js\?v=663/);
assert.match(serviceWorker,/provider\.js\?v=663/);
assert.match(serviceWorker,/CACHE_PREFIX}v663/);
