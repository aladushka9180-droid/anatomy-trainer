...
assert.match(providerHtml,/client-results\.css\?v=637/);
assert.match(providerHtml,/client-results\.js\?v=637[\s\S]*provider\.js\?v=637/);
...
assert.match(serviceWorker,/client-results\.css\?v=637/);
assert.match(serviceWorker,/client-results\.js\?v=637/);
assert.match(serviceWorker,/provider\.js\?v=637/);
assert.match(serviceWorker,/CACHE_PREFIX}v637/);
