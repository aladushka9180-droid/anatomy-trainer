...
assert.match(providerHtml,/client-results\.css\?v=553/);
assert.match(providerHtml,/client-results\.js\?v=553[\s\S]*provider\.js\?v=553/);
...
assert.match(serviceWorker,/client-results\.css\?v=553/);
assert.match(serviceWorker,/client-results\.js\?v=553/);
assert.match(serviceWorker,/provider\.js\?v=553/);
assert.match(serviceWorker,/CACHE_PREFIX}v553/);
