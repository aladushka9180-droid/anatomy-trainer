...
assert.match(providerHtml,/client-results\.css\?v=577/);
assert.match(providerHtml,/client-results\.js\?v=577[\s\S]*provider\.js\?v=577/);
...
assert.match(serviceWorker,/client-results\.css\?v=577/);
assert.match(serviceWorker,/client-results\.js\?v=577/);
assert.match(serviceWorker,/provider\.js\?v=577/);
assert.match(serviceWorker,/CACHE_PREFIX}v577/);
