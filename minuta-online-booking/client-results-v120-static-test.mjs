...
assert.match(providerHtml,/client-results\.css\?v=552/);
assert.match(providerHtml,/client-results\.js\?v=552[\s\S]*provider\.js\?v=552/);
...
assert.match(serviceWorker,/client-results\.css\?v=552/);
assert.match(serviceWorker,/client-results\.js\?v=552/);
assert.match(serviceWorker,/provider\.js\?v=552/);
assert.match(serviceWorker,/CACHE_PREFIX}v552/);
