...
assert.match(providerHtml,/client-results\.css\?v=674/);
assert.match(providerHtml,/client-results\.js\?v=674[\s\S]*provider\.js\?v=674/);
...
assert.match(serviceWorker,/client-results\.css\?v=674/);
assert.match(serviceWorker,/client-results\.js\?v=674/);
assert.match(serviceWorker,/provider\.js\?v=674/);
assert.match(serviceWorker,/CACHE_PREFIX}v674/);
