...
assert.match(providerHtml,/client-results\.css\?v=590/);
assert.match(providerHtml,/client-results\.js\?v=590[\s\S]*provider\.js\?v=590/);
...
assert.match(serviceWorker,/client-results\.css\?v=590/);
assert.match(serviceWorker,/client-results\.js\?v=590/);
assert.match(serviceWorker,/provider\.js\?v=590/);
assert.match(serviceWorker,/CACHE_PREFIX}v590/);
