...
assert.match(providerHtml,/client-results\.css\?v=808/);
assert.match(providerHtml,/client-results\.js\?v=808[\s\S]*provider\.js\?v=808/);
...
assert.match(serviceWorker,/client-results\.css\?v=808/);
assert.match(serviceWorker,/client-results\.js\?v=808/);
assert.match(serviceWorker,/provider\.js\?v=808/);
assert.match(serviceWorker,/CACHE_PREFIX}v808/);
