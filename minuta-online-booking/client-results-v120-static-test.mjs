...
assert.match(providerHtml,/client-results\.css\?v=707/);
assert.match(providerHtml,/client-results\.js\?v=707[\s\S]*provider\.js\?v=707/);
...
assert.match(serviceWorker,/client-results\.css\?v=707/);
assert.match(serviceWorker,/client-results\.js\?v=707/);
assert.match(serviceWorker,/provider\.js\?v=707/);
assert.match(serviceWorker,/CACHE_PREFIX}v707/);
