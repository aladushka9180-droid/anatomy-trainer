...
assert.match(providerHtml,/client-results\.css\?v=790/);
assert.match(providerHtml,/client-results\.js\?v=790[\s\S]*provider\.js\?v=790/);
...
assert.match(serviceWorker,/client-results\.css\?v=790/);
assert.match(serviceWorker,/client-results\.js\?v=790/);
assert.match(serviceWorker,/provider\.js\?v=790/);
assert.match(serviceWorker,/CACHE_PREFIX}v790/);
