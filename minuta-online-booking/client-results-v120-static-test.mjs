...
assert.match(providerHtml,/client-results\.css\?v=573/);
assert.match(providerHtml,/client-results\.js\?v=573[\s\S]*provider\.js\?v=573/);
...
assert.match(serviceWorker,/client-results\.css\?v=573/);
assert.match(serviceWorker,/client-results\.js\?v=573/);
assert.match(serviceWorker,/provider\.js\?v=573/);
assert.match(serviceWorker,/CACHE_PREFIX}v573/);
