...
assert.match(providerHtml,/client-results\.css\?v=609/);
assert.match(providerHtml,/client-results\.js\?v=609[\s\S]*provider\.js\?v=609/);
...
assert.match(serviceWorker,/client-results\.css\?v=609/);
assert.match(serviceWorker,/client-results\.js\?v=609/);
assert.match(serviceWorker,/provider\.js\?v=609/);
assert.match(serviceWorker,/CACHE_PREFIX}v609/);
