...
assert.match(providerHtml,/client-results\.css\?v=742/);
assert.match(providerHtml,/client-results\.js\?v=742[\s\S]*provider\.js\?v=742/);
...
assert.match(serviceWorker,/client-results\.css\?v=742/);
assert.match(serviceWorker,/client-results\.js\?v=742/);
assert.match(serviceWorker,/provider\.js\?v=742/);
assert.match(serviceWorker,/CACHE_PREFIX}v742/);
