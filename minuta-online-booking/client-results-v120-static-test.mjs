...
assert.match(providerHtml,/client-results\.css\?v=801/);
assert.match(providerHtml,/client-results\.js\?v=801[\s\S]*provider\.js\?v=801/);
...
assert.match(serviceWorker,/client-results\.css\?v=801/);
assert.match(serviceWorker,/client-results\.js\?v=801/);
assert.match(serviceWorker,/provider\.js\?v=801/);
assert.match(serviceWorker,/CACHE_PREFIX}v801/);
