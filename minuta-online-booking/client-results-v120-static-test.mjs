...
assert.match(providerHtml,/client-results\.css\?v=755/);
assert.match(providerHtml,/client-results\.js\?v=755[\s\S]*provider\.js\?v=755/);
...
assert.match(serviceWorker,/client-results\.css\?v=755/);
assert.match(serviceWorker,/client-results\.js\?v=755/);
assert.match(serviceWorker,/provider\.js\?v=755/);
assert.match(serviceWorker,/CACHE_PREFIX}v755/);
