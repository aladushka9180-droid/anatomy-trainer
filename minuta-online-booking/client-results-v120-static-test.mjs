...
assert.match(providerHtml,/client-results\.css\?v=763/);
assert.match(providerHtml,/client-results\.js\?v=763[\s\S]*provider\.js\?v=763/);
...
assert.match(serviceWorker,/client-results\.css\?v=763/);
assert.match(serviceWorker,/client-results\.js\?v=763/);
assert.match(serviceWorker,/provider\.js\?v=763/);
assert.match(serviceWorker,/CACHE_PREFIX}v763/);
