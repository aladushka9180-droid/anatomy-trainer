...
assert.match(providerHtml,/client-results\.css\?v=876/);
assert.match(providerHtml,/client-results\.js\?v=876[\s\S]*provider\.js\?v=\d+/);
...
const cacheVersion = serviceWorker.match(/CACHE_PREFIX}v(\d+)/)?.[1];
assert.ok(cacheVersion);
assert.ok(serviceWorker.includes(`provider.js?v=${cacheVersion}`));
