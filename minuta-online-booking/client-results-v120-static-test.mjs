...
assert.match(providerHtml,/client-results\.css\?v=607/);
assert.match(providerHtml,/client-results\.js\?v=607[\s\S]*provider\.js\?v=607/);
...
assert.match(serviceWorker,/client-results\.css\?v=607/);
assert.match(serviceWorker,/client-results\.js\?v=607/);
assert.match(serviceWorker,/provider\.js\?v=607/);
assert.match(serviceWorker,/CACHE_PREFIX}v607/);
