...
assert.match(providerHtml,/client-results\.css\?v=777/);
assert.match(providerHtml,/client-results\.js\?v=777[\s\S]*provider\.js\?v=777/);
...
assert.match(serviceWorker,/client-results\.css\?v=777/);
assert.match(serviceWorker,/client-results\.js\?v=777/);
assert.match(serviceWorker,/provider\.js\?v=777/);
assert.match(serviceWorker,/CACHE_PREFIX}v777/);
