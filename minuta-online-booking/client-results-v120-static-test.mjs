...
assert.match(providerHtml,/client-results\.css\?v=778/);
assert.match(providerHtml,/client-results\.js\?v=778[\s\S]*provider\.js\?v=778/);
...
assert.match(serviceWorker,/client-results\.css\?v=778/);
assert.match(serviceWorker,/client-results\.js\?v=778/);
assert.match(serviceWorker,/provider\.js\?v=778/);
assert.match(serviceWorker,/CACHE_PREFIX}v778/);
