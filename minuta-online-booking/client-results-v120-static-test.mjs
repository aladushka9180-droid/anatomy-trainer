...
assert.match(providerHtml,/client-results\.css\?v=605/);
assert.match(providerHtml,/client-results\.js\?v=605[\s\S]*provider\.js\?v=605/);
...
assert.match(serviceWorker,/client-results\.css\?v=605/);
assert.match(serviceWorker,/client-results\.js\?v=605/);
assert.match(serviceWorker,/provider\.js\?v=605/);
assert.match(serviceWorker,/CACHE_PREFIX}v605/);
