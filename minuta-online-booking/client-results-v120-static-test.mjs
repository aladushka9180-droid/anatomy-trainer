...
assert.match(providerHtml,/client-results\.css\?v=691/);
assert.match(providerHtml,/client-results\.js\?v=691[\s\S]*provider\.js\?v=691/);
...
assert.match(serviceWorker,/client-results\.css\?v=691/);
assert.match(serviceWorker,/client-results\.js\?v=691/);
assert.match(serviceWorker,/provider\.js\?v=691/);
assert.match(serviceWorker,/CACHE_PREFIX}v691/);
