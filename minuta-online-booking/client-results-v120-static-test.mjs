...
assert.match(providerHtml,/client-results\.css\?v=735/);
assert.match(providerHtml,/client-results\.js\?v=735[\s\S]*provider\.js\?v=735/);
...
assert.match(serviceWorker,/client-results\.css\?v=735/);
assert.match(serviceWorker,/client-results\.js\?v=735/);
assert.match(serviceWorker,/provider\.js\?v=735/);
assert.match(serviceWorker,/CACHE_PREFIX}v735/);
