...
assert.match(providerHtml,/client-results\.css\?v=680/);
assert.match(providerHtml,/client-results\.js\?v=680[\s\S]*provider\.js\?v=680/);
...
assert.match(serviceWorker,/client-results\.css\?v=680/);
assert.match(serviceWorker,/client-results\.js\?v=680/);
assert.match(serviceWorker,/provider\.js\?v=680/);
assert.match(serviceWorker,/CACHE_PREFIX}v680/);
