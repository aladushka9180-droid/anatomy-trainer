...
assert.match(providerHtml,/client-results\.css\?v=572/);
assert.match(providerHtml,/client-results\.js\?v=572[\s\S]*provider\.js\?v=572/);
...
assert.match(serviceWorker,/client-results\.css\?v=572/);
assert.match(serviceWorker,/client-results\.js\?v=572/);
assert.match(serviceWorker,/provider\.js\?v=572/);
assert.match(serviceWorker,/CACHE_PREFIX}v572/);
