...
assert.match(providerHtml,/client-results\.css\?v=581/);
assert.match(providerHtml,/client-results\.js\?v=581[\s\S]*provider\.js\?v=581/);
...
assert.match(serviceWorker,/client-results\.css\?v=581/);
assert.match(serviceWorker,/client-results\.js\?v=581/);
assert.match(serviceWorker,/provider\.js\?v=581/);
assert.match(serviceWorker,/CACHE_PREFIX}v581/);
