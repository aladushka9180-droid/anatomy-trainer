...
assert.match(providerHtml,/client-results\.css\?v=639/);
assert.match(providerHtml,/client-results\.js\?v=639[\s\S]*provider\.js\?v=639/);
...
assert.match(serviceWorker,/client-results\.css\?v=639/);
assert.match(serviceWorker,/client-results\.js\?v=639/);
assert.match(serviceWorker,/provider\.js\?v=639/);
assert.match(serviceWorker,/CACHE_PREFIX}v639/);
