...
assert.match(providerHtml,/client-results\.css\?v=618/);
assert.match(providerHtml,/client-results\.js\?v=618[\s\S]*provider\.js\?v=618/);
...
assert.match(serviceWorker,/client-results\.css\?v=618/);
assert.match(serviceWorker,/client-results\.js\?v=618/);
assert.match(serviceWorker,/provider\.js\?v=618/);
assert.match(serviceWorker,/CACHE_PREFIX}v618/);
