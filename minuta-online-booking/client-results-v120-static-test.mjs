...
assert.match(providerHtml,/client-results\.css\?v=730/);
assert.match(providerHtml,/client-results\.js\?v=730[\s\S]*provider\.js\?v=730/);
...
assert.match(serviceWorker,/client-results\.css\?v=730/);
assert.match(serviceWorker,/client-results\.js\?v=730/);
assert.match(serviceWorker,/provider\.js\?v=730/);
assert.match(serviceWorker,/CACHE_PREFIX}v730/);
