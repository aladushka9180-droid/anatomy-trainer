...
assert.match(providerHtml,/client-results\.css\?v=716/);
assert.match(providerHtml,/client-results\.js\?v=716[\s\S]*provider\.js\?v=716/);
...
assert.match(serviceWorker,/client-results\.css\?v=716/);
assert.match(serviceWorker,/client-results\.js\?v=716/);
assert.match(serviceWorker,/provider\.js\?v=716/);
assert.match(serviceWorker,/CACHE_PREFIX}v716/);
