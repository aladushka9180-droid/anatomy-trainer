...
assert.match(providerHtml,/client-results\.css\?v=557/);
assert.match(providerHtml,/client-results\.js\?v=557[\s\S]*provider\.js\?v=557/);
...
assert.match(serviceWorker,/client-results\.css\?v=557/);
assert.match(serviceWorker,/client-results\.js\?v=557/);
assert.match(serviceWorker,/provider\.js\?v=557/);
assert.match(serviceWorker,/CACHE_PREFIX}v557/);
