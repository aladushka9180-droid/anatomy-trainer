...
assert.match(providerHtml,/client-results\.css\?v=598/);
assert.match(providerHtml,/client-results\.js\?v=598[\s\S]*provider\.js\?v=598/);
...
assert.match(serviceWorker,/client-results\.css\?v=598/);
assert.match(serviceWorker,/client-results\.js\?v=598/);
assert.match(serviceWorker,/provider\.js\?v=598/);
assert.match(serviceWorker,/CACHE_PREFIX}v598/);
