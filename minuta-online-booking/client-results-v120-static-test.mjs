...
assert.match(providerHtml,/client-results\.css\?v=706/);
assert.match(providerHtml,/client-results\.js\?v=706[\s\S]*provider\.js\?v=706/);
...
assert.match(serviceWorker,/client-results\.css\?v=706/);
assert.match(serviceWorker,/client-results\.js\?v=706/);
assert.match(serviceWorker,/provider\.js\?v=706/);
assert.match(serviceWorker,/CACHE_PREFIX}v706/);
