...
assert.match(providerHtml,/client-results\.css\?v=647/);
assert.match(providerHtml,/client-results\.js\?v=647[\s\S]*provider\.js\?v=647/);
...
assert.match(serviceWorker,/client-results\.css\?v=647/);
assert.match(serviceWorker,/client-results\.js\?v=647/);
assert.match(serviceWorker,/provider\.js\?v=647/);
assert.match(serviceWorker,/CACHE_PREFIX}v647/);
