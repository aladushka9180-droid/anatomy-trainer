...
assert.match(providerHtml,/client-results\.css\?v=565/);
assert.match(providerHtml,/client-results\.js\?v=565[\s\S]*provider\.js\?v=565/);
...
assert.match(serviceWorker,/client-results\.css\?v=565/);
assert.match(serviceWorker,/client-results\.js\?v=565/);
assert.match(serviceWorker,/provider\.js\?v=565/);
assert.match(serviceWorker,/CACHE_PREFIX}v565/);
