...
assert.match(providerHtml,/client-results\.css\?v=642/);
assert.match(providerHtml,/client-results\.js\?v=642[\s\S]*provider\.js\?v=642/);
...
assert.match(serviceWorker,/client-results\.css\?v=642/);
assert.match(serviceWorker,/client-results\.js\?v=642/);
assert.match(serviceWorker,/provider\.js\?v=642/);
assert.match(serviceWorker,/CACHE_PREFIX}v642/);
