...
assert.match(providerHtml,/client-results\.css\?v=696/);
assert.match(providerHtml,/client-results\.js\?v=696[\s\S]*provider\.js\?v=696/);
...
assert.match(serviceWorker,/client-results\.css\?v=696/);
assert.match(serviceWorker,/client-results\.js\?v=696/);
assert.match(serviceWorker,/provider\.js\?v=696/);
assert.match(serviceWorker,/CACHE_PREFIX}v696/);
