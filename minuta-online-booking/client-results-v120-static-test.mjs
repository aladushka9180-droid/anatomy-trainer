...
assert.match(providerHtml,/client-results\.css\?v=795/);
assert.match(providerHtml,/client-results\.js\?v=795[\s\S]*provider\.js\?v=795/);
...
assert.match(serviceWorker,/client-results\.css\?v=795/);
assert.match(serviceWorker,/client-results\.js\?v=795/);
assert.match(serviceWorker,/provider\.js\?v=795/);
assert.match(serviceWorker,/CACHE_PREFIX}v795/);
