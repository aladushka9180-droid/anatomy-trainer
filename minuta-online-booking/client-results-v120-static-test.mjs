...
assert.match(providerHtml,/client-results\.css\?v=555/);
assert.match(providerHtml,/client-results\.js\?v=555[\s\S]*provider\.js\?v=555/);
...
assert.match(serviceWorker,/client-results\.css\?v=555/);
assert.match(serviceWorker,/client-results\.js\?v=555/);
assert.match(serviceWorker,/provider\.js\?v=555/);
assert.match(serviceWorker,/CACHE_PREFIX}v555/);
