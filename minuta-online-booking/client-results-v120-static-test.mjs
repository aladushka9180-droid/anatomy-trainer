...
assert.match(providerHtml,/client-results\.css\?v=633/);
assert.match(providerHtml,/client-results\.js\?v=633[\s\S]*provider\.js\?v=633/);
...
assert.match(serviceWorker,/client-results\.css\?v=633/);
assert.match(serviceWorker,/client-results\.js\?v=633/);
assert.match(serviceWorker,/provider\.js\?v=633/);
assert.match(serviceWorker,/CACHE_PREFIX}v633/);
