...
assert.match(providerHtml,/client-results\.css\?v=769/);
assert.match(providerHtml,/client-results\.js\?v=769[\s\S]*provider\.js\?v=769/);
...
assert.match(serviceWorker,/client-results\.css\?v=769/);
assert.match(serviceWorker,/client-results\.js\?v=769/);
assert.match(serviceWorker,/provider\.js\?v=769/);
assert.match(serviceWorker,/CACHE_PREFIX}v769/);
