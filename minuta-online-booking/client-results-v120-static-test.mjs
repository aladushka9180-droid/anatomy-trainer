...
assert.match(providerHtml,/client-results\.css\?v=630/);
assert.match(providerHtml,/client-results\.js\?v=630[\s\S]*provider\.js\?v=630/);
...
assert.match(serviceWorker,/client-results\.css\?v=630/);
assert.match(serviceWorker,/client-results\.js\?v=630/);
assert.match(serviceWorker,/provider\.js\?v=630/);
assert.match(serviceWorker,/CACHE_PREFIX}v630/);
