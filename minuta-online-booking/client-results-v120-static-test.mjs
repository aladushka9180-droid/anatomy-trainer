...
assert.match(providerHtml,/client-results\.css\?v=661/);
assert.match(providerHtml,/client-results\.js\?v=661[\s\S]*provider\.js\?v=661/);
...
assert.match(serviceWorker,/client-results\.css\?v=661/);
assert.match(serviceWorker,/client-results\.js\?v=661/);
assert.match(serviceWorker,/provider\.js\?v=661/);
assert.match(serviceWorker,/CACHE_PREFIX}v661/);
