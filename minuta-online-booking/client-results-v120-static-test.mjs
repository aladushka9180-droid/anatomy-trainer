...
assert.match(providerHtml,/client-results\.css\?v=746/);
assert.match(providerHtml,/client-results\.js\?v=746[\s\S]*provider\.js\?v=746/);
...
assert.match(serviceWorker,/client-results\.css\?v=746/);
assert.match(serviceWorker,/client-results\.js\?v=746/);
assert.match(serviceWorker,/provider\.js\?v=746/);
assert.match(serviceWorker,/CACHE_PREFIX}v746/);
