...
assert.match(providerHtml,/client-results\.css\?v=767/);
assert.match(providerHtml,/client-results\.js\?v=767[\s\S]*provider\.js\?v=767/);
...
assert.match(serviceWorker,/client-results\.css\?v=767/);
assert.match(serviceWorker,/client-results\.js\?v=767/);
assert.match(serviceWorker,/provider\.js\?v=767/);
assert.match(serviceWorker,/CACHE_PREFIX}v767/);
