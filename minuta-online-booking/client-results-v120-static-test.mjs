...
assert.match(providerHtml,/client-results\.css\?v=623/);
assert.match(providerHtml,/client-results\.js\?v=623[\s\S]*provider\.js\?v=623/);
...
assert.match(serviceWorker,/client-results\.css\?v=623/);
assert.match(serviceWorker,/client-results\.js\?v=623/);
assert.match(serviceWorker,/provider\.js\?v=623/);
assert.match(serviceWorker,/CACHE_PREFIX}v623/);
