...
assert.match(providerHtml,/client-results\.css\?v=562/);
assert.match(providerHtml,/client-results\.js\?v=562[\s\S]*provider\.js\?v=562/);
...
assert.match(serviceWorker,/client-results\.css\?v=562/);
assert.match(serviceWorker,/client-results\.js\?v=562/);
assert.match(serviceWorker,/provider\.js\?v=562/);
assert.match(serviceWorker,/CACHE_PREFIX}v562/);
