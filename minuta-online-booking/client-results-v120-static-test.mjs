...
assert.match(providerHtml,/client-results\.css\?v=687/);
assert.match(providerHtml,/client-results\.js\?v=687[\s\S]*provider\.js\?v=687/);
...
assert.match(serviceWorker,/client-results\.css\?v=687/);
assert.match(serviceWorker,/client-results\.js\?v=687/);
assert.match(serviceWorker,/provider\.js\?v=687/);
assert.match(serviceWorker,/CACHE_PREFIX}v687/);
