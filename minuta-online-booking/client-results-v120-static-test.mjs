...
assert.match(providerHtml,/client-results\.css\?v=718/);
assert.match(providerHtml,/client-results\.js\?v=718[\s\S]*provider\.js\?v=718/);
...
assert.match(serviceWorker,/client-results\.css\?v=718/);
assert.match(serviceWorker,/client-results\.js\?v=718/);
assert.match(serviceWorker,/provider\.js\?v=718/);
assert.match(serviceWorker,/CACHE_PREFIX}v718/);
