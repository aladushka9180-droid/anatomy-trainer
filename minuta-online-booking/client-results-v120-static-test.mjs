...
assert.match(providerHtml,/client-results\.css\?v=665/);
assert.match(providerHtml,/client-results\.js\?v=665[\s\S]*provider\.js\?v=665/);
...
assert.match(serviceWorker,/client-results\.css\?v=665/);
assert.match(serviceWorker,/client-results\.js\?v=665/);
assert.match(serviceWorker,/provider\.js\?v=665/);
assert.match(serviceWorker,/CACHE_PREFIX}v665/);
