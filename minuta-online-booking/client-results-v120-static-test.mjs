...
assert.match(providerHtml,/client-results\.css\?v=727/);
assert.match(providerHtml,/client-results\.js\?v=727[\s\S]*provider\.js\?v=727/);
...
assert.match(serviceWorker,/client-results\.css\?v=727/);
assert.match(serviceWorker,/client-results\.js\?v=727/);
assert.match(serviceWorker,/provider\.js\?v=727/);
assert.match(serviceWorker,/CACHE_PREFIX}v727/);
