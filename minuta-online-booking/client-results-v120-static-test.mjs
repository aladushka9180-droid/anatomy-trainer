...
assert.match(providerHtml,/client-results\.css\?v=803/);
assert.match(providerHtml,/client-results\.js\?v=803[\s\S]*provider\.js\?v=803/);
...
assert.match(serviceWorker,/client-results\.css\?v=803/);
assert.match(serviceWorker,/client-results\.js\?v=803/);
assert.match(serviceWorker,/provider\.js\?v=803/);
assert.match(serviceWorker,/CACHE_PREFIX}v803/);
