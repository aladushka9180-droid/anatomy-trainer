...
assert.match(providerHtml,/client-results\.css\?v=731/);
assert.match(providerHtml,/client-results\.js\?v=731[\s\S]*provider\.js\?v=731/);
...
assert.match(serviceWorker,/client-results\.css\?v=731/);
assert.match(serviceWorker,/client-results\.js\?v=731/);
assert.match(serviceWorker,/provider\.js\?v=731/);
assert.match(serviceWorker,/CACHE_PREFIX}v731/);
