...
assert.match(providerHtml,/client-results\.css\?v=676/);
assert.match(providerHtml,/client-results\.js\?v=676[\s\S]*provider\.js\?v=676/);
...
assert.match(serviceWorker,/client-results\.css\?v=676/);
assert.match(serviceWorker,/client-results\.js\?v=676/);
assert.match(serviceWorker,/provider\.js\?v=676/);
assert.match(serviceWorker,/CACHE_PREFIX}v676/);
