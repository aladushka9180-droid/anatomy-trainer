...
assert.match(providerHtml,/client-results\.css\?v=751/);
assert.match(providerHtml,/client-results\.js\?v=751[\s\S]*provider\.js\?v=751/);
...
assert.match(serviceWorker,/client-results\.css\?v=751/);
assert.match(serviceWorker,/client-results\.js\?v=751/);
assert.match(serviceWorker,/provider\.js\?v=751/);
assert.match(serviceWorker,/CACHE_PREFIX}v751/);
