...
assert.match(providerHtml,/client-results\.css\?v=532/);
assert.match(providerHtml,/client-results\.js\?v=532[\s\S]*provider\.js\?v=532/);
...
assert.match(serviceWorker,/client-results\.css\?v=532/);
assert.match(serviceWorker,/client-results\.js\?v=532/);
assert.match(serviceWorker,/CACHE_PREFIX}v532/);
