...
assert.match(providerHtml,/client-results\.css\?v=588/);
assert.match(providerHtml,/client-results\.js\?v=588[\s\S]*provider\.js\?v=588/);
...
assert.match(serviceWorker,/client-results\.css\?v=588/);
assert.match(serviceWorker,/client-results\.js\?v=588/);
assert.match(serviceWorker,/provider\.js\?v=588/);
assert.match(serviceWorker,/CACHE_PREFIX}v588/);
