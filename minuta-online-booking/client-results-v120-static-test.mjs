...
assert.match(providerHtml,/client-results\.css\?v=685/);
assert.match(providerHtml,/client-results\.js\?v=685[\s\S]*provider\.js\?v=685/);
...
assert.match(serviceWorker,/client-results\.css\?v=685/);
assert.match(serviceWorker,/client-results\.js\?v=685/);
assert.match(serviceWorker,/provider\.js\?v=685/);
assert.match(serviceWorker,/CACHE_PREFIX}v685/);
