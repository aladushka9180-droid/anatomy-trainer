...
assert.match(providerHtml,/client-results\.css\?v=682/);
assert.match(providerHtml,/client-results\.js\?v=682[\s\S]*provider\.js\?v=682/);
...
assert.match(serviceWorker,/client-results\.css\?v=682/);
assert.match(serviceWorker,/client-results\.js\?v=682/);
assert.match(serviceWorker,/provider\.js\?v=682/);
assert.match(serviceWorker,/CACHE_PREFIX}v682/);
