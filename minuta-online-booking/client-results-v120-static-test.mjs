...
assert.match(providerHtml,/client-results\.css\?v=547/);
assert.match(providerHtml,/client-results\.js\?v=547[\s\S]*provider\.js\?v=547/);
...
assert.match(serviceWorker,/client-results\.css\?v=547/);
assert.match(serviceWorker,/client-results\.js\?v=547/);
assert.match(serviceWorker,/provider\.js\?v=547/);
assert.match(serviceWorker,/CACHE_PREFIX}v547/);
