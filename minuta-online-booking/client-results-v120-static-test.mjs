...
assert.match(providerHtml,/client-results\.css\?v=762/);
assert.match(providerHtml,/client-results\.js\?v=762[\s\S]*provider\.js\?v=762/);
...
assert.match(serviceWorker,/client-results\.css\?v=762/);
assert.match(serviceWorker,/client-results\.js\?v=762/);
assert.match(serviceWorker,/provider\.js\?v=762/);
assert.match(serviceWorker,/CACHE_PREFIX}v762/);
