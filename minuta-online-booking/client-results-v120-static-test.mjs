...
assert.match(providerHtml,/client-results\.css\?v=658/);
assert.match(providerHtml,/client-results\.js\?v=658[\s\S]*provider\.js\?v=658/);
...
assert.match(serviceWorker,/client-results\.css\?v=658/);
assert.match(serviceWorker,/client-results\.js\?v=658/);
assert.match(serviceWorker,/provider\.js\?v=658/);
assert.match(serviceWorker,/CACHE_PREFIX}v658/);
