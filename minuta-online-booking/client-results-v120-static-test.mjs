...
assert.match(providerHtml,/client-results\.css\?v=541/);
assert.match(providerHtml,/client-results\.js\?v=541[\s\S]*provider\.js\?v=541/);
...
assert.match(serviceWorker,/client-results\.css\?v=541/);
assert.match(serviceWorker,/client-results\.js\?v=541/);
assert.match(serviceWorker,/provider\.js\?v=541/);
assert.match(serviceWorker,/CACHE_PREFIX}v541/);
