...
assert.match(providerHtml,/client-results\.css\?v=602/);
assert.match(providerHtml,/client-results\.js\?v=602[\s\S]*provider\.js\?v=602/);
...
assert.match(serviceWorker,/client-results\.css\?v=602/);
assert.match(serviceWorker,/client-results\.js\?v=602/);
assert.match(serviceWorker,/provider\.js\?v=602/);
assert.match(serviceWorker,/CACHE_PREFIX}v602/);
