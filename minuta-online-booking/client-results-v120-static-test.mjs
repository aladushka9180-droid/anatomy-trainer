...
assert.match(providerHtml,/client-results\.css\?v=616/);
assert.match(providerHtml,/client-results\.js\?v=616[\s\S]*provider\.js\?v=616/);
...
assert.match(serviceWorker,/client-results\.css\?v=616/);
assert.match(serviceWorker,/client-results\.js\?v=616/);
assert.match(serviceWorker,/provider\.js\?v=616/);
assert.match(serviceWorker,/CACHE_PREFIX}v616/);
