...
assert.match(providerHtml,/client-results\.css\?v=690/);
assert.match(providerHtml,/client-results\.js\?v=690[\s\S]*provider\.js\?v=690/);
...
assert.match(serviceWorker,/client-results\.css\?v=690/);
assert.match(serviceWorker,/client-results\.js\?v=690/);
assert.match(serviceWorker,/provider\.js\?v=690/);
assert.match(serviceWorker,/CACHE_PREFIX}v690/);
