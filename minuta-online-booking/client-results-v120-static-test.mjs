...
assert.match(providerHtml,/client-results\.css\?v=549/);
assert.match(providerHtml,/client-results\.js\?v=549[\s\S]*provider\.js\?v=549/);
...
assert.match(serviceWorker,/client-results\.css\?v=549/);
assert.match(serviceWorker,/client-results\.js\?v=549/);
assert.match(serviceWorker,/provider\.js\?v=549/);
assert.match(serviceWorker,/CACHE_PREFIX}v549/);
