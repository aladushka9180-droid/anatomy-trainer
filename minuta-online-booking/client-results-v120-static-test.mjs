...
assert.match(providerHtml,/client-results\.css\?v=568/);
assert.match(providerHtml,/client-results\.js\?v=568[\s\S]*provider\.js\?v=568/);
...
assert.match(serviceWorker,/client-results\.css\?v=568/);
assert.match(serviceWorker,/client-results\.js\?v=568/);
assert.match(serviceWorker,/provider\.js\?v=568/);
assert.match(serviceWorker,/CACHE_PREFIX}v568/);
