...
assert.match(providerHtml,/client-results\.css\?v=779/);
assert.match(providerHtml,/client-results\.js\?v=779[\s\S]*provider\.js\?v=779/);
...
assert.match(serviceWorker,/client-results\.css\?v=779/);
assert.match(serviceWorker,/client-results\.js\?v=779/);
assert.match(serviceWorker,/provider\.js\?v=779/);
assert.match(serviceWorker,/CACHE_PREFIX}v779/);
