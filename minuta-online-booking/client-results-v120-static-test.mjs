...
assert.match(providerHtml,/client-results\.css\?v=539/);
assert.match(providerHtml,/client-results\.js\?v=539[\s\S]*provider\.js\?v=539/);
...
assert.match(serviceWorker,/client-results\.css\?v=539/);
assert.match(serviceWorker,/client-results\.js\?v=539/);
assert.match(serviceWorker,/provider\.js\?v=539/);
assert.match(serviceWorker,/CACHE_PREFIX}v539/);
