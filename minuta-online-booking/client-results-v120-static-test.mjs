...
assert.match(providerHtml,/client-results\.css\?v=722/);
assert.match(providerHtml,/client-results\.js\?v=722[\s\S]*provider\.js\?v=722/);
...
assert.match(serviceWorker,/client-results\.css\?v=722/);
assert.match(serviceWorker,/client-results\.js\?v=722/);
assert.match(serviceWorker,/provider\.js\?v=722/);
assert.match(serviceWorker,/CACHE_PREFIX}v722/);
