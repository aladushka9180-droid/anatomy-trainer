...
assert.match(providerHtml,/client-results\.css\?v=773/);
assert.match(providerHtml,/client-results\.js\?v=773[\s\S]*provider\.js\?v=773/);
...
assert.match(serviceWorker,/client-results\.css\?v=773/);
assert.match(serviceWorker,/client-results\.js\?v=773/);
assert.match(serviceWorker,/provider\.js\?v=773/);
assert.match(serviceWorker,/CACHE_PREFIX}v773/);
