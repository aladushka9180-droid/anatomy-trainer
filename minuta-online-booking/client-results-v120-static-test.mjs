...
assert.match(providerHtml,/client-results\.css\?v=606/);
assert.match(providerHtml,/client-results\.js\?v=606[\s\S]*provider\.js\?v=606/);
...
assert.match(serviceWorker,/client-results\.css\?v=606/);
assert.match(serviceWorker,/client-results\.js\?v=606/);
assert.match(serviceWorker,/provider\.js\?v=606/);
assert.match(serviceWorker,/CACHE_PREFIX}v606/);
