...
assert.match(providerHtml,/client-results\.css\?v=571/);
assert.match(providerHtml,/client-results\.js\?v=571[\s\S]*provider\.js\?v=571/);
...
assert.match(serviceWorker,/client-results\.css\?v=571/);
assert.match(serviceWorker,/client-results\.js\?v=571/);
assert.match(serviceWorker,/provider\.js\?v=571/);
assert.match(serviceWorker,/CACHE_PREFIX}v571/);
