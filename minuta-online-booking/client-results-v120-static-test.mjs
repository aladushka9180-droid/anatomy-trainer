...
assert.match(providerHtml,/client-results\.css\?v=580/);
assert.match(providerHtml,/client-results\.js\?v=580[\s\S]*provider\.js\?v=580/);
...
assert.match(serviceWorker,/client-results\.css\?v=580/);
assert.match(serviceWorker,/client-results\.js\?v=580/);
assert.match(serviceWorker,/provider\.js\?v=580/);
assert.match(serviceWorker,/CACHE_PREFIX}v580/);
