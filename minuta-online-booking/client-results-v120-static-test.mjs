...
assert.match(providerHtml,/client-results\.css\?v=640/);
assert.match(providerHtml,/client-results\.js\?v=640[\s\S]*provider\.js\?v=640/);
...
assert.match(serviceWorker,/client-results\.css\?v=640/);
assert.match(serviceWorker,/client-results\.js\?v=640/);
assert.match(serviceWorker,/provider\.js\?v=640/);
assert.match(serviceWorker,/CACHE_PREFIX}v640/);
