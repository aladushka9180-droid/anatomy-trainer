...
assert.match(providerHtml,/client-results\.css\?v=653/);
assert.match(providerHtml,/client-results\.js\?v=653[\s\S]*provider\.js\?v=653/);
...
assert.match(serviceWorker,/client-results\.css\?v=653/);
assert.match(serviceWorker,/client-results\.js\?v=653/);
assert.match(serviceWorker,/provider\.js\?v=653/);
assert.match(serviceWorker,/CACHE_PREFIX}v653/);
