...
assert.match(providerHtml,/client-results\.css\?v=783/);
assert.match(providerHtml,/client-results\.js\?v=783[\s\S]*provider\.js\?v=783/);
...
assert.match(serviceWorker,/client-results\.css\?v=783/);
assert.match(serviceWorker,/client-results\.js\?v=783/);
assert.match(serviceWorker,/provider\.js\?v=783/);
assert.match(serviceWorker,/CACHE_PREFIX}v783/);
