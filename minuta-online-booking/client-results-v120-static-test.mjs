...
assert.match(providerHtml,/client-results\.css\?v=648/);
assert.match(providerHtml,/client-results\.js\?v=648[\s\S]*provider\.js\?v=648/);
...
assert.match(serviceWorker,/client-results\.css\?v=648/);
assert.match(serviceWorker,/client-results\.js\?v=648/);
assert.match(serviceWorker,/provider\.js\?v=648/);
assert.match(serviceWorker,/CACHE_PREFIX}v648/);
