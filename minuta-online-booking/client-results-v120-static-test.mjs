...
assert.match(providerHtml,/client-results\.css\?v=744/);
assert.match(providerHtml,/client-results\.js\?v=744[\s\S]*provider\.js\?v=744/);
...
assert.match(serviceWorker,/client-results\.css\?v=744/);
assert.match(serviceWorker,/client-results\.js\?v=744/);
assert.match(serviceWorker,/provider\.js\?v=744/);
assert.match(serviceWorker,/CACHE_PREFIX}v744/);
