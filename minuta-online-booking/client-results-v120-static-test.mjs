...
assert.match(providerHtml,/client-results\.css\?v=600/);
assert.match(providerHtml,/client-results\.js\?v=600[\s\S]*provider\.js\?v=600/);
...
assert.match(serviceWorker,/client-results\.css\?v=600/);
assert.match(serviceWorker,/client-results\.js\?v=600/);
assert.match(serviceWorker,/provider\.js\?v=600/);
assert.match(serviceWorker,/CACHE_PREFIX}v600/);
