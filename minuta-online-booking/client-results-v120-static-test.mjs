...
assert.match(providerHtml,/client-results\.css\?v=792/);
assert.match(providerHtml,/client-results\.js\?v=792[\s\S]*provider\.js\?v=792/);
...
assert.match(serviceWorker,/client-results\.css\?v=792/);
assert.match(serviceWorker,/client-results\.js\?v=792/);
assert.match(serviceWorker,/provider\.js\?v=792/);
assert.match(serviceWorker,/CACHE_PREFIX}v792/);
