...
assert.match(providerHtml,/client-results\.css\?v=624/);
assert.match(providerHtml,/client-results\.js\?v=624[\s\S]*provider\.js\?v=624/);
...
assert.match(serviceWorker,/client-results\.css\?v=624/);
assert.match(serviceWorker,/client-results\.js\?v=624/);
assert.match(serviceWorker,/provider\.js\?v=624/);
assert.match(serviceWorker,/CACHE_PREFIX}v624/);
