...
assert.match(providerHtml,/client-results\.css\?v=584/);
assert.match(providerHtml,/client-results\.js\?v=584[\s\S]*provider\.js\?v=584/);
...
assert.match(serviceWorker,/client-results\.css\?v=584/);
assert.match(serviceWorker,/client-results\.js\?v=584/);
assert.match(serviceWorker,/provider\.js\?v=584/);
assert.match(serviceWorker,/CACHE_PREFIX}v584/);
