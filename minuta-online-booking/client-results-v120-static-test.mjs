...
assert.match(providerHtml,/client-results\.css\?v=566/);
assert.match(providerHtml,/client-results\.js\?v=566[\s\S]*provider\.js\?v=566/);
...
assert.match(serviceWorker,/client-results\.css\?v=566/);
assert.match(serviceWorker,/client-results\.js\?v=566/);
assert.match(serviceWorker,/provider\.js\?v=566/);
assert.match(serviceWorker,/CACHE_PREFIX}v566/);
