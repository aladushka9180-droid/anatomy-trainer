...
assert.match(providerHtml,/client-results\.css\?v=750/);
assert.match(providerHtml,/client-results\.js\?v=750[\s\S]*provider\.js\?v=750/);
...
assert.match(serviceWorker,/client-results\.css\?v=750/);
assert.match(serviceWorker,/client-results\.js\?v=750/);
assert.match(serviceWorker,/provider\.js\?v=750/);
assert.match(serviceWorker,/CACHE_PREFIX}v750/);
