...
assert.match(providerHtml,/client-results\.css\?v=626/);
assert.match(providerHtml,/client-results\.js\?v=626[\s\S]*provider\.js\?v=626/);
...
assert.match(serviceWorker,/client-results\.css\?v=626/);
assert.match(serviceWorker,/client-results\.js\?v=626/);
assert.match(serviceWorker,/provider\.js\?v=626/);
assert.match(serviceWorker,/CACHE_PREFIX}v626/);
