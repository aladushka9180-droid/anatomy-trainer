...
assert.match(providerHtml,/client-results\.css\?v=738/);
assert.match(providerHtml,/client-results\.js\?v=738[\s\S]*provider\.js\?v=738/);
...
assert.match(serviceWorker,/client-results\.css\?v=738/);
assert.match(serviceWorker,/client-results\.js\?v=738/);
assert.match(serviceWorker,/provider\.js\?v=738/);
assert.match(serviceWorker,/CACHE_PREFIX}v738/);
