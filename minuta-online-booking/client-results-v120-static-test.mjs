...
assert.match(providerHtml,/client-results\.css\?v=712/);
assert.match(providerHtml,/client-results\.js\?v=712[\s\S]*provider\.js\?v=712/);
...
assert.match(serviceWorker,/client-results\.css\?v=712/);
assert.match(serviceWorker,/client-results\.js\?v=712/);
assert.match(serviceWorker,/provider\.js\?v=712/);
assert.match(serviceWorker,/CACHE_PREFIX}v712/);
