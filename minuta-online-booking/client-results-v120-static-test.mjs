...
assert.match(providerHtml,/client-results\.css\?v=673/);
assert.match(providerHtml,/client-results\.js\?v=673[\s\S]*provider\.js\?v=673/);
...
assert.match(serviceWorker,/client-results\.css\?v=673/);
assert.match(serviceWorker,/client-results\.js\?v=673/);
assert.match(serviceWorker,/provider\.js\?v=673/);
assert.match(serviceWorker,/CACHE_PREFIX}v673/);
