...
assert.match(providerHtml,/client-results\.css\?v=714/);
assert.match(providerHtml,/client-results\.js\?v=714[\s\S]*provider\.js\?v=714/);
...
assert.match(serviceWorker,/client-results\.css\?v=714/);
assert.match(serviceWorker,/client-results\.js\?v=714/);
assert.match(serviceWorker,/provider\.js\?v=714/);
assert.match(serviceWorker,/CACHE_PREFIX}v714/);
