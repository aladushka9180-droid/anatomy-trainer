...
assert.match(providerHtml,/client-results\.css\?v=724/);
assert.match(providerHtml,/client-results\.js\?v=724[\s\S]*provider\.js\?v=724/);
...
assert.match(serviceWorker,/client-results\.css\?v=724/);
assert.match(serviceWorker,/client-results\.js\?v=724/);
assert.match(serviceWorker,/provider\.js\?v=724/);
assert.match(serviceWorker,/CACHE_PREFIX}v724/);
