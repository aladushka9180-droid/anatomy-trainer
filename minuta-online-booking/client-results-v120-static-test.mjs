...
assert.match(providerHtml,/client-results\.css\?v=761/);
assert.match(providerHtml,/client-results\.js\?v=761[\s\S]*provider\.js\?v=761/);
...
assert.match(serviceWorker,/client-results\.css\?v=761/);
assert.match(serviceWorker,/client-results\.js\?v=761/);
assert.match(serviceWorker,/provider\.js\?v=761/);
assert.match(serviceWorker,/CACHE_PREFIX}v761/);
