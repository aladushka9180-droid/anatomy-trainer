...
assert.match(providerHtml,/client-results\.css\?v=594/);
assert.match(providerHtml,/client-results\.js\?v=594[\s\S]*provider\.js\?v=594/);
...
assert.match(serviceWorker,/client-results\.css\?v=594/);
assert.match(serviceWorker,/client-results\.js\?v=594/);
assert.match(serviceWorker,/provider\.js\?v=594/);
assert.match(serviceWorker,/CACHE_PREFIX}v594/);
