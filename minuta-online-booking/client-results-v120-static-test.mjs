...
assert.match(providerHtml,/client-results\.css\?v=629/);
assert.match(providerHtml,/client-results\.js\?v=629[\s\S]*provider\.js\?v=629/);
...
assert.match(serviceWorker,/client-results\.css\?v=629/);
assert.match(serviceWorker,/client-results\.js\?v=629/);
assert.match(serviceWorker,/provider\.js\?v=629/);
assert.match(serviceWorker,/CACHE_PREFIX}v629/);
