...
assert.match(providerHtml,/client-results\.css\?v=774/);
assert.match(providerHtml,/client-results\.js\?v=774[\s\S]*provider\.js\?v=774/);
...
assert.match(serviceWorker,/client-results\.css\?v=774/);
assert.match(serviceWorker,/client-results\.js\?v=774/);
assert.match(serviceWorker,/provider\.js\?v=774/);
assert.match(serviceWorker,/CACHE_PREFIX}v774/);
