...
assert.match(providerHtml,/client-results\.css\?v=800/);
assert.match(providerHtml,/client-results\.js\?v=800[\s\S]*provider\.js\?v=800/);
...
assert.match(serviceWorker,/client-results\.css\?v=800/);
assert.match(serviceWorker,/client-results\.js\?v=800/);
assert.match(serviceWorker,/provider\.js\?v=800/);
assert.match(serviceWorker,/CACHE_PREFIX}v800/);
