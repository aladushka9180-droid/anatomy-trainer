...
assert.match(providerHtml,/client-results\.css\?v=586/);
assert.match(providerHtml,/client-results\.js\?v=586[\s\S]*provider\.js\?v=586/);
...
assert.match(serviceWorker,/client-results\.css\?v=586/);
assert.match(serviceWorker,/client-results\.js\?v=586/);
assert.match(serviceWorker,/provider\.js\?v=586/);
assert.match(serviceWorker,/CACHE_PREFIX}v586/);
