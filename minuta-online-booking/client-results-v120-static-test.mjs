...
assert.match(providerHtml,/client-results\.css\?v=802/);
assert.match(providerHtml,/client-results\.js\?v=802[\s\S]*provider\.js\?v=802/);
...
assert.match(serviceWorker,/client-results\.css\?v=802/);
assert.match(serviceWorker,/client-results\.js\?v=802/);
assert.match(serviceWorker,/provider\.js\?v=802/);
assert.match(serviceWorker,/CACHE_PREFIX}v802/);
