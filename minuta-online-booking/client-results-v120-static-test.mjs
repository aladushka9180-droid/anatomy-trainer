...
assert.match(providerHtml,/client-results\.css\?v=715/);
assert.match(providerHtml,/client-results\.js\?v=715[\s\S]*provider\.js\?v=715/);
...
assert.match(serviceWorker,/client-results\.css\?v=715/);
assert.match(serviceWorker,/client-results\.js\?v=715/);
assert.match(serviceWorker,/provider\.js\?v=715/);
assert.match(serviceWorker,/CACHE_PREFIX}v715/);
