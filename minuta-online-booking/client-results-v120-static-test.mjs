...
assert.match(providerHtml,/client-results\.css\?v=789/);
assert.match(providerHtml,/client-results\.js\?v=789[\s\S]*provider\.js\?v=789/);
...
assert.match(serviceWorker,/client-results\.css\?v=789/);
assert.match(serviceWorker,/client-results\.js\?v=789/);
assert.match(serviceWorker,/provider\.js\?v=789/);
assert.match(serviceWorker,/CACHE_PREFIX}v789/);
