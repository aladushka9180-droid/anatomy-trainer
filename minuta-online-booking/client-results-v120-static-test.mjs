...
assert.match(providerHtml,/client-results\.css\?v=625/);
assert.match(providerHtml,/client-results\.js\?v=625[\s\S]*provider\.js\?v=625/);
...
assert.match(serviceWorker,/client-results\.css\?v=625/);
assert.match(serviceWorker,/client-results\.js\?v=625/);
assert.match(serviceWorker,/provider\.js\?v=625/);
assert.match(serviceWorker,/CACHE_PREFIX}v625/);
