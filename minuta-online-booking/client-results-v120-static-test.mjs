...
assert.match(providerHtml,/client-results\.css\?v=659/);
assert.match(providerHtml,/client-results\.js\?v=659[\s\S]*provider\.js\?v=659/);
...
assert.match(serviceWorker,/client-results\.css\?v=659/);
assert.match(serviceWorker,/client-results\.js\?v=659/);
assert.match(serviceWorker,/provider\.js\?v=659/);
