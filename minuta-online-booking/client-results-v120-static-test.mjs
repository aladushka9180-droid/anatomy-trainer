...
assert.match(providerHtml,/client-results\.css\?v=708/);
assert.match(providerHtml,/client-results\.js\?v=708[\s\S]*provider\.js\?v=708/);
...
assert.match(serviceWorker,/client-results\.css\?v=708/);
assert.match(serviceWorker,/client-results\.js\?v=708/);
assert.match(serviceWorker,/provider\.js\?v=708/);
assert.match(serviceWorker,/CACHE_PREFIX}v708/);
