...
assert.match(providerHtml,/client-results\.css\?v=601/);
assert.match(providerHtml,/client-results\.js\?v=601[\s\S]*provider\.js\?v=601/);
...
assert.match(serviceWorker,/client-results\.css\?v=601/);
assert.match(serviceWorker,/client-results\.js\?v=601/);
assert.match(serviceWorker,/provider\.js\?v=601/);
assert.match(serviceWorker,/CACHE_PREFIX}v601/);
