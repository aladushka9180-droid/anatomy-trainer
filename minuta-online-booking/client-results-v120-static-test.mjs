...
assert.match(providerHtml,/client-results\.css\?v=604/);
assert.match(providerHtml,/client-results\.js\?v=604[\s\S]*provider\.js\?v=604/);
...
assert.match(serviceWorker,/client-results\.css\?v=604/);
assert.match(serviceWorker,/client-results\.js\?v=604/);
assert.match(serviceWorker,/provider\.js\?v=604/);
assert.match(serviceWorker,/CACHE_PREFIX}v604/);
