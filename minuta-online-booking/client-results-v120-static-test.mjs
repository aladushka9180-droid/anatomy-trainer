...
assert.match(providerHtml,/client-results\.css\?v=597/);
assert.match(providerHtml,/client-results\.js\?v=597[\s\S]*provider\.js\?v=597/);
...
assert.match(serviceWorker,/client-results\.css\?v=597/);
assert.match(serviceWorker,/client-results\.js\?v=597/);
assert.match(serviceWorker,/provider\.js\?v=597/);
assert.match(serviceWorker,/CACHE_PREFIX}v597/);
