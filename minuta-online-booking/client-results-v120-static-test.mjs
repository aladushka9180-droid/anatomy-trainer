...
assert.match(providerHtml,/client-results\.css\?v=764/);
assert.match(providerHtml,/client-results\.js\?v=764[\s\S]*provider\.js\?v=764/);
...
assert.match(serviceWorker,/client-results\.css\?v=764/);
assert.match(serviceWorker,/client-results\.js\?v=764/);
assert.match(serviceWorker,/provider\.js\?v=764/);
assert.match(serviceWorker,/CACHE_PREFIX}v764/);
