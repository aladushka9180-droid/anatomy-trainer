...
assert.match(providerHtml,/client-results\.css\?v=671/);
assert.match(providerHtml,/client-results\.js\?v=671[\s\S]*provider\.js\?v=671/);
...
assert.match(serviceWorker,/client-results\.css\?v=671/);
assert.match(serviceWorker,/client-results\.js\?v=671/);
assert.match(serviceWorker,/provider\.js\?v=671/);
assert.match(serviceWorker,/CACHE_PREFIX}v671/);
