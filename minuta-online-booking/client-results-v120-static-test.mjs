...
assert.match(providerHtml,/client-results\.css\?v=721/);
assert.match(providerHtml,/client-results\.js\?v=721[\s\S]*provider\.js\?v=721/);
...
assert.match(serviceWorker,/client-results\.css\?v=721/);
assert.match(serviceWorker,/client-results\.js\?v=721/);
assert.match(serviceWorker,/provider\.js\?v=721/);
assert.match(serviceWorker,/CACHE_PREFIX}v721/);
