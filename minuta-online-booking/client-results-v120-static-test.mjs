...
assert.match(providerHtml,/client-results\.css\?v=582/);
assert.match(providerHtml,/client-results\.js\?v=582[\s\S]*provider\.js\?v=582/);
...
assert.match(serviceWorker,/client-results\.css\?v=582/);
assert.match(serviceWorker,/client-results\.js\?v=582/);
assert.match(serviceWorker,/provider\.js\?v=582/);
assert.match(serviceWorker,/CACHE_PREFIX}v582/);
