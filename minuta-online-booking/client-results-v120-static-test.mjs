...
assert.match(providerHtml,/client-results\.css\?v=753/);
assert.match(providerHtml,/client-results\.js\?v=753[\s\S]*provider\.js\?v=753/);
...
assert.match(serviceWorker,/client-results\.css\?v=753/);
assert.match(serviceWorker,/client-results\.js\?v=753/);
assert.match(serviceWorker,/provider\.js\?v=753/);
assert.match(serviceWorker,/CACHE_PREFIX}v753/);
