...
assert.match(providerHtml,/client-results\.css\?v=645/);
assert.match(providerHtml,/client-results\.js\?v=645[\s\S]*provider\.js\?v=645/);
...
assert.match(serviceWorker,/client-results\.css\?v=645/);
assert.match(serviceWorker,/client-results\.js\?v=645/);
assert.match(serviceWorker,/provider\.js\?v=645/);
assert.match(serviceWorker,/CACHE_PREFIX}v645/);
