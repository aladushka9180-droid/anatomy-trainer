...
assert.match(providerHtml,/client-results\.css\?v=631/);
assert.match(providerHtml,/client-results\.js\?v=631[\s\S]*provider\.js\?v=631/);
...
assert.match(serviceWorker,/client-results\.css\?v=631/);
assert.match(serviceWorker,/client-results\.js\?v=631/);
assert.match(serviceWorker,/provider\.js\?v=631/);
assert.match(serviceWorker,/CACHE_PREFIX}v631/);
