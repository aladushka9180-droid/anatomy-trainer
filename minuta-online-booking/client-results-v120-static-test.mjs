...
assert.match(providerHtml,/client-results\.css\?v=776/);
assert.match(providerHtml,/client-results\.js\?v=776[\s\S]*provider\.js\?v=776/);
...
assert.match(serviceWorker,/client-results\.css\?v=776/);
assert.match(serviceWorker,/client-results\.js\?v=776/);
assert.match(serviceWorker,/provider\.js\?v=776/);
assert.match(serviceWorker,/CACHE_PREFIX}v776/);
