...
assert.match(providerHtml,/client-results\.css\?v=664/);
assert.match(providerHtml,/client-results\.js\?v=664[\s\S]*provider\.js\?v=664/);
...
assert.match(serviceWorker,/client-results\.css\?v=664/);
assert.match(serviceWorker,/client-results\.js\?v=664/);
assert.match(serviceWorker,/provider\.js\?v=664/);
assert.match(serviceWorker,/CACHE_PREFIX}v664/);
