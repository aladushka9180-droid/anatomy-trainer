...
assert.match(providerHtml,/client-results\.css\?v=796/);
assert.match(providerHtml,/client-results\.js\?v=796[\s\S]*provider\.js\?v=796/);
...
assert.match(serviceWorker,/client-results\.css\?v=796/);
assert.match(serviceWorker,/client-results\.js\?v=796/);
assert.match(serviceWorker,/provider\.js\?v=796/);
assert.match(serviceWorker,/CACHE_PREFIX}v796/);
