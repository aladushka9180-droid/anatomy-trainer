...
assert.match(providerHtml,/client-results\.css\?v=643/);
assert.match(providerHtml,/client-results\.js\?v=643[\s\S]*provider\.js\?v=643/);
...
assert.match(serviceWorker,/client-results\.css\?v=643/);
assert.match(serviceWorker,/client-results\.js\?v=643/);
assert.match(serviceWorker,/provider\.js\?v=643/);
assert.match(serviceWorker,/CACHE_PREFIX}v643/);
