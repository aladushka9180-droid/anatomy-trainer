...
assert.match(providerHtml,/client-results\.css\?v=649/);
assert.match(providerHtml,/client-results\.js\?v=649[\s\S]*provider\.js\?v=649/);
...
assert.match(serviceWorker,/client-results\.css\?v=649/);
assert.match(serviceWorker,/client-results\.js\?v=649/);
assert.match(serviceWorker,/provider\.js\?v=649/);
assert.match(serviceWorker,/CACHE_PREFIX}v649/);
