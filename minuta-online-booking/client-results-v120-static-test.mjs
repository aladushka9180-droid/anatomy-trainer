...
assert.match(providerHtml,/client-results\.css\?v=780/);
assert.match(providerHtml,/client-results\.js\?v=780[\s\S]*provider\.js\?v=780/);
...
assert.match(serviceWorker,/client-results\.css\?v=780/);
assert.match(serviceWorker,/client-results\.js\?v=780/);
assert.match(serviceWorker,/provider\.js\?v=780/);
assert.match(serviceWorker,/CACHE_PREFIX}v780/);
