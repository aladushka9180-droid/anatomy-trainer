...
assert.match(providerHtml,/client-results\.css\?v=546/);
assert.match(providerHtml,/client-results\.js\?v=546[\s\S]*provider\.js\?v=546/);
...
assert.match(serviceWorker,/client-results\.css\?v=546/);
assert.match(serviceWorker,/client-results\.js\?v=546/);
assert.match(serviceWorker,/provider\.js\?v=546/);
assert.match(serviceWorker,/CACHE_PREFIX}v546/);
