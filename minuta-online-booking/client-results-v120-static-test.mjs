...
assert.match(providerHtml,/client-results\.css\?v=638/);
assert.match(providerHtml,/client-results\.js\?v=638[\s\S]*provider\.js\?v=638/);
...
assert.match(serviceWorker,/client-results\.css\?v=638/);
assert.match(serviceWorker,/client-results\.js\?v=638/);
assert.match(serviceWorker,/provider\.js\?v=638/);
assert.match(serviceWorker,/CACHE_PREFIX}v638/);
