...
assert.match(providerHtml,/client-results\.css\?v=551/);
assert.match(providerHtml,/client-results\.js\?v=551[\s\S]*provider\.js\?v=551/);
...
assert.match(serviceWorker,/client-results\.css\?v=551/);
assert.match(serviceWorker,/client-results\.js\?v=551/);
assert.match(serviceWorker,/provider\.js\?v=551/);
assert.match(serviceWorker,/CACHE_PREFIX}v551/);
