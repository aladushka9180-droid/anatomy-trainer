...
assert.match(providerHtml,/client-results\.css\?v=797/);
assert.match(providerHtml,/client-results\.js\?v=797[\s\S]*provider\.js\?v=797/);
...
assert.match(serviceWorker,/client-results\.css\?v=797/);
assert.match(serviceWorker,/client-results\.js\?v=797/);
assert.match(serviceWorker,/provider\.js\?v=797/);
assert.match(serviceWorker,/CACHE_PREFIX}v797/);
