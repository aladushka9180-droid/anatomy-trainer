...
assert.match(providerHtml,/client-results\.css\?v=611/);
assert.match(providerHtml,/client-results\.js\?v=611[\s\S]*provider\.js\?v=611/);
...
assert.match(serviceWorker,/client-results\.css\?v=611/);
assert.match(serviceWorker,/client-results\.js\?v=611/);
assert.match(serviceWorker,/provider\.js\?v=611/);
assert.match(serviceWorker,/CACHE_PREFIX}v611/);
