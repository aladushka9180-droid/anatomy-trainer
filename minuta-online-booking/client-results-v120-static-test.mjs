...
assert.match(providerHtml,/client-results\.css\?v=749/);
assert.match(providerHtml,/client-results\.js\?v=749[\s\S]*provider\.js\?v=749/);
...
assert.match(serviceWorker,/client-results\.css\?v=749/);
assert.match(serviceWorker,/client-results\.js\?v=749/);
assert.match(serviceWorker,/provider\.js\?v=749/);
assert.match(serviceWorker,/CACHE_PREFIX}v749/);
