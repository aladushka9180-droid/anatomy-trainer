...
assert.match(providerHtml,/client-results\.css\?v=765/);
assert.match(providerHtml,/client-results\.js\?v=765[\s\S]*provider\.js\?v=765/);
...
assert.match(serviceWorker,/client-results\.css\?v=765/);
assert.match(serviceWorker,/client-results\.js\?v=765/);
assert.match(serviceWorker,/provider\.js\?v=765/);
assert.match(serviceWorker,/CACHE_PREFIX}v765/);
