...
assert.match(providerHtml,/client-results\.css\?v=698/);
assert.match(providerHtml,/client-results\.js\?v=698[\s\S]*provider\.js\?v=698/);
...
assert.match(serviceWorker,/client-results\.css\?v=698/);
assert.match(serviceWorker,/client-results\.js\?v=698/);
assert.match(serviceWorker,/provider\.js\?v=698/);
assert.match(serviceWorker,/CACHE_PREFIX}v698/);
