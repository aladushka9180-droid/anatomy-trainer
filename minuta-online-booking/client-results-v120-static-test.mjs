...
assert.match(providerHtml,/client-results\.css\?v=585/);
assert.match(providerHtml,/client-results\.js\?v=585[\s\S]*provider\.js\?v=585/);
...
assert.match(serviceWorker,/client-results\.css\?v=585/);
assert.match(serviceWorker,/client-results\.js\?v=585/);
assert.match(serviceWorker,/provider\.js\?v=585/);
assert.match(serviceWorker,/CACHE_PREFIX}v585/);
