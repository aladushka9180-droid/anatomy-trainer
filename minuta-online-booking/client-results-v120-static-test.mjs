...
assert.match(providerHtml,/client-results\.css\?v=729/);
assert.match(providerHtml,/client-results\.js\?v=729[\s\S]*provider\.js\?v=729/);
...
assert.match(serviceWorker,/client-results\.css\?v=729/);
assert.match(serviceWorker,/client-results\.js\?v=729/);
assert.match(serviceWorker,/provider\.js\?v=729/);
assert.match(serviceWorker,/CACHE_PREFIX}v729/);
