...
assert.match(providerHtml,/client-results\.css\?v=548/);
assert.match(providerHtml,/client-results\.js\?v=548[\s\S]*provider\.js\?v=548/);
...
assert.match(serviceWorker,/client-results\.css\?v=548/);
assert.match(serviceWorker,/client-results\.js\?v=548/);
assert.match(serviceWorker,/provider\.js\?v=548/);
assert.match(serviceWorker,/CACHE_PREFIX}v548/);
