...
assert.match(providerHtml,/client-results\.css\?v=798/);
assert.match(providerHtml,/client-results\.js\?v=798[\s\S]*provider\.js\?v=798/);
...
assert.match(serviceWorker,/client-results\.css\?v=798/);
assert.match(serviceWorker,/client-results\.js\?v=798/);
assert.match(serviceWorker,/provider\.js\?v=798/);
assert.match(serviceWorker,/CACHE_PREFIX}v798/);
