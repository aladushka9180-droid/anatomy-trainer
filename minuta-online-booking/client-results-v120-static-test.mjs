...
assert.match(providerHtml,/client-results\.css\?v=635/);
assert.match(providerHtml,/client-results\.js\?v=635[\s\S]*provider\.js\?v=635/);
...
assert.match(serviceWorker,/client-results\.css\?v=635/);
assert.match(serviceWorker,/client-results\.js\?v=635/);
assert.match(serviceWorker,/provider\.js\?v=635/);
assert.match(serviceWorker,/CACHE_PREFIX}v635/);
