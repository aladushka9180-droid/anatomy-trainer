...
assert.match(providerHtml,/client-results\.css\?v=752/);
assert.match(providerHtml,/client-results\.js\?v=752[\s\S]*provider\.js\?v=752/);
...
assert.match(serviceWorker,/client-results\.css\?v=752/);
assert.match(serviceWorker,/client-results\.js\?v=752/);
assert.match(serviceWorker,/provider\.js\?v=752/);
assert.match(serviceWorker,/CACHE_PREFIX}v752/);
