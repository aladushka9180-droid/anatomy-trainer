...
assert.match(providerHtml,/client-results\.css\?v=747/);
assert.match(providerHtml,/client-results\.js\?v=747[\s\S]*provider\.js\?v=747/);
...
assert.match(serviceWorker,/client-results\.css\?v=747/);
assert.match(serviceWorker,/client-results\.js\?v=747/);
assert.match(serviceWorker,/provider\.js\?v=747/);
assert.match(serviceWorker,/CACHE_PREFIX}v747/);
