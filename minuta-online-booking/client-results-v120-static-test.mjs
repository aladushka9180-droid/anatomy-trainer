...
assert.match(providerHtml,/client-results\.css\?v=732/);
assert.match(providerHtml,/client-results\.js\?v=732[\s\S]*provider\.js\?v=732/);
...
assert.match(serviceWorker,/client-results\.css\?v=732/);
assert.match(serviceWorker,/client-results\.js\?v=732/);
assert.match(serviceWorker,/provider\.js\?v=732/);
assert.match(serviceWorker,/CACHE_PREFIX}v732/);
