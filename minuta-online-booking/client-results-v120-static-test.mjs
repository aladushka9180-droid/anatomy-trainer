...
assert.match(providerHtml,/client-results\.css\?v=613/);
assert.match(providerHtml,/client-results\.js\?v=613[\s\S]*provider\.js\?v=613/);
...
assert.match(serviceWorker,/client-results\.css\?v=613/);
assert.match(serviceWorker,/client-results\.js\?v=613/);
assert.match(serviceWorker,/provider\.js\?v=613/);
assert.match(serviceWorker,/CACHE_PREFIX}v613/);
