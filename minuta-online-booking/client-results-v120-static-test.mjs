...
assert.match(providerHtml,/client-results\.css\?v=595/);
assert.match(providerHtml,/client-results\.js\?v=595[\s\S]*provider\.js\?v=595/);
...
assert.match(serviceWorker,/client-results\.css\?v=595/);
assert.match(serviceWorker,/client-results\.js\?v=595/);
assert.match(serviceWorker,/provider\.js\?v=595/);
assert.match(serviceWorker,/CACHE_PREFIX}v595/);
