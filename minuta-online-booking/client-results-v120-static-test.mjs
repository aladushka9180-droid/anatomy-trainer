...
assert.match(providerHtml,/client-results\.css\?v=627/);
assert.match(providerHtml,/client-results\.js\?v=627[\s\S]*provider\.js\?v=627/);
...
assert.match(serviceWorker,/client-results\.css\?v=627/);
assert.match(serviceWorker,/client-results\.js\?v=627/);
assert.match(serviceWorker,/provider\.js\?v=627/);
assert.match(serviceWorker,/CACHE_PREFIX}v627/);
