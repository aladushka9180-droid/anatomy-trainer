...
assert.match(providerHtml,/client-results\.css\?v=775/);
assert.match(providerHtml,/client-results\.js\?v=775[\s\S]*provider\.js\?v=775/);
...
assert.match(serviceWorker,/client-results\.css\?v=775/);
assert.match(serviceWorker,/client-results\.js\?v=775/);
assert.match(serviceWorker,/provider\.js\?v=775/);
assert.match(serviceWorker,/CACHE_PREFIX}v775/);
