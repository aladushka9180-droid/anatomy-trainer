...
assert.match(providerHtml,/client-results\.css\?v=650/);
assert.match(providerHtml,/client-results\.js\?v=650[\s\S]*provider\.js\?v=650/);
...
assert.match(serviceWorker,/client-results\.css\?v=650/);
assert.match(serviceWorker,/client-results\.js\?v=650/);
assert.match(serviceWorker,/provider\.js\?v=650/);
assert.match(serviceWorker,/CACHE_PREFIX}v650/);
