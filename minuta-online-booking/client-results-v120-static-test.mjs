...
assert.match(providerHtml,/client-results\.css\?v=756/);
assert.match(providerHtml,/client-results\.js\?v=756[\s\S]*provider\.js\?v=756/);
...
assert.match(serviceWorker,/client-results\.css\?v=756/);
assert.match(serviceWorker,/client-results\.js\?v=756/);
assert.match(serviceWorker,/provider\.js\?v=756/);
assert.match(serviceWorker,/CACHE_PREFIX}v756/);
