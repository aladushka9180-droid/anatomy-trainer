...
assert.match(providerHtml,/client-results\.css\?v=786/);
assert.match(providerHtml,/client-results\.js\?v=786[\s\S]*provider\.js\?v=786/);
...
assert.match(serviceWorker,/client-results\.css\?v=786/);
assert.match(serviceWorker,/client-results\.js\?v=786/);
assert.match(serviceWorker,/provider\.js\?v=786/);
assert.match(serviceWorker,/CACHE_PREFIX}v786/);
