...
assert.match(providerHtml,/client-results\.css\?v=717/);
assert.match(providerHtml,/client-results\.js\?v=717[\s\S]*provider\.js\?v=717/);
...
assert.match(serviceWorker,/client-results\.css\?v=717/);
assert.match(serviceWorker,/client-results\.js\?v=717/);
assert.match(serviceWorker,/provider\.js\?v=717/);
assert.match(serviceWorker,/CACHE_PREFIX}v717/);
