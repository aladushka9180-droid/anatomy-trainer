...
assert.match(providerHtml,/client-results\.css\?v=636/);
assert.match(providerHtml,/client-results\.js\?v=636[\s\S]*provider\.js\?v=636/);
...
assert.match(serviceWorker,/client-results\.css\?v=636/);
assert.match(serviceWorker,/client-results\.js\?v=636/);
assert.match(serviceWorker,/provider\.js\?v=636/);
assert.match(serviceWorker,/CACHE_PREFIX}v636/);
