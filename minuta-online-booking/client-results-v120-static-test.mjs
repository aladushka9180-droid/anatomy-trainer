...
assert.match(providerHtml,/client-results\.css\?v=570/);
assert.match(providerHtml,/client-results\.js\?v=570[\s\S]*provider\.js\?v=570/);
...
assert.match(serviceWorker,/client-results\.css\?v=570/);
assert.match(serviceWorker,/client-results\.js\?v=570/);
assert.match(serviceWorker,/provider\.js\?v=570/);
assert.match(serviceWorker,/CACHE_PREFIX}v570/);
