...
assert.match(providerHtml,/client-results\.css\?v=560/);
assert.match(providerHtml,/client-results\.js\?v=560[\s\S]*provider\.js\?v=560/);
...
assert.match(serviceWorker,/client-results\.css\?v=560/);
assert.match(serviceWorker,/client-results\.js\?v=560/);
assert.match(serviceWorker,/provider\.js\?v=560/);
assert.match(serviceWorker,/CACHE_PREFIX}v560/);
