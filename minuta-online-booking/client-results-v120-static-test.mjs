...
assert.match(providerHtml,/client-results\.css\?v=740/);
assert.match(providerHtml,/client-results\.js\?v=740[\s\S]*provider\.js\?v=740/);
...
assert.match(serviceWorker,/client-results\.css\?v=740/);
assert.match(serviceWorker,/client-results\.js\?v=740/);
assert.match(serviceWorker,/provider\.js\?v=740/);
assert.match(serviceWorker,/CACHE_PREFIX}v740/);
