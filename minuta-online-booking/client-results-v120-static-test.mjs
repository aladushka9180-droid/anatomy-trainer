...
assert.match(providerHtml,/client-results\.css\?v=754/);
assert.match(providerHtml,/client-results\.js\?v=754[\s\S]*provider\.js\?v=754/);
...
assert.match(serviceWorker,/client-results\.css\?v=754/);
assert.match(serviceWorker,/client-results\.js\?v=754/);
assert.match(serviceWorker,/provider\.js\?v=754/);
assert.match(serviceWorker,/CACHE_PREFIX}v754/);
