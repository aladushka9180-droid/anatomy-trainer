...
assert.match(providerHtml,/client-results\.css\?v=711/);
assert.match(providerHtml,/client-results\.js\?v=711[\s\S]*provider\.js\?v=711/);
...
assert.match(serviceWorker,/client-results\.css\?v=711/);
assert.match(serviceWorker,/client-results\.js\?v=711/);
assert.match(serviceWorker,/provider\.js\?v=711/);
assert.match(serviceWorker,/CACHE_PREFIX}v711/);
