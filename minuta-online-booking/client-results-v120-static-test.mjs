...
assert.match(providerHtml,/client-results\.css\?v=694/);
assert.match(providerHtml,/client-results\.js\?v=694[\s\S]*provider\.js\?v=694/);
...
assert.match(serviceWorker,/client-results\.css\?v=694/);
assert.match(serviceWorker,/client-results\.js\?v=694/);
assert.match(serviceWorker,/provider\.js\?v=694/);
assert.match(serviceWorker,/CACHE_PREFIX}v694/);
