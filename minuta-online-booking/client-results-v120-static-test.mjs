...
assert.match(providerHtml,/client-results\.css\?v=701/);
assert.match(providerHtml,/client-results\.js\?v=701[\s\S]*provider\.js\?v=701/);
...
assert.match(serviceWorker,/client-results\.css\?v=701/);
assert.match(serviceWorker,/client-results\.js\?v=701/);
assert.match(serviceWorker,/provider\.js\?v=701/);
assert.match(serviceWorker,/CACHE_PREFIX}v701/);
