...
assert.match(providerHtml,/client-results\.css\?v=785/);
assert.match(providerHtml,/client-results\.js\?v=785[\s\S]*provider\.js\?v=785/);
...
assert.match(serviceWorker,/client-results\.css\?v=785/);
assert.match(serviceWorker,/client-results\.js\?v=785/);
assert.match(serviceWorker,/provider\.js\?v=785/);
assert.match(serviceWorker,/CACHE_PREFIX}v785/);
