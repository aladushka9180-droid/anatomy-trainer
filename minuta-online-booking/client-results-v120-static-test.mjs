...
assert.match(providerHtml,/client-results\.css\?v=770/);
assert.match(providerHtml,/client-results\.js\?v=770[\s\S]*provider\.js\?v=770/);
...
assert.match(serviceWorker,/client-results\.css\?v=770/);
assert.match(serviceWorker,/client-results\.js\?v=770/);
assert.match(serviceWorker,/provider\.js\?v=770/);
assert.match(serviceWorker,/CACHE_PREFIX}v770/);
