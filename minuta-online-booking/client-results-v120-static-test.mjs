...
assert.match(providerHtml,/client-results\.css\?v=683/);
assert.match(providerHtml,/client-results\.js\?v=683[\s\S]*provider\.js\?v=683/);
...
assert.match(serviceWorker,/client-results\.css\?v=683/);
assert.match(serviceWorker,/client-results\.js\?v=683/);
assert.match(serviceWorker,/provider\.js\?v=683/);
assert.match(serviceWorker,/CACHE_PREFIX}v683/);
