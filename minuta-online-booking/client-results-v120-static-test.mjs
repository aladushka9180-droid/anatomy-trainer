...
assert.match(providerHtml,/client-results\.css\?v=672/);
assert.match(providerHtml,/client-results\.js\?v=672[\s\S]*provider\.js\?v=672/);
...
assert.match(serviceWorker,/client-results\.css\?v=672/);
assert.match(serviceWorker,/client-results\.js\?v=672/);
assert.match(serviceWorker,/provider\.js\?v=672/);
assert.match(serviceWorker,/CACHE_PREFIX}v672/);
