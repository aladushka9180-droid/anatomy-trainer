...
assert.match(providerHtml,/client-results\.css\?v=678/);
assert.match(providerHtml,/client-results\.js\?v=678[\s\S]*provider\.js\?v=678/);
...
assert.match(serviceWorker,/client-results\.css\?v=678/);
assert.match(serviceWorker,/client-results\.js\?v=678/);
assert.match(serviceWorker,/provider\.js\?v=678/);
assert.match(serviceWorker,/CACHE_PREFIX}v678/);
