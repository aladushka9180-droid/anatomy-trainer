...
assert.match(providerHtml,/client-results\.css\?v=743/);
assert.match(providerHtml,/client-results\.js\?v=743[\s\S]*provider\.js\?v=743/);
...
assert.match(serviceWorker,/client-results\.css\?v=743/);
assert.match(serviceWorker,/client-results\.js\?v=743/);
assert.match(serviceWorker,/provider\.js\?v=743/);
assert.match(serviceWorker,/CACHE_PREFIX}v743/);
