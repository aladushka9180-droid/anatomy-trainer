...
assert.match(providerHtml,/client-results\.css\?v=681/);
assert.match(providerHtml,/client-results\.js\?v=681[\s\S]*provider\.js\?v=681/);
...
assert.match(serviceWorker,/client-results\.css\?v=681/);
assert.match(serviceWorker,/client-results\.js\?v=681/);
assert.match(serviceWorker,/provider\.js\?v=681/);
assert.match(serviceWorker,/CACHE_PREFIX}v681/);
