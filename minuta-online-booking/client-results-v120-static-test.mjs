...
assert.match(providerHtml,/client-results\.css\?v=619/);
assert.match(providerHtml,/client-results\.js\?v=619[\s\S]*provider\.js\?v=619/);
...
assert.match(serviceWorker,/client-results\.css\?v=619/);
assert.match(serviceWorker,/client-results\.js\?v=619/);
assert.match(serviceWorker,/provider\.js\?v=619/);
assert.match(serviceWorker,/CACHE_PREFIX}v619/);
