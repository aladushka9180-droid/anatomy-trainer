...
assert.match(providerHtml,/client-results\.css\?v=675/);
assert.match(providerHtml,/client-results\.js\?v=675[\s\S]*provider\.js\?v=675/);
...
assert.match(serviceWorker,/client-results\.css\?v=675/);
assert.match(serviceWorker,/client-results\.js\?v=675/);
assert.match(serviceWorker,/provider\.js\?v=675/);
assert.match(serviceWorker,/CACHE_PREFIX}v675/);
