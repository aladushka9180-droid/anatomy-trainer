...
assert.match(providerHtml,/client-results\.css\?v=788/);
assert.match(providerHtml,/client-results\.js\?v=788[\s\S]*provider\.js\?v=788/);
...
assert.match(serviceWorker,/client-results\.css\?v=788/);
assert.match(serviceWorker,/client-results\.js\?v=788/);
assert.match(serviceWorker,/provider\.js\?v=788/);
assert.match(serviceWorker,/CACHE_PREFIX}v788/);
