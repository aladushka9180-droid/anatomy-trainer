...
assert.match(providerHtml,/client-results\.css\?v=810/);
assert.match(providerHtml,/client-results\.js\?v=810[\s\S]*provider\.js\?v=810/);
...
assert.match(serviceWorker,/client-results\.css\?v=810/);
assert.match(serviceWorker,/client-results\.js\?v=810/);
assert.match(serviceWorker,/provider\.js\?v=810/);
assert.match(serviceWorker,/CACHE_PREFIX}v810/);
