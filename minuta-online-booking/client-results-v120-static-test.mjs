...
assert.match(providerHtml,/client-results\.css\?v=760/);
assert.match(providerHtml,/client-results\.js\?v=760[\s\S]*provider\.js\?v=760/);
...
assert.match(serviceWorker,/client-results\.css\?v=760/);
assert.match(serviceWorker,/client-results\.js\?v=760/);
assert.match(serviceWorker,/provider\.js\?v=760/);
assert.match(serviceWorker,/CACHE_PREFIX}v760/);
