...
assert.match(providerHtml,/client-results\.css\?v=679/);
assert.match(providerHtml,/client-results\.js\?v=679[\s\S]*provider\.js\?v=679/);
...
assert.match(serviceWorker,/client-results\.css\?v=679/);
assert.match(serviceWorker,/client-results\.js\?v=679/);
assert.match(serviceWorker,/provider\.js\?v=679/);
assert.match(serviceWorker,/CACHE_PREFIX}v679/);
