...
assert.match(providerHtml,/client-results\.css\?v=723/);
assert.match(providerHtml,/client-results\.js\?v=723[\s\S]*provider\.js\?v=723/);
...
assert.match(serviceWorker,/client-results\.css\?v=723/);
assert.match(serviceWorker,/client-results\.js\?v=723/);
assert.match(serviceWorker,/provider\.js\?v=723/);
assert.match(serviceWorker,/CACHE_PREFIX}v723/);
