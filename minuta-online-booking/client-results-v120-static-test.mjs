...
assert.match(providerHtml,/client-results\.css\?v=634/);
assert.match(providerHtml,/client-results\.js\?v=634[\s\S]*provider\.js\?v=634/);
...
assert.match(serviceWorker,/client-results\.css\?v=634/);
assert.match(serviceWorker,/client-results\.js\?v=634/);
assert.match(serviceWorker,/provider\.js\?v=634/);
assert.match(serviceWorker,/CACHE_PREFIX}v634/);
