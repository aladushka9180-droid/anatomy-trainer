...
assert.match(providerHtml,/client-results\.css\?v=559/);
assert.match(providerHtml,/client-results\.js\?v=559[\s\S]*provider\.js\?v=559/);
...
assert.match(serviceWorker,/client-results\.css\?v=559/);
assert.match(serviceWorker,/client-results\.js\?v=559/);
assert.match(serviceWorker,/provider\.js\?v=559/);
assert.match(serviceWorker,/CACHE_PREFIX}v559/);
