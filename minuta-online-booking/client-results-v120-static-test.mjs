...
assert.match(providerHtml,/client-results\.css\?v=620/);
assert.match(providerHtml,/client-results\.js\?v=620[\s\S]*provider\.js\?v=620/);
...
assert.match(serviceWorker,/client-results\.css\?v=620/);
assert.match(serviceWorker,/client-results\.js\?v=620/);
assert.match(serviceWorker,/provider\.js\?v=620/);
assert.match(serviceWorker,/CACHE_PREFIX}v620/);
