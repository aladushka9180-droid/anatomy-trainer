...
assert.match(providerHtml,/client-results\.css\?v=806/);
assert.match(providerHtml,/client-results\.js\?v=806[\s\S]*provider\.js\?v=806/);
...
assert.match(serviceWorker,/client-results\.css\?v=806/);
assert.match(serviceWorker,/client-results\.js\?v=806/);
assert.match(serviceWorker,/provider\.js\?v=806/);
assert.match(serviceWorker,/CACHE_PREFIX}v806/);
