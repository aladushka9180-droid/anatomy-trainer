...
assert.match(providerHtml,/client-results\.css\?v=804/);
assert.match(providerHtml,/client-results\.js\?v=804[\s\S]*provider\.js\?v=804/);
...
assert.match(serviceWorker,/client-results\.css\?v=804/);
assert.match(serviceWorker,/client-results\.js\?v=804/);
assert.match(serviceWorker,/provider\.js\?v=804/);
assert.match(serviceWorker,/CACHE_PREFIX}v804/);
