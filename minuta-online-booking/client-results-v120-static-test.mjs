...
assert.match(providerHtml,/client-results\.css\?v=710/);
assert.match(providerHtml,/client-results\.js\?v=710[\s\S]*provider\.js\?v=710/);
...
assert.match(serviceWorker,/client-results\.css\?v=710/);
assert.match(serviceWorker,/client-results\.js\?v=710/);
assert.match(serviceWorker,/provider\.js\?v=710/);
assert.match(serviceWorker,/CACHE_PREFIX}v710/);
