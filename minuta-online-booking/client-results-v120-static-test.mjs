...
assert.match(providerHtml,/client-results\.css\?v=593/);
assert.match(providerHtml,/client-results\.js\?v=593[\s\S]*provider\.js\?v=593/);
...
assert.match(serviceWorker,/client-results\.css\?v=593/);
assert.match(serviceWorker,/client-results\.js\?v=593/);
assert.match(serviceWorker,/provider\.js\?v=593/);
assert.match(serviceWorker,/CACHE_PREFIX}v593/);
