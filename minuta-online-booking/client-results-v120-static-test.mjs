...
assert.match(providerHtml,/client-results\.css\?v=615/);
assert.match(providerHtml,/client-results\.js\?v=615[\s\S]*provider\.js\?v=615/);
...
assert.match(serviceWorker,/client-results\.css\?v=615/);
assert.match(serviceWorker,/client-results\.js\?v=615/);
assert.match(serviceWorker,/provider\.js\?v=615/);
assert.match(serviceWorker,/CACHE_PREFIX}v615/);
