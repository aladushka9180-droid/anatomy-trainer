...
assert.match(providerHtml,/client-results\.css\?v=734/);
assert.match(providerHtml,/client-results\.js\?v=734[\s\S]*provider\.js\?v=734/);
...
assert.match(serviceWorker,/client-results\.css\?v=734/);
assert.match(serviceWorker,/client-results\.js\?v=734/);
assert.match(serviceWorker,/provider\.js\?v=734/);
assert.match(serviceWorker,/CACHE_PREFIX}v734/);
