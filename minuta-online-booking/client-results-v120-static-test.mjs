...
assert.match(providerHtml,/client-results\.css\?v=641/);
assert.match(providerHtml,/client-results\.js\?v=641[\s\S]*provider\.js\?v=641/);
...
assert.match(serviceWorker,/client-results\.css\?v=641/);
assert.match(serviceWorker,/client-results\.js\?v=641/);
assert.match(serviceWorker,/provider\.js\?v=641/);
assert.match(serviceWorker,/CACHE_PREFIX}v641/);
