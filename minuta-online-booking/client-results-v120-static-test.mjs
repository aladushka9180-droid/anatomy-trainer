...
assert.match(providerHtml,/client-results\.css\?v=574/);
assert.match(providerHtml,/client-results\.js\?v=574[\s\S]*provider\.js\?v=574/);
...
assert.match(serviceWorker,/client-results\.css\?v=574/);
assert.match(serviceWorker,/client-results\.js\?v=574/);
assert.match(serviceWorker,/provider\.js\?v=574/);
assert.match(serviceWorker,/CACHE_PREFIX}v574/);
