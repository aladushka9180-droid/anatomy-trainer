...
assert.match(providerHtml,/client-results\.css\?v=703/);
assert.match(providerHtml,/client-results\.js\?v=703[\s\S]*provider\.js\?v=703/);
...
assert.match(serviceWorker,/client-results\.css\?v=703/);
assert.match(serviceWorker,/client-results\.js\?v=703/);
assert.match(serviceWorker,/provider\.js\?v=703/);
assert.match(serviceWorker,/CACHE_PREFIX}v703/);
