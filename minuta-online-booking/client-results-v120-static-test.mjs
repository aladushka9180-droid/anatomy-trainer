...
assert.match(providerHtml,/client-results\.css\?v=554/);
assert.match(providerHtml,/client-results\.js\?v=554[\s\S]*provider\.js\?v=554/);
...
assert.match(serviceWorker,/client-results\.css\?v=554/);
assert.match(serviceWorker,/client-results\.js\?v=554/);
assert.match(serviceWorker,/provider\.js\?v=554/);
assert.match(serviceWorker,/CACHE_PREFIX}v554/);
