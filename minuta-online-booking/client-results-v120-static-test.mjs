...
assert.match(providerHtml,/client-results\.css\?v=677/);
assert.match(providerHtml,/client-results\.js\?v=677[\s\S]*provider\.js\?v=677/);
...
assert.match(serviceWorker,/client-results\.css\?v=677/);
assert.match(serviceWorker,/client-results\.js\?v=677/);
assert.match(serviceWorker,/provider\.js\?v=677/);
assert.match(serviceWorker,/CACHE_PREFIX}v677/);
