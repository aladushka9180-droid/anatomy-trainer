...
assert.match(provider, /provider-themes-signature\.css\?v=780/, 'Кабинет не подключает Signature Collection v780');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=780/, 'Service Worker не кэширует Signature Collection v780');
...
console.log('Signature themes v780: Snow Leopard canvas OK');
