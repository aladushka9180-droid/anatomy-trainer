...
assert.match(provider, /provider-themes-signature\.css\?v=471/, 'Кабинет не подключает Signature Collection v471');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=471/, 'Service Worker не кэширует Signature Collection v471');
...
console.log('Signature themes v471: 13 unified themes OK');
