...
assert.match(provider, /provider-themes-signature\.css\?v=772/, 'Кабинет не подключает Signature Collection v772');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=772/, 'Service Worker не кэширует Signature Collection v772');
...
console.log('Signature themes v772: Snow Leopard canvas OK');
