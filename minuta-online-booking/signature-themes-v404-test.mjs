...
assert.match(provider, /provider-themes-signature\.css\?v=773/, 'Кабинет не подключает Signature Collection v773');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=773/, 'Service Worker не кэширует Signature Collection v773');
...
console.log('Signature themes v773: Snow Leopard canvas OK');
