...
assert.match(provider, /provider-themes-signature\.css\?v=670/, 'Кабинет не подключает Signature Collection v670');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=670/, 'Service Worker не кэширует Signature Collection v670');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=670/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=670/);
...
console.log('Signature themes v670: Snow Leopard canvas OK');
