...
assert.match(provider, /provider-themes-signature\.css\?v=761/, 'Кабинет не подключает Signature Collection v761');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=761/, 'Service Worker не кэширует Signature Collection v761');
...
console.log('Signature themes v761: Snow Leopard canvas OK');
