...
assert.match(provider, /provider-themes-signature\.css\?v=662/, 'Кабинет не подключает Signature Collection v662');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=662/, 'Service Worker не кэширует Signature Collection v662');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=662/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=662/);
...
console.log('Signature themes v662: Snow Leopard canvas OK');
