...
assert.match(provider, /provider-themes-signature\.css\?v=633/, 'Кабинет не подключает Signature Collection v633');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=633/, 'Service Worker не кэширует Signature Collection v633');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=633/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=633/);
...
console.log('Signature themes v633: Snow Leopard canvas OK');
