...
assert.match(provider, /provider-themes-signature\.css\?v=612/, 'Кабинет не подключает Signature Collection v612');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=612/, 'Service Worker не кэширует Signature Collection v612');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=612/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=612/);
...
console.log('Signature themes v612: Snow Leopard canvas OK');
