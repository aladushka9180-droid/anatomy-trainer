...
assert.match(provider, /provider-themes-signature\.css\?v=752/, 'Кабинет не подключает Signature Collection v752');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=752/, 'Service Worker не кэширует Signature Collection v752');
...
console.log('Signature themes v752: Snow Leopard canvas OK');
