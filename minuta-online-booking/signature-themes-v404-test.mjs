...
assert.match(provider, /provider-themes-signature\.css\?v=749/, 'Кабинет не подключает Signature Collection v749');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=749/, 'Service Worker не кэширует Signature Collection v749');
...
console.log('Signature themes v749: Snow Leopard canvas OK');
