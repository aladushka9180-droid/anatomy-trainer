...
assert.match(provider, /provider-themes-signature\.css\?v=595/, 'Кабинет не подключает Signature Collection v595');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=595/, 'Service Worker не кэширует Signature Collection v595');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=595/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=595/);
...
console.log('Signature themes v595: Snow Leopard canvas OK');
