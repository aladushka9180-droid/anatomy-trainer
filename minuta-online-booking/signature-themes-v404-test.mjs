...
assert.match(provider, /provider-themes-signature\.css\?v=502/, 'Кабинет не подключает Signature Collection v502');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=502/, 'Service Worker не кэширует Signature Collection v502');
...
assert.match(snowCanvas, /provider-snow-leopard-crisp-seamless-4k-v4\.webp\?v=502/);
...
console.log('Signature themes v502: 13 unified themes OK');
