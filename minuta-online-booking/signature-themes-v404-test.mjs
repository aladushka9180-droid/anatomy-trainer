...
assert.match(provider, /provider-themes-signature\.css\?v=762/, 'Кабинет не подключает Signature Collection v762');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=762/, 'Service Worker не кэширует Signature Collection v762');
...
console.log('Signature themes v762: Snow Leopard canvas OK');
