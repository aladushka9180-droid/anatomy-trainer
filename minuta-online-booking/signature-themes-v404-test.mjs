...
assert.match(provider, /provider-themes-signature\.css\?v=455/, 'Кабинет не подключает Signature Collection v455');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=455/, 'Service Worker не кэширует Signature Collection v455');
...
console.log('Signature themes v455: 13 unified themes OK');
