...
assert.match(provider, /provider-themes-signature\.css\?v=723/, 'Кабинет не подключает Signature Collection v723');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=723/, 'Service Worker не кэширует Signature Collection v723');
...
console.log('Signature themes v723: Snow Leopard canvas OK');
