...
assert.match(provider, /provider-themes-signature\.css\?v=760/, 'Кабинет не подключает Signature Collection v760');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=760/, 'Service Worker не кэширует Signature Collection v760');
...
console.log('Signature themes v760: Snow Leopard canvas OK');
