...
assert.match(provider, /provider-themes-signature\.css\?v=793/, 'Кабинет не подключает Signature Collection v793');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=793/, 'Service Worker не кэширует Signature Collection v793');
...
console.log('Signature themes v793: Snow Leopard canvas OK');
