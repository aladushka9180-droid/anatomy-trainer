...
assert.match(provider, /provider-themes-signature\.css\?v=494/, 'Кабинет не подключает Signature Collection v494');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=494/, 'Service Worker не кэширует Signature Collection v494');
...
console.log('Signature themes v494: 13 unified themes OK');
