...
assert.match(provider, /provider-themes-signature\.css\?v=769/, 'Кабинет не подключает Signature Collection v769');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=769/, 'Service Worker не кэширует Signature Collection v769');
...
console.log('Signature themes v769: Snow Leopard canvas OK');
