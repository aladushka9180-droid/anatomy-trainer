...
assert.match(provider, /provider-themes-signature\.css\?v=470/, 'Кабинет не подключает Signature Collection v470');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=470/, 'Service Worker не кэширует Signature Collection v470');
...
console.log('Signature themes v470: 13 unified themes OK');
