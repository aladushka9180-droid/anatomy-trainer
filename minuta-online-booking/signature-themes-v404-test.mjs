...
assert.match(provider, /provider-themes-signature\.css\?v=695/, 'Кабинет не подключает Signature Collection v695');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=695/, 'Service Worker не кэширует Signature Collection v695');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=695/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=695/);
...
console.log('Signature themes v695: Snow Leopard canvas OK');
