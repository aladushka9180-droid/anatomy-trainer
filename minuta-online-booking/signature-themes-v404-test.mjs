...
assert.match(provider, /provider-themes-signature\.css\?v=460/, 'Кабинет не подключает Signature Collection v460');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=460/, 'Service Worker не кэширует Signature Collection v460');
...
console.log('Signature themes v460: 13 unified themes OK');
