...
assert.match(provider, /provider-themes-signature\.css\?v=598/, 'Кабинет не подключает Signature Collection v598');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=598/, 'Service Worker не кэширует Signature Collection v598');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=598/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=598/);
...
console.log('Signature themes v598: Snow Leopard canvas OK');
