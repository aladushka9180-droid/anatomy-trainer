...
assert.match(provider, /provider-themes-signature\.css\?v=743/, 'Кабинет не подключает Signature Collection v743');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=743/, 'Service Worker не кэширует Signature Collection v743');
...
console.log('Signature themes v743: Snow Leopard canvas OK');
