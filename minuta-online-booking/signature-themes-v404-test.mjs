...
assert.match(provider, /provider-themes-signature\.css\?v=791/, 'Кабинет не подключает Signature Collection v791');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=791/, 'Service Worker не кэширует Signature Collection v791');
...
console.log('Signature themes v791: Snow Leopard canvas OK');
