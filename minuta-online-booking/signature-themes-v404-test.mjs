...
assert.match(provider, /provider-themes-signature\.css\?v=466/, 'Кабинет не подключает Signature Collection v466');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=466/, 'Service Worker не кэширует Signature Collection v466');
...
console.log('Signature themes v466: 13 unified themes OK');
