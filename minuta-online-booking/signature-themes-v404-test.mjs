...
assert.match(provider, /provider-themes-signature\.css\?v=498/, 'Кабинет не подключает Signature Collection v498');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=498/, 'Service Worker не кэширует Signature Collection v498');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=498/);
...
console.log('Signature themes v498: 13 unified themes OK');
