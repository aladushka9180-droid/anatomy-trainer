...
assert.match(provider, /provider-themes-signature\.css\?v=477/, 'Кабинет не подключает Signature Collection v477');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=477/, 'Service Worker не кэширует Signature Collection v477');
...
console.log('Signature themes v477: 13 unified themes OK');
