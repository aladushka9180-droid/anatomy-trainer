...
assert.match(provider, /provider-themes-signature\.css\?v=745/, 'Кабинет не подключает Signature Collection v745');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=745/, 'Service Worker не кэширует Signature Collection v745');
...
console.log('Signature themes v745: Snow Leopard canvas OK');
