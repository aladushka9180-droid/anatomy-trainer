...
assert.match(provider, /provider-themes-signature\.css\?v=584/, 'Кабинет не подключает Signature Collection v584');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=584/, 'Service Worker не кэширует Signature Collection v584');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=584/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=584/);
...
console.log('Signature themes v584: Snow Leopard canvas OK');
