...
assert.match(provider, /provider-themes-signature\.css\?v=704/, 'Кабинет не подключает Signature Collection v704');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=704/, 'Service Worker не кэширует Signature Collection v704');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=704/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=704/);
...
console.log('Signature themes v704: Snow Leopard canvas OK');
