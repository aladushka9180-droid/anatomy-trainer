...
assert.match(provider, /provider-themes-signature\.css\?v=735/, 'Кабинет не подключает Signature Collection v735');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=735/, 'Service Worker не кэширует Signature Collection v735');
...
console.log('Signature themes v735: Snow Leopard canvas OK');
