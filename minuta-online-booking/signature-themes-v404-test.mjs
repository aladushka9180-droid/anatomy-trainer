...
assert.match(provider, /provider-themes-signature\.css\?v=717/, 'Кабинет не подключает Signature Collection v717');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=717/, 'Service Worker не кэширует Signature Collection v717');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=717/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=717/);
...
console.log('Signature themes v717: Snow Leopard canvas OK');
