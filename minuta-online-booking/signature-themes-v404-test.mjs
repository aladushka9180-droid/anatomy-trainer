...
assert.match(provider, /provider-themes-signature\.css\?v=755/, 'Кабинет не подключает Signature Collection v755');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=755/, 'Service Worker не кэширует Signature Collection v755');
...
console.log('Signature themes v755: Snow Leopard canvas OK');
