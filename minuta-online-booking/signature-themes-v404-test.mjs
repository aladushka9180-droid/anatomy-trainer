...
assert.match(provider, /provider-themes-signature\.css\?v=503/, 'Кабинет не подключает Signature Collection v503');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=503/, 'Service Worker не кэширует Signature Collection v503');
...
assert.match(snowCanvas, /provider-snow-leopard-crisp-seamless-4k-v4\.webp\?v=503/);
...
console.log('Signature themes v503: 13 unified themes OK');
