...
assert.match(provider, /provider-themes-signature\.css\?v=418/, 'Кабинет не подключает Signature Collection v418');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=418/, 'Service Worker не кэширует Signature Collection v418');

console.log('Signature themes v418: 8 unified themes OK');
