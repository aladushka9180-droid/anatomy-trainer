...
assert.match(provider, /provider-themes-signature\.css\?v=774/, 'Кабинет не подключает Signature Collection v774');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=774/, 'Service Worker не кэширует Signature Collection v774');
...
console.log('Signature themes v774: Snow Leopard canvas OK');
