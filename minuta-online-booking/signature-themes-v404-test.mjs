...
assert.match(provider, /provider-themes-signature\.css\?v=644/, 'Кабинет не подключает Signature Collection v644');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=644/, 'Service Worker не кэширует Signature Collection v644');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=644/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=644/);
...
console.log('Signature themes v644: Snow Leopard canvas OK');
