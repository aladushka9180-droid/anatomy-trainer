...
assert.match(provider, /provider-themes-signature\.css\?v=657/, 'Кабинет не подключает Signature Collection v657');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=657/, 'Service Worker не кэширует Signature Collection v657');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=657/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=657/);
...
console.log('Signature themes v657: Snow Leopard canvas OK');
