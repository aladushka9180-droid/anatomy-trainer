...
assert.match(provider, /provider-themes-signature\.css\?v=691/, 'Кабинет не подключает Signature Collection v691');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=691/, 'Service Worker не кэширует Signature Collection v691');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=691/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=691/);
...
console.log('Signature themes v691: Snow Leopard canvas OK');
