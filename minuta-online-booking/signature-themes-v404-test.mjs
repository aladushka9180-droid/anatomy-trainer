...
assert.match(provider, /provider-themes-signature\.css\?v=489/, 'Кабинет не подключает Signature Collection v489');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=489/, 'Service Worker не кэширует Signature Collection v489');
...
console.log('Signature themes v489: 13 unified themes OK');
