...
assert.match(provider, /provider-themes-signature\.css\?v=474/, 'Кабинет не подключает Signature Collection v474');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=474/, 'Service Worker не кэширует Signature Collection v474');
...
console.log('Signature themes v474: 13 unified themes OK');
