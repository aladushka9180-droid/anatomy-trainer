...
assert.match(provider, /provider-themes-signature\.css\?v=495/, 'Кабинет не подключает Signature Collection v495');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=495/, 'Service Worker не кэширует Signature Collection v495');
...
assert.match(snowCanvas, /provider-snow-leopard-mosaic-4k-v2\.webp\?v=495/);
...
console.log('Signature themes v495: 13 unified themes OK');
