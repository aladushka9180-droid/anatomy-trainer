...
assert.match(provider, /provider-themes-signature\.css\?v=435/, 'Кабинет не подключает Signature Collection v435');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=435/, 'Service Worker не кэширует Signature Collection v435');

console.log('Signature themes v435: 8 unified themes OK');
