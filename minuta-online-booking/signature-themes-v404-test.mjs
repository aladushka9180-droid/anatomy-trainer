...
assert.match(provider, /provider-themes-signature\.css\?v=621/, 'Кабинет не подключает Signature Collection v621');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=621/, 'Service Worker не кэширует Signature Collection v621');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=621/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=621/);
...
console.log('Signature themes v621: Snow Leopard canvas OK');
