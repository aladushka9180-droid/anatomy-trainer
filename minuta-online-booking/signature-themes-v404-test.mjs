...
assert.match(provider, /provider-themes-signature\.css\?v=504/, 'Кабинет не подключает Signature Collection v504');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=504/, 'Service Worker не кэширует Signature Collection v504');
...
assert.match(snowCanvas, /provider-snow-leopard-crisp-seamless-4k-v4\.webp\?v=504/);
...
console.log('Signature themes v504: 13 unified themes OK');
