...
assert.match(provider, /provider-themes-signature\.css\?v=677/, 'Кабинет не подключает Signature Collection v677');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=677/, 'Service Worker не кэширует Signature Collection v677');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=677/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=677/);
...
console.log('Signature themes v677: Snow Leopard canvas OK');
