...
assert.match(provider, /provider-themes-signature\.css\?v=783/, 'Кабинет не подключает Signature Collection v783');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=783/, 'Service Worker не кэширует Signature Collection v783');
...
console.log('Signature themes v783: Snow Leopard canvas OK');
