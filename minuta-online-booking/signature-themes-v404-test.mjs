...
assert.match(provider, /provider-themes-signature\.css\?v=606/, 'Кабинет не подключает Signature Collection v606');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=606/, 'Service Worker не кэширует Signature Collection v606');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=606/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=606/);
...
console.log('Signature themes v606: Snow Leopard canvas OK');
