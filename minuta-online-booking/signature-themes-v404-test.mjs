...
assert.match(provider, /provider-themes-signature\.css\?v=708/, 'Кабинет не подключает Signature Collection v708');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=708/, 'Service Worker не кэширует Signature Collection v708');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=708/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=708/);
...
console.log('Signature themes v708: Snow Leopard canvas OK');
