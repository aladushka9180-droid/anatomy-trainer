...
assert.match(provider, /provider-themes-signature\.css\?v=689/, 'Кабинет не подключает Signature Collection v689');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=689/, 'Service Worker не кэширует Signature Collection v689');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=689/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=689/);
...
console.log('Signature themes v689: Snow Leopard canvas OK');
