...
assert.match(provider, /provider-themes-signature\.css\?v=692/, 'Кабинет не подключает Signature Collection v692');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=692/, 'Service Worker не кэширует Signature Collection v692');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=692/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=692/);
...
console.log('Signature themes v692: Snow Leopard canvas OK');
