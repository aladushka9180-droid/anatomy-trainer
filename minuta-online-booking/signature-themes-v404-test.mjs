...
assert.match(provider, /provider-themes-signature\.css\?v=712/, 'Кабинет не подключает Signature Collection v712');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=712/, 'Service Worker не кэширует Signature Collection v712');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=712/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=712/);
...
console.log('Signature themes v712: Snow Leopard canvas OK');
