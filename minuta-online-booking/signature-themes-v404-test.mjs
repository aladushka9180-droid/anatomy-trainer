...
assert.match(provider, /provider-themes-signature\.css\?v=798/, 'Кабинет не подключает Signature Collection v798');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=798/, 'Service Worker не кэширует Signature Collection v798');
...
console.log('Signature themes v798: Snow Leopard canvas OK');
