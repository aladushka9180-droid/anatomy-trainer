...
assert.match(provider, /provider-themes-signature\.css\?v=758/, 'Кабинет не подключает Signature Collection v758');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=758/, 'Service Worker не кэширует Signature Collection v758');
...
console.log('Signature themes v758: Snow Leopard canvas OK');
