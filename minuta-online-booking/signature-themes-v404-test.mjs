...
assert.match(provider, /provider-themes-signature\.css\?v=726/, 'Кабинет не подключает Signature Collection v726');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=726/, 'Service Worker не кэширует Signature Collection v726');
...
console.log('Signature themes v726: Snow Leopard canvas OK');
