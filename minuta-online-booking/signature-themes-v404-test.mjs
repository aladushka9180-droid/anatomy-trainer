...
assert.match(provider, /provider-themes-signature\.css\?v=636/, 'Кабинет не подключает Signature Collection v636');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=636/, 'Service Worker не кэширует Signature Collection v636');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=636/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=636/);
...
console.log('Signature themes v636: Snow Leopard canvas OK');
