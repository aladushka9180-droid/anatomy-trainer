...
assert.match(provider, /provider-themes-signature\.css\?v=656/, 'Кабинет не подключает Signature Collection v656');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=656/, 'Service Worker не кэширует Signature Collection v656');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=656/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=656/);
...
console.log('Signature themes v656: Snow Leopard canvas OK');
