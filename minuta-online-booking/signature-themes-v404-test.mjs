...
assert.match(provider, /provider-themes-signature\.css\?v=741/, 'Кабинет не подключает Signature Collection v741');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=741/, 'Service Worker не кэширует Signature Collection v741');
...
console.log('Signature themes v741: Snow Leopard canvas OK');
