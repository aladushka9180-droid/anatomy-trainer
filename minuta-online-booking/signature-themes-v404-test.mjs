...
assert.match(provider, /provider-themes-signature\.css\?v=577/, 'Кабинет не подключает Signature Collection v577');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=577/, 'Service Worker не кэширует Signature Collection v577');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=577/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=577/);
...
console.log('Signature themes v577: Snow Leopard canvas OK');
