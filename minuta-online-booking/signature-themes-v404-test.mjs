...
assert.match(provider, /provider-themes-signature\.css\?v=617/, 'Кабинет не подключает Signature Collection v617');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=617/, 'Service Worker не кэширует Signature Collection v617');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=617/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=617/);
...
console.log('Signature themes v617: Snow Leopard canvas OK');
