...
assert.match(provider, /provider-themes-signature\.css\?v=660/, 'Кабинет не подключает Signature Collection v660');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=660/, 'Service Worker не кэширует Signature Collection v660');
...
console.log('Signature themes v660: Snow Leopard canvas OK');
