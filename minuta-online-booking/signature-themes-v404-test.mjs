...
assert.match(provider, /provider-themes-signature\.css\?v=804/, 'Кабинет не подключает Signature Collection v804');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=804/, 'Service Worker не кэширует Signature Collection v804');
...
console.log('Signature themes v804: Snow Leopard canvas OK');
