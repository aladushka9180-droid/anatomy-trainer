...
assert.match(provider, /provider-themes-signature\.css\?v=748/, 'Кабинет не подключает Signature Collection v748');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=748/, 'Service Worker не кэширует Signature Collection v748');
...
console.log('Signature themes v748: Snow Leopard canvas OK');
