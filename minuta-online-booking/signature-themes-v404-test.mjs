...
assert.match(provider, /provider-themes-signature\.css\?v=501/, 'Кабинет не подключает Signature Collection v501');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=501/, 'Service Worker не кэширует Signature Collection v501');
...
console.log('Signature themes v501: 13 unified themes OK');
