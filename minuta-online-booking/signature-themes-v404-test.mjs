...
assert.match(provider, /provider-themes-signature\.css\?v=638/, 'Кабинет не подключает Signature Collection v638');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=638/, 'Service Worker не кэширует Signature Collection v638');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=638/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=638/);
...
console.log('Signature themes v638: Snow Leopard canvas OK');
