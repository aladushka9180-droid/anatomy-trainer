...
assert.match(provider, /provider-themes-signature\.css\?v=734/, 'Кабинет не подключает Signature Collection v734');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=734/, 'Service Worker не кэширует Signature Collection v734');
...
console.log('Signature themes v734: Snow Leopard canvas OK');
