...
assert.match(provider, /provider-themes-signature\.css\?v=807/, 'Кабинет не подключает Signature Collection v807');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=807/, 'Service Worker не кэширует Signature Collection v807');
...
console.log('Signature themes v807: Snow Leopard canvas OK');
