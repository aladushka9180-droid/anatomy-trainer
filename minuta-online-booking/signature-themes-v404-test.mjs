...
assert.match(provider, /provider-themes-signature\.css\?v=792/, 'Кабинет не подключает Signature Collection v792');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=792/, 'Service Worker не кэширует Signature Collection v792');
...
console.log('Signature themes v792: Snow Leopard canvas OK');
