...
assert.match(provider, /provider-themes-signature\.css\?v=693/, 'Кабинет не подключает Signature Collection v693');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=693/, 'Service Worker не кэширует Signature Collection v693');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=693/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=693/);
...
console.log('Signature themes v693: Snow Leopard canvas OK');
