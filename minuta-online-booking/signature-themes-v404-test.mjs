...
assert.match(provider, /provider-themes-signature\.css\?v=631/, 'Кабинет не подключает Signature Collection v631');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=631/, 'Service Worker не кэширует Signature Collection v631');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=631/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=631/);
...
console.log('Signature themes v631: Snow Leopard canvas OK');
