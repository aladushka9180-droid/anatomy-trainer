...
assert.match(provider, /provider-themes-signature\.css\?v=629/, 'Кабинет не подключает Signature Collection v629');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=629/, 'Service Worker не кэширует Signature Collection v629');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=629/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=629/);
...
console.log('Signature themes v629: Snow Leopard canvas OK');
