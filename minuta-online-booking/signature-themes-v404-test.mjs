...
assert.match(provider, /provider-themes-signature\.css\?v=615/, 'Кабинет не подключает Signature Collection v615');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=615/, 'Service Worker не кэширует Signature Collection v615');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=615/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=615/);
...
console.log('Signature themes v615: Snow Leopard canvas OK');
