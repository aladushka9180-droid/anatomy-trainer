...
assert.match(provider, /provider-themes-signature\.css\?v=763/, 'Кабинет не подключает Signature Collection v763');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=763/, 'Service Worker не кэширует Signature Collection v763');
...
console.log('Signature themes v763: Snow Leopard canvas OK');
