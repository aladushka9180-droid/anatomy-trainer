...
assert.match(provider, /provider-themes-signature\.css\?v=608/, 'Кабинет не подключает Signature Collection v608');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=608/, 'Service Worker не кэширует Signature Collection v608');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=608/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=608/);
...
console.log('Signature themes v608: Snow Leopard canvas OK');
