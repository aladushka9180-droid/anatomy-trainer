...
assert.match(provider, /provider-themes-signature\.css\?v=733/, 'Кабинет не подключает Signature Collection v733');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=733/, 'Service Worker не кэширует Signature Collection v733');
...
console.log('Signature themes v733: Snow Leopard canvas OK');
