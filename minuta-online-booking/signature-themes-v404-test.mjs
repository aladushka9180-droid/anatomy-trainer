...
assert.match(provider, /provider-themes-signature\.css\?v=412/, 'Кабинет не подключает Signature Collection v412');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=412/, 'Service Worker не кэширует Signature Collection v412');

console.log('Signature themes v412: 8 unified themes OK');
