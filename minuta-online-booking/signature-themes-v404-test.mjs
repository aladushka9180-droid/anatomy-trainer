...
assert.match(provider, /provider-themes-signature\.css\?v=430/, 'Кабинет не подключает Signature Collection v430');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=430/, 'Service Worker не кэширует Signature Collection v430');

console.log('Signature themes v430: 8 unified themes OK');
