...
assert.match(provider, /provider-themes-signature\.css\?v=464/, 'Кабинет не подключает Signature Collection v464');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=464/, 'Service Worker не кэширует Signature Collection v464');
...
console.log('Signature themes v464: 13 unified themes OK');
