...
assert.match(provider, /provider-themes-signature\.css\?v=794/, 'Кабинет не подключает Signature Collection v794');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=794/, 'Service Worker не кэширует Signature Collection v794');
...
console.log('Signature themes v794: Snow Leopard canvas OK');
