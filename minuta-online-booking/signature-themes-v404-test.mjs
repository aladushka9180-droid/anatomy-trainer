...
assert.match(provider, /provider-themes-signature\.css\?v=766/, 'Кабинет не подключает Signature Collection v766');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=766/, 'Service Worker не кэширует Signature Collection v766');
...
console.log('Signature themes v766: Snow Leopard canvas OK');
