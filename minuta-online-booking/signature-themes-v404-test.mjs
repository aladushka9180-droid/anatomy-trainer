...
assert.match(provider, /provider-themes-signature\.css\?v=777/, 'Кабинет не подключает Signature Collection v777');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=777/, 'Service Worker не кэширует Signature Collection v777');
...
console.log('Signature themes v777: Snow Leopard canvas OK');
