...
assert.match(provider, /provider-themes-signature\.css\?v=625/, 'Кабинет не подключает Signature Collection v625');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=625/, 'Service Worker не кэширует Signature Collection v625');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=625/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=625/);
...
console.log('Signature themes v625: Snow Leopard canvas OK');
