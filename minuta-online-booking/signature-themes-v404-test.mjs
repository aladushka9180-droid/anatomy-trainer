...
assert.match(provider, /provider-themes-signature\.css\?v=469/, 'Кабинет не подключает Signature Collection v469');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=469/, 'Service Worker не кэширует Signature Collection v469');
...
console.log('Signature themes v469: 13 unified themes OK');
