...
assert.match(provider, /provider-themes-signature\.css\?v=490/, 'Кабинет не подключает Signature Collection v490');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=490/, 'Service Worker не кэширует Signature Collection v490');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-v1\.webp\?v=490/);
...
console.log('Signature themes v490: 13 unified themes OK');
