...
assert.match(provider, /provider-themes-signature\.css\?v=714/, 'Кабинет не подключает Signature Collection v714');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=714/, 'Service Worker не кэширует Signature Collection v714');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=714/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=714/);
...
console.log('Signature themes v714: Snow Leopard canvas OK');
