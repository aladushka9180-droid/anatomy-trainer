...
assert.match(provider, /provider-themes-signature\.css\?v=620/, 'Кабинет не подключает Signature Collection v620');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=620/, 'Service Worker не кэширует Signature Collection v620');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=620/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=620/);
...
console.log('Signature themes v620: Snow Leopard canvas OK');
