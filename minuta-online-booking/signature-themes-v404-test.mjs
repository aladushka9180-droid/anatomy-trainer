...
assert.match(provider, /provider-themes-signature\.css\?v=581/, 'Кабинет не подключает Signature Collection v581');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=581/, 'Service Worker не кэширует Signature Collection v581');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=581/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=581/);
...
console.log('Signature themes v581: Snow Leopard canvas OK');
