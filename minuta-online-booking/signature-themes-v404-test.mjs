...
assert.match(provider, /provider-themes-signature\.css\?v=676/, 'Кабинет не подключает Signature Collection v676');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=676/, 'Service Worker не кэширует Signature Collection v676');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=676/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=676/);
...
console.log('Signature themes v676: Snow Leopard canvas OK');
