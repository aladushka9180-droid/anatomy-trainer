...
assert.match(provider, /provider-themes-signature\.css\?v=737/, 'Кабинет не подключает Signature Collection v737');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=737/, 'Service Worker не кэширует Signature Collection v737');
...
console.log('Signature themes v737: Snow Leopard canvas OK');
