...
assert.match(provider, /provider-themes-signature\.css\?v=698/, 'Кабинет не подключает Signature Collection v698');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=698/, 'Service Worker не кэширует Signature Collection v698');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=698/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=698/);
...
console.log('Signature themes v698: Snow Leopard canvas OK');
