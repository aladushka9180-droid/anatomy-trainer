...
assert.match(provider, /provider-themes-signature\.css\?v=795/, 'Кабинет не подключает Signature Collection v795');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=795/, 'Service Worker не кэширует Signature Collection v795');
...
console.log('Signature themes v795: Snow Leopard canvas OK');
