...
assert.match(provider, /provider-themes-signature\.css\?v=651/, 'Кабинет не подключает Signature Collection v651');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=651/, 'Service Worker не кэширует Signature Collection v651');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=651/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=651/);
...
console.log('Signature themes v651: Snow Leopard canvas OK');
