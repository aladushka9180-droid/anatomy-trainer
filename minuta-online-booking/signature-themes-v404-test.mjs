...
assert.match(provider, /provider-themes-signature\.css\?v=747/, 'Кабинет не подключает Signature Collection v747');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=747/, 'Service Worker не кэширует Signature Collection v747');
...
console.log('Signature themes v747: Snow Leopard canvas OK');
