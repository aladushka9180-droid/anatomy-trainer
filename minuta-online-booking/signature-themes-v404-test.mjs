...
assert.match(provider, /provider-themes-signature\.css\?v=746/, 'Кабинет не подключает Signature Collection v746');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=746/, 'Service Worker не кэширует Signature Collection v746');
...
console.log('Signature themes v746: Snow Leopard canvas OK');
