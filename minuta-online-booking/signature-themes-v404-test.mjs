...
assert.match(provider, /provider-themes-signature\.css\?v=611/, 'Кабинет не подключает Signature Collection v611');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=611/, 'Service Worker не кэширует Signature Collection v611');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=611/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=611/);
...
console.log('Signature themes v611: Snow Leopard canvas OK');
