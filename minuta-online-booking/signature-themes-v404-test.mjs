...
assert.match(provider, /provider-themes-signature\.css\?v=781/, 'Кабинет не подключает Signature Collection v781');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=781/, 'Service Worker не кэширует Signature Collection v781');
...
console.log('Signature themes v781: Snow Leopard canvas OK');
