...
assert.match(provider, /provider-themes-signature\.css\?v=497/, 'Кабинет не подключает Signature Collection v497');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=497/, 'Service Worker не кэширует Signature Collection v497');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=497/);
...
console.log('Signature themes v497: 13 unified themes OK');
