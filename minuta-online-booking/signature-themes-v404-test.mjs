...
assert.match(provider, /provider-themes-signature\.css\?v=665/, 'Кабинет не подключает Signature Collection v665');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=665/, 'Service Worker не кэширует Signature Collection v665');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=665/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=665/);
...
console.log('Signature themes v665: Snow Leopard canvas OK');
