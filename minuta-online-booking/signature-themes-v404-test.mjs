...
assert.match(provider, /provider-themes-signature\.css\?v=779/, 'Кабинет не подключает Signature Collection v779');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=779/, 'Service Worker не кэширует Signature Collection v779');
...
console.log('Signature themes v779: Snow Leopard canvas OK');
