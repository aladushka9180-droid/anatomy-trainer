...
assert.match(provider, /provider-themes-signature\.css\?v=627/, 'Кабинет не подключает Signature Collection v627');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=627/, 'Service Worker не кэширует Signature Collection v627');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=627/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=627/);
...
console.log('Signature themes v627: Snow Leopard canvas OK');
