...
assert.match(provider, /provider-themes-signature\.css\?v=756/, 'Кабинет не подключает Signature Collection v756');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=756/, 'Service Worker не кэширует Signature Collection v756');
...
console.log('Signature themes v756: Snow Leopard canvas OK');
