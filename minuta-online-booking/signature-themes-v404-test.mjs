...
assert.match(provider, /provider-themes-signature\.css\?v=458/, 'Кабинет не подключает Signature Collection v458');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=458/, 'Service Worker не кэширует Signature Collection v458');
...
console.log('Signature themes v458: 13 unified themes OK');
