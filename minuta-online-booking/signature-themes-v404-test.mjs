...
assert.match(provider, /provider-themes-signature\.css\?v=473/, 'Кабинет не подключает Signature Collection v473');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=473/, 'Service Worker не кэширует Signature Collection v473');
...
console.log('Signature themes v473: 13 unified themes OK');
