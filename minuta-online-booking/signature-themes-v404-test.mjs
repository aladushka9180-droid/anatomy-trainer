...
assert.match(provider, /provider-themes-signature\.css\?v=579/, 'Кабинет не подключает Signature Collection v579');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=579/, 'Service Worker не кэширует Signature Collection v579');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=579/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=579/);
...
console.log('Signature themes v579: Snow Leopard canvas OK');
