...
assert.match(provider, /provider-themes-signature\.css\?v=759/, 'Кабинет не подключает Signature Collection v759');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=759/, 'Service Worker не кэширует Signature Collection v759');
...
console.log('Signature themes v759: Snow Leopard canvas OK');
