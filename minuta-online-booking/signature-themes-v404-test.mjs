...
assert.match(provider, /provider-themes-signature\.css\?v=694/, 'Кабинет не подключает Signature Collection v694');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=694/, 'Service Worker не кэширует Signature Collection v694');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=694/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=694/);
...
console.log('Signature themes v694: Snow Leopard canvas OK');
