...
assert.match(provider, /provider-themes-signature\.css\?v=468/, 'Кабинет не подключает Signature Collection v468');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=468/, 'Service Worker не кэширует Signature Collection v468');
...
console.log('Signature themes v468: 13 unified themes OK');
