...
assert.match(provider, /provider-themes-signature\.css\?v=707/, 'Кабинет не подключает Signature Collection v707');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=707/, 'Service Worker не кэширует Signature Collection v707');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=707/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=707/);
...
console.log('Signature themes v707: Snow Leopard canvas OK');
