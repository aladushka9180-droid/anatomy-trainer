...
assert.match(provider, /provider-themes-signature\.css\?v=744/, 'Кабинет не подключает Signature Collection v744');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=744/, 'Service Worker не кэширует Signature Collection v744');
...
console.log('Signature themes v744: Snow Leopard canvas OK');
