...
assert.match(provider, /provider-themes-signature\.css\?v=797/, 'Кабинет не подключает Signature Collection v797');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=797/, 'Service Worker не кэширует Signature Collection v797');
...
console.log('Signature themes v797: Snow Leopard canvas OK');
