...
assert.match(provider, /provider-themes-signature\.css\?v=771/, 'Кабинет не подключает Signature Collection v771');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=771/, 'Service Worker не кэширует Signature Collection v771');
...
console.log('Signature themes v771: Snow Leopard canvas OK');
