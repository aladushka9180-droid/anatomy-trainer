...
assert.match(provider, /provider-themes-signature\.css\?v=575/, 'Кабинет не подключает Signature Collection v575');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=575/, 'Service Worker не кэширует Signature Collection v575');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=575/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=575/);
...
console.log('Signature themes v575: Snow Leopard canvas OK');
