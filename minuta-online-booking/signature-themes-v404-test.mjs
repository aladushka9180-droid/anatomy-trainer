...
assert.match(provider, /provider-themes-signature\.css\?v=775/, 'Кабинет не подключает Signature Collection v775');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=775/, 'Service Worker не кэширует Signature Collection v775');
...
console.log('Signature themes v775: Snow Leopard canvas OK');
