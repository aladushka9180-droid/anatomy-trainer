...
assert.match(provider, /provider-themes-signature\.css\?v=715/, 'Кабинет не подключает Signature Collection v715');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=715/, 'Service Worker не кэширует Signature Collection v715');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=715/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=715/);
...
console.log('Signature themes v715: Snow Leopard canvas OK');
