...
assert.match(provider, /provider-themes-signature\.css\?v=459/, 'Кабинет не подключает Signature Collection v459');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=459/, 'Service Worker не кэширует Signature Collection v459');
...
console.log('Signature themes v459: 13 unified themes OK');
