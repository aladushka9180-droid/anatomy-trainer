...
assert.match(provider, /provider-themes-signature\.css\?v=590/, 'Кабинет не подключает Signature Collection v590');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=590/, 'Service Worker не кэширует Signature Collection v590');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=590/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=590/);
...
console.log('Signature themes v590: Snow Leopard canvas OK');
