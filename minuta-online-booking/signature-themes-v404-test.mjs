...
assert.match(provider, /provider-themes-signature\.css\?v=655/, 'Кабинет не подключает Signature Collection v655');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=655/, 'Service Worker не кэширует Signature Collection v655');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=655/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=655/);
