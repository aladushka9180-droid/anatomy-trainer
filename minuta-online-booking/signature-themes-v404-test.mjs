...
assert.match(provider, /provider-themes-signature\.css\?v=653/, 'Кабинет не подключает Signature Collection v653');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=653/, 'Service Worker не кэширует Signature Collection v653');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=653/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=653/);
...
console.log('Signature themes v653: Snow Leopard canvas OK');
