...
assert.match(provider, /provider-themes-signature\.css\?v=765/, 'Кабинет не подключает Signature Collection v765');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=765/, 'Service Worker не кэширует Signature Collection v765');
...
console.log('Signature themes v765: Snow Leopard canvas OK');
