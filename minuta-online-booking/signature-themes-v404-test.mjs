...
assert.match(provider, /provider-themes-signature\.css\?v=784/, 'Кабинет не подключает Signature Collection v784');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=784/, 'Service Worker не кэширует Signature Collection v784');
...
console.log('Signature themes v784: Snow Leopard canvas OK');
