...
assert.match(provider, /provider-themes-signature\.css\?v=465/, 'Кабинет не подключает Signature Collection v465');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=465/, 'Service Worker не кэширует Signature Collection v465');
...
console.log('Signature themes v465: 13 unified themes OK');
