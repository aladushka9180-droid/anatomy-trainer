...
assert.match(provider, /provider-themes-signature\.css\?v=767/, 'Кабинет не подключает Signature Collection v767');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=767/, 'Service Worker не кэширует Signature Collection v767');
...
console.log('Signature themes v767: Snow Leopard canvas OK');
