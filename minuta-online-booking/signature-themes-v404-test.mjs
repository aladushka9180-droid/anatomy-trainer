...
assert.match(provider, /provider-themes-signature\.css\?v=805/, 'Кабинет не подключает Signature Collection v805');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=805/, 'Service Worker не кэширует Signature Collection v805');
...
console.log('Signature themes v805: Snow Leopard canvas OK');
