...
assert.match(provider, /provider-themes-signature\.css\?v=757/, 'Кабинет не подключает Signature Collection v757');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=757/, 'Service Worker не кэширует Signature Collection v757');
...
console.log('Signature themes v757: Snow Leopard canvas OK');
