...
assert.match(provider, /provider-themes-signature\.css\?v=614/, 'Кабинет не подключает Signature Collection v614');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=614/, 'Service Worker не кэширует Signature Collection v614');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=614/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=614/);
...
console.log('Signature themes v614: Snow Leopard canvas OK');
