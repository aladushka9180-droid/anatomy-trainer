...
assert.match(provider, /provider-themes-signature\.css\?v=658/, 'Кабинет не подключает Signature Collection v658');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=658/, 'Service Worker не кэширует Signature Collection v658');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=658/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=658/);
...
console.log('Signature themes v658: Snow Leopard canvas OK');
