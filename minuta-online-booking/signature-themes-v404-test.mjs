...
assert.match(provider, /provider-themes-signature\.css\?v=457/, 'Кабинет не подключает Signature Collection v457');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=457/, 'Service Worker не кэширует Signature Collection v457');
...
console.log('Signature themes v457: 13 unified themes OK');
