...
assert.match(provider, /provider-themes-signature\.css\?v=467/, 'Кабинет не подключает Signature Collection v467');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=467/, 'Service Worker не кэширует Signature Collection v467');
...
console.log('Signature themes v467: 13 unified themes OK');
