...
assert.match(provider, /provider-themes-signature\.css\?v=711/, 'Кабинет не подключает Signature Collection v711');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=711/, 'Service Worker не кэширует Signature Collection v711');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=711/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=711/);
...
console.log('Signature themes v711: Snow Leopard canvas OK');
