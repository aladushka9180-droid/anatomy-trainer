...
assert.match(provider, /provider-themes-signature\.css\?v=576/, 'Кабинет не подключает Signature Collection v576');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=576/, 'Service Worker не кэширует Signature Collection v576');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=576/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=576/);
...
console.log('Signature themes v576: Snow Leopard canvas OK');
