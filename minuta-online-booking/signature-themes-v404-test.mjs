...
assert.match(provider, /provider-themes-signature\.css\?v=713/, 'Кабинет не подключает Signature Collection v713');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=713/, 'Service Worker не кэширует Signature Collection v713');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=713/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=713/);
...
console.log('Signature themes v713: Snow Leopard canvas OK');
