...
assert.match(provider, /provider-themes-signature\.css\?v=796/, 'Кабинет не подключает Signature Collection v796');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=796/, 'Service Worker не кэширует Signature Collection v796');
...
console.log('Signature themes v796: Snow Leopard canvas OK');
