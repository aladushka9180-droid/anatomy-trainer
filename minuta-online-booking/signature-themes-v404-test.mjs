...
assert.match(provider, /provider-themes-signature\.css\?v=790/, 'Кабинет не подключает Signature Collection v790');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=790/, 'Service Worker не кэширует Signature Collection v790');
...
console.log('Signature themes v790: Snow Leopard canvas OK');
