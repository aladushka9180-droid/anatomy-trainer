...
assert.match(provider, /provider-themes-signature\.css\?v=785/, 'Кабинет не подключает Signature Collection v785');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=785/, 'Service Worker не кэширует Signature Collection v785');
...
console.log('Signature themes v785: Snow Leopard canvas OK');
