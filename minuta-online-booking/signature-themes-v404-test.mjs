...
assert.match(provider, /provider-themes-signature\.css\?v=678/, 'Кабинет не подключает Signature Collection v678');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=678/, 'Service Worker не кэширует Signature Collection v678');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=678/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=678/);
...
console.log('Signature themes v678: Snow Leopard canvas OK');
