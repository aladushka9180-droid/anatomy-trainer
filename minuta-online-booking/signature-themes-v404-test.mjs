...
assert.match(provider, /provider-themes-signature\.css\?v=782/, 'Кабинет не подключает Signature Collection v782');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=782/, 'Service Worker не кэширует Signature Collection v782');
...
console.log('Signature themes v782: Snow Leopard canvas OK');
