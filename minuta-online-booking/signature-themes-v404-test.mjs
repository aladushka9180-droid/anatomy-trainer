...
assert.match(provider, /provider-themes-signature\.css\?v=730/, 'Кабинет не подключает Signature Collection v730');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=730/, 'Service Worker не кэширует Signature Collection v730');
...
console.log('Signature themes v730: Snow Leopard canvas OK');
