...
assert.match(provider, /provider-themes-signature\.css\?v=645/, 'Кабинет не подключает Signature Collection v645');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=645/, 'Service Worker не кэширует Signature Collection v645');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=645/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=645/);
...
console.log('Signature themes v645: Snow Leopard canvas OK');
