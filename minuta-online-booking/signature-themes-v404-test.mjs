...
assert.match(provider, /provider-themes-signature\.css\?v=680/, 'Кабинет не подключает Signature Collection v680');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=680/, 'Service Worker не кэширует Signature Collection v680');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=680/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=680/);
...
console.log('Signature themes v680: Snow Leopard canvas OK');
