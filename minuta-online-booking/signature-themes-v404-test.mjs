...
assert.match(provider, /provider-themes-signature\.css\?v=597/, 'Кабинет не подключает Signature Collection v597');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=597/, 'Service Worker не кэширует Signature Collection v597');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=597/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=597/);
...
console.log('Signature themes v597: Snow Leopard canvas OK');
