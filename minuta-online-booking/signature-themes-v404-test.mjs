...
assert.match(provider, /provider-themes-signature\.css\?v=778/, 'Кабинет не подключает Signature Collection v778');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=778/, 'Service Worker не кэширует Signature Collection v778');
...
console.log('Signature themes v778: Snow Leopard canvas OK');
