...
assert.match(provider, /provider-themes-signature\.css\?v=768/, 'Кабинет не подключает Signature Collection v768');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=768/, 'Service Worker не кэширует Signature Collection v768');
...
console.log('Signature themes v768: Snow Leopard canvas OK');
