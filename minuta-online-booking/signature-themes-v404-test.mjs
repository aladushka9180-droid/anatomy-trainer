...
assert.match(provider, /provider-themes-signature\.css\?v=697/, 'Кабинет не подключает Signature Collection v697');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=697/, 'Service Worker не кэширует Signature Collection v697');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=697/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=697/);
...
console.log('Signature themes v697: Snow Leopard canvas OK');
