...
assert.match(provider, /provider-themes-signature\.css\?v=573/, 'Кабинет не подключает Signature Collection v573');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=573/, 'Service Worker не кэширует Signature Collection v573');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=573/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=573/);
...
console.log('Signature themes v573: Snow Leopard canvas OK');
