...
assert.match(provider, /provider-themes-signature\.css\?v=722/, 'Кабинет не подключает Signature Collection v722');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=722/, 'Service Worker не кэширует Signature Collection v722');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=722/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=722/);
...
console.log('Signature themes v722: Snow Leopard canvas OK');
