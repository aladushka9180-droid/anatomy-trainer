...
assert.match(provider, /provider-themes-signature\.css\?v=718/, 'Кабинет не подключает Signature Collection v718');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=718/, 'Service Worker не кэширует Signature Collection v718');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=718/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=718/);
...
console.log('Signature themes v718: Snow Leopard canvas OK');
