...
assert.match(provider, /provider-themes-signature\.css\?v=802/, 'Кабинет не подключает Signature Collection v802');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=802/, 'Service Worker не кэширует Signature Collection v802');
...
console.log('Signature themes v802: Snow Leopard canvas OK');
