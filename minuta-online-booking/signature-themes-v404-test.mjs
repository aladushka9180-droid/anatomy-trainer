...
assert.match(provider, /provider-themes-signature\.css\?v=472/, 'Кабинет не подключает Signature Collection v472');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=472/, 'Service Worker не кэширует Signature Collection v472');
...
console.log('Signature themes v472: 13 unified themes OK');
