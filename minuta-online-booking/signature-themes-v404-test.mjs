...
assert.match(provider, /provider-themes-signature\.css\?v=725/, 'Кабинет не подключает Signature Collection v725');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=725/, 'Service Worker не кэширует Signature Collection v725');
...
console.log('Signature themes v725: Snow Leopard canvas OK');
