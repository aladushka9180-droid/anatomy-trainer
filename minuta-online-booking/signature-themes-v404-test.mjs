...
assert.match(provider, /provider-themes-signature\.css\?v=716/, 'Кабинет не подключает Signature Collection v716');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=716/, 'Service Worker не кэширует Signature Collection v716');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=716/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=716/);
...
console.log('Signature themes v716: Snow Leopard canvas OK');
