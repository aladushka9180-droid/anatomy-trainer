...
assert.match(provider, /provider-themes-signature\.css\?v=596/, 'Кабинет не подключает Signature Collection v596');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=596/, 'Service Worker не кэширует Signature Collection v596');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=596/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=596/);
...
console.log('Signature themes v596: Snow Leopard canvas OK');
