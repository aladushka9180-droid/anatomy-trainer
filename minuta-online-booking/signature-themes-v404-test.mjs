...
assert.match(provider, /provider-themes-signature\.css\?v=776/, 'Кабинет не подключает Signature Collection v776');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=776/, 'Service Worker не кэширует Signature Collection v776');
...
console.log('Signature themes v776: Snow Leopard canvas OK');
