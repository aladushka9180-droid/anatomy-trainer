...
assert.match(provider, /provider-themes-signature\.css\?v=618/, 'Кабинет не подключает Signature Collection v618');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=618/, 'Service Worker не кэширует Signature Collection v618');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=618/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=618/);
...
console.log('Signature themes v618: Snow Leopard canvas OK');
