...
assert.match(provider, /provider-themes-signature\.css\?v=742/, 'Кабинет не подключает Signature Collection v742');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=742/, 'Service Worker не кэширует Signature Collection v742');
...
console.log('Signature themes v742: Snow Leopard canvas OK');
