...
assert.match(provider, /provider-themes-signature\.css\?v=675/, 'Кабинет не подключает Signature Collection v675');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=675/, 'Service Worker не кэширует Signature Collection v675');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=675/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=675/);
...
console.log('Signature themes v675: Snow Leopard canvas OK');
