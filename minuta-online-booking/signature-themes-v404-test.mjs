...
assert.match(provider, /provider-themes-signature\.css\?v=724/, 'Кабинет не подключает Signature Collection v724');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=724/, 'Service Worker не кэширует Signature Collection v724');
...
console.log('Signature themes v724: Snow Leopard canvas OK');
