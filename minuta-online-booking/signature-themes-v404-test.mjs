...
assert.match(provider, /provider-themes-signature\.css\?v=652/, 'Кабинет не подключает Signature Collection v652');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=652/, 'Service Worker не кэширует Signature Collection v652');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=652/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=652/);
...
console.log('Signature themes v652: Snow Leopard canvas OK');
