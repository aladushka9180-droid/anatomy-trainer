...
assert.match(provider, /provider-themes-signature\.css\?v=727/, 'Кабинет не подключает Signature Collection v727');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=727/, 'Service Worker не кэширует Signature Collection v727');
...
console.log('Signature themes v727: Snow Leopard canvas OK');
