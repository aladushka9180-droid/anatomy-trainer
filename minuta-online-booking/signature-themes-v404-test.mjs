...
assert.match(provider, /provider-themes-signature\.css\?v=593/, 'Кабинет не подключает Signature Collection v593');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=593/, 'Service Worker не кэширует Signature Collection v593');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=593/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=593/);
...
console.log('Signature themes v593: Snow Leopard canvas OK');
