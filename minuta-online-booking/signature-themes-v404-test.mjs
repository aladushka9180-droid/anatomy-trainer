...
assert.match(provider, /provider-themes-signature\.css\?v=450/, 'Кабинет не подключает Signature Collection v450');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=450/, 'Service Worker не кэширует Signature Collection v450');
...
console.log('Signature themes v450: 13 unified themes OK');
