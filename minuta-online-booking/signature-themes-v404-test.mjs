...
assert.match(provider, /provider-themes-signature\.css\?v=622/, 'Кабинет не подключает Signature Collection v622');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=622/, 'Service Worker не кэширует Signature Collection v622');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=622/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=622/);
...
console.log('Signature themes v622: Snow Leopard canvas OK');
