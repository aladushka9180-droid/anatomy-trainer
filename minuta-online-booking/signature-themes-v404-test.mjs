...
assert.match(provider, /provider-themes-signature\.css\?v=616/, 'Кабинет не подключает Signature Collection v616');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=616/, 'Service Worker не кэширует Signature Collection v616');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=616/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=616/);
...
console.log('Signature themes v616: Snow Leopard canvas OK');
