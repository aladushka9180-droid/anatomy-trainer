...
assert.match(provider, /provider-themes-signature\.css\?v=649/, 'Кабинет не подключает Signature Collection v649');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=649/, 'Service Worker не кэширует Signature Collection v649');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=649/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=649/);
...
console.log('Signature themes v649: Snow Leopard canvas OK');
