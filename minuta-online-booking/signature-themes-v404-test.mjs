...
assert.match(provider, /provider-themes-signature\.css\?v=630/, 'Кабинет не подключает Signature Collection v630');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=630/, 'Service Worker не кэширует Signature Collection v630');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=630/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=630/);
...
console.log('Signature themes v630: Snow Leopard canvas OK');
