...
assert.match(provider, /provider-themes-signature\.css\?v=642/, 'Кабинет не подключает Signature Collection v642');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=642/, 'Service Worker не кэширует Signature Collection v642');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=642/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=642/);
...
console.log('Signature themes v642: Snow Leopard canvas OK');
