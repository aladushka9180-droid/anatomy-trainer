...
assert.match(provider, /provider-themes-signature\.css\?v=491/, 'Кабинет не подключает Signature Collection v491');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=491/, 'Service Worker не кэширует Signature Collection v491');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-v1\.webp\?v=491/);
...
console.log('Signature themes v491: 13 unified themes OK');
