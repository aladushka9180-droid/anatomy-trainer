...
assert.match(provider, /provider-themes-signature\.css\?v=687/, 'Кабинет не подключает Signature Collection v687');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=687/, 'Service Worker не кэширует Signature Collection v687');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=687/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=687/);
...
console.log('Signature themes v687: Snow Leopard canvas OK');
