...
assert.match(provider, /provider-themes-signature\.css\?v=632/, 'Кабинет не подключает Signature Collection v632');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=632/, 'Service Worker не кэширует Signature Collection v632');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=632/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=632/);
...
console.log('Signature themes v632: Snow Leopard canvas OK');
