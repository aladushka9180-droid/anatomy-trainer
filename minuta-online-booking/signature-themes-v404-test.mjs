...
assert.match(provider, /provider-themes-signature\.css\?v=764/, 'Кабинет не подключает Signature Collection v764');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=764/, 'Service Worker не кэширует Signature Collection v764');
...
console.log('Signature themes v764: Snow Leopard canvas OK');
