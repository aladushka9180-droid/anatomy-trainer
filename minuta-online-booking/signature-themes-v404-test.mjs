...
assert.match(provider, /provider-themes-signature\.css\?v=628/, 'Кабинет не подключает Signature Collection v628');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=628/, 'Service Worker не кэширует Signature Collection v628');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=628/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=628/);
...
console.log('Signature themes v628: Snow Leopard canvas OK');
