...
assert.match(provider, /provider-themes-signature\.css\?v=496/, 'Кабинет не подключает Signature Collection v496');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=496/, 'Service Worker не кэширует Signature Collection v496');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=496/);
...
console.log('Signature themes v496: 13 unified themes OK');
