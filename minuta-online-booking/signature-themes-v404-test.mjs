...
assert.match(provider, /provider-themes-signature\.css\?v=669/, 'Кабинет не подключает Signature Collection v669');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=669/, 'Service Worker не кэширует Signature Collection v669');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=669/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=669/);
...
console.log('Signature themes v669: Snow Leopard canvas OK');
