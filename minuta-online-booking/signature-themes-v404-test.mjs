...
assert.match(provider, /provider-themes-signature\.css\?v=786/, 'Кабинет не подключает Signature Collection v786');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=786/, 'Service Worker не кэширует Signature Collection v786');
...
console.log('Signature themes v786: Snow Leopard canvas OK');
