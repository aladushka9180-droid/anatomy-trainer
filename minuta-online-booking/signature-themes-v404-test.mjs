...
assert.match(provider, /provider-themes-signature\.css\?v=683/, 'Кабинет не подключает Signature Collection v683');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=683/, 'Service Worker не кэширует Signature Collection v683');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=683/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=683/);
...
console.log('Signature themes v683: Snow Leopard canvas OK');
