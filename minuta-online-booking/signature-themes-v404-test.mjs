...
assert.match(provider, /provider-themes-signature\.css\?v=613/, 'Кабинет не подключает Signature Collection v613');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=613/, 'Service Worker не кэширует Signature Collection v613');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=613/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=613/);
...
console.log('Signature themes v613: Snow Leopard canvas OK');
