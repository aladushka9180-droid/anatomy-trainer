...
assert.match(provider, /provider-themes-signature\.css\?v=637/, 'Кабинет не подключает Signature Collection v637');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=637/, 'Service Worker не кэширует Signature Collection v637');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=637/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=637/);
...
console.log('Signature themes v637: Snow Leopard canvas OK');
