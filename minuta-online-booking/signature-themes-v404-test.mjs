...
assert.match(provider, /provider-themes-signature\.css\?v=721/, 'Кабинет не подключает Signature Collection v721');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=721/, 'Service Worker не кэширует Signature Collection v721');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=721/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=721/);
...
console.log('Signature themes v721: Snow Leopard canvas OK');
