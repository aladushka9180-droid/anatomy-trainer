...
assert.match(provider, /provider-themes-signature\.css\?v=646/, 'Кабинет не подключает Signature Collection v646');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=646/, 'Service Worker не кэширует Signature Collection v646');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=646/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=646/);
...
console.log('Signature themes v646: Snow Leopard canvas OK');
