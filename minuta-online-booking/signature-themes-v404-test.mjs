...
assert.match(provider, /provider-themes-signature\.css\?v=699/, 'Кабинет не подключает Signature Collection v699');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=699/, 'Service Worker не кэширует Signature Collection v699');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=699/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=699/);
...
console.log('Signature themes v699: Snow Leopard canvas OK');
