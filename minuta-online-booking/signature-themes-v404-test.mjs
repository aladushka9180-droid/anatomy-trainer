...
assert.match(provider, /provider-themes-signature\.css\?v=808/, 'Кабинет не подключает Signature Collection v808');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=808/, 'Service Worker не кэширует Signature Collection v808');
...
console.log('Signature themes v808: Snow Leopard canvas OK');
