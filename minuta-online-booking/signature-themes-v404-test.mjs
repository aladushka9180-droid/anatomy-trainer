...
assert.match(provider, /provider-themes-signature\.css\?v=607/, 'Кабинет не подключает Signature Collection v607');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=607/, 'Service Worker не кэширует Signature Collection v607');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=607/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=607/);
...
console.log('Signature themes v607: Snow Leopard canvas OK');
