...
assert.match(provider, /provider-themes-signature\.css\?v=592/, 'Кабинет не подключает Signature Collection v592');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=592/, 'Service Worker не кэширует Signature Collection v592');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=592/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=592/);
...
console.log('Signature themes v592: Snow Leopard canvas OK');
