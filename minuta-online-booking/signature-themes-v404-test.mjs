...
assert.match(provider, /provider-themes-signature\.css\?v=461/, 'Кабинет не подключает Signature Collection v461');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=461/, 'Service Worker не кэширует Signature Collection v461');
...
console.log('Signature themes v461: 13 unified themes OK');
