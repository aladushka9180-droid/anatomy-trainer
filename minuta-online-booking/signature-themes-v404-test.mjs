...
assert.match(provider, /provider-themes-signature\.css\?v=710/, 'Кабинет не подключает Signature Collection v710');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=710/, 'Service Worker не кэширует Signature Collection v710');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=710/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=710/);
...
console.log('Signature themes v710: Snow Leopard canvas OK');
