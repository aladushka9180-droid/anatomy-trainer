...
assert.match(provider, /provider-themes-signature\.css\?v=770/, 'Кабинет не подключает Signature Collection v770');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=770/, 'Service Worker не кэширует Signature Collection v770');
...
console.log('Signature themes v770: Snow Leopard canvas OK');
