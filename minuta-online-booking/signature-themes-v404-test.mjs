...
assert.match(provider, /provider-themes-signature\.css\?v=601/, 'Кабинет не подключает Signature Collection v601');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=601/, 'Service Worker не кэширует Signature Collection v601');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=601/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=601/);
...
console.log('Signature themes v601: Snow Leopard canvas OK');
