...
assert.match(provider, /provider-themes-signature\.css\?v=484/, 'Кабинет не подключает Signature Collection v484');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=484/, 'Service Worker не кэширует Signature Collection v484');
