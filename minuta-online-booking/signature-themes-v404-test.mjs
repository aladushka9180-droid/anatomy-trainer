...
assert.match(provider, /provider-themes-signature\.css\?v=803/, 'Кабинет не подключает Signature Collection v803');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=803/, 'Service Worker не кэширует Signature Collection v803');
...
console.log('Signature themes v803: Snow Leopard canvas OK');
