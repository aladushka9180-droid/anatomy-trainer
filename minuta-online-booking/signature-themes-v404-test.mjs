...
assert.match(provider, /provider-themes-signature\.css\?v=801/, 'Кабинет не подключает Signature Collection v801');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=801/, 'Service Worker не кэширует Signature Collection v801');
...
console.log('Signature themes v801: Snow Leopard canvas OK');
