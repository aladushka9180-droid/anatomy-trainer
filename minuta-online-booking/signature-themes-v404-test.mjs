...
assert.match(provider, /provider-themes-signature\.css\?v=623/, 'Кабинет не подключает Signature Collection v623');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=623/, 'Service Worker не кэширует Signature Collection v623');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=623/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=623/);
...
console.log('Signature themes v623: Snow Leopard canvas OK');
