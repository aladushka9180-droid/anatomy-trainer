...
assert.match(provider, /provider-themes-signature\.css\?v=488/, 'Кабинет не подключает Signature Collection v488');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=488/, 'Service Worker не кэширует Signature Collection v488');
...
console.log('Signature themes v488: 13 unified themes OK');
