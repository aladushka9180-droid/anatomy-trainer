...
assert.match(provider, /provider-themes-signature\.css\?v=701/, 'Кабинет не подключает Signature Collection v701');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=701/, 'Service Worker не кэширует Signature Collection v701');
...
assert.match(snowCanvas, /provider-snow-leopard-continuous-4k-v3\.webp\?v=701/);
...
assert.match(mobileSnow, /provider-snow-leopard-mobile-v1\.png\?v=701/);
...
console.log('Signature themes v701: Snow Leopard canvas OK');
