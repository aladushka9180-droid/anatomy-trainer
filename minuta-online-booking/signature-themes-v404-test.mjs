...
assert.match(provider, /provider-themes-signature\.css\?v=806/, 'Кабинет не подключает Signature Collection v806');
assert.match(worker, /\.\/provider-themes-signature\.css\?v=806/, 'Service Worker не кэширует Signature Collection v806');
...
console.log('Signature themes v806: Snow Leopard canvas OK');
