...
const ASSETS = [
  ...
  './styles.css?v=167',
  './config.js?v=167',
  './reliability.js?v=167',
  './app.js?v=167',
  './resource-management.js?v=167',
  './shift-management.js?v=167',
  './organization.js?v=167',
  './payroll-management.js?v=167',
  './benefit-management.js?v=167',
  './loyalty-management.js?v=167',
  './inventory-management.js?v=167',
  './retention-management.js?v=167',
  './booking-policy-management.js?v=167',
  './team-calendar.js?v=167',
  './free-slots-share.js?v=167',
  './group-bookings.js?v=167',
  './provider.js?v=167',
  './booking.js?v=167',
  './my-bookings.js?v=167',
  './waitlist.js?v=167',
  './ui-icons.svg',
  './ui-icons.svg?v=167',
