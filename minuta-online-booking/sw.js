...
const CACHE = `${CACHE_PREFIX}v453`;
const ASSETS = [
  './provider-apricot-tiger-mobile.svg?v=453',
  './provider-apricot-tiger.svg?v=453',
  './provider-snow-leopard-natural-v2.webp?v=453',
  './provider-header.css?v=453',
  './free-slots-compact.css?v=453',
  './vendor/qrcodegen.js?v=453',
  './provider-layout-responsive.css?v=453',
  './provider-ux.css?v=453',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=453',
  './help/help-data.js?v=453',
  './help/help.js?v=453',
  './help/article.js?v=453',
  './help/category.js?v=453',
  ...
  './provider.webmanifest?v=453',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=453',
  './utm-funnel.css?v=453',
  './onboarding.css?v=453',
  './visitor-presence.css?v=453',
  './subscription-pricing.css?v=453',
  './provider-theme-loft-modern.css?v=453',
  './provider-themes-signature.css?v=453',
  './provider-themes-calm.css?v=453',
  './config.js?v=453',
  './site-update.js?v=453',
  './reliability.js?v=453',
  './phone-auth.js?v=453',
  './social-auth.js?v=453',
  './app.js?v=453',
  './resource-management.js?v=453',
  './shift-management.js?v=453',
  './organization.js?v=453',
  './payroll-management.js?v=453',
  './benefit-management.js?v=453',
  './loyalty-management.js?v=453',
  './inventory-management.js?v=453',
  './retention-management.js?v=453',
  './payment-management.js?v=453',
  './notification-center.js?v=453',
  './client-fields.js?v=453',
  './client-import.js?v=453',
  './provider-feedback.js?v=453',
  './batch-bookings.js?v=453',
  './booking-policy-management.js?v=453',
  './team-calendar.js?v=453',
  './free-slots-share.js?v=453',
  './group-bookings.js?v=453',
  './telegram-auth.js?v=453',
  './pwa-install.js?v=453',
  './client-messaging.js?v=453',
  './provider-read-fetch.js?v=453',
  './provider.js?v=453',
  './data-governance.js?v=453',
  './onboarding.js?v=453',
  './report-worker.js?v=453',
  './voice-assistant.js?v=453',
  './booking.js?v=453',
  './my-bookings.js?v=453',
  './waitlist.js?v=453',
  './privacy.js?v=453',
  './ui-icons.svg',
  './ui-icons.svg?v=453',
