...
const CACHE = `${CACHE_PREFIX}v540`;
const ASSETS = [
  './microphone-diagnostic.js?v=540',
  './report-reconciliation.js?v=540',
  './provider-apricot-tiger-mobile.svg?v=540',
  './provider-apricot-tiger.svg?v=540',
  './provider-snow-leopard-natural-v2.webp?v=540',
  './provider-snow-leopard-unified-landscape-v5.png?v=540',
  './provider-snow-leopard-unified-portrait-v6.png?v=540',
  './theme-catalog.js?v=540',
  './client-themes.css?v=540',
  './provider-header.css?v=540',
  './settings-nav-scroll.css?v=540',
  './settings-nav-scroll.js?v=540',
  './settings-smart-search.css?v=540',
  './settings-smart-search.js?v=540',
  './contextual-help.css?v=540',
  './contextual-help.js?v=540',
  './settings-mobile-minimalism.css?v=540',
  './provider-themes-wildlife.css?v=540',
  './provider-theme-noir-safari.css?v=540',
  './provider-noir-safari-bg.webp?v=540',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=540',
  './free-slots-compact.css?v=540',
  './vendor/qrcodegen.js?v=540',
  './provider-layout-responsive.css?v=540',
  './provider-ux.css?v=540',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=540',
  './help/help-data.js?v=540',
  './help/help.js?v=540',
  './help/article.js?v=540',
  './help/category.js?v=540',
  ...
  './provider.webmanifest?v=540',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=540',
  './code-scanner.css?v=540',
  './utm-funnel.css?v=540',
  './onboarding.css?v=540',
  './visitor-presence.css?v=540',
  './subscription-pricing.css?v=540',
  './provider-theme-loft-modern.css?v=540',
  './provider-themes-signature.css?v=540',
  './provider-themes-calm.css?v=540',
  './config.js?v=540',
  './site-update.js?v=540',
  './reliability.js?v=540',
  './phone-auth.js?v=540',
  './social-auth.js?v=540',
  './app.js?v=540',
  './resource-management.js?v=540',
  './shift-management.js?v=540',
  './organization.js?v=540',
  './payroll-management.js?v=540',
  './benefit-management.js?v=540',
  './loyalty-management.js?v=540',
  './inventory-management.js?v=540',
  './retention-management.js?v=540',
  './payment-management.js?v=540',
  './notification-center.js?v=540',
  './client-fields.js?v=540',
  './client-records.css?v=540',
  './client-records.js?v=540',
  './client-results.css?v=540',
  './client-results.js?v=540',
  './client-import.js?v=540',
  './code-scanner.js?v=540',
  './provider-feedback.js?v=540',
  './batch-bookings.js?v=540',
  './booking-policy-management.js?v=540',
  './team-calendar.js?v=540',
  './free-slots-share.js?v=540',
  './group-bookings.js?v=540',
  './telegram-auth.js?v=540',
  './pwa-install.js?v=540',
  './client-messaging.js?v=540',
  './provider-read-fetch.js?v=540',
  './provider.js?v=540',
  './client-directory.js?v=540',
  './client-directory.css?v=540',
  './provider-ui-refinements.css?v=540',
  './provider-schedule-minimal.css?v=540',
  './data-governance.js?v=540',
  './onboarding.js?v=540',
  './report-worker.js?v=540',
  './voice-assistant.js?v=540',
  './booking.js?v=540',
  './my-bookings.js?v=540',
  './waitlist.js?v=540',
  './privacy.js?v=540',
  './ui-icons.svg',
  './ui-icons.svg?v=540',
