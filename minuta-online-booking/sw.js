...
const CACHE = `${CACHE_PREFIX}v539`;
const ASSETS = [
  './microphone-diagnostic.js?v=539',
  './report-reconciliation.js?v=539',
  './provider-apricot-tiger-mobile.svg?v=539',
  './provider-apricot-tiger.svg?v=539',
  './provider-snow-leopard-natural-v2.webp?v=539',
  './provider-snow-leopard-unified-landscape-v5.png?v=539',
  './provider-snow-leopard-unified-portrait-v6.png?v=539',
  './theme-catalog.js?v=539',
  './client-themes.css?v=539',
  './provider-header.css?v=539',
  './settings-nav-scroll.css?v=539',
  './settings-nav-scroll.js?v=539',
  './settings-smart-search.css?v=539',
  './settings-smart-search.js?v=539',
  './contextual-help.css?v=539',
  './contextual-help.js?v=539',
  './settings-mobile-minimalism.css?v=539',
  './provider-themes-wildlife.css?v=539',
  './provider-theme-noir-safari.css?v=539',
  './provider-noir-safari-bg.webp?v=539',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=539',
  './free-slots-compact.css?v=539',
  './vendor/qrcodegen.js?v=539',
  './provider-layout-responsive.css?v=539',
  './provider-ux.css?v=539',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=539',
  './help/help-data.js?v=539',
  './help/help.js?v=539',
  './help/article.js?v=539',
  './help/category.js?v=539',
  ...
  './provider.webmanifest?v=539',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=539',
  './code-scanner.css?v=539',
  './utm-funnel.css?v=539',
  './onboarding.css?v=539',
  './visitor-presence.css?v=539',
  './subscription-pricing.css?v=539',
  './provider-theme-loft-modern.css?v=539',
  './provider-themes-signature.css?v=539',
  './provider-themes-calm.css?v=539',
  './config.js?v=539',
  './site-update.js?v=539',
  './reliability.js?v=539',
  './phone-auth.js?v=539',
  './social-auth.js?v=539',
  './app.js?v=539',
  './resource-management.js?v=539',
  './shift-management.js?v=539',
  './organization.js?v=539',
  './payroll-management.js?v=539',
  './benefit-management.js?v=539',
  './loyalty-management.js?v=539',
  './inventory-management.js?v=539',
  './retention-management.js?v=539',
  './payment-management.js?v=539',
  './notification-center.js?v=539',
  './client-fields.js?v=539',
  './client-records.css?v=539',
  './client-records.js?v=539',
  './client-results.css?v=539',
  './client-results.js?v=539',
  './client-import.js?v=539',
  './code-scanner.js?v=539',
  './provider-feedback.js?v=539',
  './batch-bookings.js?v=539',
  './booking-policy-management.js?v=539',
  './team-calendar.js?v=539',
  './free-slots-share.js?v=539',
  './group-bookings.js?v=539',
  './telegram-auth.js?v=539',
  './pwa-install.js?v=539',
  './client-messaging.js?v=539',
  './provider-read-fetch.js?v=539',
  './provider.js?v=539',
  './client-directory.js?v=539',
  './client-directory.css?v=539',
  './provider-ui-refinements.css?v=539',
  './provider-schedule-minimal.css?v=539',
  './data-governance.js?v=539',
  './onboarding.js?v=539',
  './report-worker.js?v=539',
  './voice-assistant.js?v=539',
  './booking.js?v=539',
  './my-bookings.js?v=539',
  './waitlist.js?v=539',
  './privacy.js?v=539',
  './ui-icons.svg',
  './ui-icons.svg?v=539',
