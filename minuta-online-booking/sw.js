...
const ASSETS = [
  ...
  './offline.html',
  './offline.js',
  './provider.webmanifest?v=867',
  './provider-icon-192.png?v=867',
  './provider-icon-512.png?v=867',
  './provider-icon-maskable-512.png?v=867',
  './provider-icon.svg?v=867',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=865',
