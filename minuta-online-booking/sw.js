...
const CACHE = `${CACHE_PREFIX}v529`;
const ASSETS = [
  './microphone-diagnostic.js?v=529',
  './report-reconciliation.js?v=529',
  './provider-apricot-tiger-mobile.svg?v=529',
  './provider-apricot-tiger.svg?v=529',
  './provider-snow-leopard-natural-v2.webp?v=529',
  './provider-snow-leopard-unified-landscape-v5.png?v=529',
  './provider-snow-leopard-unified-portrait-v6.png?v=529',
  './theme-catalog.js?v=529',
  './client-themes.css?v=529',
  './provider-header.css?v=529',
  './settings-nav-scroll.css?v=529',
  './settings-nav-scroll.js?v=529',
  './settings-smart-search.css?v=529',
  './settings-smart-search.js?v=529',
  './contextual-help.css?v=529',
  './contextual-help.js?v=529',
  './settings-mobile-minimalism.css?v=529',
  './provider-themes-wildlife.css?v=529',
  './provider-theme-noir-safari.css?v=529',
  './provider-noir-safari-bg.webp?v=529',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=529',
  './free-slots-compact.css?v=529',
  './vendor/qrcodegen.js?v=529',
  './provider-layout-responsive.css?v=529',
  './provider-ux.css?v=529',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=529',
  './help/help-data.js?v=529',
  './help/help.js?v=529',
  './help/article.js?v=529',
  './help/category.js?v=529',
  ...
  './provider.webmanifest?v=529',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=529',
  './code-scanner.css?v=529',
  './utm-funnel.css?v=529',
  './onboarding.css?v=529',
  './visitor-presence.css?v=529',
  './subscription-pricing.css?v=529',
  './provider-theme-loft-modern.css?v=529',
  './provider-themes-signature.css?v=529',
  './provider-themes-calm.css?v=529',
  './config.js?v=529',
  './site-update.js?v=529',
  './reliability.js?v=529',
  './phone-auth.js?v=529',
  './social-auth.js?v=529',
  './app.js?v=529',
  './resource-management.js?v=529',
  './shift-management.js?v=529',
  './organization.js?v=529',
  './payroll-management.js?v=529',
  './benefit-management.js?v=529',
  './loyalty-management.js?v=529',
  './inventory-management.js?v=529',
  './retention-management.js?v=529',
  './payment-management.js?v=529',
  './notification-center.js?v=529',
  './client-fields.js?v=529',
  './client-records.css?v=529',
  './client-records.js?v=529',
  './client-import.js?v=529',
  './code-scanner.js?v=529',
  './provider-feedback.js?v=529',
  './batch-bookings.js?v=529',
  './booking-policy-management.js?v=529',
  './team-calendar.js?v=529',
  './free-slots-share.js?v=529',
  './group-bookings.js?v=529',
  './telegram-auth.js?v=529',
  './pwa-install.js?v=529',
  './client-messaging.js?v=529',
  './provider-read-fetch.js?v=529',
  './provider.js?v=529',
  './client-directory.js?v=529',
  './client-directory.css?v=529',
  './provider-ui-refinements.css?v=529',
  './provider-schedule-minimal.css?v=529',
  './data-governance.js?v=529',
  './onboarding.js?v=529',
  './report-worker.js?v=529',
  './voice-assistant.js?v=529',
  './booking.js?v=529',
  './my-bookings.js?v=529',
  './waitlist.js?v=529',
  './privacy.js?v=529',
  './ui-icons.svg',
  './ui-icons.svg?v=529',
