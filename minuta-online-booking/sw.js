...
const CACHE = `${CACHE_PREFIX}v512`;
const ASSETS = [
  './microphone-diagnostic.js?v=512',
  './report-reconciliation.js?v=512',
  './provider-apricot-tiger-mobile.svg?v=512',
  './provider-apricot-tiger.svg?v=512',
  './provider-snow-leopard-natural-v2.webp?v=512',
  './provider-snow-leopard-unified-landscape-v5.png?v=512',
  './provider-snow-leopard-unified-portrait-v6.png?v=512',
  './theme-catalog.js?v=512',
  './client-themes.css?v=512',
  './provider-header.css?v=512',
  './settings-nav-scroll.css?v=512',
  './settings-nav-scroll.js?v=512',
  './settings-smart-search.css?v=512',
  './settings-smart-search.js?v=512',
  './contextual-help.css?v=512',
  './contextual-help.js?v=512',
  './settings-mobile-minimalism.css?v=512',
  './provider-themes-wildlife.css?v=512',
  './provider-theme-noir-safari.css?v=512',
  './provider-noir-safari-bg.webp?v=512',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=512',
  './free-slots-compact.css?v=512',
  './vendor/qrcodegen.js?v=512',
  './provider-layout-responsive.css?v=512',
  './provider-ux.css?v=512',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=512',
  './help/help-data.js?v=512',
  './help/help.js?v=512',
  './help/article.js?v=512',
  './help/category.js?v=512',
  ...
  './provider.webmanifest?v=512',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=512',
  './code-scanner.css?v=512',
  './utm-funnel.css?v=512',
  './onboarding.css?v=512',
  './visitor-presence.css?v=512',
  './subscription-pricing.css?v=512',
  './provider-theme-loft-modern.css?v=512',
  './provider-themes-signature.css?v=512',
  './provider-themes-calm.css?v=512',
  './config.js?v=512',
  './site-update.js?v=512',
  './reliability.js?v=512',
  './phone-auth.js?v=512',
  './social-auth.js?v=512',
  './app.js?v=512',
  './resource-management.js?v=512',
  './shift-management.js?v=512',
  './organization.js?v=512',
  './payroll-management.js?v=512',
  './benefit-management.js?v=512',
  './loyalty-management.js?v=512',
  './inventory-management.js?v=512',
  './retention-management.js?v=512',
  './payment-management.js?v=512',
  './notification-center.js?v=512',
  './client-fields.js?v=512',
  './client-records.css?v=512',
  './client-records.js?v=512',
  './client-import.js?v=512',
  './code-scanner.js?v=512',
  './provider-feedback.js?v=512',
  './batch-bookings.js?v=512',
  './booking-policy-management.js?v=512',
  './team-calendar.js?v=512',
  './free-slots-share.js?v=512',
  './group-bookings.js?v=512',
  './telegram-auth.js?v=512',
  './pwa-install.js?v=512',
  './client-messaging.js?v=512',
  './provider-read-fetch.js?v=512',
  './provider.js?v=512',
  './client-directory.js?v=512',
  './client-directory.css?v=512',
  './provider-ui-refinements.css?v=512',
  './provider-schedule-minimal.css?v=512',
  './data-governance.js?v=512',
  './onboarding.js?v=512',
  './report-worker.js?v=512',
  './voice-assistant.js?v=512',
  './booking.js?v=512',
  './my-bookings.js?v=512',
  './waitlist.js?v=512',
  './privacy.js?v=512',
  './ui-icons.svg',
  './ui-icons.svg?v=512',
