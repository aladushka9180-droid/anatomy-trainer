...
const CACHE = `${CACHE_PREFIX}v447`;
const ASSETS = [
  './provider-apricot-tiger.svg?v=447',
  './provider-snow-leopard-natural-v2.webp?v=447',
  './provider-header.css?v=447',
  './free-slots-compact.css?v=447',
  './vendor/qrcodegen.js?v=447',
  './provider-layout-responsive.css?v=447',
  './provider-ux.css?v=447',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=447',
  './help/help-data.js?v=447',
  './help/help.js?v=447',
  './help/article.js?v=447',
  './help/category.js?v=447',
  ...
  './provider.webmanifest?v=447',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=447',
  './utm-funnel.css?v=447',
  './onboarding.css?v=447',
  './visitor-presence.css?v=447',
  './subscription-pricing.css?v=447',
  './provider-theme-loft-modern.css?v=447',
  './provider-themes-signature.css?v=447',
  './provider-themes-calm.css?v=447',
  './config.js?v=447',
  './site-update.js?v=447',
  './reliability.js?v=447',
  './phone-auth.js?v=447',
  './social-auth.js?v=447',
  './app.js?v=447',
  './resource-management.js?v=447',
  './shift-management.js?v=447',
  './organization.js?v=447',
  './payroll-management.js?v=447',
  './benefit-management.js?v=447',
  './loyalty-management.js?v=447',
  './inventory-management.js?v=447',
  './retention-management.js?v=447',
  './payment-management.js?v=447',
  './notification-center.js?v=447',
  './client-fields.js?v=447',
  './client-import.js?v=447',
  './provider-feedback.js?v=447',
  './batch-bookings.js?v=447',
  './booking-policy-management.js?v=447',
  './team-calendar.js?v=447',
  './free-slots-share.js?v=447',
  './group-bookings.js?v=447',
  './telegram-auth.js?v=447',
  './pwa-install.js?v=447',
  './client-messaging.js?v=447',
  './provider-read-fetch.js?v=447',
  './provider.js?v=447',
  './data-governance.js?v=447',
  './onboarding.js?v=447',
  './report-worker.js?v=447',
  './voice-assistant.js?v=447',
  './booking.js?v=447',
  './my-bookings.js?v=447',
  './waitlist.js?v=447',
  './privacy.js?v=447',
  './ui-icons.svg',
  './ui-icons.svg?v=447',
