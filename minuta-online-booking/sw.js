...
const ASSETS = [
  ...
  './styles.css?v=219',
  './config.js?v=219',
  './reliability.js?v=219',
  './app.js?v=219',
  './resource-management.js?v=219',
  './shift-management.js?v=219',
  './organization.js?v=219',
  './payroll-management.js?v=219',
  './benefit-management.js?v=219',
  './loyalty-management.js?v=219',
  './inventory-management.js?v=219',
  './retention-management.js?v=219',
  './payment-management.js?v=219',
  './notification-center.js?v=219',
  './client-fields.js?v=219',
  './batch-bookings.js?v=219',
  './booking-policy-management.js?v=219',
  './team-calendar.js?v=219',
  './free-slots-share.js?v=219',
  './group-bookings.js?v=219',
  './provider.js?v=219',
  './voice-assistant.js?v=219',
  './booking.js?v=219',
  './my-bookings.js?v=219',
  './waitlist.js?v=219',
  './ui-icons.svg',
  './ui-icons.svg?v=219',
