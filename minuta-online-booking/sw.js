...
const ASSETS = [
  ...
  './styles.css?v=212',
  './config.js?v=212',
  './reliability.js?v=212',
  './app.js?v=212',
  './resource-management.js?v=212',
  './shift-management.js?v=212',
  './organization.js?v=212',
  './payroll-management.js?v=212',
  './benefit-management.js?v=212',
  './loyalty-management.js?v=212',
  './inventory-management.js?v=212',
  './retention-management.js?v=212',
  './payment-management.js?v=212',
  './notification-center.js?v=212',
  './client-fields.js?v=212',
  './batch-bookings.js?v=212',
  './booking-policy-management.js?v=212',
  './team-calendar.js?v=212',
  './free-slots-share.js?v=212',
  './group-bookings.js?v=212',
  './provider.js?v=212',
  './voice-assistant.js?v=212',
  './booking.js?v=212',
  './my-bookings.js?v=212',
  './waitlist.js?v=212',
  './ui-icons.svg',
  './ui-icons.svg?v=212',
