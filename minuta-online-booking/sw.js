...
const ASSETS = [
  ...
  './styles.css?v=169',
  './config.js?v=169',
  './reliability.js?v=169',
  './app.js?v=169',
  './resource-management.js?v=169',
  './shift-management.js?v=169',
  './organization.js?v=169',
  './payroll-management.js?v=169',
  './benefit-management.js?v=169',
  './loyalty-management.js?v=169',
  './inventory-management.js?v=169',
  './retention-management.js?v=169',
  './booking-policy-management.js?v=169',
  './team-calendar.js?v=169',
  './free-slots-share.js?v=169',
  './group-bookings.js?v=169',
  './provider.js?v=169',
  './booking.js?v=169',
  './my-bookings.js?v=169',
  './waitlist.js?v=169',
  './ui-icons.svg',
  './ui-icons.svg?v=169',
