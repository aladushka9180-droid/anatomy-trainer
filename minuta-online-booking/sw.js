...
const ASSETS = [
  ...
  './offline.html',
  './offline.js',
  './provider.webmanifest?v=831',
  './provider-icon-192.png?v=831',
  './provider-icon-512.png?v=831',
  './provider-icon-maskable-512.png?v=831',
  './provider-icon.svg?v=831',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=821',
  ...
  './provider-schedule-minimal.css?v=831',
  ...
  './voice-wake.js?v=811',
  './provider-feature-assets.js?v=831',
];

// Warm after the first screen. A cold installation must not wait for tools
// that are only used from a dialog; retain their offline use after warming.
const OPTIONAL_ASSETS = [
  './provider-schedule-desktop-reference.css?v=831',
