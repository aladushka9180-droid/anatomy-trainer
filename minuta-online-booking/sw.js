...
const CACHE = `${CACHE_PREFIX}v549`;
const ASSETS = [
  './microphone-diagnostic.js?v=549',
  './report-reconciliation.js?v=549',
  './provider-apricot-tiger-mobile.svg?v=549',
  './provider-apricot-tiger.svg?v=549',
  './provider-snow-leopard-natural-v2.webp?v=549',
  './provider-snow-leopard-unified-landscape-v5.png?v=549',
  './provider-snow-leopard-unified-portrait-v6.png?v=549',
  './theme-catalog.js?v=549',
  './client-themes.css?v=549',
  './provider-header.css?v=549',
  './settings-nav-scroll.css?v=549',
  './settings-nav-scroll.js?v=549',
  './settings-smart-search.css?v=549',
  './settings-smart-search.js?v=549',
  './contextual-help.css?v=549',
  './contextual-help.js?v=549',
  './settings-mobile-minimalism.css?v=549',
  './provider-themes-wildlife.css?v=549',
  './provider-theme-noir-safari.css?v=549',
  './provider-noir-safari-bg.webp?v=549',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=549',
  './free-slots-compact.css?v=549',
  './vendor/qrcodegen.js?v=549',
  './provider-layout-responsive.css?v=549',
  './provider-ux.css?v=549',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=549',
  './help/help-data.js?v=549',
  './help/help.js?v=549',
  './help/article.js?v=549',
  './help/category.js?v=549',
  ...
  './provider.webmanifest?v=549',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=549',
  './code-scanner.css?v=549',
  './utm-funnel.css?v=549',
  './onboarding.css?v=549',
  './visitor-presence.css?v=549',
  './subscription-pricing.css?v=549',
  './provider-theme-loft-modern.css?v=549',
  './provider-themes-signature.css?v=549',
  './provider-themes-calm.css?v=549',
  './config.js?v=549',
  './site-update.js?v=549',
  './reliability.js?v=549',
  './phone-auth.js?v=549',
  './social-auth.js?v=549',
  './app.js?v=549',
  './resource-management.js?v=549',
  './shift-management.js?v=549',
  './organization.js?v=549',
  './payroll-management.js?v=549',
  './benefit-management.js?v=549',
  './loyalty-management.js?v=549',
  './inventory-management.js?v=549',
  './retention-management.js?v=549',
  './payment-management.js?v=549',
  './notification-center.js?v=549',
  './client-fields.js?v=549',
  './client-records.css?v=549',
  './client-records.js?v=549',
  './client-results.css?v=549',
  './client-results.js?v=549',
  './client-import.js?v=549',
  './code-scanner.js?v=549',
  './provider-feedback.js?v=549',
  './batch-bookings.js?v=549',
  './booking-policy-management.js?v=549',
  './team-calendar.js?v=549',
  './free-slots-share.js?v=549',
  './group-bookings.js?v=549',
  './telegram-auth.js?v=549',
  './pwa-install.js?v=549',
  './client-messaging.js?v=549',
  './provider-read-fetch.js?v=549',
  './provider.js?v=549',
  './client-directory.js?v=549',
  './client-directory.css?v=549',
  './provider-ui-refinements.css?v=549',
  './provider-schedule-minimal.css?v=549',
  './data-governance.js?v=549',
  './onboarding.js?v=549',
  './report-worker.js?v=549',
  './voice-assistant.js?v=549',
  './booking.js?v=549',
  './my-bookings.js?v=549',
  './waitlist.js?v=549',
  './privacy.js?v=549',
  './ui-icons.svg',
  './ui-icons.svg?v=549',
