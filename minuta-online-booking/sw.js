...
const CACHE = `${CACHE_PREFIX}v124-mobile-install-1`;
const ASSETS = [
  './',
  './index.html',
  './provider.html',
  ...
  './waitlist.html',
  './privacy.html',
  './provider.webmanifest?v=124',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v3.webp',
  './styles.css?v=124',
  './config.js?v=124',
  './reliability.js?v=124',
  './app.js?v=124',
  './organization.js?v=124',
  './team-calendar.js?v=124',
  './provider.js?v=124',
  './booking.js?v=124',
  './my-bookings.js?v=124',
  './waitlist.js?v=124',
  './ui-icons.svg',
  './ui-icons.svg?v=124',
