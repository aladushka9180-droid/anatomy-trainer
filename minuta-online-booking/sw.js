...
const CACHE = `${CACHE_PREFIX}v546`;
const ASSETS = [
  './microphone-diagnostic.js?v=546',
  './report-reconciliation.js?v=546',
  './provider-apricot-tiger-mobile.svg?v=546',
  './provider-apricot-tiger.svg?v=546',
  './provider-snow-leopard-natural-v2.webp?v=546',
  './provider-snow-leopard-unified-landscape-v5.png?v=546',
  './provider-snow-leopard-unified-portrait-v6.png?v=546',
  './theme-catalog.js?v=546',
  './client-themes.css?v=546',
  './provider-header.css?v=546',
  './settings-nav-scroll.css?v=546',
  './settings-nav-scroll.js?v=546',
  './settings-smart-search.css?v=546',
  './settings-smart-search.js?v=546',
  './contextual-help.css?v=546',
  './contextual-help.js?v=546',
  './settings-mobile-minimalism.css?v=546',
  './provider-themes-wildlife.css?v=546',
  './provider-theme-noir-safari.css?v=546',
  './provider-noir-safari-bg.webp?v=546',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=546',
  './free-slots-compact.css?v=546',
  './vendor/qrcodegen.js?v=546',
  './provider-layout-responsive.css?v=546',
  './provider-ux.css?v=546',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=546',
  './help/help-data.js?v=546',
  './help/help.js?v=546',
  './help/article.js?v=546',
  './help/category.js?v=546',
  ...
  './provider.webmanifest?v=546',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=546',
  './code-scanner.css?v=546',
  './utm-funnel.css?v=546',
  './onboarding.css?v=546',
  './visitor-presence.css?v=546',
  './subscription-pricing.css?v=546',
  './provider-theme-loft-modern.css?v=546',
  './provider-themes-signature.css?v=546',
  './provider-themes-calm.css?v=546',
  './config.js?v=546',
  './site-update.js?v=546',
  './reliability.js?v=546',
  './phone-auth.js?v=546',
  './social-auth.js?v=546',
  './app.js?v=546',
  './resource-management.js?v=546',
  './shift-management.js?v=546',
  './organization.js?v=546',
  './payroll-management.js?v=546',
  './benefit-management.js?v=546',
  './loyalty-management.js?v=546',
  './inventory-management.js?v=546',
  './retention-management.js?v=546',
  './payment-management.js?v=546',
  './notification-center.js?v=546',
  './client-fields.js?v=546',
  './client-records.css?v=546',
  './client-records.js?v=546',
  './client-results.css?v=546',
  './client-results.js?v=546',
  './client-import.js?v=546',
  './code-scanner.js?v=546',
  './provider-feedback.js?v=546',
  './batch-bookings.js?v=546',
  './booking-policy-management.js?v=546',
  './team-calendar.js?v=546',
  './free-slots-share.js?v=546',
  './group-bookings.js?v=546',
  './telegram-auth.js?v=546',
  './pwa-install.js?v=546',
  './client-messaging.js?v=546',
  './provider-read-fetch.js?v=546',
  './provider.js?v=546',
  './client-directory.js?v=546',
  './client-directory.css?v=546',
  './provider-ui-refinements.css?v=546',
  './provider-schedule-minimal.css?v=546',
  './data-governance.js?v=546',
  './onboarding.js?v=546',
  './report-worker.js?v=546',
  './voice-assistant.js?v=546',
  './booking.js?v=546',
  './my-bookings.js?v=546',
  './waitlist.js?v=546',
  './privacy.js?v=546',
  './ui-icons.svg',
  './ui-icons.svg?v=546',
