...
const CACHE = `${CACHE_PREFIX}v555`;
const ASSETS = [
  './microphone-diagnostic.js?v=555',
  './report-reconciliation.js?v=555',
  './provider-apricot-tiger-mobile.svg?v=555',
  './provider-apricot-tiger.svg?v=555',
  './provider-snow-leopard-natural-v2.webp?v=555',
  './provider-snow-leopard-unified-landscape-v5.png?v=555',
  './provider-snow-leopard-unified-portrait-v6.png?v=555',
  './theme-catalog.js?v=555',
  './client-themes.css?v=555',
  './legal-ux.css?v=555',
  './provider-header.css?v=555',
  './settings-nav-scroll.css?v=555',
  './settings-nav-scroll.js?v=555',
  './settings-smart-search.css?v=555',
  './settings-smart-search.js?v=555',
  './contextual-help.css?v=555',
  './contextual-help.js?v=555',
  './settings-mobile-minimalism.css?v=555',
  './provider-themes-wildlife.css?v=555',
  './provider-theme-noir-safari.css?v=555',
  './provider-noir-safari-bg.webp?v=555',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=555',
  './free-slots-compact.css?v=555',
  './vendor/qrcodegen.js?v=555',
  './provider-layout-responsive.css?v=555',
  './provider-ux.css?v=555',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=555',
  './help/help-data.js?v=555',
  './help/help.js?v=555',
  './help/article.js?v=555',
  './help/category.js?v=555',
  ...
  './provider.webmanifest?v=555',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=555',
  './code-scanner.css?v=555',
  './utm-funnel.css?v=555',
  './onboarding.css?v=555',
  './visitor-presence.css?v=555',
  './subscription-pricing.css?v=555',
  './provider-theme-loft-modern.css?v=555',
  './provider-themes-signature.css?v=555',
  './provider-themes-calm.css?v=555',
  './config.js?v=555',
  './site-update.js?v=555',
  './reliability.js?v=555',
  './phone-auth.js?v=555',
  './social-auth.js?v=555',
  './app.js?v=555',
  './resource-management.js?v=555',
  './shift-management.js?v=555',
  './organization.js?v=555',
  './payroll-management.js?v=555',
  './benefit-management.js?v=555',
  './loyalty-management.js?v=555',
  './inventory-management.js?v=555',
  './retention-management.js?v=555',
  './payment-management.js?v=555',
  './notification-center.js?v=555',
  './client-fields.js?v=555',
  './client-records.css?v=555',
  './client-records.js?v=555',
  './client-results.css?v=555',
  './client-results.js?v=555',
  './client-import.js?v=555',
  './code-scanner.js?v=555',
  './provider-feedback.js?v=555',
  './batch-bookings.js?v=555',
  './booking-policy-management.js?v=555',
  './team-calendar.js?v=555',
  './free-slots-share.js?v=555',
  './group-bookings.js?v=555',
  './telegram-auth.js?v=555',
  './pwa-install.js?v=555',
  './client-messaging.js?v=555',
  './provider-read-fetch.js?v=555',
  './provider.js?v=555',
  './client-directory.js?v=555',
  './client-directory.css?v=555',
  './provider-ui-refinements.css?v=555',
  './provider-schedule-minimal.css?v=555',
  './data-governance.js?v=555',
  './onboarding.js?v=555',
  './report-worker.js?v=555',
  './voice-assistant.js?v=555',
  './booking.js?v=555',
  './my-bookings.js?v=555',
  './waitlist.js?v=555',
  './privacy.js?v=555',
  './ui-icons.svg',
  './ui-icons.svg?v=555',
