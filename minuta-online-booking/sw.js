...
const CACHE = `${CACHE_PREFIX}v440`;
const ASSETS = [
  './provider-snow-leopard-natural-v2.webp?v=440',
  './provider-header.css?v=440',
  './free-slots-compact.css?v=440',
  './vendor/qrcodegen.js?v=440',
  './provider-layout-responsive.css?v=440',
  './provider-ux.css?v=440',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=440',
  './help/help-data.js?v=440',
  './help/help.js?v=440',
  './help/article.js?v=440',
  './help/category.js?v=440',
  ...
  './provider.webmanifest?v=440',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=440',
  './utm-funnel.css?v=440',
  './onboarding.css?v=440',
  './visitor-presence.css?v=440',
  './subscription-pricing.css?v=440',
  './provider-theme-loft-modern.css?v=440',
  './provider-themes-signature.css?v=440',
  './provider-themes-calm.css?v=440',
  './config.js?v=440',
  './site-update.js?v=440',
  './reliability.js?v=440',
  './phone-auth.js?v=440',
  './social-auth.js?v=440',
  './app.js?v=440',
  './resource-management.js?v=440',
  './shift-management.js?v=440',
  './organization.js?v=440',
  './payroll-management.js?v=440',
  './benefit-management.js?v=440',
  './loyalty-management.js?v=440',
  './inventory-management.js?v=440',
  './retention-management.js?v=440',
  './payment-management.js?v=440',
  './notification-center.js?v=440',
  './client-fields.js?v=440',
  './client-import.js?v=440',
  './provider-feedback.js?v=440',
  './batch-bookings.js?v=440',
  './booking-policy-management.js?v=440',
  './team-calendar.js?v=440',
  './free-slots-share.js?v=440',
  './group-bookings.js?v=440',
  './telegram-auth.js?v=440',
  './pwa-install.js?v=440',
  './client-messaging.js?v=440',
  './provider-read-fetch.js?v=440',
  './provider.js?v=440',
  './data-governance.js?v=440',
  './onboarding.js?v=440',
  './report-worker.js?v=440',
  './voice-assistant.js?v=440',
  './booking.js?v=440',
  './my-bookings.js?v=440',
  './waitlist.js?v=440',
  './privacy.js?v=440',
  './ui-icons.svg',
  './ui-icons.svg?v=440',
