...
const CACHE = `${CACHE_PREFIX}v438`;
const ASSETS = [
  './provider-snow-leopard-natural-v2.webp?v=438',
  './provider-header.css?v=438',
  './free-slots-compact.css?v=438',
  './vendor/qrcodegen.js?v=438',
  './provider-layout-responsive.css?v=438',
  './provider-ux.css?v=438',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=438',
  './help/help-data.js?v=438',
  './help/help.js?v=438',
  './help/article.js?v=438',
  './help/category.js?v=438',
  ...
  './provider.webmanifest?v=438',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=438',
  './utm-funnel.css?v=438',
  './onboarding.css?v=438',
  './visitor-presence.css?v=438',
  './subscription-pricing.css?v=438',
  './provider-theme-loft-modern.css?v=438',
  './provider-themes-signature.css?v=438',
  './provider-themes-calm.css?v=438',
  './config.js?v=438',
  './site-update.js?v=438',
  './reliability.js?v=438',
  './phone-auth.js?v=438',
  './social-auth.js?v=438',
  './app.js?v=438',
  './resource-management.js?v=438',
  './shift-management.js?v=438',
  './organization.js?v=438',
  './payroll-management.js?v=438',
  './benefit-management.js?v=438',
  './loyalty-management.js?v=438',
  './inventory-management.js?v=438',
  './retention-management.js?v=438',
  './payment-management.js?v=438',
  './notification-center.js?v=438',
  './client-fields.js?v=438',
  './client-import.js?v=438',
  './provider-feedback.js?v=438',
  './batch-bookings.js?v=438',
  './booking-policy-management.js?v=438',
  './team-calendar.js?v=438',
  './free-slots-share.js?v=438',
  './group-bookings.js?v=438',
  './telegram-auth.js?v=438',
  './pwa-install.js?v=438',
  './client-messaging.js?v=438',
  './provider-read-fetch.js?v=438',
  './provider.js?v=438',
  './data-governance.js?v=438',
  './onboarding.js?v=438',
  './report-worker.js?v=438',
  './voice-assistant.js?v=438',
  './booking.js?v=438',
  './my-bookings.js?v=438',
  './waitlist.js?v=438',
  './privacy.js?v=438',
  './ui-icons.svg',
  './ui-icons.svg?v=438',
