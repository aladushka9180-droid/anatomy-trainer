...
const CACHE = `${CACHE_PREFIX}v527`;
const ASSETS = [
  './microphone-diagnostic.js?v=527',
  './report-reconciliation.js?v=527',
  './provider-apricot-tiger-mobile.svg?v=527',
  './provider-apricot-tiger.svg?v=527',
  './provider-snow-leopard-natural-v2.webp?v=527',
  './provider-snow-leopard-unified-landscape-v5.png?v=527',
  './provider-snow-leopard-unified-portrait-v6.png?v=527',
  './theme-catalog.js?v=527',
  './client-themes.css?v=527',
  './provider-header.css?v=527',
  './settings-nav-scroll.css?v=527',
  './settings-nav-scroll.js?v=527',
  './settings-smart-search.css?v=527',
  './settings-smart-search.js?v=527',
  './contextual-help.css?v=527',
  './contextual-help.js?v=527',
  './settings-mobile-minimalism.css?v=527',
  './provider-themes-wildlife.css?v=527',
  './provider-theme-noir-safari.css?v=527',
  './provider-noir-safari-bg.webp?v=527',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=527',
  './free-slots-compact.css?v=527',
  './vendor/qrcodegen.js?v=527',
  './provider-layout-responsive.css?v=527',
  './provider-ux.css?v=527',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=527',
  './help/help-data.js?v=527',
  './help/help.js?v=527',
  './help/article.js?v=527',
  './help/category.js?v=527',
  ...
  './provider.webmanifest?v=527',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=527',
  './code-scanner.css?v=527',
  './utm-funnel.css?v=527',
  './onboarding.css?v=527',
  './visitor-presence.css?v=527',
  './subscription-pricing.css?v=527',
  './provider-theme-loft-modern.css?v=527',
  './provider-themes-signature.css?v=527',
  './provider-themes-calm.css?v=527',
  './config.js?v=527',
  './site-update.js?v=527',
  './reliability.js?v=527',
  './phone-auth.js?v=527',
  './social-auth.js?v=527',
  './app.js?v=527',
  './resource-management.js?v=527',
  './shift-management.js?v=527',
  './organization.js?v=527',
  './payroll-management.js?v=527',
  './benefit-management.js?v=527',
  './loyalty-management.js?v=527',
  './inventory-management.js?v=527',
  './retention-management.js?v=527',
  './payment-management.js?v=527',
  './notification-center.js?v=527',
  './client-fields.js?v=527',
  './client-records.css?v=527',
  './client-records.js?v=527',
  './client-import.js?v=527',
  './code-scanner.js?v=527',
  './provider-feedback.js?v=527',
  './batch-bookings.js?v=527',
  './booking-policy-management.js?v=527',
  './team-calendar.js?v=527',
  './free-slots-share.js?v=527',
  './group-bookings.js?v=527',
  './telegram-auth.js?v=527',
  './pwa-install.js?v=527',
  './client-messaging.js?v=527',
  './provider-read-fetch.js?v=527',
  './provider.js?v=527',
  './client-directory.js?v=527',
  './client-directory.css?v=527',
  './provider-ui-refinements.css?v=527',
  './provider-schedule-minimal.css?v=527',
  './data-governance.js?v=527',
  './onboarding.js?v=527',
  './report-worker.js?v=527',
  './voice-assistant.js?v=527',
  './booking.js?v=527',
  './my-bookings.js?v=527',
  './waitlist.js?v=527',
  './privacy.js?v=527',
  './ui-icons.svg',
  './ui-icons.svg?v=527',
