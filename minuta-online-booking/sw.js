...
const CACHE = `${CACHE_PREFIX}v561`;
const ASSETS = [
  './microphone-diagnostic.js?v=561',
  './report-reconciliation.js?v=561',
  './provider-apricot-tiger-mobile.svg?v=561',
  './provider-apricot-tiger.svg?v=561',
  './provider-snow-leopard-natural-v2.webp?v=561',
  './provider-snow-leopard-unified-landscape-v5.png?v=561',
  './provider-snow-leopard-unified-portrait-v6.png?v=561',
  './theme-catalog.js?v=561',
  './client-themes.css?v=561',
  './legal-ux.css?v=561',
  './provider-header.css?v=561',
  './settings-nav-scroll.css?v=561',
  './settings-nav-scroll.js?v=561',
  './settings-smart-search.css?v=561',
  './settings-smart-search.js?v=561',
  './contextual-help.css?v=561',
  './contextual-help.js?v=561',
  './settings-mobile-minimalism.css?v=561',
  './provider-themes-wildlife.css?v=561',
  './provider-theme-noir-safari.css?v=561',
  './provider-noir-safari-bg.webp?v=561',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=561',
  './free-slots-compact.css?v=561',
  './vendor/qrcodegen.js?v=561',
  './provider-layout-responsive.css?v=561',
  './provider-ux.css?v=561',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=561',
  './help/help-data.js?v=561',
  './help/help.js?v=561',
  './help/article.js?v=561',
  './help/category.js?v=561',
  ...
  './provider.webmanifest?v=561',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=561',
  './code-scanner.css?v=561',
  './utm-funnel.css?v=561',
  './onboarding.css?v=561',
  './visitor-presence.css?v=561',
  './subscription-pricing.css?v=561',
  './provider-theme-loft-modern.css?v=561',
  './provider-themes-signature.css?v=561',
  './provider-themes-calm.css?v=561',
  './config.js?v=561',
  './site-update.js?v=561',
  './reliability.js?v=561',
  './phone-auth.js?v=561',
  './social-auth.js?v=561',
  './app.js?v=561',
  './resource-management.js?v=561',
  './shift-management.js?v=561',
  './organization.js?v=561',
  './payroll-management.js?v=561',
  './benefit-management.js?v=561',
  './loyalty-management.js?v=561',
  './inventory-management.js?v=561',
  './retention-management.js?v=561',
  './payment-management.js?v=561',
  './notification-center.js?v=561',
  './client-fields.js?v=561',
  './client-records.css?v=561',
  './client-records.js?v=561',
  './client-results.css?v=561',
  './client-results.js?v=561',
  './client-import.js?v=561',
  './code-scanner.js?v=561',
  './provider-feedback.js?v=561',
  './batch-bookings.js?v=561',
  './booking-policy-management.js?v=561',
  './team-calendar.js?v=561',
  './free-slots-share.js?v=561',
  './group-bookings.js?v=561',
  './telegram-auth.js?v=561',
  './pwa-install.js?v=561',
  './client-messaging.js?v=561',
  './provider-read-fetch.js?v=561',
  './provider.js?v=561',
  './client-directory.js?v=561',
  './client-directory.css?v=561',
  './provider-ui-refinements.css?v=561',
  './provider-schedule-minimal.css?v=561',
  './data-governance.js?v=561',
  './onboarding.js?v=561',
  './report-worker.js?v=561',
  './voice-assistant.js?v=561',
  './booking.js?v=561',
  './my-bookings.js?v=561',
  './waitlist.js?v=561',
  './privacy.js?v=561',
  './ui-icons.svg',
  './ui-icons.svg?v=561',
