...
const ASSETS = [
  ...
  './styles.css?v=164',
  './config.js?v=164',
  './reliability.js?v=164',
  './app.js?v=164',
  './resource-management.js?v=164',
  './shift-management.js?v=164',
  './organization.js?v=164',
  './payroll-management.js?v=164',
  './benefit-management.js?v=164',
  './loyalty-management.js?v=164',
  './inventory-management.js?v=164',
  './booking-policy-management.js?v=164',
  './team-calendar.js?v=164',
  './free-slots-share.js?v=164',
  './group-bookings.js?v=164',
  './provider.js?v=164',
  './booking.js?v=164',
  './my-bookings.js?v=164',
  './waitlist.js?v=164',
  './ui-icons.svg',
  './ui-icons.svg?v=164',
