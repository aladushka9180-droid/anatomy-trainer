...
const ASSETS = [
  ...
  './offline.html',
  './offline.js',
  './provider.webmanifest?v=832',
  './provider-icon-192.png?v=832',
  './provider-icon-512.png?v=832',
  './provider-icon-maskable-512.png?v=832',
  './provider-icon.svg?v=832',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=821',
  ...
  './provider-schedule-minimal.css?v=832',
  ...
  './voice-wake.js?v=811',
  './provider-feature-assets.js?v=832',
];

// Warm after the first screen. A cold installation must not wait for tools
// that are only used from a dialog; retain their offline use after warming.
const OPTIONAL_ASSETS = [
  './provider-schedule-desktop-reference.css?v=832',
