...
const ASSETS = [
  ...
  './styles.css?v=215',
  './config.js?v=215',
  './reliability.js?v=215',
  './app.js?v=215',
  './resource-management.js?v=215',
  './shift-management.js?v=215',
  './organization.js?v=215',
  './payroll-management.js?v=215',
  './benefit-management.js?v=215',
  './loyalty-management.js?v=215',
  './inventory-management.js?v=215',
  './retention-management.js?v=215',
  './payment-management.js?v=215',
  './notification-center.js?v=215',
  './client-fields.js?v=215',
  './batch-bookings.js?v=215',
  './booking-policy-management.js?v=215',
  './team-calendar.js?v=215',
  './free-slots-share.js?v=215',
  './group-bookings.js?v=215',
  './provider.js?v=215',
  './voice-assistant.js?v=215',
  './booking.js?v=215',
  './my-bookings.js?v=215',
  './waitlist.js?v=215',
  './ui-icons.svg',
  './ui-icons.svg?v=215',
