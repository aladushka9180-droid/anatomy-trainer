...
const ASSETS = [
  ...
  './offline.html',
  './offline.js',
  './provider.webmanifest?v=843',
  './provider-icon-192.png?v=843',
  './provider-icon-512.png?v=843',
  './provider-icon-maskable-512.png?v=843',
  './provider-icon.svg?v=843',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=843',
  ...
  './provider-ux.css?v=843',
  './provider-service-actions.css?v=811',
  './provider-header.css?v=843',
  ...
  './provider-schedule-minimal.css?v=843',
  './provider-themes-distinct.css?v=821',
  './provider-theme-families.css?v=821',
  './provider-theme-backgrounds-tema1.css?v=843',
  './vendor/supabase-2.112.4.min.js',
  './config.js?v=811',
  './pwa-install.js?v=811',
  './site-update.js?v=843',
  ...
  './provider.js?v=843',
  './voice-wake.js?v=811',
  './provider-feature-assets.js?v=843',
];

// Warm after the first screen. A cold installation must not wait for tools
// that are only used from a dialog; retain their offline use after warming.
const OPTIONAL_ASSETS = [
  './provider-schedule-desktop-reference.css?v=843',
  './settings-nav-scroll.js?v=843',
  './settings-smart-search.js?v=843',
  './provider-theme-noir-safari.css?v=811',
  './index.html',
  './redirect.js?v=826',
  './privacy.js?v=811',
  './settings-nav-scroll.css?v=843',
