...
const ASSETS = [
  ...
  './offline.html',
  './offline.js',
  './provider.webmanifest?v=844',
  './provider-icon-192.png?v=844',
  './provider-icon-512.png?v=844',
  './provider-icon-maskable-512.png?v=844',
  './provider-icon.svg?v=844',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=844',
  ...
  './provider-ux.css?v=844',
  './provider-service-actions.css?v=811',
  './provider-header.css?v=844',
  ...
  './provider-schedule-minimal.css?v=844',
  './provider-themes-distinct.css?v=821',
  './provider-theme-families.css?v=821',
  './provider-theme-backgrounds-tema1.css?v=844',
  './vendor/supabase-2.112.4.min.js',
  './config.js?v=811',
  './pwa-install.js?v=811',
  './site-update.js?v=844',
  ...
  './provider.js?v=844',
  './voice-wake.js?v=811',
  './provider-feature-assets.js?v=844',
];

// Warm after the first screen. A cold installation must not wait for tools
// that are only used from a dialog; retain their offline use after warming.
const OPTIONAL_ASSETS = [
  './provider-schedule-desktop-reference.css?v=844',
  './settings-nav-scroll.js?v=844',
  './settings-smart-search.js?v=844',
  './provider-theme-noir-safari.css?v=811',
  './index.html',
  './redirect.js?v=826',
  './privacy.js?v=811',
  './settings-nav-scroll.css?v=844',
