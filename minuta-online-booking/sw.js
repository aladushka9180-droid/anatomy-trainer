...
const ASSETS = [
  ...
  './offline.html',
  './offline.js',
  './provider.webmanifest?v=838',
  './provider-icon-192.png?v=838',
  './provider-icon-512.png?v=838',
  './provider-icon-maskable-512.png?v=838',
  './provider-icon.svg?v=838',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=838',
  ...
  './provider-schedule-minimal.css?v=838',
  './provider-themes-distinct.css?v=821',
  './provider-theme-families.css?v=821',
  './provider-theme-backgrounds-tema1.css?v=838',
  './vendor/supabase-2.112.4.min.js',
  './config.js?v=811',
  './pwa-install.js?v=811',
  './site-update.js?v=838',
  ...
  './provider.js?v=838',
  './voice-wake.js?v=811',
  './provider-feature-assets.js?v=838',
];

// Warm after the first screen. A cold installation must not wait for tools
// that are only used from a dialog; retain their offline use after warming.
const OPTIONAL_ASSETS = [
  './provider-schedule-desktop-reference.css?v=838',
