...
const CACHE = `${CACHE_PREFIX}v556`;
const ASSETS = [
  './microphone-diagnostic.js?v=556',
  './report-reconciliation.js?v=556',
  './provider-apricot-tiger-mobile.svg?v=556',
  './provider-apricot-tiger.svg?v=556',
  './provider-snow-leopard-natural-v2.webp?v=556',
  './provider-snow-leopard-unified-landscape-v5.png?v=556',
  './provider-snow-leopard-unified-portrait-v6.png?v=556',
  './theme-catalog.js?v=556',
  './client-themes.css?v=556',
  './legal-ux.css?v=556',
  './provider-header.css?v=556',
  './settings-nav-scroll.css?v=556',
  './settings-nav-scroll.js?v=556',
  './settings-smart-search.css?v=556',
  './settings-smart-search.js?v=556',
  './contextual-help.css?v=556',
  './contextual-help.js?v=556',
  './settings-mobile-minimalism.css?v=556',
  './provider-themes-wildlife.css?v=556',
  './provider-theme-noir-safari.css?v=556',
  './provider-noir-safari-bg.webp?v=556',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=556',
  './free-slots-compact.css?v=556',
  './vendor/qrcodegen.js?v=556',
  './provider-layout-responsive.css?v=556',
  './provider-ux.css?v=556',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=556',
  './help/help-data.js?v=556',
  './help/help.js?v=556',
  './help/article.js?v=556',
  './help/category.js?v=556',
  ...
  './provider.webmanifest?v=556',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=556',
  './code-scanner.css?v=556',
  './utm-funnel.css?v=556',
  './onboarding.css?v=556',
  './visitor-presence.css?v=556',
  './subscription-pricing.css?v=556',
  './provider-theme-loft-modern.css?v=556',
  './provider-themes-signature.css?v=556',
  './provider-themes-calm.css?v=556',
  './config.js?v=556',
  './site-update.js?v=556',
  './reliability.js?v=556',
  './phone-auth.js?v=556',
  './social-auth.js?v=556',
  './app.js?v=556',
  './resource-management.js?v=556',
  './shift-management.js?v=556',
  './organization.js?v=556',
  './payroll-management.js?v=556',
  './benefit-management.js?v=556',
  './loyalty-management.js?v=556',
  './inventory-management.js?v=556',
  './retention-management.js?v=556',
  './payment-management.js?v=556',
  './notification-center.js?v=556',
  './client-fields.js?v=556',
  './client-records.css?v=556',
  './client-records.js?v=556',
  './client-results.css?v=556',
  './client-results.js?v=556',
  './client-import.js?v=556',
  './code-scanner.js?v=556',
  './provider-feedback.js?v=556',
  './batch-bookings.js?v=556',
  './booking-policy-management.js?v=556',
  './team-calendar.js?v=556',
  './free-slots-share.js?v=556',
  './group-bookings.js?v=556',
  './telegram-auth.js?v=556',
  './pwa-install.js?v=556',
  './client-messaging.js?v=556',
  './provider-read-fetch.js?v=556',
  './provider.js?v=556',
  './client-directory.js?v=556',
  './client-directory.css?v=556',
  './provider-ui-refinements.css?v=556',
  './provider-schedule-minimal.css?v=556',
  './data-governance.js?v=556',
  './onboarding.js?v=556',
  './report-worker.js?v=556',
  './voice-assistant.js?v=556',
  './booking.js?v=556',
  './my-bookings.js?v=556',
  './waitlist.js?v=556',
  './privacy.js?v=556',
  './ui-icons.svg',
  './ui-icons.svg?v=556',
