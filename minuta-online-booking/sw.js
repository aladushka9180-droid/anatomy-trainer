...
const ASSETS = [
  ...
  './provider-ux.css?v=841',
  './provider-service-actions.css?v=811',
  './provider-header.css?v=841',
  ...
  './provider-schedule-minimal.css?v=841',
  './provider-themes-distinct.css?v=821',
  './provider-theme-families.css?v=821',
  './provider-theme-backgrounds-tema1.css?v=841',
...
const OPTIONAL_ASSETS = [
  ...
  './settings-nav-scroll.js?v=841',
  './settings-smart-search.js?v=841',
  './provider-theme-noir-safari.css?v=811',
  './index.html',
  './redirect.js?v=826',
  './privacy.js?v=811',
  './settings-nav-scroll.css?v=841',
