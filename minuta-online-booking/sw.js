...
const ASSETS = [
  ...
  './styles.css?v=278',
  './config.js?v=278',
  './site-update.js?v=278',
  './reliability.js?v=278',
  './phone-auth.js?v=278',
  './social-auth.js?v=278',
  './app.js?v=278',
  './resource-management.js?v=278',
  './shift-management.js?v=278',
  './organization.js?v=278',
  './payroll-management.js?v=278',
  './benefit-management.js?v=278',
  './loyalty-management.js?v=278',
  './inventory-management.js?v=278',
  './retention-management.js?v=278',
  './payment-management.js?v=278',
  './notification-center.js?v=278',
  './client-fields.js?v=278',
  './client-import.js?v=278',
  './batch-bookings.js?v=278',
  './booking-policy-management.js?v=278',
  './team-calendar.js?v=278',
  './free-slots-share.js?v=278',
  './group-bookings.js?v=278',
  './provider.js?v=278',
  './report-worker.js?v=278',
  './voice-assistant.js?v=278',
  './booking.js?v=278',
  './my-bookings.js?v=278',
  './waitlist.js?v=278',
  './ui-icons.svg',
  './ui-icons.svg?v=278',
