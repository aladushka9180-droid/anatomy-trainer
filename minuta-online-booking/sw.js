...
const CACHE = `${CACHE_PREFIX}v463`;
const ASSETS = [
  './report-reconciliation.js?v=463',
  './provider-apricot-tiger-mobile.svg?v=463',
  './provider-apricot-tiger.svg?v=463',
  './provider-snow-leopard-natural-v2.webp?v=463',
  './provider-header.css?v=463',
  './provider-themes-wildlife.css?v=463',
  './free-slots-compact.css?v=463',
  './vendor/qrcodegen.js?v=463',
  './provider-layout-responsive.css?v=463',
  './provider-ux.css?v=463',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=463',
  './help/help-data.js?v=463',
  './help/help.js?v=463',
  './help/article.js?v=463',
  './help/category.js?v=463',
  ...
  './provider.webmanifest?v=463',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=463',
  './code-scanner.css?v=463',
  './utm-funnel.css?v=463',
  './onboarding.css?v=463',
  './visitor-presence.css?v=463',
  './subscription-pricing.css?v=463',
  './provider-theme-loft-modern.css?v=463',
  './provider-themes-signature.css?v=463',
  './provider-themes-calm.css?v=463',
  './config.js?v=463',
  './site-update.js?v=463',
  './reliability.js?v=463',
  './phone-auth.js?v=463',
  './social-auth.js?v=463',
  './app.js?v=463',
  './resource-management.js?v=463',
  './shift-management.js?v=463',
  './organization.js?v=463',
  './payroll-management.js?v=463',
  './benefit-management.js?v=463',
  './loyalty-management.js?v=463',
  './inventory-management.js?v=463',
  './retention-management.js?v=463',
  './payment-management.js?v=463',
  './notification-center.js?v=463',
  './client-fields.js?v=463',
  './client-records.css?v=463',
  './client-records.js?v=463',
  './client-import.js?v=463',
  './code-scanner.js?v=463',
  './provider-feedback.js?v=463',
  './batch-bookings.js?v=463',
  './booking-policy-management.js?v=463',
  './team-calendar.js?v=463',
  './free-slots-share.js?v=463',
  './group-bookings.js?v=463',
  './telegram-auth.js?v=463',
  './pwa-install.js?v=463',
  './client-messaging.js?v=463',
  './provider-read-fetch.js?v=463',
  './provider.js?v=463',
  './data-governance.js?v=463',
  './onboarding.js?v=463',
  './report-worker.js?v=463',
  './voice-assistant.js?v=463',
  './booking.js?v=463',
  './my-bookings.js?v=463',
  './waitlist.js?v=463',
  './privacy.js?v=463',
  './ui-icons.svg',
  './ui-icons.svg?v=463',
