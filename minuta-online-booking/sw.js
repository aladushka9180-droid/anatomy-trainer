...
const ASSETS = [
  ...
  './styles.css?v=241',
  './config.js?v=241',
  './site-update.js?v=241',
  './reliability.js?v=241',
  './phone-auth.js?v=241',
  './app.js?v=241',
  './resource-management.js?v=241',
  './shift-management.js?v=241',
  './organization.js?v=241',
  './payroll-management.js?v=241',
  './benefit-management.js?v=241',
  './loyalty-management.js?v=241',
  './inventory-management.js?v=241',
  './retention-management.js?v=241',
  './payment-management.js?v=241',
  './notification-center.js?v=241',
  './client-fields.js?v=241',
  './batch-bookings.js?v=241',
  './booking-policy-management.js?v=241',
  './team-calendar.js?v=241',
  './free-slots-share.js?v=241',
  './group-bookings.js?v=241',
  './provider.js?v=241',
  './voice-assistant.js?v=241',
  './booking.js?v=241',
  './my-bookings.js?v=241',
  './waitlist.js?v=241',
  './ui-icons.svg',
  './ui-icons.svg?v=241',
