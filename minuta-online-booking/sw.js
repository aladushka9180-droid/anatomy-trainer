...
const ASSETS = [
  ...
  './styles.css?v=233',
  './config.js?v=233',
  './reliability.js?v=233',
  './phone-auth.js?v=233',
  './app.js?v=233',
  './resource-management.js?v=233',
  './shift-management.js?v=233',
  './organization.js?v=233',
  './payroll-management.js?v=233',
  './benefit-management.js?v=233',
  './loyalty-management.js?v=233',
  './inventory-management.js?v=233',
  './retention-management.js?v=233',
  './payment-management.js?v=233',
  './notification-center.js?v=233',
  './client-fields.js?v=233',
  './batch-bookings.js?v=233',
  './booking-policy-management.js?v=233',
  './team-calendar.js?v=233',
  './free-slots-share.js?v=233',
  './group-bookings.js?v=233',
  './provider.js?v=233',
  './voice-assistant.js?v=233',
  './booking.js?v=233',
  './my-bookings.js?v=233',
  './waitlist.js?v=233',
  './ui-icons.svg',
  './ui-icons.svg?v=233',
