...
const ASSETS = [
  ...
  './styles.css?v=239',
  './config.js?v=239',
  './reliability.js?v=239',
  './phone-auth.js?v=239',
  './app.js?v=239',
  './resource-management.js?v=239',
  './shift-management.js?v=239',
  './organization.js?v=239',
  './payroll-management.js?v=239',
  './benefit-management.js?v=239',
  './loyalty-management.js?v=239',
  './inventory-management.js?v=239',
  './retention-management.js?v=239',
  './payment-management.js?v=239',
  './notification-center.js?v=239',
  './client-fields.js?v=239',
  './batch-bookings.js?v=239',
  './booking-policy-management.js?v=239',
  './team-calendar.js?v=239',
  './free-slots-share.js?v=239',
  './group-bookings.js?v=239',
  './provider.js?v=239',
  './voice-assistant.js?v=239',
  './booking.js?v=239',
  './my-bookings.js?v=239',
  './waitlist.js?v=239',
  './ui-icons.svg',
  './ui-icons.svg?v=239',
