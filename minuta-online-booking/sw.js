...
const ASSETS = [
  ...
  './styles.css?v=230',
  './config.js?v=230',
  './reliability.js?v=230',
  './phone-auth.js?v=230',
  './app.js?v=230',
  './resource-management.js?v=230',
  './shift-management.js?v=230',
  './organization.js?v=230',
  './payroll-management.js?v=230',
  './benefit-management.js?v=230',
  './loyalty-management.js?v=230',
  './inventory-management.js?v=230',
  './retention-management.js?v=230',
  './payment-management.js?v=230',
  './notification-center.js?v=230',
  './client-fields.js?v=230',
  './batch-bookings.js?v=230',
  './booking-policy-management.js?v=230',
  './team-calendar.js?v=230',
  './free-slots-share.js?v=230',
  './group-bookings.js?v=230',
  './provider.js?v=230',
  './voice-assistant.js?v=230',
  './booking.js?v=230',
  './my-bookings.js?v=230',
  './waitlist.js?v=230',
  './ui-icons.svg',
  './ui-icons.svg?v=230',
