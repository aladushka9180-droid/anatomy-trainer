...
const CACHE = `${CACHE_PREFIX}v516`;
const ASSETS = [
  './microphone-diagnostic.js?v=516',
  './report-reconciliation.js?v=516',
  './provider-apricot-tiger-mobile.svg?v=516',
  './provider-apricot-tiger.svg?v=516',
  './provider-snow-leopard-natural-v2.webp?v=516',
  './provider-snow-leopard-unified-landscape-v5.png?v=516',
  './provider-snow-leopard-unified-portrait-v6.png?v=516',
  './theme-catalog.js?v=516',
  './client-themes.css?v=516',
  './provider-header.css?v=516',
  './settings-nav-scroll.css?v=516',
  './settings-nav-scroll.js?v=516',
  './settings-smart-search.css?v=516',
  './settings-smart-search.js?v=516',
  './contextual-help.css?v=516',
  './contextual-help.js?v=516',
  './settings-mobile-minimalism.css?v=516',
  './provider-themes-wildlife.css?v=516',
  './provider-theme-noir-safari.css?v=516',
  './provider-noir-safari-bg.webp?v=516',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=516',
  './free-slots-compact.css?v=516',
  './vendor/qrcodegen.js?v=516',
  './provider-layout-responsive.css?v=516',
  './provider-ux.css?v=516',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=516',
  './help/help-data.js?v=516',
  './help/help.js?v=516',
  './help/article.js?v=516',
  './help/category.js?v=516',
  ...
  './provider.webmanifest?v=516',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=516',
  './code-scanner.css?v=516',
  './utm-funnel.css?v=516',
  './onboarding.css?v=516',
  './visitor-presence.css?v=516',
  './subscription-pricing.css?v=516',
  './provider-theme-loft-modern.css?v=516',
  './provider-themes-signature.css?v=516',
  './provider-themes-calm.css?v=516',
  './config.js?v=516',
  './site-update.js?v=516',
  './reliability.js?v=516',
  './phone-auth.js?v=516',
  './social-auth.js?v=516',
  './app.js?v=516',
  './resource-management.js?v=516',
  './shift-management.js?v=516',
  './organization.js?v=516',
  './payroll-management.js?v=516',
  './benefit-management.js?v=516',
  './loyalty-management.js?v=516',
  './inventory-management.js?v=516',
  './retention-management.js?v=516',
  './payment-management.js?v=516',
  './notification-center.js?v=516',
  './client-fields.js?v=516',
  './client-records.css?v=516',
  './client-records.js?v=516',
  './client-import.js?v=516',
  './code-scanner.js?v=516',
  './provider-feedback.js?v=516',
  './batch-bookings.js?v=516',
  './booking-policy-management.js?v=516',
  './team-calendar.js?v=516',
  './free-slots-share.js?v=516',
  './group-bookings.js?v=516',
  './telegram-auth.js?v=516',
  './pwa-install.js?v=516',
  './client-messaging.js?v=516',
  './provider-read-fetch.js?v=516',
  './provider.js?v=516',
  './client-directory.js?v=516',
  './client-directory.css?v=516',
  './provider-ui-refinements.css?v=516',
  './provider-schedule-minimal.css?v=516',
  './data-governance.js?v=516',
  './onboarding.js?v=516',
  './report-worker.js?v=516',
  './voice-assistant.js?v=516',
  './booking.js?v=516',
  './my-bookings.js?v=516',
  './waitlist.js?v=516',
  './privacy.js?v=516',
  './ui-icons.svg',
  './ui-icons.svg?v=516',
