...
const CACHE = `${CACHE_PREFIX}v476`;
const ASSETS = [
  './microphone-diagnostic.js?v=476',
  './report-reconciliation.js?v=476',
  './provider-apricot-tiger-mobile.svg?v=476',
  './provider-apricot-tiger.svg?v=476',
  './provider-snow-leopard-natural-v2.webp?v=476',
  './provider-header.css?v=476',
  './settings-nav-scroll.css?v=476',
  './settings-nav-scroll.js?v=476',
  './settings-smart-search.css?v=476',
  './settings-smart-search.js?v=476',
  './contextual-help.css?v=476',
  './contextual-help.js?v=476',
  './settings-mobile-minimalism.css?v=476',
  './provider-themes-wildlife.css?v=476',
  './provider-theme-noir-safari.css?v=476',
  './provider-noir-safari-bg.webp?v=476',
  './free-slots-compact.css?v=476',
  './vendor/qrcodegen.js?v=476',
  './provider-layout-responsive.css?v=476',
  './provider-ux.css?v=476',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=476',
  './help/help-data.js?v=476',
  './help/help.js?v=476',
  './help/article.js?v=476',
  './help/category.js?v=476',
  ...
  './provider.webmanifest?v=476',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=476',
  './code-scanner.css?v=476',
  './utm-funnel.css?v=476',
  './onboarding.css?v=476',
  './visitor-presence.css?v=476',
  './subscription-pricing.css?v=476',
  './provider-theme-loft-modern.css?v=476',
  './provider-themes-signature.css?v=476',
  './provider-themes-calm.css?v=476',
  './config.js?v=476',
  './site-update.js?v=476',
  './reliability.js?v=476',
  './phone-auth.js?v=476',
  './social-auth.js?v=476',
  './app.js?v=476',
  './resource-management.js?v=476',
  './shift-management.js?v=476',
  './organization.js?v=476',
  './payroll-management.js?v=476',
  './benefit-management.js?v=476',
  './loyalty-management.js?v=476',
  './inventory-management.js?v=476',
  './retention-management.js?v=476',
  './payment-management.js?v=476',
  './notification-center.js?v=476',
  './client-fields.js?v=476',
  './client-records.css?v=476',
  './client-records.js?v=476',
  './client-import.js?v=476',
  './code-scanner.js?v=476',
  './provider-feedback.js?v=476',
  './batch-bookings.js?v=476',
  './booking-policy-management.js?v=476',
  './team-calendar.js?v=476',
  './free-slots-share.js?v=476',
  './group-bookings.js?v=476',
  './telegram-auth.js?v=476',
  './pwa-install.js?v=476',
  './client-messaging.js?v=476',
  './provider-read-fetch.js?v=476',
  './provider.js?v=476',
  './data-governance.js?v=476',
  './onboarding.js?v=476',
  './report-worker.js?v=476',
  './voice-assistant.js?v=476',
  './booking.js?v=476',
  './my-bookings.js?v=476',
  './waitlist.js?v=476',
  './privacy.js?v=476',
  './ui-icons.svg',
  './ui-icons.svg?v=476',
