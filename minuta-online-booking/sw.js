...
const ASSETS = [
  ...
  './reliability.js?v=313',
  './phone-auth.js?v=313',
  './social-auth.js?v=313',
  './app.js?v=313',
  './resource-management.js?v=313',
  './shift-management.js?v=313',
  './organization.js?v=313',
  './payroll-management.js?v=313',
  './benefit-management.js?v=313',
  './loyalty-management.js?v=313',
  './inventory-management.js?v=313',
  './retention-management.js?v=313',
  './payment-management.js?v=313',
  './notification-center.js?v=313',
  './client-fields.js?v=313',
  './client-import.js?v=313',
  './batch-bookings.js?v=313',
  './booking-policy-management.js?v=313',
  './team-calendar.js?v=313',
  './free-slots-share.js?v=313',
  './group-bookings.js?v=313',
  './pwa-install.js?v=313',
  './provider.js?v=313',
  './onboarding.js?v=313',
  './report-worker.js?v=313',
  './voice-assistant.js?v=313',
  './booking.js?v=313',
  './my-bookings.js?v=313',
  './waitlist.js?v=313',
  './ui-icons.svg',
  './ui-icons.svg?v=313',
