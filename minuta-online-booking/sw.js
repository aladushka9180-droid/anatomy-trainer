...
const ASSETS = [
  ...
  './offline.html',
  './offline.js',
  './provider.webmanifest?v=855',
  './provider-icon-192.png?v=855',
  './provider-icon-512.png?v=855',
  './provider-icon-maskable-512.png?v=855',
  './provider-icon.svg?v=855',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=855',
