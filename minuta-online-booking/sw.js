...
const CACHE = `${CACHE_PREFIX}v520`;
const ASSETS = [
  './microphone-diagnostic.js?v=520',
  './report-reconciliation.js?v=520',
  './provider-apricot-tiger-mobile.svg?v=520',
  './provider-apricot-tiger.svg?v=520',
  './provider-snow-leopard-natural-v2.webp?v=520',
  './provider-snow-leopard-unified-landscape-v5.png?v=520',
  './provider-snow-leopard-unified-portrait-v6.png?v=520',
  './theme-catalog.js?v=520',
  './client-themes.css?v=520',
  './provider-header.css?v=520',
  './settings-nav-scroll.css?v=520',
  './settings-nav-scroll.js?v=520',
  './settings-smart-search.css?v=520',
  './settings-smart-search.js?v=520',
  './contextual-help.css?v=520',
  './contextual-help.js?v=520',
  './settings-mobile-minimalism.css?v=520',
  './provider-themes-wildlife.css?v=520',
  './provider-theme-noir-safari.css?v=520',
  './provider-noir-safari-bg.webp?v=520',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=520',
  './free-slots-compact.css?v=520',
  './vendor/qrcodegen.js?v=520',
  './provider-layout-responsive.css?v=520',
  './provider-ux.css?v=520',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=520',
  './help/help-data.js?v=520',
  './help/help.js?v=520',
  './help/article.js?v=520',
  './help/category.js?v=520',
  ...
  './provider.webmanifest?v=520',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=520',
  './code-scanner.css?v=520',
  './utm-funnel.css?v=520',
  './onboarding.css?v=520',
  './visitor-presence.css?v=520',
  './subscription-pricing.css?v=520',
  './provider-theme-loft-modern.css?v=520',
  './provider-themes-signature.css?v=520',
  './provider-themes-calm.css?v=520',
  './config.js?v=520',
  './site-update.js?v=520',
  './reliability.js?v=520',
  './phone-auth.js?v=520',
  './social-auth.js?v=520',
  './app.js?v=520',
  './resource-management.js?v=520',
  './shift-management.js?v=520',
  './organization.js?v=520',
  './payroll-management.js?v=520',
  './benefit-management.js?v=520',
  './loyalty-management.js?v=520',
  './inventory-management.js?v=520',
  './retention-management.js?v=520',
  './payment-management.js?v=520',
  './notification-center.js?v=520',
  './client-fields.js?v=520',
  './client-records.css?v=520',
  './client-records.js?v=520',
  './client-import.js?v=520',
  './code-scanner.js?v=520',
  './provider-feedback.js?v=520',
  './batch-bookings.js?v=520',
  './booking-policy-management.js?v=520',
  './team-calendar.js?v=520',
  './free-slots-share.js?v=520',
  './group-bookings.js?v=520',
  './telegram-auth.js?v=520',
  './pwa-install.js?v=520',
  './client-messaging.js?v=520',
  './provider-read-fetch.js?v=520',
  './provider.js?v=520',
  './client-directory.js?v=520',
  './client-directory.css?v=520',
  './provider-ui-refinements.css?v=520',
  './provider-schedule-minimal.css?v=520',
  './data-governance.js?v=520',
  './onboarding.js?v=520',
  './report-worker.js?v=520',
  './voice-assistant.js?v=520',
  './booking.js?v=520',
  './my-bookings.js?v=520',
  './waitlist.js?v=520',
  './privacy.js?v=520',
  './ui-icons.svg',
  './ui-icons.svg?v=520',
