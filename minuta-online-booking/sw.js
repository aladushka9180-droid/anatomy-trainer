...
const ASSETS = [
  ...
  './styles.css?v=231',
  './config.js?v=231',
  './reliability.js?v=231',
  './phone-auth.js?v=231',
  './app.js?v=231',
  './resource-management.js?v=231',
  './shift-management.js?v=231',
  './organization.js?v=231',
  './payroll-management.js?v=231',
  './benefit-management.js?v=231',
  './loyalty-management.js?v=231',
  './inventory-management.js?v=231',
  './retention-management.js?v=231',
  './payment-management.js?v=231',
  './notification-center.js?v=231',
  './client-fields.js?v=231',
  './batch-bookings.js?v=231',
  './booking-policy-management.js?v=231',
  './team-calendar.js?v=231',
  './free-slots-share.js?v=231',
  './group-bookings.js?v=231',
  './provider.js?v=231',
  './voice-assistant.js?v=231',
  './booking.js?v=231',
  './my-bookings.js?v=231',
  './waitlist.js?v=231',
  './ui-icons.svg',
  './ui-icons.svg?v=231',
