...
const CACHE = `${CACHE_PREFIX}v551`;
const ASSETS = [
  './microphone-diagnostic.js?v=551',
  './report-reconciliation.js?v=551',
  './provider-apricot-tiger-mobile.svg?v=551',
  './provider-apricot-tiger.svg?v=551',
  './provider-snow-leopard-natural-v2.webp?v=551',
  './provider-snow-leopard-unified-landscape-v5.png?v=551',
  './provider-snow-leopard-unified-portrait-v6.png?v=551',
  './theme-catalog.js?v=551',
  './client-themes.css?v=551',
  './provider-header.css?v=551',
  './settings-nav-scroll.css?v=551',
  './settings-nav-scroll.js?v=551',
  './settings-smart-search.css?v=551',
  './settings-smart-search.js?v=551',
  './contextual-help.css?v=551',
  './contextual-help.js?v=551',
  './settings-mobile-minimalism.css?v=551',
  './provider-themes-wildlife.css?v=551',
  './provider-theme-noir-safari.css?v=551',
  './provider-noir-safari-bg.webp?v=551',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=551',
  './free-slots-compact.css?v=551',
  './vendor/qrcodegen.js?v=551',
  './provider-layout-responsive.css?v=551',
  './provider-ux.css?v=551',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=551',
  './help/help-data.js?v=551',
  './help/help.js?v=551',
  './help/article.js?v=551',
  './help/category.js?v=551',
  ...
  './provider.webmanifest?v=551',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=551',
  './code-scanner.css?v=551',
  './utm-funnel.css?v=551',
  './onboarding.css?v=551',
  './visitor-presence.css?v=551',
  './subscription-pricing.css?v=551',
  './provider-theme-loft-modern.css?v=551',
  './provider-themes-signature.css?v=551',
  './provider-themes-calm.css?v=551',
  './config.js?v=551',
  './site-update.js?v=551',
  './reliability.js?v=551',
  './phone-auth.js?v=551',
  './social-auth.js?v=551',
  './app.js?v=551',
  './resource-management.js?v=551',
  './shift-management.js?v=551',
  './organization.js?v=551',
  './payroll-management.js?v=551',
  './benefit-management.js?v=551',
  './loyalty-management.js?v=551',
  './inventory-management.js?v=551',
  './retention-management.js?v=551',
  './payment-management.js?v=551',
  './notification-center.js?v=551',
  './client-fields.js?v=551',
  './client-records.css?v=551',
  './client-records.js?v=551',
  './client-results.css?v=551',
  './client-results.js?v=551',
  './client-import.js?v=551',
  './code-scanner.js?v=551',
  './provider-feedback.js?v=551',
  './batch-bookings.js?v=551',
  './booking-policy-management.js?v=551',
  './team-calendar.js?v=551',
  './free-slots-share.js?v=551',
  './group-bookings.js?v=551',
  './telegram-auth.js?v=551',
  './pwa-install.js?v=551',
  './client-messaging.js?v=551',
  './provider-read-fetch.js?v=551',
  './provider.js?v=551',
  './client-directory.js?v=551',
  './client-directory.css?v=551',
  './provider-ui-refinements.css?v=551',
  './provider-schedule-minimal.css?v=551',
  './data-governance.js?v=551',
  './onboarding.js?v=551',
  './report-worker.js?v=551',
  './voice-assistant.js?v=551',
  './booking.js?v=551',
  './my-bookings.js?v=551',
  './waitlist.js?v=551',
  './privacy.js?v=551',
  './ui-icons.svg',
  './ui-icons.svg?v=551',
