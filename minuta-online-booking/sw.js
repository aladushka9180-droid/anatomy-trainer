...
const ASSETS = [
  ...
  './styles.css?v=263',
  './config.js?v=263',
  './site-update.js?v=263',
  './reliability.js?v=263',
  './phone-auth.js?v=263',
  './social-auth.js?v=263',
  './app.js?v=263',
  './resource-management.js?v=263',
  './shift-management.js?v=263',
  './organization.js?v=263',
  './payroll-management.js?v=263',
  './benefit-management.js?v=263',
  './loyalty-management.js?v=263',
  './inventory-management.js?v=263',
  './retention-management.js?v=263',
  './payment-management.js?v=263',
  './notification-center.js?v=263',
  './client-fields.js?v=263',
  './client-import.js?v=263',
  './batch-bookings.js?v=263',
  './booking-policy-management.js?v=263',
  './team-calendar.js?v=263',
  './free-slots-share.js?v=263',
  './group-bookings.js?v=263',
  './provider.js?v=263',
  './report-worker.js?v=263',
  './voice-assistant.js?v=263',
  './booking.js?v=263',
  './my-bookings.js?v=263',
  './waitlist.js?v=263',
  './ui-icons.svg',
  './ui-icons.svg?v=263',
