...
const ASSETS = [
  ...
  './styles.css?v=234',
  './config.js?v=234',
  './reliability.js?v=234',
  './phone-auth.js?v=234',
  './app.js?v=234',
  './resource-management.js?v=234',
  './shift-management.js?v=234',
  './organization.js?v=234',
  './payroll-management.js?v=234',
  './benefit-management.js?v=234',
  './loyalty-management.js?v=234',
  './inventory-management.js?v=234',
  './retention-management.js?v=234',
  './payment-management.js?v=234',
  './notification-center.js?v=234',
  './client-fields.js?v=234',
  './batch-bookings.js?v=234',
  './booking-policy-management.js?v=234',
  './team-calendar.js?v=234',
  './free-slots-share.js?v=234',
  './group-bookings.js?v=234',
  './provider.js?v=234',
  './voice-assistant.js?v=234',
  './booking.js?v=234',
  './my-bookings.js?v=234',
  './waitlist.js?v=234',
  './ui-icons.svg',
  './ui-icons.svg?v=234',
