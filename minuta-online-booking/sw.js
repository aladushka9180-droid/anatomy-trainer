...
const ASSETS = [
  ...
  './styles.css?v=236',
  './config.js?v=236',
  './reliability.js?v=236',
  './phone-auth.js?v=236',
  './app.js?v=236',
  './resource-management.js?v=236',
  './shift-management.js?v=236',
  './organization.js?v=236',
  './payroll-management.js?v=236',
  './benefit-management.js?v=236',
  './loyalty-management.js?v=236',
  './inventory-management.js?v=236',
  './retention-management.js?v=236',
  './payment-management.js?v=236',
  './notification-center.js?v=236',
  './client-fields.js?v=236',
  './batch-bookings.js?v=236',
  './booking-policy-management.js?v=236',
  './team-calendar.js?v=236',
  './free-slots-share.js?v=236',
  './group-bookings.js?v=236',
  './provider.js?v=236',
  './voice-assistant.js?v=236',
  './booking.js?v=236',
  './my-bookings.js?v=236',
  './waitlist.js?v=236',
  './ui-icons.svg',
  './ui-icons.svg?v=236',
