...
const ASSETS = [
  ...
  './provider-ux.css?v=855',
  './provider-service-actions.css?v=811',
  './provider-header.css?v=855',
...
const OPTIONAL_ASSETS = [
  ...
  './loyalty-program-v166.js?v=855',
  './provider-schedule-desktop-reference.css?v=855',
  './settings-nav-scroll.js?v=855',
  './settings-smart-search.js?v=855',
  './provider-theme-noir-safari.css?v=811',
  './index.html',
  './redirect.js?v=826',
  './privacy.js?v=811',
  './settings-nav-scroll.css?v=855',
