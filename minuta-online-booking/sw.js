...
const ASSETS = [
  ...
  './offline.html',
  './offline.js',
  './provider.webmanifest?v=860',
  './provider-icon-192.png?v=860',
  './provider-icon-512.png?v=860',
  './provider-icon-maskable-512.png?v=860',
  './provider-icon.svg?v=860',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=860',
  ...
  './provider-ux.css?v=860',
  './provider-service-actions.css?v=811',
  './provider-header.css?v=860',
  ...
  './provider-schedule-minimal.css?v=860',
  './provider-themes-distinct.css?v=821',
  './provider-theme-families.css?v=821',
  './provider-theme-backgrounds-tema1.css?v=860',
  './vendor/supabase-2.112.4.min.js',
  './config.js?v=811',
  './pwa-install.js?v=811',
  './site-update.js?v=860',
  ...
  './provider.js?v=860',
  './voice-wake.js?v=811',
  './provider-feature-assets.js?v=860',
];
...
const OPTIONAL_ASSETS = [
  ...
  './loyalty-program-v166.js?v=860',
  './provider-schedule-desktop-reference.css?v=860',
  './settings-nav-scroll.js?v=860',
  './settings-smart-search.js?v=860',
  './provider-theme-noir-safari.css?v=811',
  './index.html',
  './redirect.js?v=826',
  './privacy.js?v=811',
  './settings-nav-scroll.css?v=860',
