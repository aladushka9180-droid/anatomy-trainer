...
const CACHE = `${CACHE_PREFIX}v962`;
const CACHE_READY = './.precache-ready-v962';
...
const ASSETS = [
  ...
  './ui-icons.svg',
  './styles.css?v=950',
  './provider-reference-screens.css?v=962',
...
const OPTIONAL_ASSETS = [
  ...
  './provider-schedule-desktop-reference.css?v=946',
