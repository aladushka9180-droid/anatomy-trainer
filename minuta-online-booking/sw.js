...
const ASSETS = [
  ...
  './styles.css?v=237',
  './config.js?v=237',
  './reliability.js?v=237',
  './phone-auth.js?v=237',
  './app.js?v=237',
  './resource-management.js?v=237',
  './shift-management.js?v=237',
  './organization.js?v=237',
  './payroll-management.js?v=237',
  './benefit-management.js?v=237',
  './loyalty-management.js?v=237',
  './inventory-management.js?v=237',
  './retention-management.js?v=237',
  './payment-management.js?v=237',
  './notification-center.js?v=237',
  './client-fields.js?v=237',
  './batch-bookings.js?v=237',
  './booking-policy-management.js?v=237',
  './team-calendar.js?v=237',
  './free-slots-share.js?v=237',
  './group-bookings.js?v=237',
  './provider.js?v=237',
  './voice-assistant.js?v=237',
  './booking.js?v=237',
  './my-bookings.js?v=237',
  './waitlist.js?v=237',
  './ui-icons.svg',
  './ui-icons.svg?v=237',
