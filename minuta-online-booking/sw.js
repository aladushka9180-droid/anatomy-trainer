...
const CACHE = `${CACHE_PREFIX}v499`;
const ASSETS = [
  './microphone-diagnostic.js?v=499',
  './report-reconciliation.js?v=499',
  './provider-apricot-tiger-mobile.svg?v=499',
  './provider-apricot-tiger.svg?v=499',
  './provider-snow-leopard-natural-v2.webp?v=499',
  './provider-snow-leopard-continuous-4k-v3.webp?v=499',
  './provider-header.css?v=499',
  './settings-nav-scroll.css?v=499',
  './settings-nav-scroll.js?v=499',
  './settings-smart-search.css?v=499',
  './settings-smart-search.js?v=499',
  './contextual-help.css?v=499',
  './contextual-help.js?v=499',
  './settings-mobile-minimalism.css?v=499',
  './provider-themes-wildlife.css?v=499',
  './provider-theme-noir-safari.css?v=499',
  './provider-noir-safari-bg.webp?v=499',
  './provider-pearl-zebra-smooth-4k-v4.webp?v=499',
  './free-slots-compact.css?v=499',
  './vendor/qrcodegen.js?v=499',
  './provider-layout-responsive.css?v=499',
  './provider-ux.css?v=499',
  './',
  './index.html',
  './provider.html',
  './booking.html',
  ...
  './help/category.html',
  './help/help.css?v=499',
  './help/help-data.js?v=499',
  './help/help.js?v=499',
  './help/article.js?v=499',
  './help/category.js?v=499',
  ...
  './provider.webmanifest?v=499',
  './provider-icon-192.png',
  './provider-icon-512.png',
  './provider-icon-maskable-512.png',
  './provider-luxury-marble-v4.webp',
  './styles.css?v=499',
  './code-scanner.css?v=499',
  './utm-funnel.css?v=499',
  './onboarding.css?v=499',
  './visitor-presence.css?v=499',
  './subscription-pricing.css?v=499',
  './provider-theme-loft-modern.css?v=499',
  './provider-themes-signature.css?v=499',
  './provider-themes-calm.css?v=499',
  './config.js?v=499',
  './site-update.js?v=499',
  './reliability.js?v=499',
  './phone-auth.js?v=499',
  './social-auth.js?v=499',
  './app.js?v=499',
  './resource-management.js?v=499',
  './shift-management.js?v=499',
  './organization.js?v=499',
  './payroll-management.js?v=499',
  './benefit-management.js?v=499',
  './loyalty-management.js?v=499',
  './inventory-management.js?v=499',
  './retention-management.js?v=499',
  './payment-management.js?v=499',
  './notification-center.js?v=499',
  './client-fields.js?v=499',
  './client-records.css?v=499',
  './client-records.js?v=499',
  './client-import.js?v=499',
  './code-scanner.js?v=499',
  './provider-feedback.js?v=499',
  './batch-bookings.js?v=499',
  './booking-policy-management.js?v=499',
  './team-calendar.js?v=499',
  './free-slots-share.js?v=499',
  './group-bookings.js?v=499',
  './telegram-auth.js?v=499',
  './pwa-install.js?v=499',
  './client-messaging.js?v=499',
  './provider-read-fetch.js?v=499',
  './provider.js?v=499',
  './client-directory.js?v=499',
  './client-directory.css?v=499',
  './data-governance.js?v=499',
  './onboarding.js?v=499',
  './report-worker.js?v=499',
  './voice-assistant.js?v=499',
  './booking.js?v=499',
  './my-bookings.js?v=499',
  './waitlist.js?v=499',
  './privacy.js?v=499',
  './ui-icons.svg',
  './ui-icons.svg?v=499',
