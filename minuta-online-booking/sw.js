...
const ASSETS = [
  ...
  './styles.css?v=235',
  './config.js?v=235',
  './reliability.js?v=235',
  './phone-auth.js?v=235',
  './app.js?v=235',
  './resource-management.js?v=235',
  './shift-management.js?v=235',
  './organization.js?v=235',
  './payroll-management.js?v=235',
  './benefit-management.js?v=235',
  './loyalty-management.js?v=235',
  './inventory-management.js?v=235',
  './retention-management.js?v=235',
  './payment-management.js?v=235',
  './notification-center.js?v=235',
  './client-fields.js?v=235',
  './batch-bookings.js?v=235',
  './booking-policy-management.js?v=235',
  './team-calendar.js?v=235',
  './free-slots-share.js?v=235',
  './group-bookings.js?v=235',
  './provider.js?v=235',
  './voice-assistant.js?v=235',
  './booking.js?v=235',
  './my-bookings.js?v=235',
  './waitlist.js?v=235',
  './ui-icons.svg',
  './ui-icons.svg?v=235',
