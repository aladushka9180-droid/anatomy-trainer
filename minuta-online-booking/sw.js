...
const ASSETS = [
  ...
  './styles.css?v=221',
  './config.js?v=221',
  './reliability.js?v=221',
  './app.js?v=221',
  './resource-management.js?v=221',
  './shift-management.js?v=221',
  './organization.js?v=221',
  './payroll-management.js?v=221',
  './benefit-management.js?v=221',
  './loyalty-management.js?v=221',
  './inventory-management.js?v=221',
  './retention-management.js?v=221',
  './payment-management.js?v=221',
  './notification-center.js?v=221',
  './client-fields.js?v=221',
  './batch-bookings.js?v=221',
  './booking-policy-management.js?v=221',
  './team-calendar.js?v=221',
  './free-slots-share.js?v=221',
  './group-bookings.js?v=221',
  './provider.js?v=221',
  './voice-assistant.js?v=221',
  './booking.js?v=221',
  './my-bookings.js?v=221',
  './waitlist.js?v=221',
  './ui-icons.svg',
  './ui-icons.svg?v=221',
