...
assert.match(provider, /openNewBookingSheet\(time, \{ date:dateIso, historical:dateIso < businessTodayIso\(\) \}\)/, 'Нажатие на время передаёт выбранную дату, не превращая прошедшее время сегодня в состоявшийся визит');
...
assert.match(provider, /newBookingHistoricalMode \? historicalCaption/, 'Кнопка сохранения не объясняет действие');
