...
assert.match(families, /\.provider-theme-option\[class\*="theme-"\]:not\(:is\(\.theme-snow-leopard,\.theme-pearl-zebra,\.theme-concrete-signal,\.theme-luxury,\.theme-cocoa-pearl,\.theme-coastal\)\) \.theme-swatch/);
...
assert.match(provider, /theme-catalog\.js\?v=750/);
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v750`/);
assert.match(worker, /\.\/theme-catalog\.js\?v=750/);
...
console.log('Theme background patterns v750: PASS');
