...
assert.match(provider, /theme-catalog\.js\?v=723/);
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v723`/);
assert.match(worker, /\.\/theme-catalog\.js\?v=723/);
...
console.log('Theme background patterns v723: PASS');
