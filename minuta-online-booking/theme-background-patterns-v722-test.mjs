...
assert.match(provider, /theme-catalog\.js\?v=728/);
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v728`/);
assert.match(worker, /\.\/theme-catalog\.js\?v=728/);
...
console.log('Theme background patterns v728: PASS');
