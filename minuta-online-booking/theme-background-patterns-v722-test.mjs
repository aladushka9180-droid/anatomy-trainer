...
assert.match(provider, /theme-catalog\.js\?v=815/);
assert.match(worker, /const CACHE = `\$\{CACHE_PREFIX\}v815`/);
assert.match(worker, /\.\/theme-catalog\.js\?v=815/);
...
console.log('Theme background patterns v811: PASS');
