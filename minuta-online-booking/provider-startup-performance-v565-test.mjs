...
assert.ok(assets.length > 0 && assets.length <= 74, `Unexpected core precache size: ${assets.length}`);
...
console.log(`Provider startup performance v720: PASS (${assets.length} core files, ${precacheBytes} bytes)`);
