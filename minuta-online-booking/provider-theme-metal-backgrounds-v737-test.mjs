...
const assets = [
  ['provider-cobalt-forge-desktop-v3.webp', 450_000, 1_200_000],
  ['provider-petrol-steel-desktop-v2.webp', 900_000, 1_800_000],
  ['provider-cobalt-forge-mobile-v3.webp', 450_000, 1_200_000],
...
assert.match(css, /data-provider-theme="cobalt-forge"[\s\S]*::after[\s\S]*provider-cobalt-forge-desktop-v3\.webp/);
