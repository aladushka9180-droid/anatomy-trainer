...
const ASSETS=['./','./index.html','./minimal-redesign.css?v=75','./professional-learning.css?v=50','./anatomy-learning.css?v=14','./profiles.js?v=6','./massage-data.js','./practice-cases.js','./learning-paths.js','./learning-sources.js','./reference-data.js?v=8','./massage-techniques.js?v=38','./practice-curriculum.js?v=38','./professional-learning.js?v=53','./ai-assistant.js?v=46','./anatomy-learning.js?v=16','./manifest.webmanifest','./icon-192.png','./icon-512.png','./anatomy-upper-limb.png','./anatomy-deltoid.png','./anatomy-leg.png','./anatomy-calf.png','./anatomy-gluteal.png','./anatomy-adductors.png','./anatomy-back.png','./anatomy-neck.png','./bones-skull.svg','./bones-upper-limb.svg?v=2','./bones-spine.png','./bones-vertebrae.png','./bones-lower-limb.svg?v=2','./practice-compression.png','./practice-percussion.png','./practice-passive-stretch.png',...MOTION_LEGACY];
