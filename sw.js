const CACHE='anatomy-v24';
const ASSETS=['./','./index.html','./minimal-redesign.css?v=24','./massage-data.js','./practice-cases.js','./learning-paths.js','./learning-sources.js','./reference-data.js','./ai-assistant.js?v=24','./manifest.webmanifest','./icon-192.png','./icon-512.png','./anatomy-upper-limb.png','./anatomy-leg.png','./anatomy-calf.png','./anatomy-gluteal.png','./anatomy-adductors.png','./anatomy-back.png','./anatomy-neck.png','./bones-skull.svg','./bones-upper-limb.svg','./bones-spine.png','./bones-vertebrae.png','./bones-lower-limb.svg'];
